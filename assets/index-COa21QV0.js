...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ws(e,t,n){let r=new Float32Array(As),i=new U(0,1,0);return new Va({name:`SphericalGaussianBlur`,defines:{n:As,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:qs(),fragmentShader:`
	...
	`}var Js=class extends Yt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new _a(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `});this.mesh=new Y(new ja(700,32,20),t),this.mesh.frustumCulled=!1,this.mesh.renderOrder=-10,e.add(this.mesh)}update(e){this.uniforms.uTime.value=e}dispose(){this.mesh.geometry.dispose(),this.mesh.material.dispose()}},Pu=class{constructor(e){this.uniforms={uBase:{value:new q(`#252e3a`)},uAccent:{value:new q(`#446080`)},uVein:{value:.22},uKey:{value:new q(`#bcd2ff`)},uAmb:{value:new q(`#334e78`)},uFog:{value:new q(`#141c28`)},uFogNear:{value:26},uFogFar:{value:100},uTime:{value:0}};let t=new Va({fog:!1,uniforms:this.uniforms,vertexShader:`
        varying vec3 vWorld;
        void main() {
      ...
      `});this.mesh=new Y(new Ca(150,72),t),this.mesh.rotation.x=-Math.PI/2,e.add(this.mesh)}update(e){this.uniforms.uTime.value=e}dispose(){this.mesh.geometry.dispose(),this.mesh.material.dispose()}},Fu=1400,Iu=56,Lu=17,Ru={snow:{body:`
    ...
    `,alpha:.8},sparks:{body:`
      ...
      vSz = 0.6 + aSeed * 0.7;
    `,alpha:.85}},zu=class{constructor(e){this.scene=e,this._mode=`none`,this._systems=new Map;for(let[t,n]of Object.entries(Ru)){let r=new Or,i=new Float32Array(Fu*3),a=new Float32Array(Fu);for(let e=0;e<Fu;e++)i[e*3+0]=(Math.random()-.5)*Iu,i[e*3+1]=Math.random()*Lu,i[e*3+2]=(Math.random()-.5)*Iu,a[e]=Math.random();r.setAttribute(`position`,new J(i,3)),r.setAttribute(`aSeed`,new J(a,1)),r.boundingSphere=null;let o=new Va({transparent:!0,depthWrite:!1,blending:2,fog:!1,uniforms:{uTime:{value:0},uIntensity:{value:0},uH:{value:Lu},uPixelRatio:{value:1}},vertexShader:`
          uniform float uTime;
          uniform float uH;
...
`;function ef(){return new Va({transparent:!0,depthWrite:!1,depthTest:!0,blending:2,side:2,toneMapped:!1,uniforms:{uTime:{value:0},uFade:{value:1},uDissolve:{value:0},uSwelling:{value:0},uColorA:{value:new q(`#9fd8ff`)},uColorB:{value:new q(`#ffffff`)}},vertexShader:Qd,fragmentShader:$d})}var tf=class{constructor(e){this.root=new En,this.body=new En,this.root.add(this.body),this.scene=e,e.add(this.root);let t=new Ua({color:`#2b3547`,roughness:.75,metalness:.05,flatShading:!0}),n=new Ua({color:`#42536e`,roughness:.6,flatShading:!0});this.robe=new Y(new Ta(.52,1.55,9),t),this.robe.position.y=.78;let r=new Y(new wa(.3,.36,.22,9),n);r.position.y=1.42,this.head=new En;let i=new Y(new Ta(.3,.52,8),t);i.position.y=.28;let a=new Y(new ja(.21,12,10),new Ua({color:`#101620`,roughness:.9}));a.position.set(0,.12,.1),this.head.add(i,a),this.head.position.y=1.5,this._eyeMaterial=new ii({color:`#9fd8ff`});let o=new ja(.028,6,6),s=new Y(o,this._eyeMaterial);s.position.set(-.07,.14,.26);let c=new Y(o,this._eyeMaterial);c.position.set(.07,.14,.26),this.head.add(s,c),this.staff=new En;let l=new Y(new wa(.035,.05,1.85,6),new Ua({color:`#1a1410`,roughness:.85}));l.position.y=.92,this._orbMaterial=new Ua({color:`#9fd8ff`,emissive:`#9fd8ff`,emissiveIntensity:1.6,roughness:.3}),this.orb=new Y(new ja(.14,14,12),this._orbMaterial),this.orb.position.y=1.95,this.orb.renderOrder=20,this.orbLight=new Vo(`#9fd8ff`,6,7,2),this.orbLight.position.y=1.95,this.staff.add(l,this.orb,this.orbLight),this.staff.position.set(.44,.05,.12),this.staff.rotation.x=-.08,this.blob=new Y(new Ca(.62,24),new ii({color:`#000000`,transparent:!0,opacity:.34,depthWrite:!1})),this.blob.rotation.x=-Math.PI/2,this.blob.position.y=.02,e.add(this.blob),this.hoverGlow=new Y(new Ca(.85,26),new ii({color:`#9fd8ff`,transparent:!0,opacity:0,blending:2,depthWrite:!1})),this.hoverGlow.rotation.x=-Math.PI/2,e.add(this.hoverGlow),this.shield=new Y(new ja(1.35,40,26),ef()),this.shield.visible=!1,this.shield.renderOrder=20,e.add(this.shield),this._shieldShown=!1,this._dissolveT=1,this._dissolveFrom=new U,this.body.add(this.robe,r,this.head,this.staff),this.position=new U(0,0,0),this.velocity=new U,this.facing=0,this._moveAmount=0,this._castT=1,this._bobT=0,this._hover=0,this._tilt=0,this.edgePush=0,this.edgeProximity=0,this.edgeAngle=0,this.edgePoint=new U,this._scratch=new U}updateShield(e,t,n=1/60){let r=this.shield.material.uniforms;if(r.uTime.value=e,this._shieldShown&&t<=0&&(this._shieldShown=!1,this._dissolveT=0,this._dissolveFrom.copy(this.shield.position)),this._dissolveT<1){this._dissolveT=Math.min(1,this._dissolveT+n/.45);let e=this._dissolveT;this.shield.visible=!0,this.shield.position.copy(this._dissolveFrom),this.shield.scale.setScalar(1+e*.65),r.uDissolve.value=e,r.uFade.value=(1-e)*.9,r.uSwelling.value=e,e>=1&&(this.shield.visible=!1);return}if(t<=0){this.shield.visible=!1,this._shieldShown=!1;return}this._shieldShown||(this._shieldShown=!0,this.shield.scale.setScalar(.6));let i=this.shield.scale.x+(1-this.shield.scale.x)*Math.min(1,n*10);this.shield.visible=!0,this.shield.position.set(this.position.x,1.05,this.position.z);let a=Math.min(1,t/.35),o=.78+.22*Math.sin(e*16);r.uFade.value=.9*a*o,r.uDissolve.value=0,r.uSwelling.value=0,this.shield.scale.setScalar(i*(1+.03*Math.sin(e*11)))}getOrbWorldPosition(e){return this.orb.getWorldPosition(e)}setElement(e){this._orbMaterial.color.set(e),this._orbMaterial.emissive.set(e),this.orbLight.color.set(e),this._eyeMaterial.color.set(e),this.hoverGlow.material.color.set(e)}playCast(){this._castT=0}update(e,t,n,r,i=!1){let a=i?17:6.2;if(t){this.position.addScaledVector(t,a*e);let n=Math.hypot(this.position.x,this.position.z),r=!1;n>58&&(this.position.x*=58/n,this.position.z*=58/n,r=!0);let o=n>1e-4?1/n:0,s=(t.x*this.position.x+t.z*this.position.z)*o,c=r&&s>.12,l=c?Math.min(1,.5+s*.6):0;this.edgePush+=(l-this.edgePush)*Math.min(1,e*(c?14:6)),this._faceToward(Math.atan2(t.x,t.z),e,i?9:14),this._moveAmount=Math.min(1,this._moveAmount+e*6)}else if(this._moveAmount=Math.max(0,this._moveAmount-e*6),this.edgePush+=(0-this.edgePush)*Math.min(1,e*6),n){let t=n.x-this.position.x,r=n.z-this.position.z;t*t+r*r>1&&this._faceToward(Math.atan2(t,r),e,4)}let o=58-Math.hypot(this.position.x,this.position.z);this.edgeProximity=Math.max(0,Math.min(1,1-o/9)),this.edgeAngle=Math.atan2(this.position.x,this.position.z),this.edgePoint.set(Math.sin(this.edgeAngle)*58,.08,Math.cos(this.edgeAngle)*58);let s=i?1.25:0;this._hover+=(s-this._hover)*Math.min(1,e*4.5);let c=i&&t?.42:0;this._tilt+=(c-this._tilt)*Math.min(1,e*6),this.body.rotation.x=this._tilt,this._bobT+=e*(5+this._moveAmount*6);let l=0;if(this._castT<1){this._castT=Math.min(1,this._castT+e/.55);let t=Math.sin(this._castT*Math.PI);l=t*.09,this.staff.rotation.x=-.08-t*.85;let n=1+t*.9;this.orb.scale.setScalar(n),this.orbLight.intensity=6+t*26,this.body.rotation.z=t*.06}else this.staff.rotation.x=-.08,this.orb.scale.setScalar(1),this.orbLight.intensity=6,this.body.rotation.z=0;this.root.position.set(this.position.x,this._hover+Math.abs(Math.sin(this._bobT))*.09*this._moveAmount+l,this.position.z),this.root.rotation.y=this.facing,this.blob.position.set(this.position.x,.02,this.position.z);let u=Math.min(1,this._hover/1.25);this.blob.material.opacity=.34*(1-u*.7),this.blob.scale.setScalar(1-u*.35);let d=u*(t?.55:.3),f=.85+.15*Math.sin(r*14);this.hoverGlow.position.set(this.position.x,.07,this.position.z),this.hoverGlow.material.opacity=d*f,this.hoverGlow.scale.setScalar(1+u*.25+f*.08)}_faceToward(e,t,n){let r=e-this.facing;for(;r>Math.PI;)r-=Math.PI*2;for(;r<-Math.PI;)r+=Math.PI*2;this.facing+=r*Math.min(1,t*n)}dispose(){this.scene.remove(this.root,this.blob,this.hoverGlow,this.shield),this.root.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&e.material.dispose()}),this.blob.geometry.dispose(),this.blob.material.dispose(),this.hoverGlow.geometry.dispose(),this.hoverGlow.material.dispose(),this.shield.geometry.dispose(),this.shield.material.dispose()}},nf=new Set;function rf(e){e?.isMeshStandardMaterial&&!nf.has(e.uuid)&&(nf.add(e.uuid),e.onBeforeCompile=e=>{e.vertexShader=e.vertexShader.replace(`#include <common>`,[`#include <common>`,`varying vec3 vArenaWorld;`].join(`
...
`))},e.customProgramCacheKey=()=>`arena-marble-v2`,e.needsUpdate=!0)}function af(e){let t=[],n=e.geometry;for(let r of n.groups){let i=e.material[r.materialIndex];if(!i||r.count===0)continue;let a=n.clone();if(n.index){let e=n.index.array.slice(r.start,r.start+r.count);a.setIndex(new J(e,1))}else for(let e of Object.keys(a.attributes)){let t=a.attributes[e],n=t.array.slice(t.itemSize*r.start,t.itemSize*(r.start+r.count));a.setAttribute(e,new J(n,t.itemSize))}a.clearGroups(),a.morphAttributes={},t.push({geo:a,material:i})}return t}function of(e){e.updateMatrixWorld(!0);let t=new Map,n=[];e.traverse(e=>{if(!e.isMesh||!e.material)return;let r=(e,n)=>{let r=n.uuid;t.has(r)||t.set(r,{material:n,nodes:[],geos:[],indexed:!0});let i=t.get(r);for(let t of Object.keys(e.attributes))t!==`position`&&t!==`normal`&&t!==`uv`&&e.deleteAttribute(t);if(e.morphAttributes={},!e.attributes.uv){let t=e.attributes.position.count;e.setAttribute(`uv`,new J(new Float32Array(t*2),2))}e.attributes.normal||e.computeVertexNormals(),e.index||(i.indexed=!1),i.geos.push(e)};if(Array.isArray(e.material)){let t=new Set,i=af(e);for(let n of i)n.geo.applyMatrix4(e.matrixWorld),r(n.geo,n.material),t.add(n.material.uuid);n.push({node:e,usedIds:t,extraGeos:[]})}else{let t=e.geometry.clone();t.applyMatrix4(e.matrixWorld),r(t,e.material),n.push({node:e,usedIds:new Set([e.material.uuid]),extraGeos:[t]})}});let r=[],i=0,a=0;for(let e of t.values()){let t=Bu(e.indexed?e.geos:e.geos.map(e=>e.index?e.toNonIndexed():e),!1);if(!t){a++;for(let t of e.geos)t.dispose();continue}let n=new Y(t,e.material);n.matrixAutoUpdate=!1,r.push(n);for(let t of e.geos)t.dispose();e.geos=[]}for(let{node:e,usedIds:r,extraGeos:a}of n){let n=r.size>0;for(let e of r){let r=t.get(e);if(!r||r.geos.length>0){n=!1;break}}n&&(e.parent?.remove(e),e.geometry.dispose(),i++);for(let e of a)e.dispose()}return console.info(`[arena] 合并网格：${i} -> ${r.length}（按材质，失败组 ${a} 保留原样）`),of.stats={removed:i,failed:a,merged:r.length},r}function sf(e,t,n){let r=new Y(new Ca(59,96),new Ua({color:`#10141c`,roughness:.95,metalness:.05}));r.rotation.x=-Math.PI/2,r.position.y=-.35,e.add(r);let i=new Jd;i.setDecoderPath(`draco/`);let a=new Gu;a.setDRACOLoader(i),a.load(`arena.glb`,n=>{let r=n.scene;r.traverse(e=>{e.isMesh&&(e.castShadow=!1,e.receiveShadow=!1)});let i=of(r);window.__arenaMerge=of.stats;for(let e of i)rf(e.material),r.add(e);e.add(r),t?.(!0)},e=>{n&&(e.total>0?n(Math.min(99,Math.round(e.loaded/e.total*100)),e.loaded/1048576):n(null,e.loaded/1048576))},e=>{console.error(`[arena] 场景加载失败`,e),t?.(!1)})}function cf(e){let t=new Vo(`#8fb4de`,70,150,1.8);return t.position.set(0,20,0),e.add(t),t}var lf=[`ice`,`fire`,`storm`],uf={ice:{key:`Q`,label:`霜新星`,accent:`#56d8ff`,family:`ice`},fire:{key:`E`,label:`落炎陨石`,accent:`#ff8a3c`,family:`fire`},storm:{key:`R`,label:`天雷殛灭`,accent:`#a98bff`,family:`storm`}},df={ice:`ice`,fire:`fire`,storm:`storm`},ff={neutral:{id:`neutral`,label:`元素荒原 · Neutral Realm`,glyph:`◇`,accent:`#9fb4c8`,weather:`none`,skyTop:`#0b1120`,skyBottom:`#1b2534`,skyHorizon:`#33475e`,stars:1,fogColor:`#141c28`,fogNear:55,fogFar:235,groundBase:`#252e3a`,groundAccent:`#446080`,veinStrength:.22,keyColor:`#bcd2ff`,keyIntensity:3.4,hemiSky:`#334e78`,hemiGround:`#10161f`,hemiIntensity:1.45,vignette:`rgba(4, 8, 16, 0.55)`},ice:{id:`ice`,label:`冰封领域 · Frozen Realm`,glyph:`❄`,accent:`#56d8ff`,weather:`snow`,skyTop:`#5eb0e0`,skyBottom:`#c4e9fa`,skyHorizon:`#e8f7ff`,stars:.15,fogColor:`#b9dcEE`,fogNear:46,fogFar:190,groundBase:`#9fc0d2`,groundAccent:`#38c8ff`,veinStrength:.85,keyColor:`#ffffff`,keyIntensity:3.7,hemiSky:`#d6f0ff`,hemiGround:`#6d94aa`,hemiIntensity:1.5,vignette:`rgba(150, 205, 235, 0.28)`},fire:{id:`fire`,label:`烈焰领域 · Burning Realm`,glyph:`🔥`,accent:`#ff8a3c`,weather:`embers`,skyTop:`#1b0908`,skyBottom:`#5c1e0c`,skyHorizon:`#ff7a2e`,stars:.3,fogColor:`#2c110a`,fogNear:40,fogFar:170,groundBase:`#261410`,groundAccent:`#ff5410`,veinStrength:1,keyColor:`#ffd9a8`,keyIntensity:3.4,hemiSky:`#a8462a`,hemiGround:`#170a08`,hemiIntensity:1.4,vignette:`rgba(58, 10, 4, 0.5)`},storm:{id:`storm`,label:`雷暴领域 · Storm Realm`,glyph:`⚡`,accent:`#a98bff`,weather:`sparks`,skyTop:`#0c0f2e`,skyBottom:`#2c3168`,skyHorizon:`#6f6fff`,stars:.6,fogColor:`#181d42`,fogNear:36,fogFar:160,groundBase:`#1b1e3a`,groundAccent:`#8f6bff`,veinStrength:.9,keyColor:`#cfe0ff`,keyIntensity:3,hemiSky:`#4c5cba`,hemiGround:`#0e1024`,hemiIntensity:1.3,vignette:`rgba(10, 12, 40, 0.55)`}},pf=[`skyTop`,`skyBottom`,`skyHorizon`,`fogColor`,`groundBase`,`groundAccent`,`keyColor`,`hemiSky`,`hemiGround`],mf=[`stars`,`fogNear`,`fogFar`,`veinStrength`,`keyIntensity`,`hemiIntensity`],hf=2.4,gf=1.5,_f=22,vf=-120;function yf(){return new Va({transparent:!0,depthWrite:!1,blending:2,fog:!1,uniforms:{uTime:{value:gf},uColor:{value:new q(1,1,1)}},vertexShader:`
      varying vec2 vLocal;
      void main() {
        vLocal = uv * 2.0 - 1.0;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,fragmentShader:`
      ...
      void main() {
        float t = clamp(uTime / ${gf.toFixed(1)}, 0.0, 1.0);
        float radius = ${_f.toFixed(1)} * (1.0 - pow(1.0 - t, 3.0));
    ...
    `})}var bf=class e{constructor(){this.scene=new Fn,this.fog=new Pn(`#141c28`,55,235),this.scene.fog=this.fog,this.sky=new Nu(this.scene),this.ground=new Pu(this.scene),this.ground.mesh.position.y=vf,this.ground.mesh.scale.setScalar(2.6),this.key=new Wo(`#bcd2ff`,3.4),this.key.position.set(18,30,10),this.fill=new Wo(`#46536e`,1.3),this.fill.position.set(-22,24,-16),this.hemi=new To(`#334e78`,`#10161f`,1.45),this.scene.add(this.key,this.fill,this.hemi),this.candle=cf(this.scene),sf(this.scene,e=>{this.arenaReady=e,this.onArenaReady?.(e)},(e,t)=>this.onArenaProgress?.(e,t)),this.weather=new zu(this.scene),this.current=`neutral`,this.currentAccent=ff.neutral.accent,this.onShift=null,this._waveMaterial=yf(),this._wave=new Y(new ka(44,44),this._waveMaterial),this._wave.rotation.x=-Math.PI/2,this._wave.visible=!1,this._wave.renderOrder=4,this.scene.add(this._wave),this._waveTime=gf,this._progress=1,this._from={},this._to=null,this._cA=new q,this._cB=new q}get theme(){return ff[this.current]}shift(e,t){let n=ff[e];if(n){if(e!==this.current){let t=this._readLive();for(let e of pf)this._from[e]=t[e];for(let e of mf)this._from[e]=t[e];this._to=n,this._progress=0,this.weather.setMode(n.weather),this.current=e}this.currentAccent=n.accent,this._wave.position.set(t.x,.05,t.z),this._waveMaterial.uniforms.uColor.value.set(n.accent),this._waveTime=0,this._wave.visible=!0,this.onShift?.({id:e,theme:n})}}_readLive(){return{skyTop:this._cA.copy(this.sky.uniforms.uTop.value).clone(),skyBottom:this.sky.uniforms.uBottom.value.clone(),skyHorizon:this.sky.uniforms.uHorizon.value.clone(),fogColor:this.fog.color.clone(),groundBase:this.ground.uniforms.uBase.value.clone(),groundAccent:this.ground.uniforms.uAccent.value.clone(),keyColor:this.key.color.clone(),hemiSky:this.hemi.color.clone(),hemiGround:this.hemi.groundColor.clone(),stars:this.sky.uniforms.uStars.value,fogNear:this.fog.near,fogFar:this.fog.far,veinStrength:this.ground.uniforms.uVein.value,keyIntensity:this.key.intensity,hemiIntensity:this.hemi.intensity}}_apply(e,t){switch(e){case`skyTop`:this.sky.uniforms.uTop.value.copy(t);break;case`skyBottom`:this.sky.uniforms.uBottom.value.copy(t);break;case`skyHorizon`:this.sky.uniforms.uHorizon.value.copy(t);break;case`fogColor`:this.fog.color.copy(t),this.ground.uniforms.uFog.value.copy(t);break;case`groundBase`:this.ground.uniforms.uBase.value.copy(t);break;case`groundAccent`:this.ground.uniforms.uAccent.value.copy(t);break;case`keyColor`:this.key.color.copy(t);break;case`hemiSky`:this.hemi.color.copy(t);break;case`hemiGround`:this.hemi.groundColor.copy(t);break;case`stars`:this.sky.uniforms.uStars.value=t;break;case`fogNear`:this.fog.near=t,this.ground.uniforms.uFogNear.value=t;break;case`fogFar`:this.fog.far=t,this.ground.uniforms.uFogFar.value=t;break;case`veinStrength`:this.ground.uniforms.uVein.value=t;break;case`keyIntensity`:this.key.intensity=t;break;case`hemiIntensity`:this.hemi.intensity=t}}static SOFTEN_DESAT=.42;static SOFTEN_DIM=.8;_soften(t){let n=t.r*.299+t.g*.587+t.b*.114;return t.r+=(n-t.r)*e.SOFTEN_DESAT,t.g+=(n-t.g)*e.SOFTEN_DESAT,t.b+=(n-t.b)*e.SOFTEN_DESAT,t.multiplyScalar(e.SOFTEN_DIM),t}_tickShift(e,t){if(this._progress>=1)return;this._progress=Math.min(1,this._progress+e/hf);let n=this._progress*this._progress*(3-2*this._progress),r=this.current!==`neutral`;for(let e of pf)this._cA.copy(this._from[e]),this._cB.set(this._to[e]),this._cA.lerp(this._cB,n),r&&this._soften(this._cA),this._apply(e,this._cA);for(let e of mf){let t=this._from[e]+(this._to[e]-this._from[e])*n;r&&(e===`keyIntensity`||e===`hemiIntensity`?t*=.75:e===`veinStrength`&&(t*=.5)),this._apply(e,t)}let i=this._to.vignette.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?\)/);i&&this._progress>.5&&(t.style.boxShadow=`inset 0 0 190px 30px rgba(${i[1]}, ${i[2]}, ${i[3]}, ${i[4]??.5})`)}update(e,t,n,r){this._tickShift(e,r),this.sky.update(t),this.ground.update(t),this.weather.update(e,t,n),this._waveTime+=e,this._waveTime<gf?this._waveMaterial.uniforms.uTime.value=this._waveTime:this._wave.visible=!1}dispose(){this.sky.dispose(),this.ground.dispose(),this.weather.dispose(),this.scene.remove(this.candle),this._wave.geometry.dispose(),this._waveMaterial.dispose()}},xf={uTime:{value:0},uDelta:{value:0},uResolution:{value:new H(1,1)},uSceneDepth:{value:null},uCameraNear:{value:.1},uCameraFar:{value:1400},uLightDir:{value:new U(.45,.78,.44).normalize()},uShaderIntensity:{value:1},uGlobalGlow:{value:1}};function Sf(e={}){return{uTime:xf.uTime,uResolution:xf.uResolution,uSceneDepth:xf.uSceneDepth,uCameraNear:xf.uCameraNear,uCameraFar:xf.uCameraFar,uLightDir:xf.uLightDir,uShaderIntensity:xf.uShaderIntensity,uGlobalGlow:xf.uGlobalGlow,...e}}var Cf=(e,t,n)=>e<t?t:e>n?n:e,wf=e=>Cf(e,0,1),Tf=(e,t,n)=>e+(t-e)*n,Ef=(e,t,n)=>{let r=wf((n-e)/(t-e||1e-6));return r*r*(3-2*r)},Df=(e,t)=>e+Math.random()*(t-e);function Of(e){let t=Math.sin(e*127.1)*43758.5453123;return t-Math.floor(t)}var kf={linear:e=>e,inQuad:e=>e*e,outQuad:e=>e*(2-e),inOutQuad:e=>e<.5?2*e*e:-1+(4-2*e)*e,inCubic:e=>e*e*e,outCubic:e=>1-(1-e)**3,inOutCubic:e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2,outQuint:e=>1-(1-e)**5,outExpo:e=>e>=1?1:1-2**(-10*e),pop:e=>Math.sin(Math.min(1,e)*Math.PI)**.6},Af=Math.PI*2,jf=[0,.22,.5,.75,.92];function Mf(e,t){return t+(1-t)*(1-e)**1.15}function Nf({seed:e=1,sides:t=6,taper:n=.13,roughness:r=.28,bend:i=.22}={}){let a=Math.max(3,Math.round(t)),o=Math.min(.9,Math.max(.01,n)),s=Of(e*1.77)*Af,c=Math.cos(s),l=Math.sin(s),u=e=>i*.5*e**1.6,d=[];for(let t=0;t<a;t++){let n=(Of(e*3.13+t*7.7)-.5)*(Af/a)*.55*r*3;d.push(t/a*Af+n)}let f=jf.map((t,n)=>{let i=Mf(t,o)*.5,a=u(t),s=t+(Of(e*5.9+n*2.3)-.5)*.06*r*(t>0);return d.map((o,u)=>{let d=1+(Of(e*11.1+n*13.7+u*3.9)-.5)*r*1.3*(.35+.65*t),f=Math.max(.002,i*d);return[Math.cos(o)*f+c*a,s,Math.sin(o)*f+l*a]})}),p=u(1),m=[c*p+(Of(e*17.3)-.5)*.09*r,1,l*p+(Of(e*19.7)-.5)*.09*r],h=[0,0,0],g=[],_=e=>g.push(e[0],e[1],e[2]);for(let e=0;e<f.length-1;e++){let t=f[e],n=f[e+1];for(let e=0;e<a;e++){let r=(e+1)%a;_(t[e]),_(t[r]),_(n[e]),_(t[r]),_(n[r]),_(n[e])}}let v=f[f.length-1],y=f[0];for(let e=0;e<a;e++){let t=(e+1)%a;_(v[e]),_(v[t]),_(m),_(h),_(y[t]),_(y[e])}let b=new Or;return b.setAttribute(`position`,new gr(g,3)),b.computeVertexNormals(),b}function Pf(e,t,n,r){return Of(e*127.1+t*311.7+n*74.7+r*19.19)}function Ff(e,t,n,r){let i=Math.floor(e),a=Math.floor(t),o=Math.floor(n),s=e-i,c=t-a,l=n-o,u=s*s*(3-2*s),d=c*c*(3-2*c),f=l*l*(3-2*l),p=Pf(i,a,o,r),m=Pf(i+1,a,o,r),h=Pf(i,a+1,o,r),g=Pf(i+1,a+1,o,r),_=Pf(i,a,o+1,r),v=Pf(i+1,a,o+1,r),y=Pf(i,a+1,o+1,r),b=Pf(i+1,a+1,o+1,r),x=p+(m-p)*u,S=h+(g-h)*u,C=_+(v-_)*u,w=y+(b-y)*u,T=x+(S-x)*d;return T+(C+(w-C)*d-T)*f}function If(e,t,n,r,i){let a=0,o=.5,s=1;for(let c=0;c<i;c++)a+=o*(Ff(e*s,t*s,n*s,r+c*7.7)*2-1),s*=2.03,o*=.5;return a}function Lf({seed:e=1,detail:t=3,lumpiness:n=.26,noiseScale:r=1.5,roughness:i=.16,cuts:a=7,cutDepth:o=.2,craters:s=5,craterDepth:c=.18,craterSize:l=.5}={}){let u=new Da(1,Cf(Math.round(t),0,3)).toNonIndexed(),d=u.attributes.position.array,f=(e,t)=>{let n=Math.acos(2*Of(e)-1),r=Of(t)*Af,i=Math.sin(n);return{x:i*Math.cos(r),y:Math.cos(n),z:i*Math.sin(r)}},p=[];for(let t=0;t<Math.max(0,Math.round(a));t++){let n=f(e*2.3+t*9.1,e*5.7+t*4.3);n.offset=1-o*(.35+.9*Of(e*13.1+t*6.7)),p.push(n)}let m=[];for(let t=0;t<Math.max(0,Math.round(s));t++){let n=f(e*3.1+t*12.9,e*7.7+t*5.3);n.radius=Math.max(.08,l*(.45+.8*Of(e*11.3+t*3.7))),n.depth=c*(.5+Of(e*17.9+t*2.1)),m.push(n)}for(let t=0;t<d.length;t+=3){let a=d[t],o=d[t+1],s=d[t+2],c=1;c+=If(a*r,o*r,s*r,e,3)*n,c+=If(a*r*4.3,o*r*4.3,s*r*4.3,e+31.7,2)*i*.5;for(let e of m){let t=Math.acos(Cf(a*e.x+o*e.y+s*e.z,-1,1))/e.radius;t>=1.4||(c-=e.depth*Math.max(0,1-t*t),c+=e.depth*.5*Ef(.72,1,t)*(1-Ef(1,1.4,t)))}c=Math.max(.35,c);let l=a*c,u=o*c,f=s*c;for(let e of p){let t=l*e.x+u*e.y+f*e.z-e.offset;t<=0||(l-=e.x*t,u-=e.y*t,f-=e.z*t)}d[t]=l,d[t+1]=u,d[t+2]=f}return u.attributes.position.needsUpdate=!0,u.computeVertexNormals(),u.computeBoundingSphere(),u}function Rf(e=72,t=24){let n=Math.max(2,Math.round(e)),r=Math.max(1,Math.round(t)),i=new Float32Array(n*2*3);for(let e=0;e<n;e++){let t=e/(n-1),r=e*6;i[r+0]=t,i[r+1]=-1,i[r+3]=t,i[r+4]=1}let a=new Uint16Array((n-1)*6);for(let e=0;e<n-1;e++){let t=e*2,n=e*6;a[n+0]=t,a[n+1]=t+1,a[n+2]=t+2,a[n+3]=t+1,a[n+4]=t+3,a[n+5]=t+2}let o=new Float32Array(r);for(let e=0;e<r;e++)o[e]=e;let s=new Ko;return s.setAttribute(`position`,new J(i,3)),s.setAttribute(`aStrand`,new Ni(o,1)),s.setIndex(new J(a,1)),s.instanceCount=r,s.boundingSphere=new br(new U,1e4),s}function zf(e=96,t=26){let n=Math.max(2,Math.round(e)),r=Math.max(3,Math.round(t)),i=r+1,a=new Float32Array(n*i*3),o=0;for(let e=0;e<n;e++){let t=e/(n-1);for(let e=0;e<i;e++)a[o++]=t,a[o++]=e/r,a[o++]=0}let s=new Uint16Array((n-1)*r*6),c=0;for(let e=0;e<n-1;e++)for(let t=0;t<r;t++){let n=e*i+t,r=n+i;s[c++]=n,s[c++]=r,s[c++]=n+1,s[c++]=r,s[c++]=r+1,s[c++]=n+1}let l=new Or;return l.setAttribute(`position`,new J(a,3)),l.setIndex(new J(s,1)),l.boundingSphere=new br(new U,1e4),l}function Bf(e=10,t=44){let n=Math.max(1,Math.round(e)),r=Math.max(6,Math.round(t)),i=r+1,a=new Float32Array(2*i*3),o=0;for(let e=0;e<2;e++)for(let t=0;t<i;t++)a[o++]=e,a[o++]=t/r,a[o++]=0;let s=new Uint16Array(r*6),c=0;for(let e=0;e<r;e++){let t=e,n=i+e;s[c++]=t,s[c++]=n,s[c++]=t+1,s[c++]=n,s[c++]=n+1,s[c++]=t+1}let l=new Float32Array(n);for(let e=0;e<n;e++)l[e]=e;let u=new Ko;return u.setAttribute(`position`,new J(a,3)),u.setAttribute(`aRing`,new Ni(l,1)),u.setIndex(new J(s,1)),u.instanceCount=n,u.boundingSphere=new br(new U,1e4),u}function Vf(e={}){let t=new Ua({color:16777215,roughness:.16,metalness:0,flatShading:!0,transparent:!0,side:2,depthWrite:!0,opacity:.92}),n={uTime:xf.uTime,uColorDeep:{value:new q(e.colorDeep??`#3e737a`)},uColorIce:{value:new q(e.colorIce??`#8adaff`)},uColorRim:{value:new q(e.colorRim??`#f2feff`)},uColorCore:{value:new q(e.colorCore??`#638797`)},uDensity:{value:1.15},uFresnel:{value:2.3},uFresnelPower:{value:2.4},uTranslucency:{value:1.5},uFacetSharp:{value:.68},uFracture:{value:.62},uFractureScale:{value:6.5},uVeins:{value:.45},uVeinScale:{value:3.2},uSparkle:{value:1.1},uSparkleScale:{value:34},uSparkleSpeed:{value:.7},uFrostLine:{value:.5},uGlow:{value:.85},uEdgeGlow:{value:1.1},uBirthGlow:{value:1.6}};return t.onBeforeCompile=e=>{Object.assign(e.uniforms,n),e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
         attribute float aSeed;
         ...
         ${Xd}`).replace(`#include <emissivemap_fragment>`,`#include <emissivemap_fragment>
         {
         ...
         }`)},t.customProgramCacheKey=()=>`solitude-ice-v1`,t.userData.uniforms=n,t}function Hf(){let e=new Ua({color:16777215,roughness:.94,metalness:0,flatShading:!0}),t={uTime:xf.uTime,uColorRock:{value:new q(`#6e675f`)},uColorChar:{value:new q(`#17130f`)},uColorCrack:{value:new q(`#ff6a12`)},uColorHot:{value:new q(`#fff3d0`)},uCrackScale:{value:.95},uCrackWidth:{value:.045},uCrackBranches:{value:.5},uCrackGlow:{value:2.2},uFlow:{value:.7},uFlowSpeed:{value:.9},uRockScale:{value:3.4},uFacetTint:{value:.5},uCavity:{value:.25},uSoot:{value:.6},uRimHeat:{value:.7},uLead:{value:.9},uLeadSharp:{value:2.6},uHeading:{value:new U(0,-1,0)},uCharge:{value:0},uGlow:{value:.75}};return e.onBeforeCompile=e=>{Object.assign(e.uniforms,t),e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
         attribute float aSeed;
         ...
         ${Xd}`).replace(`#include <emissivemap_fragment>`,`#include <emissivemap_fragment>
         {
           ...
           totalEmissiveRadiance += glow;
         }`)},e.customProgramCacheKey=()=>`solitude-meteor-v1`,e.userData.uniforms=t,e.userData.sync=(e=0,n=null)=>{t.uCharge.value=e,n&&t.uHeading.value.copy(n)},e}var Uf=`
  uniform float uTime;
  uniform float uSeed;
...
`;function Gf(e={}){let t=new Va({transparent:!0,depthWrite:!1,depthTest:!0,blending:2,side:0,toneMapped:!1,uniforms:Sf({uSeed:{value:e.seed??Math.random()*10},uOrbTurbulence:{value:e.turbulence??.22},uOrbScale:{value:e.scale??2.2},uOrbFlow:{value:e.flow??.9},uOrbBands:{value:e.bands??5},uOrbRim:{value:e.rim??1.8},uCharge:{value:1},uOpacity:{value:e.opacity??1},uGlow:{value:e.glow??2.8},uColorCore:{value:new q(e.core??`#ffffff`)},uColorInner:{value:new q(e.inner??`#d3f4ff`)},uColorOuter:{value:new q(e.outer??`#3ec6ff`)}}),vertexShader:Uf,fragmentShader:Wf});return t.userData.setPalette=({core:e,inner:n,outer:r,glow:i})=>{e&&t.uniforms.uColorCore.value.set(e),n&&t.uniforms.uColorInner.value.set(n),r&&t.uniforms.uColorOuter.value.set(r),i!==void 0&&(t.uniforms.uGlow.value=i)},t}var Kf=Object.freeze({CORE:0,GLOW:1});function qf(e={}){return{sag:.22,strands:9,spread:.75,spreadNear:.05,spreadCurve:1.6,twist:.45,twistSpeed:.8,branchDim:.72,jitter:.34,jitterScale:.85,octaves:4,jitterFalloff:.55,crawl:3.2,pinch:.14,converge:.8,width:.025,widthTip:.43,widthCurve:1.09,coreWidth:1.31,coreSharp:4.95,glowWidth:5.7,glowFalloff:2.4,glowOpacity:.49,restrike:24,flicker:.3,flickerSpeed:34,strandFlash:.5,tipGlow:2,tipLength:.08,glow:2.3,opacity:1,colorCore:`#ffffff`,colorInner:`#c9ecff`,colorOuter:`#3aa0ff`,colorHalo:`#0b3fc8`,...e}}var Jf=`
...
`;function Xf(e=Kf.CORE,t){let n=t,r=e===Kf.GLOW,i=new Va({defines:r?{BOLT_GLOW:``}:{},transparent:!0,depthWrite:!1,depthTest:!0,blending:2,side:2,toneMapped:!1,uniforms:Sf({uOrigin:{value:new U},uTarget:{value:new U(0,0,1)},uSide:{value:new U(1,0,0)},uSag:{value:n.sag},uSeed:{value:0},uRestrike:{value:n.restrike},uProgress:{value:0},uFade:{value:1},uStrands:{value:n.strands},uSpread:{value:n.spread},uSpreadNear:{value:n.spreadNear},uSpreadCurve:{value:n.spreadCurve},uTwist:{value:n.twist},uTwistSpeed:{value:n.twistSpeed},uBranchDim:{value:n.branchDim},uJitter:{value:n.jitter},uJitterScale:{value:n.jitterScale},uOctaves:{value:n.octaves},uJitterFalloff:{value:n.jitterFalloff},uCrawl:{value:n.crawl},uPinch:{value:n.pinch},uConverge:{value:n.converge},uWidth:{value:n.width},uWidthTip:{value:n.widthTip},uWidthCurve:{value:n.widthCurve},uCoreWidth:{value:n.coreWidth},uGlowFalloff:{value:n.glowFalloff},uCoreSharp:{value:n.coreSharp},uWidthScale:{value:r?n.glowWidth:1},uPassOpacity:{value:r?n.glowOpacity:1},uFlicker:{value:n.flicker},uFlickerSpeed:{value:n.flickerSpeed},uStrandFlash:{value:n.strandFlash},uTipGlow:{value:n.tipGlow},uTipLength:{value:n.tipLength},uOpacity:{value:n.opacity},uGlow:{value:n.glow},uColorCore:{value:new q(n.colorCore)},uColorInner:{value:new q(n.colorInner)},uColorOuter:{value:new q(n.colorOuter)},uColorHalo:{value:new q(n.colorHalo)}}),vertexShader:Jf,fragmentShader:Yf});return i.userData.sync=e=>{let t=i.uniforms;t.uOrigin.value.copy(e.origin),t.uTarget.value.copy(e.target),t.uSide.value.copy(e.side),t.uSeed.value=e.seed,t.uProgress.value=e.progress,t.uFade.value=e.fade,t.uStrands.value=e.strands,t.uGlow.value=n.glow,t.uOpacity.value=n.opacity,t.uColorCore.value.set(n.colorCore),t.uColorInner.value.set(n.colorInner),t.uColorOuter.value.set(n.colorOuter),t.uColorHalo.value.set(n.colorHalo)},i}var Zf=Object.freeze({SOFT:0,SMOKE:1,STREAK:2}),Qf={start:3,origin:3,velocity:3,color:3,spawn:1,life:1,size:1,seed:1,spin:1},$f=new U,ep=class{constructor({name:e,capacity:t=2e3,shape:n=Zf.SOFT,additive:r=!0,curl:i=!1,stretch:a=!1}){this.name=e,this.capacity=t,this.cursor=0;let o=new Ko;o.setAttribute(`position`,new J(new Float32Array([-.5,-.5,0,.5,-.5,0,.5,.5,0,-.5,.5,0]),3)),o.setAttribute(`uv`,new J(new Float32Array([0,0,1,0,1,1,0,1]),2)),o.setIndex(new J(new Uint16Array([0,1,2,0,2,3]),1)),this.data={},this.attributes={};for(let[e,n]of Object.entries(Qf)){let r=new Float32Array(t*n),i=new Ni(r,n).setUsage(Ke);this.data[e]=r,this.attributes[e]=i,o.setAttribute(`a${e[0].toUpperCase()}${e.slice(1)}`,i)}this.data.life.fill(0),o.instanceCount=t,o.boundingSphere=new br(new U,1e4),this.geometry=o;let s={SHAPE:n};i&&(s.USE_CURL=``),a&&(s.USE_STRETCH=``),this.material=new Va({defines:s,transparent:!0,depthWrite:!1,depthTest:!0,blending:r?2:1,side:2,toneMapped:!1,uniforms:Sf({uGravity:{value:new U(0,-4.5,0)},uDrag:{value:.9},uTurbulence:{value:.6},uTurbFrequency:{value:.45},uTurbSpeed:{value:.35},uSpeedScale:{value:1},uSizeScale:{value:1},uLifeScale:{value:1},uEndSize:{value:.4},uSizeIn:{value:.08},uFadeIn:{value:.08},uFadeOut:{value:.55},uOpacity:{value:1},uGlow:{value:1},uStretch:{value:.15},uColor0:{value:new q(1,1,1)},uColor1:{value:new q(1,.7,.3)},uColor2:{value:new q(.6,.15,.05)},uColor3:{value:new q(.08,.06,.06)}}),vertexShader:rp,fragmentShader:ip}),this.mesh=new Y(o,this.material),this.mesh.frustumCulled=!1,this.mesh.matrixAutoUpdate=!1,this.mesh.renderOrder=r?12:10,this.mesh.name=`Particles:${e}`,this._ranges=[],this._dirty=!1}get uniforms(){return this.material.uniforms}emit(e,t){if(e<=0)return;e=Math.min(e,this.capacity);let{position:n,radius:r=0,direction:i=null,speed:a=1,speedVariance:o=.35,spread:s=.5,size:c=.2,sizeVariance:l=.4,life:u=1,lifeVariance:d=.3,spin:f=0,tint:p=null,time:m=0}=t,h=this.data;for(let t=0;t<e;t++){let e=this.cursor;this.cursor=(this.cursor+1)%this.capacity,this._markDirty(e);let t=e*3,g=0,_=0,v=0;if(r>0){let e=r*Math.cbrt(Math.random()),t=Math.random()*Math.PI*2,n=Math.acos(2*Math.random()-1),i=Math.sin(n);g=e*i*Math.cos(t),_=e*Math.cos(n),v=e*i*Math.sin(t)}h.start[t+0]=n.x+g,h.start[t+1]=n.y+_,h.start[t+2]=n.z+v,i?$f.copy(i):$f.set(0,1,0),s>0&&($f.x+=(Math.random()-.5)*2*s,$f.y+=(Math.random()-.5)*2*s,$f.z+=(Math.random()-.5)*2*s),$f.normalize().multiplyScalar(a*(1+(Math.random()-.5)*2*o)),h.velocity[t+0]=$f.x,h.velocity[t+1]=$f.y,h.velocity[t+2]=$f.z,h.spawn[e]=m,h.life[e]=Math.max(.05,u*(1+(Math.random()-.5)*2*d)),h.size[e]=Math.max(.001,c*(1+(Math.random()-.5)*2*l)),h.seed[e]=Math.random(),h.spin[e]=(Math.random()-.5)*2*f,p?(h.color[t+0]=p.r,h.color[t+1]=p.g,h.color[t+2]=p.b):(h.color[t+0]=1,h.color[t+1]=1,h.color[t+2]=1)}}_markDirty(e){this._dirty=!0;let t=this._ranges,n=t[t.length-1];n&&e===n[0]+n[1]?n[1]++:t.push([e,1])}flush(){if(this._dirty){for(let[e,t]of Object.entries(Qf)){let n=this.attributes[e];n.needsUpdate=!0,n.clearUpdateRanges?.();for(let[e,r]of this._ranges)n.addUpdateRange?.(e*t,r*t)}this._ranges.length=0,this._dirty=!1}}setGradient(e,t,n,r){let i=this.uniforms;i.uColor0.value.set(e),i.uColor1.value.set(t),i.uColor2.value.set(n),i.uColor3.value.set(r??n)}reset(){this.data.life.fill(0),this.data.spawn.fill(-1e4);for(let e of Object.keys(Qf))this.attributes[e].needsUpdate=!0;this._ranges.length=0,this._dirty=!1,this.cursor=0}dispose(){this.geometry.dispose(),this.material.dispose()}},tp=class{constructor(){this._acc=0}reset(){this._acc=0}tick(e,t){this._acc+=t*e;let n=Math.floor(this._acc);return n>0&&(this._acc-=n),n}},np=class{constructor(e){this.scene=e,this.systems=new Map}get(e,t){let n=this.systems.get(e);return n||(n=new ep({name:e,...t}),this.systems.set(e,n),this.scene.add(n.mesh)),n}flush(){for(let e of this.systems.values())e.flush()}reset(){for(let e of this.systems.values())e.reset()}dispose(){for(let e of this.systems.values())this.scene.remove(e.mesh),e.dispose();this.systems.clear()}},rp=`
  uniform float uTime;
...
`,ap=class{constructor(e,t){this._create=e,this._release=t,this._free=[]}acquire(){return this._free.length>0?this._free.pop():this._create()}release(e){this._release?.(e),this._free.push(e)}dispose(e){if(e)for(let t of this._free)e(t);this._free.length=0}},op=Object.freeze({FIRE:0,AIR:2,FROST:4,STORM:5}),sp=`
  uniform float uTime;
  uniform float uAge;
...
`,lp=class{constructor(e){this.group=new En,this.group.name=`Bursts`,e.add(this.group),this.geometry=new Da(1,4),this.pools=new Map,this.active=[]}_poolFor(e){let t=this.pools.get(e);return t||(t=new ap(()=>this._create(e),e=>{e.mesh.visible=!1,this.group.remove(e.mesh)}),this.pools.set(e,t)),t}_create(e){let t=new Va({defines:{BURST_MODE:e},transparent:!0,depthWrite:!1,depthTest:!0,blending:2,side:2,toneMapped:!1,uniforms:Sf({uAge:{value:0},uSeed:{value:Math.random()},uDisplace:{value:.45},uTurbulence:{value:1},uIntensity:{value:1},uFresnel:{value:1},uOpacity:{value:1},uColorA:{value:new q(1,.9,.6)},uColorB:{value:new q(1,.45,.1)},uColorC:{value:new q(.4,.08,.03)}}),vertexShader:sp,fragmentShader:cp}),n=new Y(this.geometry,t);return n.renderOrder=14,n.frustumCulled=!1,{mesh:n,material:t,mode:e,age:0,life:1,radius:1,endRadius:2}}spawn(e,t,n={}){let{radius:r=.4,endRadius:i=3,life:a=.9,intensity:o=1,opacity:s=1,fresnel:c=1,displace:l=.45,turbulence:u=1,colorA:d=null,colorB:f=null,colorC:p=null,squash:m=1}=n,h=this._poolFor(e).acquire(),g=h.material.uniforms;return h.age=0,h.life=Math.max(.05,a),h.radius=r,h.endRadius=i,h.squash=m,g.uAge.value=0,g.uSeed.value=Math.random()*10,g.uIntensity.value=o,g.uOpacity.value=s,g.uFresnel.value=c,g.uDisplace.value=l,g.uTurbulence.value=u,d&&g.uColorA.value.copy(d),f&&g.uColorB.value.copy(f),p&&g.uColorC.value.copy(p),h.mesh.position.copy(t),h.mesh.scale.setScalar(r),h.mesh.visible=!0,this.group.add(h.mesh),this.active.push(h),h}update(e){for(let t=this.active.length-1;t>=0;t--){let n=this.active[t];n.age+=e;let r=Math.min(1,n.age/n.life);n.material.uniforms.uAge.value=r;let i=n.radius+(n.endRadius-n.radius)*kf.outQuint(r);n.mesh.scale.set(i,i*n.squash,i),r>=1&&(this.active.splice(t,1),this._poolFor(n.mode).release(n))}}clear(){for(let e of this.active)this._poolFor(e.mode).release(e);this.active.length=0}dispose(){this.clear();for(let e of this.pools.values())e.dispose(e=>e.material.dispose());this.pools.clear(),this.geometry.dispose(),this.group.parent?.remove(this.group)}},up=Object.freeze({SCORCH:0,CRACK:2,SHOCKWAVE:3,DUSTRING:4,FROST:6,ARC:7}),dp=`
...
`,pp=class{constructor(e){this.group=new En,this.group.name=`GroundDecals`,e.add(this.group),this.geometry=new ka(1,1).rotateX(-Math.PI/2),this.active=[],this.pools=new Map}_poolFor(e){let t=this.pools.get(e);return t||(t=new ap(()=>this._createDecal(e),e=>{e.mesh.visible=!1,this.group.remove(e.mesh)}),this.pools.set(e,t)),t}_createDecal(e){let t=e===up.SHOCKWAVE||e===up.ARC,n=new Va({defines:{DECAL:e},transparent:!0,depthWrite:!1,depthTest:!0,blending:t?2:1,toneMapped:!1,uniforms:Sf({uAge:{value:0},uSeed:{value:Math.random()},uIntensity:{value:1},uWidth:{value:.12},uRadius:{value:1},uColorA:{value:new q(.1,.06,.05)},uColorB:{value:new q(1,.5,.15)}}),vertexShader:dp,fragmentShader:fp}),r=new Y(this.geometry,n);return r.renderOrder=t?8:6,r.frustumCulled=!1,{mesh:r,material:n,type:e,age:0,life:1,radius:1,growth:0}}spawn(e,t,n={}){let{radius:r=2,life:i=2,colorA:a=null,colorB:o=null,intensity:s=1,width:c=.12,growth:l=0,height:u=.02}=n,d=this._poolFor(e).acquire(),f=d.material.uniforms;return d.age=0,d.life=Math.max(.05,i),d.radius=r,d.growth=l,f.uAge.value=0,f.uSeed.value=Math.random(),f.uIntensity.value=s,f.uWidth.value=c,f.uRadius.value=r,a&&f.uColorA.value.set(a),o&&f.uColorB.value.set(o),d.mesh.position.set(t.x,u,t.z),d.mesh.rotation.y=Math.random()*Math.PI*2,d.mesh.scale.setScalar(r*2),d.mesh.visible=!0,this.group.add(d.mesh),this.active.push(d),d}update(e){for(let t=this.active.length-1;t>=0;t--){let n=this.active[t];n.age+=e;let r=n.age/n.life;n.material.uniforms.uAge.value=r,n.growth!==0&&n.mesh.scale.setScalar(n.radius*2*(1+n.growth*r)),r>=1&&(this.active.splice(t,1),this._poolFor(n.type).release(n))}}clear(){for(let e of this.active)this._poolFor(e.type).release(e);this.active.length=0}dispose(){this.clear();for(let e of this.pools.values())e.dispose(e=>e.material.dispose());this.pools.clear(),this.geometry.dispose(),this.group.parent?.remove(this.group)}},mp=class e{constructor(e,t){this.scene=e,this.renderer=t,this.bursts=new lp(e),this.decals=new pp(e),this.particles=new np(e),this._scratchColor=new q,this._emit={},this._dir=new U,this.sparks=this.particles.get(`sparks`,{capacity:4e3,shape:Zf.STREAK,additive:!0,stretch:!0}),this.sparks.uniforms.uDrag.value=1.4,this.sparks.uniforms.uEndSize.value=.25,this.sparks.uniforms.uSizeIn.value=.02,this.sparks.uniforms.uFadeIn.value=.03,this.sparks.uniforms.uFadeOut.value=.45,this.motes=this.particles.get(`motes`,{capacity:2400,shape:Zf.SOFT,additive:!0,curl:!0}),this.motes.uniforms.uDrag.value=1.2,this.motes.uniforms.uEndSize.value=.16,this.motes.uniforms.uSizeIn.value=.05,this.motes.uniforms.uFadeIn.value=.07,this.motes.uniforms.uFadeOut.value=.4,this.smoke=this.particles.get(`smoke`,{capacity:1600,shape:Zf.SMOKE,additive:!1,curl:!0}),this.smoke.uniforms.uDrag.value=1.7,this.smoke.uniforms.uEndSize.value=3,this.smoke.uniforms.uSizeIn.value=.12,this.smoke.uniforms.uFadeIn.value=.16,this.smoke.uniforms.uFadeOut.value=.3,this.smoke.uniforms.uOpacity.value=.55,this._sparkEmitter=new tp,this._moteEmitter=new tp}static ELEMENT_BURST={ice:{a:`#a9e4ff`,b:`#cdefff`,c:`#f2feff`},fire:{a:`#ffd27a`,b:`#ff6a12`,c:`#fff3d0`},storm:{a:`#a98bff`,b:`#d3f4ff`,c:`#ffffff`},basic:{a:`#9fd8ff`,b:`#d3f4ff`,c:`#ffffff`}};sparkBurst(t,n,r={}){let i=e.ELEMENT_BURST[n]??e.ELEMENT_BURST.basic,a=r.count??60;this.sparks.setGradient(`#ffffff`,i.c,i.b,i.a),this.sparks.uniforms.uGravity.value.set(0,r.gravity??-11,0),this.sparks.uniforms.uSizeScale.value=r.size??1.2,this.sparks.uniforms.uLifeScale.value=r.life??.8,this.sparks.uniforms.uGlow.value=1.6;let o=this._emit;o.position=t,o.radius=r.radius??.25,o.direction=this._dir.set(0,r.up??.7,0).normalize(),o.speed=r.speed??9,o.speedVariance=.85,o.spread=1,o.size=.22,o.sizeVariance=.8,o.life=.6,o.lifeVariance=.6,o.spin=0,o.tint=null,o.time=xf.uTime.value,this.sparks.emit(a,o)}killBurst(t,n,r=1){let i=e.ELEMENT_BURST[n]??e.ELEMENT_BURST.basic,a={ice:op.FROST,fire:op.FIRE,storm:op.STORM,basic:op.AIR};this.bursts.spawn(a[n]??op.AIR,t,{radius:.2*r,endRadius:(n===`basic`?2.6:3.4)*r,life:.55+.15*r,intensity:1.1,opacity:.95,fresnel:n===`basic`?2.2:1.6,displace:.45,colorA:i.a,colorB:i.b,colorC:i.c}),this.decals.spawn(up.SHOCKWAVE,t,{radius:2.2*r,life:.5,width:.05,intensity:.85,colorA:i.b,colorB:`#ffffff`}),this.sparkBurst(t,n,{count:Math.round(46*r),speed:8*r,life:.9,size:1.1})}update(e,t,n){if(xf.uTime.value+=e,xf.uDelta.value=e,n){let e=n.getSize(new H),t=n.getPixelRatio();xf.uResolution.value.set(e.x*t,e.y*t)}t&&(xf.uCameraNear.value=t.near,xf.uCameraFar.value=t.far),this.bursts.update(e),this.decals.update(e),this.particles.flush()}clear(){this.bursts.clear(),this.decals.clear(),this.particles.reset(),this._sparkEmitter.reset(),this._moteEmitter.reset()}dispose(){this.bursts.dispose(),this.decals.dispose(),this.particles.dispose()}},hp={ice:{core:`#ffffff`,inner:`#d3f4ff`,outer:`#56d8ff`},fire:{core:`#ffffff`,inner:`#ffe8c0`,outer:`#ff8a3c`},storm:{core:`#ffffff`,inner:`#e7dcff`,outer:`#a98bff`}},gp=class{constructor(e,t=1400){this.max=t,this.particles=[],this._positions=new Float32Array(t*3),this._colors=new Float32Array(t*3),this._alphas=new Float32Array(t),this._sizes=new Float32Array(t);let n=new Or;n.setAttribute(`position`,new J(this._positions,3)),n.setAttribute(`aColor`,new J(this._colors,3)),n.setAttribute(`aAlpha`,new J(this._alphas,1)),n.setAttribute(`aSize`,new J(this._sizes,1)),n.boundingSphere=null,this._material=new Va({transparent:!0,depthWrite:!1,blending:2,fog:!1,uniforms:{uPixelRatio:{value:1}},vertexShader:`
        uniform float uPixelRatio;
        attribute vec3 aColor;
      ...
      `}),this._points=new ha(n,this._material),this._points.frustumCulled=!1,this._points.renderOrder=3,e.add(this._points),this._geometry=n,this._cA=new q,this._cB=new q}setPixelRatio(e){this._material.uniforms.uPixelRatio.value=e}clear(){this.particles.length=0,this._alphas.fill(0)}emit(e){for(let t=0;t<e.count;t++){this.particles.length>=this.max&&this.particles.shift();let t=Math.random()*Math.PI*2,n=Math.sqrt(Math.random())*(e.spread??1),r=Tf(e.speed[0],e.speed[1],Math.random());this.particles.push({x:e.pos.x+Math.cos(t)*n*.3,y:e.pos.y+Math.random()*.2,z:e.pos.z+Math.sin(t)*n*.3,vx:Math.cos(t)*n*r,vy:Tf(e.up[0],e.up[1],Math.random()),vz:Math.sin(t)*n*r,life:0,maxLife:Tf(e.life[0],e.life[1],Math.random()),size:Tf(e.size[0],e.size[1],Math.random()),gravity:e.gravity??-9,drag:e.drag??.6,color:this._cA.set(e.colorA).clone().lerp(this._cB.set(e.colorB),Math.random())})}}update(e){let t=this.particles,n=0;for(let r=0;r<t.length;r++){let i=t[r];if(i.life+=e,i.life>=i.maxLife)continue;let a=Math.max(0,1-i.drag*e);i.vx*=a,i.vz*=a,i.vy=i.vy*a+i.gravity*e,i.x+=i.vx*e,i.y+=i.vy*e,i.z+=i.vz*e,i.y<.03&&i.vy<0&&(i.y=.03,i.vy*=-.35),t[n++]=i}t.length=n;for(let e=0;e<this.max;e++)if(e<t.length){let n=t[e],r=1-n.life/n.maxLife;this._positions[e*3]=n.x,this._positions[e*3+1]=n.y,this._positions[e*3+2]=n.z,this._colors[e*3]=n.color.r,this._colors[e*3+1]=n.color.g,this._colors[e*3+2]=n.color.b,this._alphas[e]=r,this._sizes[e]=n.size}else this._alphas[e]=0;this._geometry.attributes.position.needsUpdate=!0,this._geometry.attributes.aColor.needsUpdate=!0,this._geometry.attributes.aAlpha.needsUpdate=!0,this._geometry.attributes.aSize.needsUpdate=!0}dispose(){this._geometry.dispose(),this._material.dispose()}},_p=3,vp=44,yp=.17,bp=.26,xp=.55,Sp=.45,Cp=1.3,wp=.9,Tp=24,Ep=class{constructor(e){this.group=new En,e.add(this.group),this.material=Vf({colorDeep:`#3e737a`,colorIce:`#8adaff`,colorRim:`#f2feff`,colorCore:`#638797`}),this.meshes=[],this.seedAttrs=[],this.birthAttrs=[];for(let e=0;e<_p;e++){let t=Nf({seed:7.3+e*21.7,sides:6,taper:.16,roughness:.24,bend:.3}),n=new Ni(new Float32Array(vp),1),r=new Ni(new Float32Array(vp),1).setUsage(Ke);t.setAttribute(`aSeed`,n),t.setAttribute(`aBirth`,r);let i=new Vi(t,this.material,vp);i.instanceMatrix.setUsage(Ke),i.count=0,i.frustumCulled=!1,i.visible=!1,this.group.add(i),this.meshes.push(i),this.seedAttrs.push(n),this.birthAttrs.push(r)}this._dummy=new Tn,this._up=new U(0,1,0),this._lean=new U,this._axis=new U,this._tilt=new At,this._spin=new At}_halfWidth(e){return Tf(.55,2.6,wf(e)**.75)}layout(e,t,n,r){let i=e.distanceTo(t),a=[];for(let t=0;t<103;t++){let o=((t+Math.random())/103)**.85,s=Df(-1,1),c=Math.sign(s)*Math.abs(s)**1.35,l=(c+Df(-1,1)*.3)*this._halfWidth(o),u=e.x+n.x*i*o+r.x*l,d=e.z+n.z*i*o+r.z*l,f=Tf(.55,3,o**1.4);f*=1+.45*wf((o-.72)/.28),f*=1-.55*wf(Math.abs(c))**1.4,f*=1+Df(-.3,.3),Math.random()<.35&&(f*=.32);let p=c,m=n.x*.75+r.x*p*.85,h=n.z*.75+r.z*p*.85,g=.42*(.35+.65*o)*(1+Df(-.5,.5));a.push({x:u,z:d,along:o,yaw:Math.random()*Math.PI*2,height:f,radius:.3+Math.random()*.28,leanX:m,leanZ:h,lean:g,stagger:Math.random()*.09,eruptTime:-1,variant:t%_p,slot:t/_p|0,seed:Math.random()})}for(let e=0;e<29;e++){let n=Math.random()*Math.PI*2,r=Math.sqrt(Math.random()),i=this._halfWidth(1)*1.3*r;a.push({x:t.x+Math.cos(n)*i,z:t.z+Math.sin(n)*i,along:1,yaw:Math.random()*Math.PI*2,height:2.1+Math.random()*1.2,radius:.34+Math.random()*.3,leanX:Math.cos(n),leanZ:Math.sin(n),lean:.3+Math.random()*.25,stagger:Math.random()*.12,eruptTime:-1,variant:(103+e)%_p,slot:(103+e)/_p|0,seed:Math.random()})}for(let e of a)this.seedAttrs[e.variant].array[e.slot]=e.seed;for(let e=0;e<_p;e++)this.seedAttrs[e].needsUpdate=!0,this.meshes[e].count=vp,this.meshes[e].visible=!0;return a}triggerUpTo(e,t,n,r){for(let i of e)i.eruptTime>=0||i.along>n||i.along>=1&&!r||(i.eruptTime=t+i.stagger)}_emergence(e,t){if(e.eruptTime<0)return-1;let n=t-e.eruptTime;if(n<0)return-1;let r=kf.outQuint(wf(n/yp));if(n<=yp)return r;let i=n-yp;return 1+bp*(Math.sin(i*14)*Math.exp(-i/xp))}update(e,t,n){let r=[0,0,0];for(let n of e){let e=this._emergence(n,t),i=this.meshes[n.variant],a=n.slot;if(r[n.variant]=Math.max(r[n.variant],a+1),e<0){this._dummy.position.set(0,-999,0),this._dummy.scale.setScalar(1e-4),this._dummy.rotation.set(0,0,0),this._dummy.updateMatrix(),i.setMatrixAt(a,this._dummy.matrix),this.birthAttrs[n.variant].array[a]=0;continue}this._lean.set(n.leanX,0,n.leanZ).normalize(),this._axis.crossVectors(this._up,this._lean).normalize(),this._tilt.setFromAxisAngle(this._axis,n.lean),this._spin.setFromAxisAngle(this._up,n.yaw),this._tilt.multiply(this._spin),this._dummy.position.set(n.x,(Math.min(e,1.3)-1)*n.height*.85,n.z),this._dummy.quaternion.copy(this._tilt);let o=Math.min(1,e);this._dummy.scale.set(n.radius,Math.max(.02,o*n.height),n.radius),this._dummy.updateMatrix(),i.setMatrixAt(a,this._dummy.matrix);let s=t-n.eruptTime;this.birthAttrs[n.variant].array[a]=wf(1-s/Sp)}for(let e=0;e<_p;e++)this.meshes[e].count=r[e],this.meshes[e].instanceMatrix.needsUpdate=!0,this.birthAttrs[e].needsUpdate=!0;if(n>0){let e=kf.inCubic(n);this.group.position.y=-e*4.2}else this.group.position.y=0}hide(){for(let e=0;e<_p;e++)this.meshes[e].count=0,this.meshes[e].visible=!1;this.group.position.y=0}dispose(){for(let e of this.meshes)e.geometry.dispose();this.material.dispose(),this.group.parent?.remove(this.group)}},Dp=14,Op=class{constructor(e){this.group=new En,e.add(this.group),this.material=Hf();let t=Lf({seed:11.7,detail:3,lumpiness:.26,noiseScale:1.5,roughness:.16,cuts:9,cutDepth:.28,craters:5,craterDepth:.18,craterSize:.5}),n=new Ni(new Float32Array([3.7]),1);this._rockHeat=new Ni(new Float32Array([0]),1).setUsage(Ke),t.setAttribute(`aSeed`,n),t.setAttribute(`aHeat`,this._rockHeat),this.rock=new Vi(t,this.material,1),this.rock.instanceMatrix.setUsage(Ke),this.rock.frustumCulled=!1,this.rock.visible=!1,this.group.add(this.rock);let r=Lf({seed:47.3,detail:1,lumpiness:.4,noiseScale:1.8,roughness:.3,cuts:5,cutDepth:.32,craters:2,craterDepth:.2,craterSize:.5}),i=new Ni(new Float32Array(Dp),1);for(let e=0;e<Dp;e++)i.array[e]=Math.random()*40;this._chunkHeat=new Ni(new Float32Array(Dp),1).setUsage(Ke),r.setAttribute(`aSeed`,i),r.setAttribute(`aHeat`,this._chunkHeat),this.chunks=new Vi(r,this.material,Dp),this.chunks.instanceMatrix.setUsage(Ke),this.chunks.frustumCulled=!1,this.chunks.visible=!1,this.group.add(this.chunks),this._dummy=new Tn,this._quat=new At,this._chunkList=[],this._rockScale=1.35}launch(e){this._dummy.position.copy(e),this._dummy.quaternion.identity(),this._dummy.scale.setScalar(this._rockScale),this._dummy.updateMatrix(),this.rock.setMatrixAt(0,this._dummy.matrix),this.rock.instanceMatrix.needsUpdate=!0,this.rock.visible=!0,this._rockHeat.array[0]=1,this._rockHeat.needsUpdate=!0,this.rock.material.userData.sync(0,null)}tickRock(e,t,n,r,i){this._dummy.position.copy(e),this._dummy.rotation.set(t,0,n),this._dummy.scale.setScalar(this._rockScale),this._dummy.updateMatrix(),this.rock.setMatrixAt(0,this._dummy.matrix),this.rock.instanceMatrix.needsUpdate=!0,this._rockHeat.array[0]=1,this._rockHeat.needsUpdate=!0,this.rock.material.userData.sync(r,i)}hideRock(){this.rock.visible=!1}burstChunks(e,t=Math.random){this._chunkList.length=0;for(let n=0;n<Dp;n++){let r=t()*Math.PI*2;this._chunkList.push({x:e.x,y:.5,z:e.z,vx:Math.cos(r)*(2+t()*5),vy:4+t()*7,vz:Math.sin(r)*(2+t()*5),rx:t()*Math.PI*2,rz:t()*Math.PI*2,wx:(t()-.5)*12,wz:(t()-.5)*12,scale:.16+t()*.22,heat:1}),this._chunkHeat.array[n]=1}this.chunks.visible=!0}tickChunks(e){if(!this.chunks.visible)return;let t=!1;for(let n=0;n<this._chunkList.length;n++){let r=this._chunkList[n];if(r.heat=Math.max(0,r.heat-e*.75),this._chunkHeat.array[n]=r.heat,r.heat<=0){this._dummy.position.set(0,-999,0),this._dummy.scale.setScalar(1e-4),this._dummy.rotation.set(0,0,0),this._dummy.updateMatrix(),this.chunks.setMatrixAt(n,this._dummy.matrix);continue}t=!0,r.vy-=17*e,r.x+=r.vx*e,r.y+=r.vy*e,r.z+=r.vz*e,r.y<.12&&r.vy<0&&(r.y=.12,r.vy*=-.38,r.vx*=.72,r.vz*=.72),r.rx+=r.wx*e,r.rz+=r.wz*e,this._dummy.position.set(r.x,r.y,r.z),this._dummy.rotation.set(r.rx,0,r.rz),this._dummy.scale.setScalar(r.scale),this._dummy.updateMatrix(),this.chunks.setMatrixAt(n,this._dummy.matrix)}this.chunks.instanceMatrix.needsUpdate=!0,this._chunkHeat.needsUpdate=!0,t||(this.chunks.visible=!1)}reset(){this.rock.visible=!1,this.chunks.visible=!1,this._chunkList.length=0,this._rockHeat.array[0]=0}dispose(){this.rock.geometry.dispose(),this.chunks.geometry.dispose(),this.material.dispose(),this.group.parent?.remove(this.group)}},kp=class{constructor(e,t){this.scene=e,this.vfx=t,this.bursts=new gp(e),this._crystals=new Ep(e),this._crystalState=null,this._meteor=new Op(e),this._meteorLight=new Vo(`#ff8a3c`,0,26,2),e.add(this._meteorLight),this._boltConfig=qf({sag:0,strands:14,spread:1.15,spreadNear:.03,spreadCurve:1.5,jitter:.58,jitterScale:.72,width:.042,widthTip:.5,coreWidth:1.55,coreSharp:4.4,glowWidth:8.5,glowOpacity:.6,glowFalloff:2.2,restrike:18,flicker:.35,strandFlash:.55,glow:2.8,colorCore:`#ffffff`,colorInner:`#e9dfff`,colorOuter:`#a98bff`,colorHalo:`#5a2bd6`}),this._boltGeometry=Rf(72,14),this._boltGroup=new En,this._boltGroup.visible=!1,e.add(this._boltGroup),this._boltMaterials=[];for(let e of[Kf.GLOW,Kf.CORE]){let t=Xf(e,this._boltConfig),n=new Y(this._boltGeometry,t);n.frustumCulled=!1,n.matrixAutoUpdate=!1,n.renderOrder=11+e*2,this._boltGroup.add(n),this._boltMaterials.push(t)}this._boltState={origin:new U,target:new U,side:new U(1,0,0),progress:0,fade:1,seed:0,strands:14},this._boltLight=new Vo(`#c9b8ff`,0,30,2),e.add(this._boltLight),this._balls=[];let n=new Da(1,3),r=document.createElement(`canvas`);r.width=r.height=64;let i=r.getContext(`2d`),a=i.createRadialGradient(32,32,2,32,32,30);a.addColorStop(0,`rgba(255,255,255,1)`),a.addColorStop(.4,`rgba(255,255,255,0.32)`),a.addColorStop(1,`rgba(255,255,255,0)`),i.fillStyle=a,i.fillRect(0,0,64,64),this._ballHaloTexture=new va(r);for(let t=0;t<8;t++){let t=new En,r=new Y(n,Gf({core:`#ffffff`,inner:`#d3f4ff`,outer:`#56d8ff`,glow:2.8}));r.scale.setScalar(.2),r.renderOrder=20;let i=new Jr(new Pr({map:this._ballHaloTexture,color:`#9fd8ff`,transparent:!0,opacity:.75,blending:2,depthWrite:!1}));i.scale.setScalar(1.6),i.renderOrder=20,t.add(r,i),t.visible=!1,e.add(t),this._balls.push({group:t,orb:r,halo:i,busy:!1})}this._active=[],this._scratchDir=new U,this._scratchUp=new U(0,1,0)}cast(e,t,n,r){e===`ice`?this._castIce(t,n,r):e===`fire`?this._castFire(t,n,r):e===`storm`&&this._castStorm(n,r)}castBasic(e,t,n,r,i){let a=this._balls.find(e=>!e.busy)??this._balls[0];a.busy=!0,a.group.visible=!0,a.group.position.copy(e),this._active.push({type:`basic`,t:0,duration:Math.max(.12,e.distanceTo(t)/26),start:e.clone(),point:t.clone(),color:n,fired:!1,hitSet:new Set,onMove:r,onImpact:i,slot:a})}_tickBasic(e,t){e.t+=t;let n=Math.min(1,e.t/e.duration);e.slot.group.position.lerpVectors(e.start,e.point,n),e.onMove?.(e.slot.group.position,e.hitSet);let r=this._elementFromColor(e.color),i=hp[r]??hp.ice,a=this.vfx;a.sparks.setGradient(`#ffffff`,i.inner,i.outer,i.outer),a.sparks.uniforms.uGravity.value.set(0,-1.5,0),a.sparks.uniforms.uSizeScale.value=.55,a.sparks.uniforms.uLifeScale.value=.32,a.sparks.uniforms.uGlow.value=1.5;let o=a._emit;return o.position=e.slot.group.position,o.radius=.1,o.direction=null,o.speed=1.2,o.speedVariance=.8,o.spread=1,o.size=.14,o.sizeVariance=.7,o.life=.3,o.lifeVariance=.5,o.spin=0,o.tint=null,o.time=xf.uTime.value,a.sparks.emit(3,o),e.slot.orb.scale.setScalar(.2*(1.1+.18*Math.sin(e.t*34))),e.slot.orb.material.uniforms.uCharge.value=1,e.slot.halo.material.color.set(e.color),n>=1&&!e.fired&&(e.fired=!0,e.slot.group.visible=!1,e.slot.busy=!1,this.vfx.bursts.spawn(op.AIR,e.point,{radius:.12,endRadius:1.9,life:.38,intensity:1,opacity:.9,fresnel:2,displace:.3,colorA:e.color,colorB:`#ffffff`,colorC:`#d3f4ff`}),this.vfx.decals.spawn(up.SHOCKWAVE,e.point,{radius:2.1,life:.42,width:.06,intensity:.9,colorA:e.color,colorB:`#ffffff`}),this.vfx.sparkBurst(e.point,r,{count:26,speed:5.5,life:.6,size:.9,up:1.2}),this._flash(e.point,e.color,110),e.onImpact(e.point,1.8,e.hitSet)),e.fired&&e.t>e.duration+.15}_elementFromColor(e){return e.startsWith(`#56d8`)?`ice`:e.startsWith(`#ff8a`)?`fire`:e.startsWith(`#a98b`)?`storm`:`basic`}_castIce(e,t,n){this._crystalState&&=(this._crystals.hide(),null);let r=this._scratchDir.set(t.x-e.x,0,t.z-e.z),i=Math.max(3,r.length());r.divideScalar(Math.max(1e-4,r.length()));let a=new U(-r.z,0,r.x),o=this._crystals.layout(e,t,r,a);this._crystalState={age:0,started:!1,fired:!1,retract:0,front:0,len:i,dir:r.clone(),side:a.clone(),start:e.clone(),point:t.clone(),records:o,frostDist:1.2,frostAccum:0,onImpact:n},this._active.push({type:`ice`})}_tickIce(e,t){let n=this._crystalState;n.age+=t;let r=n.len/Tp;n.started||(n.started=!0,this.vfx.bursts.spawn(op.FROST,n.start.clone().setY(.5),{radius:.18,endRadius:2.2,life:.45,intensity:.85,opacity:.9,fresnel:1.4,displace:.4,colorA:`#a9e4ff`,colorB:`#cdefff`,colorC:`#f2feff`}),this.vfx.decals.spawn(up.FROST,n.start,{radius:2.2,life:5.5,intensity:.6,width:1.5,colorA:`#f0f9ff`,colorB:`#79b6dd`,height:.045}),this.vfx.sparkBurst(n.start,`ice`,{count:30,speed:5,life:.6,size:.9,up:1.2}),this._flash(n.start,`#8fd8ff`,90)),n.fired||(n.front+=Tp*t);let i=wf(n.front/n.len);for(this._crystals.triggerUpTo(n.records,n.age,i,n.fired),n.frostAccum+=Tp*t;!n.fired&&n.frostAccum>=2.4&&n.frostDist<n.len-.5;){n.frostAccum-=2.4;let e=n.start.x+n.dir.x*n.frostDist+n.side.x*Df(-1,1),t=n.start.z+n.dir.z*n.frostDist+n.side.z*Df(-1,1);this.vfx.decals.spawn(up.FROST,{x:e,z:t},{radius:2,life:5,intensity:.55,width:1.5,colorA:`#f0f9ff`,colorB:`#79b6dd`,height:.045}),n.frostDist+=2.4}if(!n.fired&&i>=1&&(n.fired=!0,this.vfx.bursts.spawn(op.FROST,n.point.clone().setY(.6),{radius:.3,endRadius:4.4,life:.6,intensity:.95,opacity:.95,fresnel:1.3,displace:.45,colorA:`#a9e4ff`,colorB:`#cdefff`,colorC:`#f2feff`}),this.vfx.decals.spawn(up.SHOCKWAVE,n.point,{radius:5.4,life:.55,width:.05,intensity:.95,colorA:`#5fd0ff`,colorB:`#f2feff`}),this.vfx.decals.spawn(up.FROST,n.point,{radius:5,life:7,intensity:.85,width:1.5,colorA:`#f0f9ff`,colorB:`#79b6dd`,height:.05}),this.vfx.sparkBurst(n.point,`ice`,{count:90,speed:8,life:.9,size:1.1,up:1.4}),this._flash(n.point,`#8fd8ff`,160),n.onImpact(n.point,4.6)),n.age>r+Cp+.3&&(n.retract=Math.min(1,n.retract+t/wp)),this._crystals.update(n.records,n.age,n.retract),!n.retract){this.vfx.motes.setGradient(`#f2feff`,`#a9e4ff`,`#57c9ff`,`#0a3552`),this.vfx.motes.uniforms.uGravity.value.set(0,1.6,0),this.vfx.motes.uniforms.uSizeScale.value=.7,this.vfx.motes.uniforms.uLifeScale.value=1.4,this.vfx.motes.uniforms.uTurbulence.value=.5,this.vfx.motes.uniforms.uGlow.value=1.2;let e=this.vfx._emit,t=Math.min(n.front,n.len)*(.75+Math.random()*.25);e.position=this._scratchUp.set(n.start.x+n.dir.x*t+n.side.x*Df(-1.5,1.5),.2,n.start.z+n.dir.z*t+n.side.z*Df(-1.5,1.5)),e.radius=1,e.direction=null,e.speed=2.4,e.speedVariance=.8,e.spread=.7,e.size=.1,e.sizeVariance=.6,e.life=1.6,e.lifeVariance=.5,e.spin=0,e.tint=null,e.time=xf.uTime.value,this.vfx.motes.emit(2,e)}return n.retract>=1&&(this._crystals.hide(),this._crystalState=null,!0)}_castFire(e,t,n){let r=this._scratchDir.set(t.x-e.x,0,t.z-e.z).normalize(),i=t.clone().addScaledVector(r,-9).add(new U(0,17,0));this._meteor.launch(i),this._meteorLight.position.copy(i),this._meteorLight.intensity=130,this._active.push({type:`fire`,t:0,duration:.62,start:i,point:t.clone(),fired:!1,onImpact:n})}_tickFire(e,t){e.t+=t;let n=Math.min(1,e.t/e.duration),r=n*n,i=e.start.clone().lerp(e.point,r),a=wf(e.t/e.duration),o=e.point.clone().sub(e.start).normalize();this._meteor.tickRock(i,e.t*7,e.t*5,a,o),this._meteorLight.position.copy(i),this._meteorLight.intensity=130,this.vfx.motes.setGradient(`#fff3d0`,`#ff9a2e`,`#ff3b0d`,`#2b0d05`),this.vfx.motes.uniforms.uGravity.value.set(0,1.5,0),this.vfx.motes.uniforms.uSizeScale.value=1,this.vfx.motes.uniforms.uLifeScale.value=.8,this.vfx.motes.uniforms.uTurbulence.value=.5,this.vfx.motes.uniforms.uGlow.value=1.4;let s=this.vfx._emit;return s.position=i,s.radius=.7,s.direction=null,s.speed=2.4,s.speedVariance=.8,s.spread=.9,s.size=.28,s.sizeVariance=.6,s.life=.7,s.lifeVariance=.5,s.spin=0,s.tint=null,s.time=xf.uTime.value,this.vfx.motes.emit(5,s),this.vfx.sparkBurst(i,`fire`,{count:2,speed:3,life:.4,size:.8,up:.4,radius:.5}),n>=1&&!e.fired&&(e.fired=!0,this._meteor.hideRock(),this._meteor.burstChunks(e.point),this._meteorLight.intensity=260,this.vfx.bursts.spawn(op.FIRE,e.point.clone().setY(.8),{radius:.5,endRadius:5.6,life:.7,intensity:1.2,opacity:.95,fresnel:1,displace:.55,turbulence:1.4,colorA:`#ffd27a`,colorB:`#ff6a12`,colorC:`#fff3d0`}),this.vfx.decals.spawn(up.SHOCKWAVE,e.point,{radius:6,life:.6,width:.05,intensity:1,colorA:`#ff9a2e`,colorB:`#fff3d0`}),this.vfx.decals.spawn(up.CRACK,e.point,{radius:5.2,life:5.5,width:.14,intensity:1.2,colorA:`#1a0d05`,colorB:`#ff6a12`,height:.045}),this.vfx.decals.spawn(up.SCORCH,e.point,{radius:2.8,life:8,intensity:.95,colorA:`#0d0907`,colorB:`#ff9a2e`,height:.04}),this.vfx.decals.spawn(up.DUSTRING,e.point,{radius:4.4,life:1.1,intensity:.7,colorA:`#3a322c`,colorB:`#ffb066`,height:.05}),this.vfx.sparkBurst(e.point,`fire`,{count:150,speed:11,life:1.1,size:1.2,up:1.2}),this._flash(e.point,`#ffb066`,220),e.onImpact(e.point,5.4)),e.fired&&(this._meteor.tickChunks(t),this._meteorLight.intensity*=Math.max(0,1-t*5),e.t>e.duration+2.4)?(this._meteorLight.intensity=0,!0):!1}_castStorm(e,t){this._active.push({type:`storm`,t:0,point:e.clone(),fired:!1,seed:Math.random()*100,onImpact:t})}_tickStorm(e,t){if(e.t+=t,!e.fired&&e.t>=.15){e.fired=!0,this._boltState.origin.set(e.point.x+(Math.random()-.5)*2.5,22,e.point.z+(Math.random()-.5)*2.5),this._boltState.target.set(e.point.x,.05,e.point.z),this._boltState.seed=e.seed,this._boltGroup.visible=!0,this._boltLight.position.set(e.point.x,6,e.point.z),this.vfx.bursts.spawn(op.STORM,e.point.clone().setY(.7),{radius:.25,endRadius:3.4,life:.6,intensity:1.2,opacity:.95,fresnel:1.6,displace:.5,colorA:`#a98bff`,colorB:`#d3f4ff`,colorC:`#ffffff`}),this.vfx.decals.spawn(up.SHOCKWAVE,e.point,{radius:5.6,life:.55,width:.05,intensity:1,colorA:`#c9ecff`,colorB:`#ffffff`}),this.vfx.decals.spawn(up.ARC,e.point,{radius:3.6,life:.95,width:.6,intensity:1.1,colorA:`#12060a`,colorB:`#c9a6ff`,height:.045});for(let t=0;t<4;t++){let t=Math.random()*Math.PI*2,n=1.6+Math.random()*2.6;this.vfx.decals.spawn(up.ARC,{x:e.point.x+Math.cos(t)*n,z:e.point.z+Math.sin(t)*n},{radius:1.3+Math.random()*1.1,life:.8,width:.55,intensity:.9,colorA:`#12060a`,colorB:`#9fdcff`,height:.04})}this.vfx.decals.spawn(up.SCORCH,e.point,{radius:1.6,life:6,intensity:.5,colorA:`#080b11`,colorB:`#8f6bff`,height:.04}),this.vfx.sparkBurst(e.point,`storm`,{count:120,speed:10,life:.8,size:1.1,up:1}),this._flash(e.point,`#c9b8ff`,260),e.onImpact(e.point,5)}if(e.fired){let t=e.t-.15;this._boltState.progress=Math.min(1,t/.08),this._boltState.fade=t<.45?1:Math.max(0,1-(t-.45)/.17);for(let e of this._boltMaterials)e.userData.sync(this._boltState);if(this._boltLight.intensity=Math.max(0,260*(1-t/.5)),this._boltLight.position.y=4,t>.62)return this._boltGroup.visible=!1,this._boltLight.intensity=0,!0}return!1}_flash(e,t,n){this._light||(this._light=new Vo(t,0,30,2),this.scene.add(this._light)),this._light.color.set(t),this._light.position.set(e.x,2.6,e.z),this._light.intensity=n,this._flashT=.22,this._flashIntensity=n}reset(){this._active.length=0,this._crystals.hide(),this._crystalState=null,this._meteor.reset(),this._meteorLight.intensity=0,this._boltGroup.visible=!1,this._boltLight.intensity=0,this._light&&(this._light.intensity=0),this._flashT=0;for(let e of this._balls)e.group.visible=!1,e.busy=!1;this.bursts.clear(),this.vfx?.clear()}update(e){for(let t=this._active.length-1;t>=0;t--){let n=this._active[t];(n.type===`ice`?this._tickIce(n,e):n.type===`fire`?this._tickFire(n,e):n.type===`basic`?this._tickBasic(n,e):this._tickStorm(n,e))&&this._active.splice(t,1)}this._flashT>0&&(this._flashT-=e,this._light.intensity=Math.max(0,this._flashT/.22*this._flashIntensity)),this.bursts.update(e)}dispose(){this.bursts.dispose(),this._crystals.dispose(),this._meteor.dispose();for(let e of this._boltMaterials)e.dispose();this._boltGeometry.dispose();for(let e of this._balls)e.group.traverse(e=>e.geometry?.dispose?.()),e.orb.material.dispose(),e.halo.material.dispose();this._ballHaloTexture.dispose()}},$=new class{constructor(){this.ctx=null,this.master=null,this.noiseBuf=null,this.realm=`neutral`,this._ambient=null,this._music=null}ensure(){if(!this.ctx){let e=window.AudioContext||window.webkitAudioContext;if(!e)return null;try{this.ctx=new e}catch{return null}this.master=this.ctx.createGain(),this.master.gain.value=.5,this.master.connect(this.ctx.destination);let t=Math.floor(this.ctx.sampleRate*2);this.noiseBuf=this.ctx.createBuffer(1,t,this.ctx.sampleRate);let n=this.noiseBuf.getChannelData(0);for(let e=0;e<t;e++)n[e]=Math.random()*2-1;this._startAmbient(this.realm)}return this.ctx.state===`suspended`&&this.ctx.resume(),this.ctx}tone({type:e=`sine`,f0:t=440,f1:n=t,dur:r=.2,gain:i=.3,attack:a=.005,when:o=0}){let s=this.ensure();if(!s)return;let c=s.currentTime+o,l=s.createOscillator(),u=s.createGain();l.type=e,l.frequency.setValueAtTime(Math.max(1,t),c),n!==t&&l.frequency.exponentialRampToValueAtTime(Math.max(1,n),c+r),u.gain.setValueAtTime(1e-4,c),u.gain.exponentialRampToValueAtTime(i,c+a),u.gain.exponentialRampToValueAtTime(1e-4,c+r),l.connect(u).connect(this.master),l.start(c),l.stop(c+r+.05)}noise({dur:e=.3,gain:t=.3,type:n=`lowpass`,f0:r=1e3,f1:i=r,q:a=1,attack:o=.005,when:s=0}){let c=this.ensure();if(!c)return;let l=c.currentTime+s,u=c.createBufferSource();u.buffer=this.noiseBuf,u.loop=!0;let d=c.createBiquadFilter();d.type=n,d.frequency.setValueAtTime(Math.max(20,r),l),d.Q.value=a,i!==r&&d.frequency.exponentialRampToValueAtTime(Math.max(20,i),l+e);let f=c.createGain();f.gain.setValueAtTime(1e-4,l),f.gain.exponentialRampToValueAtTime(t,l+o),f.gain.exponentialRampToValueAtTime(1e-4,l+e),u.connect(d).connect(f).connect(this.master),u.start(l),u.stop(l+e+.05)}click(){this.tone({type:`triangle`,f0:880,f1:1320,dur:.07,gain:.25}),this.noise({dur:.05,gain:.08,type:`highpass`,f0:3200})}clickBack(){this.tone({type:`triangle`,f0:660,f1:440,dur:.1,gain:.25})}pause(){this.tone({type:`sine`,f0:660,dur:.12,gain:.2}),this.tone({type:`sine`,f0:440,dur:.2,gain:.2,when:.11}),this.duckMusic(!0)}unpause(){this.tone({type:`sine`,f0:440,dur:.12,gain:.2}),this.tone({type:`sine`,f0:660,dur:.2,gain:.2,when:.11}),this.duckMusic(!1)}shoot(){let e=.88+Math.random()*.32;this.tone({type:`square`,f0:1500*e,f1:280*e,dur:.13,gain:.2}),this.tone({type:`sawtooth`,f0:720*e,f1:130*e,dur:.1,gain:.12}),this.noise({dur:.1,gain:.13,type:`bandpass`,f0:2800,f1:900,q:1.6})}hit(){this.noise({dur:.13,gain:.26,type:`lowpass`,f0:1800,f1:320}),this.tone({type:`sine`,f0:220,f1:85,dur:.12,gain:.22})}specialHit(){this.tone({type:`square`,f0:620,f1:430,dur:.09,gain:.13}),this.tone({type:`sine`,f0:1244,f1:1080,dur:.15,gain:.09,when:.005}),this.noise({dur:.12,gain:.13,type:`bandpass`,f0:2600,q:2})}deflect(){this.tone({type:`sine`,f0:300,f1:175,dur:.1,gain:.11}),this.noise({dur:.07,gain:.05,type:`bandpass`,f0:900,q:2})}pillarWarn(){this.tone({type:`sine`,f0:600,f1:1250,dur:.5,gain:.13}),this.noise({dur:.5,gain:.07,type:`bandpass`,f0:900,f1:2600,q:1.2})}pillarStrike(){this.noise({dur:.35,gain:.28,type:`highpass`,f0:1e3}),this.tone({type:`sawtooth`,f0:220,f1:55,dur:.4,gain:.24}),this.tone({type:`sine`,f0:90,f1:40,dur:.5,gain:.28,when:.02})}laserCharge(){this.tone({type:`sawtooth`,f0:700,f1:1700,dur:1,gain:.09}),this.tone({type:`sine`,f0:1400,f1:3100,dur:1,gain:.05})}laserFire(){this.tone({type:`sawtooth`,f0:1900,f1:260,dur:.22,gain:.16}),this.noise({dur:.18,gain:.11,type:`highpass`,f0:1500})}hurt(){this.tone({type:`sawtooth`,f0:300,f1:90,dur:.28,gain:.28}),this.noise({dur:.2,gain:.18,type:`lowpass`,f0:900,f1:200})}shield(){this.tone({type:`sine`,f0:500,f1:1200,dur:.28,gain:.18}),this.tone({type:`sine`,f0:750,f1:1800,dur:.28,gain:.1,when:.03})}switch(){this.tone({type:`square`,f0:520,f1:780,dur:.08,gain:.14})}cdReady(){this.tone({type:`sine`,f0:990,dur:.1,gain:.18}),this.tone({type:`sine`,f0:1480,dur:.16,gain:.18,when:.09})}aimPulse(){this.tone({type:`sine`,f0:1560,dur:.05,gain:.07})}levelUp(){[523,659,784,1047].forEach((e,t)=>this.tone({type:`triangle`,f0:e,dur:.14,gain:.2,when:t*.09}))}heal(){this.tone({type:`sine`,f0:660,f1:990,dur:.16,gain:.18}),this.tone({type:`sine`,f0:990,f1:1320,dur:.2,gain:.13,when:.11})}staminaOut(){this.tone({type:`sawtooth`,f0:400,f1:120,dur:.4,gain:.14}),this.tone({type:`sawtooth`,f0:300,f1:90,dur:.45,gain:.1,when:.05})}specialKill(){this.noise({dur:.5,gain:.32,type:`lowpass`,f0:2400,f1:200}),[880,1175,1568].forEach((e,t)=>this.tone({type:`sine`,f0:e,dur:.2,gain:.16,when:.08+t*.07}))}death(){[392,311,233,155].forEach((e,t)=>this.tone({type:`sawtooth`,f0:e,f1:e*.94,dur:.55,gain:.22,when:t*.35})),this.noise({dur:1.6,gain:.1,type:`lowpass`,f0:600,f1:80,when:.2})}impact(e){e===`ice`?(this.noise({dur:.32,gain:.2,type:`highpass`,f0:2200}),[1568,2093,2637].forEach((e,t)=>this.tone({type:`sine`,f0:e,f1:e*.85,dur:.24,gain:.15,when:t*.05}))):e===`fire`?(this.tone({type:`sine`,f0:150,f1:45,dur:.5,gain:.38}),this.noise({dur:.55,gain:.28,type:`lowpass`,f0:1600,f1:260}),this.noise({dur:.3,gain:.1,type:`bandpass`,f0:3e3,q:1.5,when:.05})):(this.noise({dur:.3,gain:.28,type:`bandpass`,f0:3e3,f1:600,q:.8}),this.tone({type:`sawtooth`,f0:180,f1:60,dur:.35,gain:.22}),this.tone({type:`square`,f0:2400,f1:400,dur:.1,gain:.08}))}startMusic(){let e=this.ensure();e&&(this._music||=new Ap(e,this.master),this._music.start())}stopMusic(e=1.5){this._music?.stop(e),this._music=null}duckMusic(e){this._music?.duck(e)}AMBIENT={neutral:{type:`lowpass`,f0:350,q:.6,gain:.045,lfoF:.13,lfoAmt:120},ice:{type:`bandpass`,f0:1100,q:1.4,gain:.05,lfoF:.3,lfoAmt:500},fire:{type:`lowpass`,f0:260,q:.9,gain:.06,lfoF:.55,lfoAmt:90},storm:{type:`bandpass`,f0:500,q:.7,gain:.055,lfoF:.4,lfoAmt:320}};setRealm(e){this.realm=this.AMBIENT[e]?e:`neutral`;let t=this.ensure();if(t&&!(this._ambient&&this._ambient.realm===this.realm)){if(this._ambient){let{src:e,g:n}=this._ambient,r=t.currentTime;n.gain.cancelScheduledValues(r),n.gain.setValueAtTime(Math.max(1e-4,n.gain.value),r),n.gain.exponentialRampToValueAtTime(1e-4,r+.6),e.stop(r+.65),this._ambient=null}this._startAmbient(this.realm)}}_startAmbient(e){let t=this.AMBIENT[e];if(!t||!this.ctx)return;let n=this.ctx.createBufferSource();n.buffer=this.noiseBuf,n.loop=!0;let r=this.ctx.createBiquadFilter();r.type=t.type,r.frequency.value=t.f0,r.Q.value=t.q;let i=this.ctx.createGain();i.gain.setValueAtTime(1e-4,this.ctx.currentTime),i.gain.exponentialRampToValueAtTime(t.gain,this.ctx.currentTime+1.2);let a=this.ctx.createOscillator();a.frequency.value=t.lfoF;let o=this.ctx.createGain();o.gain.value=t.lfoAmt,a.connect(o).connect(r.frequency),n.connect(r).connect(i).connect(this.master),n.start(),a.start(),this._ambient={realm:e,src:n,g:i,lfo:a,lfoGain:o}}},Ap=class{constructor(e,t){Math.PI*2,this.ctx=e,this.BPM=80,this.stepDur=60/this.BPM/4,this.swing=.032,this.STEPS=128,this.out=e.createGain(),this.out.gain.value=.16,this.out.connect(t),this.delay=e.createDelay(2),this.delay.delayTime.value=this.stepDur*6,this.dfb=e.createGain(),this.dfb.gain.value=.42,this.dflt=e.createBiquadFilter(),this.dflt.type=`lowpass`,this.dflt.frequency.value=2100,this.delay.connect(this.dfb).connect(this.dflt).connect(this.delay),this.delay.connect(this.out);let n=e.createBufferSource();n.buffer=this._makeNoise(),n.loop=!0;let r=e.createBiquadFilter();r.type=`bandpass`,r.frequency.value=4200,r.Q.value=.4;let i=e.createGain();i.gain.value=.006,n.connect(r).connect(i).connect(this.out),n.start(),this.CHORDS=[{bass:55,pad:[220,261.63,329.63,493.88]},{bass:43.65,pad:[174.61,220,261.63,329.63]},{bass:65.41,pad:[261.63,329.63,392,493.88]},{bass:49,pad:[196,246.94,293.66,440]}],this.PIANO=[{s:0,n:659.26,d:2},{s:6,n:523.25,d:2},{s:10,n:587.33,d:2},{s:14,n:493.88,d:2},{s:16,n:440,d:4},{s:24,n:392,d:2},{s:28,n:440,d:3},{s:32,n:523.25,d:2},{s:38,n:440,d:2},{s:42,n:349.23,d:4},{s:48,n:392,d:3},{s:54,n:440,d:2},{s:58,n:523.25,d:3},{s:64,n:659.26,d:2},{s:70,n:587.33,d:2},{s:74,n:523.25,d:2},{s:78,n:392,d:2},{s:84,n:329.63,d:4},{s:92,n:392,d:4},{s:96,n:587.33,d:2},{s:102,n:493.88,d:2},{s:106,n:440,d:2},{s:110,n:392,d:2},{s:116,n:440,d:4},{s:124,n:493.88,d:4}],this.GUITAR=[{s:2,n:659.26,d:3},{s:10,n:783.99,d:3},{s:18,n:659.26,d:2},{s:26,n:523.25,d:4},{s:34,n:587.33,d:3},{s:44,n:523.25,d:3},{s:52,n:440,d:4},{s:66,n:783.99,d:3},{s:74,n:659.26,d:2},{s:82,n:587.33,d:4},{s:90,n:523.25,d:4},{s:98,n:880,d:4},{s:106,n:783.99,d:3},{s:114,n:659.26,d:3},{s:122,n:587.33,d:4}],this.step=0,this.cycle=0,this.nextTime=0,this.timer=null,this.ducked=!1,this.stopping=!1}_makeNoise(){let e=Math.floor(this.ctx.sampleRate*2),t=this.ctx.createBuffer(1,e,this.ctx.sampleRate),n=t.getChannelData(0);for(let t=0;t<e;t++)n[t]=Math.random()*2-1;return t}start(){this.timer||=(this.stopping=!1,this.out.gain.cancelScheduledValues(this.ctx.currentTime),this.out.gain.setTargetAtTime(this.ducked?.04:.16,this.ctx.currentTime,.8),this.nextTime=this.ctx.currentTime+.15,setInterval(()=>this._tick(),250))}stop(e=1.5){if(!this.timer)return;clearInterval(this.timer),this.timer=null;let t=this.ctx.currentTime;this.out.gain.cancelScheduledValues(t),this.out.gain.setTargetAtTime(1e-4,t,e/3);let n=this;setTimeout(()=>n.out.disconnect(),e*1e3+400)}duck(e){this.ducked=e,this.out.gain.setTargetAtTime(e?.035:.16,this.ctx.currentTime,.5)}_tick(){for(;this.nextTime<this.ctx.currentTime+1.5;)this._scheduleStep(this.step,this.cycle,this.nextTime),this.step++,this.step>=this.STEPS&&(this.step=0,this.cycle=(this.cycle+1)%4),this.nextTime+=this.stepDur}_scheduleStep(e,t,n){let r=n+(e%2==1?this.swing:0),i=this.CHORDS[Math.floor(e/32)],a=e%16;t>=1&&!(t===3&&e>=96)&&(a===0&&this._kick(r),a===7&&this._kick(r,.8),a===10&&this._kick(r,.9),(a===4||a===12)&&this._rim(r)),e%32==0&&this._bass(i.bass,r,this.stepDur*10),e%32==20&&this._bass(i.bass*2,r,this.stepDur*3,.6);for(let n of this.PIANO)n.s===e&&this._piano(n.n,r,n.d*this.stepDur,t===0?.16:.13);if(e%32==0&&t>=1){let e=t===0?.02:t===3?.03:.042;for(let t of i.pad)this._pad(t,r,this.stepDur*30,e)}if(t===2&&e%32==0)for(let e of i.pad.slice(1,3))this._voice(e,r,this.stepDur*26);if(t>=2)for(let n of this.GUITAR)n.s===e&&this._guitar(n.n,r,n.d*this.stepDur,t===2?.09:.06)}_kick(e,t=1){let n=this.ctx,r=n.createOscillator(),i=n.createGain();r.type=`sine`,r.frequency.setValueAtTime(120,e),r.frequency.exponentialRampToValueAtTime(42,e+.12),i.gain.setValueAtTime(.5*t,e),i.gain.exponentialRampToValueAtTime(.001,e+.22),r.connect(i).connect(this.out),r.start(e),r.stop(e+.25)}_rim(e){let t=this.ctx,n=t.createBufferSource();n.buffer=this._makeNoise();let r=t.createBiquadFilter();r.type=`bandpass`,r.frequency.value=1900,r.Q.value=2.5;let i=t.createGain();i.gain.setValueAtTime(.09,e),i.gain.exponentialRampToValueAtTime(.001,e+.06),n.connect(r).connect(i).connect(this.out),n.start(e,Math.random()),n.stop(e+.08)}_bass(e,t,n,r=1){let i=this.ctx,a=i.createOscillator(),o=i.createGain();a.type=`sine`,a.frequency.value=e,o.gain.setValueAtTime(1e-4,t),o.gain.exponentialRampToValueAtTime(.17*r,t+.06),o.gain.setValueAtTime(.17*r,t+n-.1),o.gain.exponentialRampToValueAtTime(.001,t+n),a.connect(o).connect(this.out),a.start(t),a.stop(t+n+.05)}_piano(e,t,n,r){let i=this.ctx;for(let[a,o]of[[1,1],[2,.22],[4,.05]]){let s=i.createOscillator(),c=i.createGain();s.type=`sine`,s.frequency.value=e*a;let l=.02*o,u=r*o;c.gain.setValueAtTime(1e-4,t),c.gain.exponentialRampToValueAtTime(u,t+l),c.gain.exponentialRampToValueAtTime(.001,t+n+.3),s.connect(c).connect(this.out),s.start(t),s.stop(t+n+.35)}}_pad(e,t,n,r){let i=this.ctx,a=i.createOscillator(),o=i.createBiquadFilter();o.type=`lowpass`,o.frequency.value=900;let s=i.createGain();a.type=`triangle`,a.frequency.value=e,a.detune.value=(Math.random()-.5)*8,s.gain.setValueAtTime(1e-4,t),s.gain.linearRampToValueAtTime(r,t+1.4),s.gain.setValueAtTime(r,t+n-1.2),s.gain.linearRampToValueAtTime(1e-4,t+n),a.connect(o).connect(s).connect(this.out),a.start(t),a.stop(t+n+.1)}_voice(e,t,n){let r=this.ctx,i=r.createOscillator(),a=r.createGain();i.type=`sine`,i.frequency.value=e*2;let o=r.createOscillator();o.frequency.value=5.2;let s=r.createGain();s.gain.value=3.5,o.connect(s).connect(i.detune),a.gain.setValueAtTime(1e-4,t),a.gain.linearRampToValueAtTime(.035,t+1.6),a.gain.setValueAtTime(.035,t+n-1.4),a.gain.linearRampToValueAtTime(1e-4,t+n),i.connect(a).connect(this.out),i.start(t),o.start(t),i.stop(t+n+.1),o.stop(t+n+.1)}_guitar(e,t,n,r){let i=this.ctx,a=i.createOscillator(),o=i.createBiquadFilter(),s=i.createGain();a.type=`triangle`,a.frequency.value=e,o.type=`lowpass`,o.frequency.setValueAtTime(3400,t),o.frequency.exponentialRampToValueAtTime(1100,t+n+.4),s.gain.setValueAtTime(1e-4,t),s.gain.exponentialRampToValueAtTime(r,t+.008),s.gain.exponentialRampToValueAtTime(.001,t+n+.5),a.connect(o).connect(s),s.connect(this.out),s.connect(this.delay),a.start(t),a.stop(t+n+.55)}},jp=Object.freeze({CORE:0,SHELL:1,HALO:2,COIL:3,RING:4});function Mp(e={}){return{radius:.77,radiusNear:.16,radiusCurve:1.27,flare:1.74,flareWidth:.09,throb:0,throbScale:4.8,throbSpeed:2.6,wander:0,wanderScale:.9,wanderSpeed:.7,ripple:.2,rippleBands:2.2,rippleScale:4.25,rippleSpeed:2,streak:1.1,streakSharp:.45,streakScale:4.2,streakBands:1.8,streakGlow:.55,flowSpeed:7,coreWidth:.2,coreSharp:1.55,coreFill:.6,shellWidth:1,shellRim:1.15,shellFill:.18,shellOpacity:.95,haloWidth:2.75,haloRim:4.3,haloOpacity:.14,edgePower:2.2,mouthGlow:1.6,mouthLength:.1,tipGlow:.6,tipLength:.09,coils:4,coilTurns:1.45,coilSpeed:-.69,coilRadius:1.88,coilFlare:.57,coilWidth:.1,coilWidthTip:1.9,coilSharp:2.2,coilPulse:.65,coilPulseFreq:3,coilPulseSpeed:1.6,coilGlow:8,coilOpacity:2,rings:10,ringSpeed:1.31,ringInner:2.42,ringOuter:2.73,ringSwell:.55,ringFade:.18,ringSharp:1.6,ringGlow:2.4,ringOpacity:.7,glow:.74,opacity:.29,colorCore:`#ffffff`,colorInner:`#d3f4ff`,colorOuter:`#3ec6ff`,colorHalo:`#0d3ce0`,colorCoil:`#ffdc8c`,colorCoilEdge:`#ff6a12`,colorRing:`#9ceeff`,...e}}var Np=`
  #define PI  3.141592653589793
  #define TAU 6.283185307179586
...
`;function Lp(e=jp.CORE,t){let n=t,r=new Va({defines:{BEAM_PASS:e},transparent:!0,depthWrite:!1,depthTest:!0,blending:2,side:2,toneMapped:!1,uniforms:Sf({uOrigin:{value:new U},uTarget:{value:new U(0,0,1)},uSide:{value:new U(1,0,0)},uSeed:{value:0},uProgress:{value:0},uFade:{value:1},uWidthFade:{value:1},uRadius:{value:n.radius},uRadiusNear:{value:n.radiusNear},uRadiusCurve:{value:n.radiusCurve},uRadiusScale:{value:1},uFlare:{value:n.flare},uFlareWidth:{value:n.flareWidth},uThrob:{value:n.throb},uThrobScale:{value:n.throbScale},uThrobSpeed:{value:n.throbSpeed},uWander:{value:n.wander},uWanderScale:{value:n.wanderScale},uWanderSpeed:{value:n.wanderSpeed},uRipple:{value:n.ripple},uRippleBands:{value:n.rippleBands},uRippleScale:{value:n.rippleScale},uRippleSpeed:{value:n.rippleSpeed},uStreak:{value:n.streak},uStreakSharp:{value:n.streakSharp},uStreakScale:{value:n.streakScale},uStreakBands:{value:n.streakBands},uStreakGlow:{value:n.streakGlow},uFlowSpeed:{value:n.flowSpeed},uCoreSharp:{value:n.coreSharp},uCoreFill:{value:n.coreFill},uEdgePower:{value:n.edgePower},uShellRim:{value:n.shellRim},uShellFill:{value:n.shellFill},uHaloRim:{value:n.haloRim},uPassOpacity:{value:1},uMouthGlow:{value:n.mouthGlow},uMouthLength:{value:n.mouthLength},uTipGlow:{value:n.tipGlow},uTipLength:{value:n.tipLength},uCoils:{value:n.coils},uCoilTurns:{value:n.coilTurns},uCoilSpeed:{value:n.coilSpeed},uCoilRadius:{value:n.coilRadius},uCoilFlare:{value:n.coilFlare},uCoilWidth:{value:n.coilWidth},uCoilWidthTip:{value:n.coilWidthTip},uCoilSharp:{value:n.coilSharp},uCoilPulse:{value:n.coilPulse},uCoilPulseFreq:{value:n.coilPulseFreq},uCoilPulseSpeed:{value:n.coilPulseSpeed},uRingCount:{value:n.rings},uRingSpeed:{value:n.ringSpeed},uRingInner:{value:n.ringInner},uRingOuter:{value:n.ringOuter},uRingSwell:{value:n.ringSwell},uRingFade:{value:n.ringFade},uRingSharp:{value:n.ringSharp},uOpacity:{value:n.opacity},uGlow:{value:n.glow},uColorCore:{value:new q(n.colorCore)},uColorInner:{value:new q(n.colorInner)},uColorOuter:{value:new q(n.colorOuter)},uColorHalo:{value:new q(n.colorHalo)},uColorCoil:{value:new q(n.colorCoil)},uColorCoilEdge:{value:new q(n.colorCoilEdge)},uColorRing:{value:new q(n.colorRing)}}),vertexShader:Fp,fragmentShader:Ip});return r.userData.sync=t=>{let i=r.uniforms;switch(i.uOrigin.value.copy(t.origin),i.uTarget.value.copy(t.target),i.uSide.value.copy(t.side),i.uSeed.value=t.seed,i.uProgress.value=t.progress,i.uFade.value=t.fade,i.uWidthFade.value=t.widthFade,i.uRadius.value=n.radius,i.uRadiusNear.value=n.radiusNear,i.uFlare.value=n.flare,i.uGlow.value=n.glow,i.uOpacity.value=n.opacity,i.uColorCore.value.set(n.colorCore),i.uColorInner.value.set(n.colorInner),i.uColorOuter.value.set(n.colorOuter),i.uColorHalo.value.set(n.colorHalo),i.uColorCoil.value.set(n.colorCoil),i.uColorCoilEdge.value.set(n.colorCoilEdge),i.uColorRing.value.set(n.colorRing),i.uCoils.value=t.coils,i.uRingCount.value=t.rings,e){case jp.CORE:i.uRadiusScale.value=n.coreWidth,i.uPassOpacity.value=1,i.uGlow.value=n.glow;break;case jp.SHELL:i.uRadiusScale.value=n.shellWidth,i.uPassOpacity.value=n.shellOpacity,i.uGlow.value=n.glow;break;case jp.HALO:i.uRadiusScale.value=n.haloWidth,i.uPassOpacity.value=n.haloOpacity,i.uGlow.value=n.glow*.8;break;case jp.COIL:i.uRadiusScale.value=1,i.uPassOpacity.value=n.coilOpacity,i.uGlow.value=n.coilGlow;break;case jp.RING:i.uRadiusScale.value=1,i.uPassOpacity.value=n.ringOpacity,i.uGlow.value=n.ringGlow}},r}var Rp=12,zp=40,Bp=7.2,Vp=1.5,Hp=25,Up=1,Wp=.35,Gp=4,Kp=1.8,qp=50,Jp={ice:`#2f7dff`},Yp=20;function Xp(){return Up+Math.random()*9}var Zp=class{constructor(e,t,n){this.scene=e,this.bursts=t,this.vfx=n,this.onCollect=null,this._laserTubeGeo=zf(48,18),this._laserOrbGeo=new Da(1,3);let r=document.createElement(`canvas`);r.width=r.height=64;let i=r.getContext(`2d`),a=i.createRadialGradient(32,32,2,32,32,30);a.addColorStop(0,`rgba(255,255,255,1)`),a.addColorStop(.35,`rgba(255,255,255,0.45)`),a.addColorStop(1,`rgba(255,255,255,0)`),i.fillStyle=a,i.fillRect(0,0,64,64);let o=new va(r);this._group=new En,e.add(this._group),this._bodyMaterial=new Ua({color:`#dceaff`,emissive:`#8fc6ef`,emissiveIntensity:2.2,roughness:.35}),this._haloMaterial=new Pr({map:o,color:`#9cc3e8`,transparent:!0,opacity:.6,blending:2,depthWrite:!1}),this._bandMaterial=new Ua({color:`#232833`,roughness:.55,metalness:.75}),this.spirits=[];for(let e=0;e<Rp;e++){let t=new En,n=new Y(new Oa(.3,0),this._bodyMaterial);n.scale.set(.82,1.7,.82);let r=new Y(new Ma(.4,.04,6,22),this._bandMaterial);r.rotation.set(Math.random()*1.2+.5,0,Math.random()*Math.PI);let i=new Jr(this._haloMaterial);i.scale.setScalar(2.2),t.add(n,r,i),this._group.add(t),this.spirits.push({group:t,core:n,band:r,halo:i,alive:!1,respawn:0,pos:new U,wander:new U,phase:Math.random()*Math.PI*2,baseY:1.1+Math.random()*.8,chasing:!1}),this._place(this.spirits[e])}for(let e of this.spirits)e.group.visible=!1;this._accent=new q(`#9fd8ff`),this.onPlayerHit=null,this._frozen=!1,this._normalTarget=3,this._specialTarget=1,this.laserTier=1,this.specials=[],this._specialTimer=Xp(),this.onSpecialSpawn=null,this.active=!1,this._pendingStart=!1,this._startCountdown=0,this._spawnNormalCount=5;let s=new Ma(.82,.055,8,42),c=new Ta(.1,.34,5);for(let e=0;e<6;e++){let e=new En,t=new Y(new Da(.46,1),new Ua({color:`#151922`,emissive:`#9fd8ff`,emissiveIntensity:1.6,roughness:.45,metalness:.7,flatShading:!0})),n=new Y(new Oa(.26,0),new Ua({color:`#dfeeff`,emissive:`#9fd8ff`,emissiveIntensity:2.6,roughness:.25}));n.position.y=.52;let r=new Y(s,new ii({color:`#9fd8ff`,transparent:!0,opacity:.85}));r.rotation.x=1.35;for(let e=0;e<3;e++){let t=new Y(c,this._bandMaterial),n=e/3*Math.PI*2;t.position.set(Math.cos(n)*.82,0,Math.sin(n)*.82),t.rotation.z=Math.PI,t.rotation.y=-n,r.add(t)}let i=new Jr(new Pr({map:o,color:`#9fd8ff`,transparent:!0,opacity:.85,blending:2,depthWrite:!1}));i.scale.setScalar(3.4),e.add(t,n,r,i),e.visible=!1,this._group.add(e);let a=Mp({radius:.16,radiusNear:.06,radiusCurve:1,flare:0,flareWidth:.05,coreWidth:.3,shellWidth:1,haloWidth:2.6,shellOpacity:1.4,haloOpacity:.4,opacity:1.8,glow:1.8,ripple:.3,streak:1,flowSpeed:9,tipGlow:1.6,mouthGlow:.8,wander:.05}),l=[],u=[];for(let e of[jp.HALO,jp.SHELL,jp.CORE]){let t=Lp(e,a),n=new Y(this._laserTubeGeo,t);n.frustumCulled=!1,n.matrixAutoUpdate=!1,n.renderOrder=11+(jp.CORE-e),n.visible=!1,this._group.add(n),l.push(n),u.push(t)}let d=new Y(this._laserOrbGeo,Gf({inner:`#d3f4ff`,outer:`#9fd8ff`,glow:2.6}));d.visible=!1,d.renderOrder=9,this._group.add(d);let f={group:e,core:t,crystal:n,ring:r,halo:i,alive:!1,element:`ice`,pos:new U,baseY:1.4,phase:Math.random()*Math.PI*2,flash:0,basicHits:0,wander:new U,laserMeshes:l,laserMaterials:u,laserConfig:a,laserOrb:d,laserState:{origin:new U,target:new U,side:new U(1,0,0),progress:0,fade:1,widthFade:1,seed:0,coils:0,rings:0},laser:{state:`idle`,t:0,cd:1.5+Math.random()*1.5,from:new U,dir:new U,len:0,hitDone:!1}};this.specials.push(f)}}_laserCd(){return Math.max(.45,2.2-(this.laserTier-5)*.35)*(.8+Math.random()*.4)}_hideLaser(e){for(let t of e.laserMeshes)t.visible=!1;e.laserOrb.visible=!1}_tintLaser(e){let t=Jp[e.element]??uf[e.element].accent,n=e.laserConfig,r=new q(t);n.colorCore=`#ffffff`,n.colorInner=`#`+r.clone().lerp(new q(`#ffffff`),.55).getHexString(),n.colorOuter=t,n.colorHalo=`#`+r.clone().multiplyScalar(.28).getHexString(),e.laserOrb.material.userData.setPalette({inner:n.colorInner,outer:t})}_syncLaser(e,t,n,r,i,a,o){let s=e.laserState;s.origin.copy(t),s.target.copy(t).addScaledVector(n,r),s.progress=i,s.fade=a,s.widthFade=o;for(let t of e.laserMaterials)t.userData.sync(s)}_updateLaser(e,t,n){let r=e.laser;if(r.t+=t,this.laserTier<5||this._frozen||!n){r.state!==`idle`&&(r.state=`idle`,r.cd=this._laserCd(),this._hideLaser(e));return}switch(r.state){case`idle`:this._hideLaser(e),r.cd-=t,r.cd<=0&&(r.from.set(e.pos.x,e.baseY,e.pos.z),r.dir.set(n.x-r.from.x,1.15-e.baseY,n.z-r.from.z),r.len=r.dir.length(),r.dir.divideScalar(r.len),r.len>2.2?(r.state=`tele`,r.t=0,r.hitDone=!1,this._tintLaser(e),$.laserCharge()):r.cd=.5);break;case`tele`:{r.from.set(e.pos.x,e.baseY,e.pos.z);let t=Math.min(1,Math.max(0,r.t/1));this._syncLaser(e,r.from,r.dir,r.len+170,.055,.35+.45*Math.abs(Math.sin(r.t*12)),1);for(let t of e.laserMeshes)t.visible=!0;e.laserOrb.visible=!0,e.laserOrb.position.copy(r.from),e.laserOrb.scale.setScalar(.26+t*.34),e.laserOrb.material.uniforms.uCharge.value=t,r.t>=1&&(r.state=`fire`,r.t=0,e.laserOrb.visible=!1,this.vfx?.sparkBurst(r.from,e.element,{count:18,speed:5,life:.5,size:.9,up:.6,radius:.3}),$.laserFire());break}case`fire`:{let t=.22;r.from.set(e.pos.x,e.baseY,e.pos.z);let i=r.t/t;if(this._syncLaser(e,r.from,r.dir,r.len+170,1,1-i,1-.45*i),e.laserOrb.visible=i<.4,e.laserOrb.material.uniforms.uCharge.value=Math.max(0,1-i*2.5),!r.hitDone){let e=Math.hypot(r.dir.x,r.dir.z)||1,t=r.dir.x/e,i=r.dir.z/e,a=n.x-r.from.x,o=n.z-r.from.z,s=Math.max(0,Math.min(r.len+170,a*t+o*i)),c=r.from.x+t*s,l=r.from.z+i*s;Math.hypot(n.x-c,n.z-l)<1.1&&(r.hitDone=!0,this.onPlayerHit?.(10))}r.t>=t&&(this._hideLaser(e),r.state=`idle`,r.cd=this._laserCd());break}}}setAccent(e){this._accent.set(e)}setNormalTarget(e){this._normalTarget=Math.min(e,this.spirits.length)}setSpecialTarget(e){this._specialTarget=Math.min(e,this.specials.length)}setSpecialTarget(e){this._specialTarget=Math.min(e,this.specials.length)}setNormalTarget(e){this._activeNormals=Math.min(e,this.spirits.length)}begin(e,t=3){this.active=!0,this._normalTarget=t,this._spawnAll(e,t)}_spawnAll(e,t){for(let n=0;n<t;n++){let r=n/t*Math.PI*2+Math.random()*.8,i=20+Math.random()*20,a=this.spirits[n];a&&(a.alive=!0,a.chasing=!1,a.pos.set((e?e.x:0)+Math.cos(r)*i,a.baseY,(e?e.z:0)+Math.sin(r)*i),a.group.visible=!0)}}setFrozen(e){if(this._frozen=e,e)for(let e of this.specials)this._hideLaser(e),e.laser.state!==`idle`&&(e.laser.state=`idle`,e.laser.cd=this._laserCd())}setTargets(e,t){this._normalTarget=e,this._specialTarget=t}respawnAll(e,t=3){this._normalTarget=t;for(let n=0;n<this.spirits.length;n++){let r=this.spirits[n];n<t?(r.alive=!0,r.chasing=!1,this._place(r,e),r.group.visible=!0):(r.alive=!1,r.group.visible=!1)}for(let e of this.specials)e.alive=!1,e.group.visible=!1,this._hideLaser(e);this._specialTimer=Xp()}reset(){this.active=!1,this._pendingStart=!1;for(let e of this.spirits)e.alive=!1,e.chasing=!1,e.group.visible=!1;for(let e of this.specials)e.alive=!1,e.group.visible=!1,this._hideLaser(e);this._specialTimer=Xp()}spawnSpecial(e){let t=this.specials.find(e=>!e.alive);if(!t)return;let n=[`ice`,`fire`,`storm`],r=n[Math.floor(Math.random()*n.length)],i=Jp[r]??uf[r].accent;t.element=r,t.alive=!0,t.flash=0,t.basicHits=0;let a=Math.random()*Math.PI*2,o=Yp+Math.random()*15,s=e?e.x:0,c=e?e.z:0;t.pos.set(s+Math.cos(a)*o,t.baseY,c+Math.sin(a)*o),t.wander.set(0,0,0),t.laser.state=`idle`,t.laser.t=0,t.laser.cd=1.2+Math.random()*1.2,t.laser.hitDone=!1,this._hideLaser(t),t.core.material.emissive.set(i),t.crystal.material.emissive.set(i),t.ring.material.color.set(i),t.halo.material.color.set(i),t.group.visible=!0,t.group.position.set(t.pos.x,t.baseY,t.pos.z),this.onSpecialSpawn?.(r,i)}_place(e,t,n=20,r=40){let i=Math.random()*Math.PI*2,a=n+Math.random()*(r-n),o=t?t.x:0,s=t?t.z:0;e.pos.set(o+Math.cos(i)*a,e.baseY,s+Math.sin(i)*a),e.group.position.copy(e.pos),e.group.visible=e.alive}collectAt(e,t,n=`basic`,r=`neutral`,i){let a=0,o=0,s=0,c=0;for(let n of this.spirits){if(!n.alive)continue;let r=n.pos.x-e.x,i=n.pos.z-e.z;r*r+i*i<=t*t&&(n.alive=!1,n.respawn=2.4+Math.random()*1.4,n.group.visible=!1,this.vfx?.killBurst(n.pos,`basic`,1),a++)}for(let a of this.specials){if(!a.alive)continue;let l=a.pos.x-e.x,u=a.pos.z-e.z;if(l*l+u*u<=t*t){if(n===`basic`){if(i?.has(a))continue;i?.add(a)}n!==`basic`&&a.element===n?(a.alive=!1,a.group.visible=!1,this._hideLaser(a),this.vfx?.killBurst(a.pos,a.element,1.7),o++):n===`basic`&&r===a.element?(a.basicHits++,a.basicHits>=3?(a.alive=!1,a.group.visible=!1,this._hideLaser(a),this.vfx?.killBurst(a.pos,a.element,1.7),o++):(a.flash=Wp,s++,this.vfx?.sparkBurst(a.pos,`basic`,{count:12,speed:3.5,life:.45,size:.6,up:.6,radius:.3}))):(a.flash=Wp,c++)}}return{normal:a,special:o,specialHit:s,immune:c}}update(e,t,n){if(!this._frozen&&this.active){this._specialTimer-=e,this._specialTimer<=0&&(this._specialTimer=Xp(),this.specials.filter(e=>e.alive).length<this._specialTarget&&this.spawnSpecial(n));for(let r of this.specials){if(!r.alive){(r.laserMeshes.some(e=>e.visible)||r.laserOrb.visible)&&(this._hideLaser(r),r.laser.state!==`idle`&&(r.laser.state=`idle`,r.laser.cd=this._laserCd()));continue}r.flash=Math.max(0,r.flash-e),r.phase+=e;let i=!1,a=!1;if(n){let t=n.x-r.pos.x,o=n.z-r.pos.z,s=Math.hypot(t,o);s>.001&&(r.pos.x+=t/s*Gp*e,r.pos.z+=o/s*Gp*e,i=!0,s<Kp&&(a=!0))}if(a){r.alive=!1,r.group.visible=!1,this._hideLaser(r),this.vfx?.killBurst(r.pos,r.element,1.7),this.onPlayerHit?.(qp);continue}if(!i){if(r.wander.lengthSq()<.001||Math.random()<e*.4){let e=Math.random()*Math.PI*2;r.wander.set(Math.cos(e),0,Math.sin(e)).multiplyScalar(.35)}r.pos.addScaledVector(r.wander,e),Math.hypot(r.pos.x,r.pos.z)>48&&r.wander.multiplyScalar(-1)}r.group.position.set(r.pos.x,r.baseY+Math.sin(t*1.6+r.pos.x)*.26,r.pos.z),r.ring.rotation.z+=e*1.3,r.ring.rotation.x+=e*.45;let o=r.flash/Wp;r.core.rotation.y+=e*(1.2+o*6),r.core.material.emissiveIntensity=1.6+o*8,r.crystal.rotation.y-=e*(1.8+o*6),r.crystal.material.emissiveIntensity=2.6+o*9+Math.sin(t*3.1+r.phase)*.5,r.halo.scale.setScalar(3.2+o*1.4+Math.sin(t*2.6+r.pos.z)*.2),this._updateLaser(r,e,n)}for(let r=0;r<this.spirits.length;r++){let i=this.spirits[r],a=r<this._normalTarget;if(!i.alive){i.respawn-=e,i.respawn<=0&&a&&(i.alive=!0,i.chasing=!1,this._place(i,n),i.group.visible=!0);continue}if(n){let t=n.x-i.pos.x,r=n.z-i.pos.z,a=Math.hypot(t,r);if(a>.001&&(i.pos.x+=t/a*Bp*e,i.pos.z+=r/a*Bp*e,a<Vp)){i.alive=!1,i.respawn=2.4+Math.random()*1.4,i.group.visible=!1,this.vfx?.killBurst(i.pos,`basic`,1),this.onPlayerHit?.(Hp);continue}}if(!i.chasing){if(i.phase+=e,i.phase>3.5||i.wander.lengthSq()<.001){i.phase=0;let e=Math.random()*Math.PI*2;i.wander.set(Math.cos(e),0,Math.sin(e)).multiplyScalar(.55)}i.pos.addScaledVector(i.wander,e),Math.hypot(i.pos.x,i.pos.z)>zp&&i.wander.multiplyScalar(-1)}i.group.position.set(i.pos.x,i.baseY+Math.sin(t*(i.chasing?3.4:1.7)+i.pos.x)*.22,i.pos.z),i.core.rotation.y+=e*(i.chasing?2.6:1.4),i.core.rotation.x+=e*.6,i.band.rotation.y-=e*(i.chasing?2.2:.8),i.band.rotation.x=.9+Math.sin(t*1.3+i.phase)*.35,i.halo.scale.setScalar((2+Math.sin(t*3.1+i.pos.z)*.25)*(i.chasing?1.3:1))}this._touched>0&&this.onTouch?.(this._touched)}}dispose(){this.scene.remove(this._group),this._group.traverse(e=>{e.geometry&&e.geometry.dispose()});for(let e of this.specials){for(let t of e.laserMaterials)t.dispose();e.laserOrb?.material.dispose()}this._bodyMaterial.dispose(),this._haloMaterial.dispose(),this._bandMaterial.dispose()}},Qp=class{constructor(){this.worldBadge=document.getElementById(`worldBadge`),this.worldGlyph=document.getElementById(`worldGlyph`),this.worldName=document.getElementById(`worldName`),this.lockHint=document.getElementById(`lockHint`),this.lockHint.classList.add(`is-hidden`),this.startScreen=document.getElementById(`startScreen`),this.healthFill=document.getElementById(`healthFill`),this.healthNum=document.getElementById(`healthNum`),this.healthPanel=document.querySelector(`.hud-health`),this.streakEl=document.getElementById(`streak`),this.staminaFill=document.getElementById(`staminaFill`),this.staminaNum=document.getElementById(`staminaNum`),this.fpsNum=document.getElementById(`fpsNum`),this.fpsNum=document.getElementById(`fpsNum`),this.levelBadge=document.getElementById(`levelBadge`),this._levelShown=1,this.gameOverScreen=document.getElementById(`gameOverScreen`),this.pauseScreen=document.getElementById(`pauseScreen`),this.finalScore=document.getElementById(`finalScore`),this.toast=document.getElementById(`toast`),this.edgeHint=document.getElementById(`edgeHint`),this.scoreElement=document.getElementById(`score`),this.scorePanel=document.querySelector(`.hud-score`),this.help=document.getElementById(`help`),this.vignette=document.getElementById(`vignette`),this.castFlashEl=document.getElementById(`castFlash`),this.skills=new Map;for(let e of document.querySelectorAll(`.skill`))this.skills.set(e.dataset.element,{root:e,card:null,numEl:e.querySelector(`.skill__cd-num`)}),e.addEventListener(`pointerdown`,t=>{t.stopPropagation(),this.onSkill?.(e.dataset.element)});this._toastTimer=0,this._cooldownShown=new Map,this.onSkill=null}setWorld(e){this.worldGlyph.textContent=e.glyph,this.worldName.textContent=e.label,this.worldBadge.style.setProperty(`--world-accent`,e.accent),this.worldBadge.style.setProperty(`--world-border`,e.accent+`59`),this.worldBadge.style.setProperty(`--world-glow`,e.accent+`40`),this.worldBadge.classList.remove(`is-pop`),this.worldBadge.offsetWidth,this.worldBadge.classList.add(`is-pop`)}setStamina(e,t){let n=Math.max(0,Math.min(100,e));this.staminaFill.style.width=`${n}%`,this.staminaFill.classList.toggle(`is-exhausted`,t),this.staminaNum.textContent=`${Math.round(n)}%`,this.staminaNum.style.color=t?`#ff5a4d`:`#9fd8ff`}setFps(e){this.fpsNum.textContent=e,this.fpsNum.className=e>=50?`is-ok`:e>=30?`is-mid`:`is-low`}hurtFlash(){this.vignette.classList.remove(`is-hurt`),this.vignette.offsetWidth,this.vignette.classList.add(`is-hurt`)}castFlash(e){this.castFlashEl&&(this.castFlashEl.style.setProperty(`--flash-color`,e),this.castFlashEl.classList.remove(`is-flash`),this.castFlashEl.offsetWidth,this.castFlashEl.classList.add(`is-flash`))}setStreak(e){this._streak=e,this._refreshStreak()}_refreshStreak(){let e=this._streak??0,t=this._hp??100;e>0&&t<100?(this.streakEl.textContent=`生命恢复 ${Math.min(e,9)}/9`,this.streakEl.classList.add(`is-visible`)):this.streakEl.classList.remove(`is-visible`)}setLevel(e){if(e===this._levelShown)return;let t=e>this._levelShown;this._levelShown=e,this.levelBadge.textContent=`LV.${e}`,t&&(this.levelBadge.classList.remove(`is-bump`),this.levelBadge.offsetWidth,this.levelBadge.classList.add(`is-bump`))}hideStartScreen(){this.startScreen.classList.add(`is-hidden`)}showStartScreen(){this.startScreen.classList.remove(`is-hidden`)}setHealth(e){this._hp=e;let t=Math.max(0,Math.min(100,e));this.healthFill.style.width=`${t}%`,this.healthNum.textContent=`${Math.round(t)}%`;let n=t>50?`#6fe38a`:t>25?`#ffb84d`:`#ff5a4d`;this.healthFill.style.background=n,this.healthNum.style.color=n,this._refreshStreak()}setFps(e){this.fpsNum.textContent=e,this.fpsNum.className=e>=50?`is-ok`:e>=30?`is-mid`:`is-low`}showPause(){this.pauseScreen.classList.remove(`is-hidden`)}hidePause(){this.pauseScreen.classList.add(`is-hidden`)}showGameOver(e){this.finalScore.textContent=e,this.gameOverScreen.classList.remove(`is-hidden`)}hideGameOver(){this.gameOverScreen.classList.add(`is-hidden`)}setLockHint(e){this.lockHint.classList.toggle(`is-hidden`,!e)}setEdgeHint(e){this.edgeHint?.classList.toggle(`is-visible`,e)}showToast(e,t=1900){this.toast.textContent=e,this.toast.classList.add(`is-visible`),clearTimeout(this._toastTimer),this._toastTimer=setTimeout(()=>this.toast.classList.remove(`is-visible`),t)}setScore(e){this.scoreElement.textContent=e,this.scorePanel.classList.remove(`is-bump`),this.scorePanel.offsetWidth,this.scorePanel.classList.add(`is-bump`)}setActive(e){for(let[t,{root:n}]of this.skills)n.classList.toggle(`is-active`,t===e)}setCooldown(e,t,n){let r=this.skills.get(e);if(!r)return;let i=t<=.001,a=Math.max(0,Math.min(1,t/Math.max(n,.001)));!i&&Math.abs(a-(this._cooldownShown.get(e)??-1))<.005||(this._cooldownShown.set(e,a),r.root.style.setProperty(`--cd`,a),r.root.classList.toggle(`is-cooling`,!i),r.root.classList.toggle(`is-empty`,!i),r.numEl&&(r.numEl.textContent=i?``:Math.ceil(t)))}toggleHelp(){this.help.classList.toggle(`is-hidden`)}},$p=58,em=5.4,tm=class{constructor(e){this.scene=e,this.uniforms={uTime:{value:0},uColor:{value:new q(`#9fb4c8`)},uProximity:{value:0},uPush:{value:0},uHit:{value:0},uDir:{value:new H(0,-1)}};let t=new Va({transparent:!0,depthWrite:!1,blending:2,fog:!1,uniforms:this.uniforms,vertexShader:`
        varying vec2 vLocal;
        void main() {
          vLocal = position.xy;
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,fragmentShader:`
        ...
        const float RADIUS = ${$p.toFixed(1)};
        ...
        void main() {
          ...
          float waveDepth = (1.0 - uHit) * ${em.toFixed(1)};
      ...
      `});this.ring=new Y(new Aa($p-em,$p+1.2,256,1),t),this.ring.rotation.x=-Math.PI/2,this.ring.position.y=.05,this.ring.renderOrder=2,e.add(this.ring),this.pylonGeometry=new Sa(.14,1.8,.14),this.pylonMaterial=new ii({color:`#9fb4c8`,transparent:!0,opacity:.32,blending:2,depthWrite:!1}),this.pylons=[];for(let t=0;t<12;t++){let n=t/12*Math.PI*2,r=new Y(this.pylonGeometry,this.pylonMaterial);r.position.set(Math.sin(n)*$p,.9,Math.cos(n)*$p),e.add(r),this.pylons.push(r)}this._colorTarget=new q(`#9fb4c8`)}flash(e=1){this.uniforms.uHit.value=Math.max(this.uniforms.uHit.value,e)}update(e,t,n,r){let i=this.uniforms;i.uTime.value=t,i.uProximity.value=n.edgeProximity,i.uPush.value+=(n.edgePush-i.uPush.value)*Math.min(1,e*10),i.uHit.value=Math.max(0,i.uHit.value-e*2.1);let a=n.position.x,o=n.position.z;a*a+o*o>.001&&i.uDir.value.set(a,-o).normalize(),this._colorTarget.set(r),i.uColor.value.lerp(this._colorTarget,Math.min(1,e*3)),this.pylonMaterial.color.copy(i.uColor.value),this.pylonMaterial.opacity=.2+.16*n.edgeProximity+.14*Math.sin(t*2.2)*.5}dispose(){this.scene.remove(this.ring,...this.pylons),this.ring.geometry.dispose(),this.ring.material.dispose(),this.pylonGeometry.dispose(),this.pylonMaterial.dispose()}},nm=class{constructor(e){this.uniforms={uTime:{value:0},uColor:{value:new q(`#9fb4c8`)},uImpact:{value:new H(0,0)},uSince:{value:99},uSeed:{value:1.7},uRealm:{value:0},uPulse:{value:0}};let t=new Va({transparent:!0,depthWrite:!1,blending:2,fog:!1,uniforms:this.uniforms,vertexShader:`
        varying vec2 vWorld;
        void main() {
          vec4 world = modelMatrix * vec4(position, 1.0);
          vWorld = world.xz;
      ...
      `});this.mesh=new Y(new Ca(59,96),t),this.mesh.rotation.x=-Math.PI/2,this.mesh.position.y=.07,this.mesh.renderOrder=1,e.add(this.mesh),this._colorTarget=new q}burst(e,t){this.uniforms.uColor.value.set(t),this.uniforms.uImpact.value.set(e.x,e.z),this.uniforms.uSince.value=0,this.uniforms.uSeed.value=Math.random()*97,this.uniforms.uPulse.value=1}update(e,t,n){let r=this.uniforms;r.uTime.value+=e,r.uSince.value+=e,r.uPulse.value=Math.max(0,r.uPulse.value-e*1.8);let i=+!!n;r.uRealm.value+=(i-r.uRealm.value)*Math.min(1,e*(n?1.5:.8)),this._colorTarget.set(t),r.uColor.value.lerp(this._colorTarget,Math.min(1,e*2))}dispose(){this.mesh.geometry.dispose(),this.mesh.material.dispose()}},rm=56,im=1.3,am=.18,om=.62,sm=class{constructor(e){this.scene=e,this.uniforms={uTime:{value:0},uColor:{value:new q(`#9fd8ff`)}},this._geometry=new Or,this._positions=new Float32Array(336),this._alphas=new Float32Array(112),this._across=new Float32Array(112);let t=new Uint16Array(330);for(let e=0;e<55;e++){let n=e*2,r=n+1,i=n+2,a=n+3;t.set([n,r,i,r,a,i],e*6)}this._geometry.setAttribute(`position`,new J(this._positions,3)),this._geometry.setAttribute(`aAlpha`,new J(this._alphas,1)),this._geometry.setAttribute(`aAcross`,new J(this._across,1)),this._geometry.setIndex(new J(t,1)),this._geometry.setDrawRange(0,0);let n=new Va({transparent:!0,depthWrite:!1,blending:2,side:2,fog:!1,uniforms:this.uniforms,vertexShader:`
        attribute float aAlpha;
      ...
      `});this._mesh=new Y(this._geometry,n),this._mesh.frustumCulled=!1,this._mesh.renderOrder=3,e.add(this._mesh),this._points=[],this._time=0,this._scratch=new q}update(e,t,n){this._time+=e,this.uniforms.uTime.value=this._time,this.uniforms.uColor.value.lerp(this._scratch.set(n),Math.min(1,e*8));let r=this._points;for(;r.length&&this._time-r[0].t>im;)r.shift();if(t){let e=r[r.length-1];(!e||(t.x-e.x)**2+(t.z-e.z)**2>am*am)&&(r.push({x:t.x,y:t.y,z:t.z,t:this._time}),r.length>rm&&r.shift())}this._rebuild()}_rebuild(){let e=this._points,t=e.length,n=this._positions,r=this._alphas,i=this._across;for(let a=0;a<t;a++){let o=e[a],s=(1-(this._time-o.t)/im)**1.35,c=e[Math.max(0,a-1)],l=e[Math.min(t-1,a+1)],u=l.x-c.x,d=l.z-c.z,f=Math.hypot(u,d)||1;u/=f,d/=f;let p=om*s/2,m=-d*p,h=u*p,g=a*6;n[g]=o.x+m,n[g+1]=o.y,n[g+2]=o.z+h,n[g+3]=o.x-m,n[g+4]=o.y,n[g+5]=o.z-h;let _=s**1.15;r[a*2]=_,r[a*2+1]=_,i[a*2]=0,i[a*2+1]=1}this._geometry.attributes.position.needsUpdate=!0,this._geometry.attributes.aAlpha.needsUpdate=!0,this._geometry.attributes.aAcross.needsUpdate=!0,this._geometry.setDrawRange(0,t>1?(t-1)*6:0)}dispose(){this.scene.remove(this._mesh),this._geometry.dispose(),this._mesh.material.dispose()}},cm=.5,lm=2,um=6,dm=26;function fm(){return Mp({radius:1.55,radiusNear:.5,radiusCurve:.85,flare:1.15,flareWidth:.14,wander:.04,coreWidth:.16,coreFill:.7,shellOpacity:.9,haloWidth:2.6,haloOpacity:.13,ripple:.25,streak:1.2,flowSpeed:8,tipGlow:1.4,tipLength:.05,coils:3,coilTurns:2.4,coilRadius:1.7,coilWidth:.09,coilOpacity:1.4,coilGlow:5,rings:6,ringSpeed:1.1,ringInner:2.2,ringOuter:2.8,ringOpacity:.9,ringGlow:2,opacity:1.8,glow:1.9,colorCore:`#ffffff`,colorInner:`#d3f4ff`,colorOuter:`#9fb4c8`,colorHalo:`#20304a`,colorCoil:`#bcd2ff`,colorCoilEdge:`#9fb4c8`,colorRing:`#d3f4ff`})}var pm=3,mm=6,hm=class{constructor(e,t,n){this.scene=e,this.onHit=t,this.vfx=n,this.group=new En,e.add(this.group),this.beams=[],this.active=!1,this.tier=1,this.accent=new q(`#9fb4c8`),this._spawnT=2,this._tubeGeo=zf(72,22),this._coilGeo=Rf(64,pm),this._ringGeo=Bf(mm,36),this._scratchColor=new q,this._state=null}setTier(e){this.tier=e;let t=e>=3;!t&&this.active&&this._clearAll(),this.active=t,this.active&&(this._spawnT=Math.min(this._spawnT,1.5))}setAccent(e){this.accent.set(e);for(let e of this.beams)this._tint(e)}_tint(e){e.ring&&e.ring.material.color.copy(this.accent);let t=e.config;if(!t)return;let n=this._scratchColor.copy(this.accent);t.colorCore=`#ffffff`,t.colorInner=`#`+n.clone().lerp(new q(`#ffffff`),.55).getHexString(),t.colorOuter=`#`+n.getHexString(),t.colorHalo=`#`+n.clone().multiplyScalar(.28).getHexString(),t.colorCoil=`#`+n.clone().lerp(new q(`#ffffff`),.3).getHexString(),t.colorCoilEdge=`#`+n.getHexString(),t.colorRing=`#`+n.clone().lerp(new q(`#ffffff`),.7).getHexString(),e.orb&&e.orb.material.userData.setPalette({inner:t.colorInner,outer:t.colorOuter})}_clearAll(){for(let e of this.beams)this._dispose(e);this.beams.length=0}dispose(){this._clearAll(),this._tubeGeo.dispose(),this._coilGeo.dispose(),this._ringGeo.dispose(),this.scene.remove(this.group)}_dispose(e){e.ring&&(e.ring.material.dispose(),this.group.remove(e.ring)),e.orb&&(e.orb.material.dispose(),this.group.remove(e.orb));for(let t of e.meshes)t.material.dispose(),this.group.remove(t);e.meshes.length=0}update(e,t,n){if(!this.active)return;let r=Math.max(3,Math.min(this.tier*2-3,19));this._spawnT-=e,this._spawnT<=0&&(this._spawnT=Math.max(1.2,3-(this.tier-3)*.22)*(.7+Math.random()*.6),this.beams.length<r&&this._spawn(n));let i=this.beams.filter(e=>e.phase===`strike`).length;for(let r=this.beams.length-1;r>=0;r--){let a=this.beams[r];if(a.t+=e,a.phase===`warn`){let e=a.t/cm;a.ring.material.opacity=.55+.4*Math.sin(t*22),a.ring.scale.setScalar(1.15-e*.35);let n=wf(a.t/cm);if(a.orb.visible=!0,a.orb.position.set(a.x,21-n*3,a.z),a.orb.scale.setScalar(.35+n*.85),a.orb.material.uniforms.uCharge.value=n,a.t>=cm){if(i>=um)continue;this._strike(a),i++}continue}a.tSinceStrike+=e;let o=a.life-a.tSinceStrike;a.state.progress=Math.min(1,a.tSinceStrike/.09),a.state.fade=Math.min(1,Math.max(0,o/.35)),a.state.widthFade=o<.18?Math.max(.06,o/.18):1;for(let e of a.materials)e.userData.sync(a.state);a.orb.visible=!1,!a.hitDone&&n&&a.tSinceStrike>.04&&Math.hypot(n.x-a.x,n.z-a.z)<lm&&(a.hitDone=!0,this.onHit?.(30)),o<=0&&(this._dispose(a),this.beams.splice(r,1))}}_spawn(e){let t=0,n=0;for(let r=0;r<20;r++){let r=Math.random()*Math.PI*2,i=5+Math.random()*35;if(t=Math.cos(r)*i,n=Math.sin(r)*i,!e||Math.hypot(t-e.x,n-e.z)>6)break}let r=new Y(this._ringGeo2??=new Aa(1.05,2.3,40),new ii({color:this.accent.clone(),transparent:!0,opacity:.8,blending:2,depthWrite:!1,side:2}));r.rotation.x=-Math.PI/2,r.position.set(t,.07,n),r.renderOrder=2,this.group.add(r);let i=new Y(this._orbGeo??=new Da(1,3),Gf({inner:`#d3f4ff`,outer:`#9fb4c8`,glow:2.6}));i.visible=!1,i.renderOrder=9,this.group.add(i);let a={phase:`warn`,x:t,z:n,t:0,life:1+Math.random()*2,hitDone:!1,ring:r,orb:i,meshes:[],materials:[],config:fm(),state:{origin:new U(t,dm,n),target:new U(t,.05,n),side:new U(1,0,0),progress:0,fade:1,widthFade:1,seed:Math.random()*100,coils:pm,rings:mm}};this._tint(a),this._buildBeamMeshes(a),this.beams.push(a),$.pillarWarn()}_buildBeamMeshes(e){let t=[[jp.HALO,this._tubeGeo,11],[jp.SHELL,this._tubeGeo,12],[jp.CORE,this._tubeGeo,13],[jp.COIL,this._coilGeo,13],[jp.RING,this._ringGeo,13]];for(let[n,r,i]of t){let t=Lp(n,e.config),a=new Y(r,t);a.frustumCulled=!1,a.matrixAutoUpdate=!1,a.visible=!1,a.renderOrder=i,this.group.add(a),e.meshes.push(a),e.materials.push(t)}}_strike(e){e.phase=`strike`,e.tSinceStrike=0,e.ring&&=(this.group.remove(e.ring),e.ring.material.dispose(),null);for(let t of e.meshes)t.visible=!0;let t=new U(e.x,.5,e.z);this.vfx?.bursts.spawn(op.AIR,t,{radius:.3,endRadius:3.2,life:.45,intensity:1,opacity:.9,fresnel:2,displace:.3,colorA:e.config.colorOuter,colorB:`#ffffff`,colorC:e.config.colorInner}),this.vfx?.decals.spawn(up.SHOCKWAVE,{x:e.x,z:e.z},{radius:5.2,life:.5,width:.05,intensity:.9,colorA:e.config.colorOuter,colorB:`#ffffff`}),this.vfx?.decals.spawn(up.DUSTRING,{x:e.x,z:e.z},{radius:3.6,life:.9,intensity:.6,colorA:`#3d5c74`,colorB:e.config.colorInner,height:.05}),this.vfx?.sparkBurst(t,`basic`,{count:60,speed:8,life:.7,size:1.1,up:1.2}),$.pillarStrike()}},gm={ice:5,fire:5,storm:5},_m=6,vm=9,ym=25,bm=3,xm=26,Sm=class e{constructor(e){this.canvas=e,this.renderer=new Mu({canvas:e,antialias:!0}),this._pxRatioCap=Math.min(window.devicePixelRatio,1.5),this._pxRatio=this._pxRatioCap,this.renderer.setPixelRatio(this._pxRatio),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.5,this.world=new bf,this.scene=this.world.scene,this.camera=new Lo(48,window.innerWidth/window.innerHeight,.1,1400),this.player=new tf(this.scene),this.vfx=new mp(this.scene,this.renderer),this.spells=new kp(this.scene,this.vfx),this.spirits=new Zp(this.scene,this.spells.bursts,this.vfx),this.edge=new tm(this.scene),this.groundFx=new nm(this.scene),this.flightTrail=new sm(this.scene),this.pillars=new hm(this.scene,e=>this._onPlayerHit(e),this.vfx),this.hud=new Qp,this._normalTarget=3,this._specialTarget=1,this.element=`ice`,this.cooldowns=new Map(lf.map(e=>[e,0])),this.score=0,this.hp=100,this.over=!1,this.elapsed=0,this._shake=0,this.keys=new Set,this.started=!1,this._invulnT=0,this._killStreak=0,this.stamina=100,this._exhausted=!1,this.paused=!1,this._worldRevertT=0,this._testMode=new URLSearchParams(location.search).get(`test`),this._testT=0,this._instanceId=Math.random().toString(36).slice(2,6),window.__game=this,window.audio=$;let t=document.getElementById(`startBtn`);t?.addEventListener(`click`,()=>this.begin()),t&&(t.disabled=!0,t.textContent=`场景装载中… 0%`),this.world.onArenaReady=e=>{t&&(t.disabled=!1,t.textContent=e?`开始游戏`:`场景加载失败 · 仍可开始`)},this.world.onArenaProgress=(e,n)=>{t&&(t.textContent=e==null?`场景装载中… ${n.toFixed(0)}MB`:`场景装载中… ${e}%`)},document.getElementById(`restartBtn`)?.addEventListener(`click`,()=>this.restart()),document.getElementById(`backToStartBtn`)?.addEventListener(`click`,()=>this.backToStart()),document.getElementById(`pauseBtn`)?.addEventListener(`click`,()=>{this.started&&!this.over&&this._setPaused(!this.paused)}),document.getElementById(`pauseScreen`)?.addEventListener(`click`,()=>{this.paused&&this._setPaused(!1)}),this.orbit={yaw:Math.PI*.25,pitch:.62,dist:24},this.pointer=new H(0,0),this._aimNDC=new H(0,-.1),this._locked=!1,this.raycaster=new fs,this.groundPlane=new Gi(new U(0,1,0),0),this.aimPoint=new U(0,0,-7),this._scratchF=new U,this._scratchR=new U,this._aimHit=new U,this._hurtColor=new q(`#ff4638`),this.reticle=new En;let n=new Y(new Aa(.34,.78,40),new ii({color:`#04070c`,transparent:!0,opacity:.6,depthWrite:!1,depthTest:!1})),r=new Y(new Aa(.42,.7,40),new ii({color:`#9fd8ff`,transparent:!0,opacity:1,depthWrite:!1,depthTest:!1})),i=new Y(new Ca(.15,20),new ii({color:`#ffffff`,transparent:!0,opacity:.95,depthWrite:!1,depthTest:!1}));n.renderOrder=7,r.renderOrder=8,i.renderOrder=8,n.rotation.x=r.rotation.x=i.rotation.x=-Math.PI/2,this.reticle.add(n,r,i),this.reticle.position.y=.03,this._reticleRing=r,this.scene.add(this.reticle),this.rangeRingShadow=new Y(new Aa(25.2,25.68,96),new ii({color:`#04070c`,transparent:!0,opacity:0,depthWrite:!1,depthTest:!1})),this.rangeRingShadow.rotation.x=-Math.PI/2,this.rangeRingShadow.position.y=.045,this.rangeRingShadow.renderOrder=7,this.scene.add(this.rangeRingShadow),this.rangeRing=new Y(new Aa(25.45,xm,96),new ii({color:`#9fd8ff`,transparent:!0,opacity:0,depthWrite:!1,depthTest:!1})),this.rangeRing.rotation.x=-Math.PI/2,this.rangeRing.position.y=.05,this.rangeRing.renderOrder=8,this.scene.add(this.rangeRing),this.aimLine=new Y(new ka(1,.18).rotateX(-Math.PI/2),new ii({color:`#9fd8ff`,transparent:!0,opacity:0,depthWrite:!1,depthTest:!1,blending:2})),this.aimLine.renderOrder=7,this.scene.add(this.aimLine),this._aiming=!1,this._lastPointer=null,this._attacking=!1,this._basicT=0,this._orbPos=new U,this.basicRingShadow=new Y(new Aa(.3,.92,40),new ii({color:`#04070c`,transparent:!0,opacity:.55,depthWrite:!1,depthTest:!1})),this.basicRingShadow.rotation.x=-Math.PI/2,this.basicRingShadow.visible=!1,this.basicRingShadow.renderOrder=7,this.scene.add(this.basicRingShadow),this.basicRing=new Y(new Aa(.42,.8,40),new ii({color:`#9fd8ff`,transparent:!0,opacity:.9,depthWrite:!1,depthTest:!1})),this.basicRing.rotation.x=-Math.PI/2,this.basicRing.visible=!1,this.basicRing.renderOrder=8,this.scene.add(this.basicRing),this.spells.bursts.setPixelRatio(this._pxRatio),this.world.weather.setPixelRatio(this._pxRatio),this._bind(),this.hud.onSkill=e=>this._select(e),this.player.setElement(uf[this.element].accent),this.hud.setActive(this.element),this.world.onShift=({theme:e})=>{this.hud.setWorld(e),$.setRealm(e.id),e.id!==`neutral`&&(this.hud.showToast(`世界已改写 → ${e.glyph} ${e.label}`),this.spirits.setAccent(e.accent),this._shake=Math.min(this._shake+.35,.6))},this.spirits.onPlayerHit=e=>this._onPlayerHit(e),this.spirits.onSpecialSpawn=e=>{let t=uf[e];this.hud.showToast(`⚠ 特殊元素之灵出现 — 用「${t.label}」清除可得 30 分`,2600)}}_bind(){window.addEventListener(`resize`,()=>{this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this._applyPixelRatio()}),window.addEventListener(`keydown`,e=>{if(!e.repeat){if(e.code===`Escape`&&this.started&&!this.over){this._setPaused(!this.paused);return}if(this.keys.add(e.code),!this.paused&&this.started&&!this.over)switch(e.code){case`KeyQ`:this._select(`ice`);break;case`KeyE`:this._select(`fire`);break;case`KeyR`:this._select(`storm`);break;case`KeyH`:this.hud.toggleHelp()}}}),window.addEventListener(`keyup`,e=>this.keys.delete(e.code)),window.addEventListener(`pointermove`,e=>{if(!this.started||this.over)return;let t=e.movementX??0,n=e.movementY??0;if(this._locked){this._aiming||this._attacking?(this._aimNDC.x=Math.max(-1,Math.min(1,this._aimNDC.x+t*.0026)),this._aimNDC.y=Math.max(-1,Math.min(1,this._aimNDC.y-n*.0026)),this.pointer.copy(this._aimNDC)):(this.orbit.yaw-=t*.0032,this.orbit.pitch=Math.max(.3,Math.min(1.25,this.orbit.pitch+n*.0026)));return}this.pointer.set(e.clientX/window.innerWidth*2-1,-(e.clientY/window.innerHeight)*2+1);let r=this._lastPointer,i=r?{dx:e.clientX-r.x,dy:e.clientY-r.y}:null;this._lastPointer={x:e.clientX,y:e.clientY},i&&!this._aiming&&(e.target?.closest?.(`.skill, .panel`)||(this.orbit.yaw-=i.dx*.0038,this.orbit.pitch=Math.max(.3,Math.min(1.25,this.orbit.pitch+i.dy*.0028))))}),this.canvas.addEventListener(`pointerdown`,e=>{!this.started||this.over||this.paused||($.ensure(),e.button===2?(this._aiming=!0,this._resetAimToPlayer(),this._updateAim()):e.button===0&&(this._locked?(this._attacking=!0,this._resetAimToPlayer(),this._updateAim(),this._basicT=0):this._requestLock()))}),window.addEventListener(`pointerup`,e=>{e.button===2&&this._aiming?(this._aiming=!1,this._updateAim(),this._castCurrent()):e.button===0&&(this._attacking=!1)}),window.addEventListener(`contextmenu`,e=>e.preventDefault()),document.addEventListener(`pointerlockchange`,()=>{this._locked=document.pointerLockElement===this.canvas,this._locked?(this._aimNDC.copy(this.pointer),clearTimeout(this._lockRetryTimer),this._lockRetries=0):this._aiming&&=!1,!this._locked&&this.started&&!this.over&&!this.paused?this._setPaused(!0):this.hud.setLockHint(!this._locked&&!this.paused&&this.started&&!this.over)}),document.addEventListener(`pointerlockerror`,()=>{}),window.addEventListener(`wheel`,e=>{this.orbit.dist=Math.max(6.5,Math.min(24,this.orbit.dist+e.deltaY*.012))},{passive:!0})}_setPaused(e){this.paused!==e&&(this.paused=e,e?($.pause(),this._attacking=!1,this._aiming=!1,this.keys.clear(),this.hud.showPause(),this.hud.setLockHint(!1),this.hud.setEdgeHint(!1),document.pointerLockElement&&document.exitPointerLock()):($.unpause(),this.hud.hidePause(),this._ensureLock()))}_ensureLock(){this._locked||this.paused||!this.started||this.over||(this._requestLock(),this._lockRetries=(this._lockRetries??0)+1,clearTimeout(this._lockRetryTimer),this._lockRetries<=12&&(this._lockRetryTimer=setTimeout(()=>this._ensureLock(),350)))}begin(){this.started||($.ensure(),$.click(),$.startMusic(),this.started=!0,this.paused=!1,this.hud.hidePause(),this.hud.hideStartScreen(),this.hud.setLockHint(!1),this._requestLock(),this.spirits.begin(this.player.position,3),this._updateSpiritTargets(),this.hud.showToast(`冒险开始 — 元素之灵已出现`,2200))}_onPlayerHit(e){this.over||this._invulnT>0||($.hurt(),$.shield(),this.hp=Math.max(0,this.hp-e),this.hud.setHealth(this.hp),this.hud.hurtFlash(),this._shake=Math.min(this._shake+.35,.7),this._killStreak>0&&(this._killStreak=0,this.hud.setStreak(0),this.hud.showToast(`连杀中断`,1200)),this._hitLog=this._hitLog||[],this._hitLog.push(`t${this._testT?.toFixed(1)??`-`} 伤${e} 血${this.hp}% 连杀→${this._killStreak}`),this.hp<=0&&this._gameOver(),this._invulnT=1.5)}_heal(e,t){this.over||this.hp>=100||(this.hp=Math.min(100,this.hp+e),this.hud.setHealth(this.hp),$.heal(),this.hud.showToast(`${t} — 生命 +${e}%`,1500))}_countKills(e,t){e<=0||(this._killStreak+=e,this.hud.setStreak(this._killStreak),this._killStreak>=9&&t&&(this._killStreak=0,this.hud.setStreak(0),this._heal(20,`连杀 ×9`)))}_gameOver(){this.over||(this.over=!0,this._attacking=!1,this._aiming=!1,this.keys.clear(),$.death(),$.stopMusic(2.5),this.spirits.setFrozen(!0),document.pointerLockElement&&document.exitPointerLock(),this.hud.setLockHint(!1),this.hud.showGameOver(this.score))}restart(){this.over=!1,this.paused=!1,this.hud.hidePause(),this.hud.setEdgeHint(!1),this._edgeWasPushing=!1,this.hp=100,this.stamina=100,this._exhausted=!1,this.score=0,this._shake=0,this._killStreak=0,this._attacking=!1,this._aiming=!1,this._aimNDC.set(0,-.1),this.pointer.copy(this._aimNDC);for(let[e]of this.cooldowns)this.cooldowns.set(e,0);this.spells.reset(),this.spirits.setFrozen(!1),this.spirits.respawnAll(this.player.position,3),$.startMusic(),this.hud.setScore(0),this.hud.setHealth(100),this.hud.setLevel(1),this._updateSpiritTargets(),this.hud.hideGameOver(),this.hud.showToast(`新的冒险开始 — 元素之灵已出现`,2e3),this._ensureLock()}backToStart(){this.started&&$.clickBack(),$.startMusic(),this.over=!1,this.started=!1,document.pointerLockElement&&document.exitPointerLock(),this.paused=!1,this.hud.hidePause(),this.hud.setEdgeHint(!1),this._edgeWasPushing=!1,this.hp=100,this.stamina=100,this._exhausted=!1,this.score=0,this._shake=0,this._killStreak=0,this._attacking=!1,this._aiming=!1,this.element=`ice`,this.player.setElement(uf.ice.accent),this._aimNDC.set(0,-.1),this.pointer.copy(this._aimNDC);for(let[e]of this.cooldowns)this.cooldowns.set(e,0);this.spells.reset(),this.spirits.setFrozen(!1),this.spirits.reset(),this.world.shift(`neutral`,this.player.position),this.hud.setScore(0),this.hud.setHealth(100),this.hud.setLevel(1),this.hud.hideGameOver(),this.hud.setActive(`ice`),this.hud.setLockHint(!1),this.hud.showStartScreen()}static TIERS=[{normal:3,special:1},{normal:4,special:2},{normal:5,special:2},{normal:6,special:3},{normal:7,special:3},{normal:8,special:4},{normal:9,special:4},{normal:10,special:5},{normal:11,special:5},{normal:12,special:6}];get tier(){return Math.min(Math.floor(this.score/100)+1,e.TIERS.length)}_updateSpiritTargets(){this._tierMem===void 0&&(this._tierMem=this.tier),this.tier>this._tierMem&&$.levelUp(),this._tierMem<3&&this.tier>=3&&this.hud.showToast(`⚠ 天空开始降下元素光柱 — 远离地面光圈！`,3200),this._tierMem=this.tier;let t=e.TIERS[this.tier-1];this.spirits.setNormalTarget(t.normal),this.spirits.setSpecialTarget(t.special),this.hud.setLevel(this.tier)}_resetAimToPlayer(){this._aimNDC.set(0,-.1),this.pointer.copy(this._aimNDC)}_requestLock(){try{let e=this.canvas.requestPointerLock();e&&e.catch&&e.catch(()=>{})}catch{}}_updateAim(){this.raycaster.setFromCamera(this.pointer,this.camera);let e=this._aimHit;if(this.raycaster.ray.intersectPlane(this.groundPlane,e)){let t=this.player.position,n=e.x-t.x,r=e.z-t.z,i=Math.hypot(n,r);i>xm?(e.x=t.x+n/i*xm,e.z=t.z+r/i*xm):i<bm&&i>.001&&(e.x=t.x+n/i*bm,e.z=t.z+r/i*bm),this.aimPoint.copy(e)}}_select(e){if(!lf.includes(e))return;e!==this.element&&(this.element=e,$.switch(),this.player.setElement(uf[e].accent),this.hud.setActive(e),this.hud.showToast(`已选择 ${uf[e].label} — 按住右键瞄准，松开释放`));let t=uf[this.element].accent;this._reticleRing.material.color.set(t),this.rangeRing.material.color.set(t),this.aimLine.material.color.set(t)}_castCurrent(){let e=this.element;if((this.cooldowns.get(e)??0)>0){this.hud.showToast(`技能冷却中`);return}this.player.playCast(),this.spells.cast(e,this.player.position,this.aimPoint.clone(),(t,n)=>this._onImpact(e,t,n)),this.cooldowns.set(e,gm[e]),this._reticleRing.material.color.set(uf[e].accent)}_onImpact(e,t,n){let r=uf[e].accent;this.world.shift(df[e],t),this._worldRevertT=6,this.groundFx.burst(t,r),this.hud.castFlash(r),$.impact(e);let i=this.spirits.collectAt(t,n,e,this.world.current);i.special>0&&$.specialKill();let a=i.normal*10+i.special*30;a>0&&(this.score+=a,this.hud.setScore(this.score)),i.immune>0&&this.hud.showToast(`属性不符 — 特殊之灵需要对应元素的技能`,1500),this._countKills(i.normal,!1),this._updateSpiritTargets(),this._shake=Math.min(this._shake+.3,.7)}_basicPathHit(e,t){let n=this.spirits.collectAt(e,1,`basic`,this.world.current,t);n.specialHit>0?$.specialHit():n.immune>0&&$.deflect(),n.normal>0&&($.hit(),this.score+=n.normal*10,this.hud.setScore(this.score)),n.special>0&&($.specialKill(),this.score+=n.special*30,this.hud.setScore(this.score),this._updateSpiritTargets(),this._heal(10*n.special,`普攻净化特殊之灵`)),this._countKills(n.normal,!0)}_basicImpact(e,t=1.6,n){let r=this.spirits.collectAt(e,t,`basic`,this.world.current,n);r.specialHit>0?$.specialHit():r.immune>0&&$.deflect(),r.normal>0&&($.hit(),this.score+=r.normal*10,this.hud.setScore(this.score)),r.special>0&&($.specialKill(),this.score+=r.special*30,this.hud.setScore(this.score),this._updateSpiritTargets(),this._heal(10*r.special,`普攻净化特殊之灵`)),this._countKills(r.normal,!0)}_emitFlightTrail(e){this._trailT=(this._trailT??0)-e,!(this._trailT>0)&&(this._trailT=.05,this._trailPos??=new U,this._trailPos.set(this.player.position.x+(Math.random()-.5)*.5,.35,this.player.position.z+(Math.random()-.5)*.5),this.spells.bursts.emit({pos:this._trailPos,count:3,speed:[.4,1.6],up:[.2,1.2],life:[.25,.55],size:[9,22],colorA:`#ffffff`,colorB:uf[this.element].accent,gravity:1.5,drag:2.2,spread:.4}))}_updateCamera(e){let{yaw:t,pitch:n,dist:r}=this.orbit,i=this._cameraTarget??=new U;i.set(this.player.position.x+Math.sin(t)*Math.cos(n)*r,Math.sin(n)*r+1.4,this.player.position.z+Math.cos(t)*Math.cos(n)*r),this._shake>.001&&(this._shake*=Math.max(0,1-e*5.5),i.x+=(Math.random()-.5)*this._shake,i.y+=(Math.random()-.5)*this._shake,i.z+=(Math.random()-.5)*this._shake),this.camera.position.lerp(i,Math.min(1,e*9)),this.camera.lookAt(this.player.position.x,1.35,this.player.position.z)}_runStreakTest(e){if(this._testMode!==`streakbreak`||!this.started||this.over)return;this._testT+=e;let t=document.getElementById(`testOut`);if(!t)return;let n=e=>`${e}[实例${this._instanceId} t${this._testT.toFixed(1)} 血${this.hp} 连杀${this._killStreak} 无敌${this._invulnT.toFixed(1)} over${+!!this.over}]`;this._testT>=1&&this._testT-e<1?(this._killStreak=5,this.hud.setStreak(5),t.textContent=n(`注入连杀5`)):this._testT>=4&&this._testT-e<4?(t.textContent+=` ‖ `+n(`受击前`),this._onPlayerHit(25),t.textContent+=` ‖ `+n(`受击后`)):this._testT>=5&&this._testT-e<5&&(t.textContent+=` ‖ `+n(this._killStreak===0?`✅清零正常`:`❌未清零`)+`｜受击日志:${(this._hitLog||[`无`]).join(`;`)}`)}_applyPixelRatio(){this.renderer.setPixelRatio(this._pxRatio),this.renderer.setSize(window.innerWidth,window.innerHeight,!1),this.spells.bursts.setPixelRatio(this._pxRatio),this.world.weather.setPixelRatio(this._pxRatio)}frame(e){if(this.elapsed+=e,this._runStreakTest(e),this._fpsFrames=(this._fpsFrames??0)+1,this._fpsTime=(this._fpsTime??0)+e,this._fpsTime>=.5&&(this._recentFps=Math.round(this._fpsFrames/this._fpsTime),this.hud.setFps(this._recentFps),this._fpsFrames=0,this._fpsTime=0),this._resT=(this._resT??0)+e,this._resT>=1.5){this._resT=0;let e=this._recentFps??0;e>=40&&e<88&&this._pxRatio>.7?(this._pxRatio=Math.max(.7,this._pxRatio-.15),this._applyPixelRatio()):e>100&&this._pxRatio<this._pxRatioCap&&(this._pxRatio=Math.min(this._pxRatioCap,this._pxRatio+.1),this._applyPixelRatio())}if(this.paused){this.renderer.render(this.scene,this.camera);return}let t=new U,n=this._scratchF.set(-Math.sin(this.orbit.yaw),0,-Math.cos(this.orbit.yaw)),r=this._scratchR.set(Math.cos(this.orbit.yaw),0,-Math.sin(this.orbit.yaw));(this.keys.has(`KeyW`)||this.keys.has(`ArrowUp`))&&t.add(n),(this.keys.has(`KeyS`)||this.keys.has(`ArrowDown`))&&t.sub(n),(this.keys.has(`KeyD`)||this.keys.has(`ArrowRight`))&&t.add(r),(this.keys.has(`KeyA`)||this.keys.has(`ArrowLeft`))&&t.sub(r),t.lengthSq()>0&&t.normalize();let i=(this.keys.has(`ShiftLeft`)||this.keys.has(`ShiftRight`))&&!this._exhausted&&!this._attacking&&!this._aiming&&!this.over;i?(this.stamina=Math.max(0,this.stamina-e/_m*100),this.stamina<=0&&(this._exhausted||$.staminaOut(),this._exhausted=!0)):this.stamina<100&&(this.stamina=Math.min(100,this.stamina+e/vm*100),this._exhausted&&this.stamina>=ym&&(this._exhausted=!1)),this.hud.setStamina(this.stamina,this._exhausted),i&&t.lengthSq()>0&&this._emitFlightTrail(e),this.over&&t.set(0,0,0),this._invulnT=Math.max(0,this._invulnT-e),this._updateAim(),this.started||(this.orbit.yaw+=e*.06),this.player.update(e,t.lengthSq()>0?t:null,this.aimPoint,this.elapsed,i),this.player.updateShield(this.elapsed,this._invulnT,e),this.flightTrail.update(e,i?this.player.root.position:null,uf[this.element].accent),this._updateCamera(e),this.edge.update(e,this.elapsed,this.player,this.world.currentAccent);let a=this.player.edgePush>.3;this.hud.setEdgeHint(a),a&&(this._edgeWasPushing||(this._shake=Math.min(this._shake+.12,.7),this.elapsed-(this._edgeToastT??-99)>6&&(this._edgeToastT=this.elapsed,this.hud.showToast(`已抵达场地边缘 — 无法再往外走了`,1500))),this._edgeSparkT=(this._edgeSparkT??0)-e,this._edgeSparkT<=0&&(this._edgeSparkT=.16,this.edge.flash(Math.min(1,this.player.edgePush)),this.spells.bursts.emit({pos:this.player.edgePoint,count:5,speed:[1.2,3.4],up:[.6,2.4],life:[.3,.6],size:[7,15],colorA:`#ffffff`,colorB:this.world.currentAccent,gravity:4.5,drag:2.6,spread:.5}))),this._edgeWasPushing=a;let o=this._aiming;o&&this.elapsed-(this._aimTickT??0)>.45&&(this._aimTickT=this.elapsed,$.aimPulse());let s=uf[this.element].accent;this.reticle.visible=o,this.reticle.position.set(this.aimPoint.x,.03+Math.sin(this.elapsed*4)*.012,this.aimPoint.z),this.reticle.rotation.y=this.elapsed*.8,this.reticle.scale.setScalar(o?1+Math.sin(this.elapsed*10)*.08:1),this._reticleRing.material.color.set(s);let c=Math.min(1,e*10);this.rangeRing.position.set(this.player.position.x,.05,this.player.position.z),this.rangeRingShadow.position.set(this.player.position.x,.045,this.player.position.z),this.rangeRing.material.opacity+=((o?.6:0)-this.rangeRing.material.opacity)*c,this.rangeRingShadow.material.opacity+=((o?.5:0)-this.rangeRingShadow.material.opacity)*c,this.aimLine.material.opacity=this.aimLine.material.opacity+((o?.9:0)-this.aimLine.material.opacity)*c;let l=this.aimPoint.x-this.player.position.x,u=this.aimPoint.z-this.player.position.z,d=Math.max(Math.hypot(l,u),.001);if(this.aimLine.position.set(this.player.position.x+l/2,.1,this.player.position.z+u/2),this.aimLine.rotation.y=-Math.atan2(u,l),this.aimLine.scale.set(d,1,1),this._attacking){if(this._basicT-=e,this._basicT<=0){this._basicT=.32;let e=uf[this.element].accent;$.shoot(),this.player.playCast(),this.player.getOrbWorldPosition(this._orbPos),this.spells.castBasic(this._orbPos,this.aimPoint.clone(),e,(e,t)=>this._basicPathHit(e,t),(e,t,n)=>this._basicImpact(e,t,n))}this.basicRing.visible=!0,this.basicRingShadow.visible=!0,this.basicRing.position.set(this.aimPoint.x,.05,this.aimPoint.z),this.basicRingShadow.position.set(this.aimPoint.x,.045,this.aimPoint.z),this.basicRing.material.color.set(s),this.basicRing.material.opacity=.85+Math.sin(this.elapsed*10)*.15,this.basicRing.scale.setScalar(1+Math.sin(this.elapsed*10)*.08)}else this.basicRing.visible=!1,this.basicRingShadow.visible=!1;this.spells.update(e),this.spirits.update(e,this.elapsed,this.player.position),this.spirits.laserTier=this.tier,this.world.update(e,this.elapsed,this.player.position,this.hud.vignette),this.groundFx.update(e,this.world.currentAccent,this.world.current!==`neutral`),this.pillars.setTier(this.tier),this.pillars.setAccent(this.world.currentAccent),this.pillars.update(e,this.elapsed,this.player.position),this.vfx.update(e,this.camera,this.renderer),this.started&&!this.over&&this._worldRevertT>0&&(this._worldRevertT-=e,this._worldRevertT<=0&&this.world.current!==`neutral`&&(this.world.shift(`neutral`,this.player.position),this.hud.showToast(`元素之力消散 — 世界恢复荒原`,1800)));for(let t of lf){let n=this.cooldowns.get(t)??0;if(n>0){let r=Math.max(0,n-e);this.cooldowns.set(t,r),r===0&&$.cdReady()}this.hud.setCooldown(t,this.cooldowns.get(t)??0,gm[t])}this.renderer.render(this.scene,this.camera)}dispose(){this.player.dispose(),this.spells.dispose(),this.spirits.dispose(),this.edge.dispose(),this.groundFx.dispose(),this.flightTrail.dispose(),this.pillars.dispose(),this.vfx.dispose(),this.world.dispose(),this.renderer.dispose()}},Cm=document.getElementById(`app`);function wm(){try{let e=new Sm(Cm);window.game=e;let t=performance.now(),n=r=>{requestAnimationFrame(n);let i=Math.min(.05,(r-t)/1e3);t=r;try{e.frame(i)}catch(e){let t=document.getElementById(`dbg`);t&&(t.style.color=`#ff8a7a`,t.textContent=`ERR `+(e?.message??e)+` @ `+String(e?.stack??``).split(`
`)[1]),console.error(`[frame]`,e)}};requestAnimationFrame(n)}catch(e){console.error(`[boot] 启动失败`,e),document.body.insertAdjacentHTML(`beforeend`,`<div style="position:fixed;inset:0;display:grid;place-items:center;background:#06090f;color:#ff9a8a;font-size:14px;z-index:99">
       ...
       </div>`)}}wm(),location.hostname.includes(`github.io`)&&`serviceWorker`in navigator&&navigator.serviceWorker.register(`sw.js`).catch(()=>{});