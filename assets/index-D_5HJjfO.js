...
`))},e.customProgramCacheKey=()=>`arena-marble-v2`,e.needsUpdate=!0)}function Gf(e){let t=[],n=e.geometry;for(let r of n.groups){let i=e.material[r.materialIndex];if(!i||r.count===0)continue;let a=n.clone();if(n.index){let e=n.index.array.slice(r.start,r.start+r.count);a.setIndex(new K(e,1))}else for(let e of Object.keys(a.attributes)){let t=a.attributes[e],n=t.array.slice(t.itemSize*r.start,t.itemSize*(r.start+r.count));a.setAttribute(e,new K(n,t.itemSize))}a.clearGroups(),a.morphAttributes={},t.push({geo:a,material:i})}return t}function Kf(e){e.updateMatrixWorld(!0);let t=new Map,n=[];e.traverse(e=>{if(!e.isMesh||!e.material)return;let r=(e,n)=>{let r=n.uuid;t.has(r)||t.set(r,{material:n,nodes:[],geos:[],indexed:!0});let i=t.get(r);for(let t of Object.keys(e.attributes))t!==`position`&&t!==`normal`&&t!==`uv`&&e.deleteAttribute(t);if(e.morphAttributes={},!e.attributes.uv){let t=e.attributes.position.count;e.setAttribute(`uv`,new K(new Float32Array(t*2),2))}e.attributes.normal||e.computeVertexNormals(),e.index||(i.indexed=!1),i.geos.push(e)};if(Array.isArray(e.material)){let t=new Set,i=Gf(e);for(let n of i)n.geo.applyMatrix4(e.matrixWorld),r(n.geo,n.material),t.add(n.material.uuid);n.push({node:e,usedIds:t,extraGeos:[]})}else{let t=e.geometry.clone();t.applyMatrix4(e.matrixWorld),r(t,e.material),n.push({node:e,usedIds:new Set([e.material.uuid]),extraGeos:[t]})}});let r=[],i=0,a=0;for(let e of t.values()){let t=$u(e.indexed?e.geos:e.geos.map(e=>e.index?e.toNonIndexed():e),!1);if(!t){a++;for(let t of e.geos)t.dispose();continue}let n=new J(t,e.material);n.matrixAutoUpdate=!1,r.push(n);for(let t of e.geos)t.dispose();e.geos=[]}for(let{node:e,usedIds:r,extraGeos:a}of n){let n=r.size>0;for(let e of r){let r=t.get(e);if(!r||r.geos.length>0){n=!1;break}}n&&(e.parent?.remove(e),e.geometry.dispose(),i++);for(let e of a)e.dispose()}return console.info(`[arena] 合并网格：${i} -> ${r.length}（按材质，失败组 ${a} 保留原样）`),Kf.stats={removed:i,failed:a,merged:r.length},r}function qf(e,t,n){let r=new J(new Oa(59,96),new qa({color:`#10141c`,roughness:.95,metalness:.05}));r.rotation.x=-Math.PI/2,r.position.y=-.35,e.add(r);let i=new cf;i.setDecoderPath(`draco/`);let a=new id;a.setDRACOLoader(i),a.load(`arena.glb`,n=>{let r=n.scene;r.traverse(e=>{e.isMesh&&(e.castShadow=!1,e.receiveShadow=!1)});let i=Kf(r);window.__arenaMerge=Kf.stats;for(let e of i)Wf(e.material),r.add(e);e.add(r),t?.(!0)},e=>{n&&(e.total>0?n(Math.min(99,Math.round(e.loaded/e.total*100)),e.loaded/1048576):n(null,e.loaded/1048576))},e=>{console.error(`[arena] 场景加载失败`,e),t?.(!1)})}function Jf(e){let t=new Yo(`#8fb4de`,70,150,1.8);return t.position.set(0,20,0),e.add(t),t}var Yf=[`ice`,`fire`,`storm`],Xf={ice:{key:`Q`,label:`霜新星`,accent:`#56d8ff`,family:`ice`},fire:{key:`E`,label:`落炎陨石`,accent:`#ff8a3c`,family:`fire`},storm:{key:`R`,label:`天雷殛灭`,accent:`#a98bff`,family:`storm`}},Zf={ice:`ice`,fire:`fire`,storm:`storm`},Qf={neutral:{id:`neutral`,label:`元素荒原 · Neutral Realm`,glyph:`◇`,accent:`#9fb4c8`,weather:`none`,skyTop:`#0b1120`,skyBottom:`#1b2534`,skyHorizon:`#33475e`,stars:1,fogColor:`#141c28`,fogNear:55,fogFar:235,groundBase:`#252e3a`,groundAccent:`#446080`,veinStrength:.22,keyColor:`#bcd2ff`,keyIntensity:3.4,hemiSky:`#334e78`,hemiGround:`#10161f`,hemiIntensity:1.45,vignette:`rgba(4, 8, 16, 0.55)`},ice:{id:`ice`,label:`冰封领域 · Frozen Realm`,glyph:`❄`,accent:`#56d8ff`,weather:`snow`,skyTop:`#5eb0e0`,skyBottom:`#c4e9fa`,skyHorizon:`#e8f7ff`,stars:.15,fogColor:`#b9dcEE`,fogNear:40,fogFar:170,groundBase:`#9fc0d2`,groundAccent:`#38c8ff`,veinStrength:.85,keyColor:`#ffffff`,keyIntensity:3.7,hemiSky:`#d6f0ff`,hemiGround:`#6d94aa`,hemiIntensity:1.5,vignette:`rgba(150, 205, 235, 0.28)`},fire:{id:`fire`,label:`烈焰领域 · Burning Realm`,glyph:`🔥`,accent:`#ff8a3c`,weather:`fog`,weather2:`embers`,skyTop:`#1b0908`,skyBottom:`#4a180b`,skyHorizon:`#c2531f`,stars:.3,fogColor:`#3a1c0e`,fogNear:5,fogFar:58,groundBase:`#261410`,groundAccent:`#ff5410`,veinStrength:1,keyColor:`#ffd9a8`,keyIntensity:2.4,hemiSky:`#a8462a`,hemiGround:`#170a08`,hemiIntensity:1.2,vignette:`rgba(58, 10, 4, 0.55)`},storm:{id:`storm`,label:`雷暴领域 · Storm Realm`,glyph:`⚡`,accent:`#a98bff`,weather:`rain`,weather2:`sparks`,skyTop:`#0c0f2e`,skyBottom:`#2c3168`,skyHorizon:`#6f6fff`,stars:.6,fogColor:`#181d42`,fogNear:26,fogFar:128,groundBase:`#1b1e3a`,groundAccent:`#8f6bff`,veinStrength:.9,keyColor:`#cfe0ff`,keyIntensity:3,hemiSky:`#4c5cba`,hemiGround:`#0e1024`,hemiIntensity:1.3,vignette:`rgba(10, 12, 40, 0.55)`}},$f=[`skyTop`,`skyBottom`,`skyHorizon`,`fogColor`,`groundBase`,`groundAccent`,`keyColor`,`hemiSky`,`hemiGround`],ep=[`stars`,`fogNear`,`fogFar`,`veinStrength`,`keyIntensity`,`hemiIntensity`],tp=2.4,np=1.5,rp=22,ip=-120;function ap(){return new Y({transparent:!0,depthWrite:!1,blending:2,fog:!1,uniforms:{uTime:{value:np},uColor:{value:new G(1,1,1)}},vertexShader:`
    ...
    `,fragmentShader:`
      ...
      void main() {
        float t = clamp(uTime / ${np.toFixed(1)}, 0.0, 1.0);
        float radius = ${rp.toFixed(1)} * (1.0 - pow(1.0 - t, 3.0));
...
`;function Ip(e=Mp.CORE,t){let n=t,r=e===Mp.GLOW,i=new Y({defines:r?{BOLT_GLOW:``}:{},transparent:!0,depthWrite:!1,depthTest:!0,blending:2,side:2,toneMapped:!1,uniforms:cp({uOrigin:{value:new V},uTarget:{value:new V(0,0,1)},uSide:{value:new V(1,0,0)},uSag:{value:n.sag},uSeed:{value:0},uRestrike:{value:n.restrike},uProgress:{value:0},uFade:{value:1},uStrands:{value:n.strands},uSpread:{value:n.spread},uSpreadNear:{value:n.spreadNear},uSpreadCurve:{value:n.spreadCurve},uTwist:{value:n.twist},uTwistSpeed:{value:n.twistSpeed},uBranchDim:{value:n.branchDim},uJitter:{value:n.jitter},uJitterScale:{value:n.jitterScale},uOctaves:{value:n.octaves},uJitterFalloff:{value:n.jitterFalloff},uCrawl:{value:n.crawl},uPinch:{value:n.pinch},uConverge:{value:n.converge},uWidth:{value:n.width},uWidthTip:{value:n.widthTip},uWidthCurve:{value:n.widthCurve},uCoreWidth:{value:n.coreWidth},uGlowFalloff:{value:n.glowFalloff},uCoreSharp:{value:n.coreSharp},uWidthScale:{value:r?n.glowWidth:1},uPassOpacity:{value:r?n.glowOpacity:1},uFlicker:{value:n.flicker},uFlickerSpeed:{value:n.flickerSpeed},uStrandFlash:{value:n.strandFlash},uTipGlow:{value:n.tipGlow},uTipLength:{value:n.tipLength},uOpacity:{value:n.opacity},uGlow:{value:n.glow},uColorCore:{value:new G(n.colorCore)},uColorInner:{value:new G(n.colorInner)},uColorOuter:{value:new G(n.colorOuter)},uColorHalo:{value:new G(n.colorHalo)}}),vertexShader:Pp,fragmentShader:Fp});return i.userData.sync=e=>{let t=i.uniforms;t.uOrigin.value.copy(e.origin),t.uTarget.value.copy(e.target),t.uSide.value.copy(e.side),t.uSeed.value=e.seed,t.uProgress.value=e.progress,t.uFade.value=e.fade,t.uStrands.value=e.strands,t.uGlow.value=n.glow,t.uOpacity.value=n.opacity,t.uColorCore.value.set(n.colorCore),t.uColorInner.value.set(n.colorInner),t.uColorOuter.value.set(n.colorOuter),t.uColorHalo.value.set(n.colorHalo)},i}var Lp=Object.freeze({SOFT:0,SMOKE:1,STREAK:2}),Rp={start:3,origin:3,velocity:3,color:3,spawn:1,life:1,size:1,seed:1,spin:1},zp=new V,Bp=class{constructor({name:e,capacity:t=2e3,shape:n=Lp.SOFT,additive:r=!0,curl:i=!1,stretch:a=!1}){this.name=e,this.capacity=t,this.cursor=0;let o=new es;o.setAttribute(`position`,new K(new Float32Array([-.5,-.5,0,.5,-.5,0,.5,.5,0,-.5,.5,0]),3)),o.setAttribute(`uv`,new K(new Float32Array([0,0,1,0,1,1,0,1]),2)),o.setIndex(new K(new Uint16Array([0,1,2,0,2,3]),1)),this.data={},this.attributes={};for(let[e,n]of Object.entries(Rp)){let r=new Float32Array(t*n),i=new Ri(r,n).setUsage(Ze);this.data[e]=r,this.attributes[e]=i,o.setAttribute(`a${e[0].toUpperCase()}${e.slice(1)}`,i)}this.data.life.fill(0),o.instanceCount=t,o.boundingSphere=new Tr(new V,1e4),this.geometry=o;let s={SHAPE:n};i&&(s.USE_CURL=``),a&&(s.USE_STRETCH=``),this.material=new Y({defines:s,transparent:!0,depthWrite:!1,depthTest:!0,blending:r?2:1,side:2,toneMapped:!1,uniforms:cp({uGravity:{value:new V(0,-4.5,0)},uDrag:{value:.9},uTurbulence:{value:.6},uTurbFrequency:{value:.45},uTurbSpeed:{value:.35},uSpeedScale:{value:1},uSizeScale:{value:1},uLifeScale:{value:1},uEndSize:{value:.4},uSizeIn:{value:.08},uFadeIn:{value:.08},uFadeOut:{value:.55},uOpacity:{value:1},uGlow:{value:1},uStretch:{value:.15},uColor0:{value:new G(1,1,1)},uColor1:{value:new G(1,.7,.3)},uColor2:{value:new G(.6,.15,.05)},uColor3:{value:new G(.08,.06,.06)}}),vertexShader:Up,fragmentShader:Wp}),this.mesh=new J(o,this.material),this.mesh.frustumCulled=!1,this.mesh.matrixAutoUpdate=!1,this.mesh.renderOrder=r?12:10,this.mesh.name=`Particles:${e}`,this._ranges=[],this._dirty=!1}get uniforms(){return this.material.uniforms}emit(e,t){if(e<=0)return;e=Math.min(e,this.capacity);let{position:n,radius:r=0,direction:i=null,speed:a=1,speedVariance:o=.35,spread:s=.5,size:c=.2,sizeVariance:l=.4,life:u=1,lifeVariance:d=.3,spin:f=0,tint:p=null,time:m=0}=t,h=this.data;for(let t=0;t<e;t++){let e=this.cursor;this.cursor=(this.cursor+1)%this.capacity,this._markDirty(e);let t=e*3,g=0,_=0,v=0;if(r>0){let e=r*Math.cbrt(Math.random()),t=Math.random()*Math.PI*2,n=Math.acos(2*Math.random()-1),i=Math.sin(n);g=e*i*Math.cos(t),_=e*Math.cos(n),v=e*i*Math.sin(t)}h.start[t+0]=n.x+g,h.start[t+1]=n.y+_,h.start[t+2]=n.z+v,i?zp.copy(i):zp.set(0,1,0),s>0&&(zp.x+=(Math.random()-.5)*2*s,zp.y+=(Math.random()-.5)*2*s,zp.z+=(Math.random()-.5)*2*s),zp.normalize().multiplyScalar(a*(1+(Math.random()-.5)*2*o)),h.velocity[t+0]=zp.x,h.velocity[t+1]=zp.y,h.velocity[t+2]=zp.z,h.spawn[e]=m,h.life[e]=Math.max(.05,u*(1+(Math.random()-.5)*2*d)),h.size[e]=Math.max(.001,c*(1+(Math.random()-.5)*2*l)),h.seed[e]=Math.random(),h.spin[e]=(Math.random()-.5)*2*f,p?(h.color[t+0]=p.r,h.color[t+1]=p.g,h.color[t+2]=p.b):(h.color[t+0]=1,h.color[t+1]=1,h.color[t+2]=1)}}_markDirty(e){this._dirty=!0;let t=this._ranges,n=t[t.length-1];n&&e===n[0]+n[1]?n[1]++:t.push([e,1])}flush(){if(this._dirty){for(let[e,t]of Object.entries(Rp)){let n=this.attributes[e];n.needsUpdate=!0,n.clearUpdateRanges?.();for(let[e,r]of this._ranges)n.addUpdateRange?.(e*t,r*t)}this._ranges.length=0,this._dirty=!1}}setGradient(e,t,n,r){let i=this.uniforms;i.uColor0.value.set(e),i.uColor1.value.set(t),i.uColor2.value.set(n),i.uColor3.value.set(r??n)}reset(){this.data.life.fill(0),this.data.spawn.fill(-1e4);for(let e of Object.keys(Rp))this.attributes[e].needsUpdate=!0;this._ranges.length=0,this._dirty=!1,this.cursor=0}dispose(){this.geometry.dispose(),this.material.dispose()}},Vp=class{constructor(){this._acc=0}reset(){this._acc=0}tick(e,t){this._acc+=t*e;let n=Math.floor(this._acc);return n>0&&(this._acc-=n),n}},Hp=class{constructor(e){this.scene=e,this.systems=new Map}get(e,t){let n=this.systems.get(e);return n||(n=new Bp({name:e,...t}),this.systems.set(e,n),this.scene.add(n.mesh)),n}flush(){for(let e of this.systems.values())e.flush()}reset(){for(let e of this.systems.values())e.reset()}dispose(){for(let e of this.systems.values())this.scene.remove(e.mesh),e.dispose();this.systems.clear()}},Up=`
  uniform float uTime;
...
`,Gp=class{constructor(e,t){this._create=e,this._release=t,this._free=[]}acquire(){return this._free.length>0?this._free.pop():this._create()}release(e){this._release?.(e),this._free.push(e)}dispose(e){if(e)for(let t of this._free)e(t);this._free.length=0}},Kp=Object.freeze({FIRE:0,AIR:2,FROST:4,STORM:5}),qp=`
  uniform float uTime;
  uniform float uAge;
...
`,Yp=class{constructor(e){this.group=new Mn,this.group.name=`Bursts`,e.add(this.group),this.geometry=new Ma(1,4),this.pools=new Map,this.active=[]}_poolFor(e){let t=this.pools.get(e);return t||(t=new Gp(()=>this._create(e),e=>{e.mesh.visible=!1,this.group.remove(e.mesh)}),this.pools.set(e,t)),t}_create(e){let t=new Y({defines:{BURST_MODE:e},transparent:!0,depthWrite:!1,depthTest:!0,blending:2,side:2,toneMapped:!1,uniforms:cp({uAge:{value:0},uSeed:{value:Math.random()},uDisplace:{value:.45},uTurbulence:{value:1},uIntensity:{value:1},uFresnel:{value:1},uOpacity:{value:1},uColorA:{value:new G(1,.9,.6)},uColorB:{value:new G(1,.45,.1)},uColorC:{value:new G(.4,.08,.03)}}),vertexShader:qp,fragmentShader:Jp}),n=new J(this.geometry,t);return n.renderOrder=14,n.frustumCulled=!1,{mesh:n,material:t,mode:e,age:0,life:1,radius:1,endRadius:2}}spawn(e,t,n={}){let{radius:r=.4,endRadius:i=3,life:a=.9,intensity:o=1,opacity:s=1,fresnel:c=1,displace:l=.45,turbulence:u=1,colorA:d=null,colorB:f=null,colorC:p=null,squash:m=1}=n,h=this._poolFor(e).acquire(),g=h.material.uniforms;return h.age=0,h.life=Math.max(.05,a),h.radius=r,h.endRadius=i,h.squash=m,g.uAge.value=0,g.uSeed.value=Math.random()*10,g.uIntensity.value=o,g.uOpacity.value=s,g.uFresnel.value=c,g.uDisplace.value=l,g.uTurbulence.value=u,d&&g.uColorA.value.copy(d),f&&g.uColorB.value.copy(f),p&&g.uColorC.value.copy(p),h.mesh.position.copy(t),h.mesh.scale.setScalar(r),h.mesh.visible=!0,this.group.add(h.mesh),this.active.push(h),h}update(e){for(let t=this.active.length-1;t>=0;t--){let n=this.active[t];n.age+=e;let r=Math.min(1,n.age/n.life);n.material.uniforms.uAge.value=r;let i=n.radius+(n.endRadius-n.radius)*vp.outQuint(r);n.mesh.scale.set(i,i*n.squash,i),r>=1&&(this.active.splice(t,1),this._poolFor(n.mode).release(n))}}clear(){for(let e of this.active)this._poolFor(e.mode).release(e);this.active.length=0}dispose(){this.clear();for(let e of this.pools.values())e.dispose(e=>e.material.dispose());this.pools.clear(),this.geometry.dispose(),this.group.parent?.remove(this.group)}},Xp=Object.freeze({SCORCH:0,CRACK:2,SHOCKWAVE:3,DUSTRING:4,FROST:6,ARC:7}),Zp=`
...
`,$p=class{constructor(e){this.group=new Mn,this.group.name=`GroundDecals`,e.add(this.group),this.geometry=new Pa(1,1).rotateX(-Math.PI/2),this.active=[],this.pools=new Map}_poolFor(e){let t=this.pools.get(e);return t||(t=new Gp(()=>this._createDecal(e),e=>{e.mesh.visible=!1,this.group.remove(e.mesh)}),this.pools.set(e,t)),t}_createDecal(e){let t=e===Xp.SHOCKWAVE||e===Xp.ARC,n=new Y({defines:{DECAL:e},transparent:!0,depthWrite:!1,depthTest:!0,blending:t?2:1,toneMapped:!1,uniforms:cp({uAge:{value:0},uSeed:{value:Math.random()},uIntensity:{value:1},uWidth:{value:.12},uRadius:{value:1},uColorA:{value:new G(.1,.06,.05)},uColorB:{value:new G(1,.5,.15)}}),vertexShader:Zp,fragmentShader:Qp}),r=new J(this.geometry,n);return r.renderOrder=t?8:6,r.frustumCulled=!1,{mesh:r,material:n,type:e,age:0,life:1,radius:1,growth:0}}spawn(e,t,n={}){let{radius:r=2,life:i=2,colorA:a=null,colorB:o=null,intensity:s=1,width:c=.12,growth:l=0,height:u=.02}=n,d=this._poolFor(e).acquire(),f=d.material.uniforms;return d.age=0,d.life=Math.max(.05,i),d.radius=r,d.growth=l,f.uAge.value=0,f.uSeed.value=Math.random(),f.uIntensity.value=s,f.uWidth.value=c,f.uRadius.value=r,a&&f.uColorA.value.set(a),o&&f.uColorB.value.set(o),d.mesh.position.set(t.x,u,t.z),d.mesh.rotation.y=Math.random()*Math.PI*2,d.mesh.scale.setScalar(r*2),d.mesh.visible=!0,this.group.add(d.mesh),this.active.push(d),d}update(e){for(let t=this.active.length-1;t>=0;t--){let n=this.active[t];n.age+=e;let r=n.age/n.life;n.material.uniforms.uAge.value=r,n.growth!==0&&n.mesh.scale.setScalar(n.radius*2*(1+n.growth*r)),r>=1&&(this.active.splice(t,1),this._poolFor(n.type).release(n))}}clear(){for(let e of this.active)this._poolFor(e.type).release(e);this.active.length=0}dispose(){this.clear();for(let e of this.pools.values())e.dispose(e=>e.material.dispose());this.pools.clear(),this.geometry.dispose(),this.group.parent?.remove(this.group)}},em=class e{constructor(e,t){this.scene=e,this.renderer=t,this.bursts=new Yp(e),this.decals=new $p(e),this.particles=new Hp(e),this._scratchColor=new G,this._emit={},this._dir=new V,this.sparks=this.particles.get(`sparks`,{capacity:4e3,shape:Lp.STREAK,additive:!0,stretch:!0}),this.sparks.uniforms.uDrag.value=1.4,this.sparks.uniforms.uEndSize.value=.25,this.sparks.uniforms.uSizeIn.value=.02,this.sparks.uniforms.uFadeIn.value=.03,this.sparks.uniforms.uFadeOut.value=.45,this.motes=this.particles.get(`motes`,{capacity:2400,shape:Lp.SOFT,additive:!0,curl:!0}),this.motes.uniforms.uDrag.value=1.2,this.motes.uniforms.uEndSize.value=.16,this.motes.uniforms.uSizeIn.value=.05,this.motes.uniforms.uFadeIn.value=.07,this.motes.uniforms.uFadeOut.value=.4,this.smoke=this.particles.get(`smoke`,{capacity:1600,shape:Lp.SMOKE,additive:!1,curl:!0}),this.smoke.uniforms.uDrag.value=1.7,this.smoke.uniforms.uEndSize.value=3,this.smoke.uniforms.uSizeIn.value=.12,this.smoke.uniforms.uFadeIn.value=.16,this.smoke.uniforms.uFadeOut.value=.3,this.smoke.uniforms.uOpacity.value=.55,this._sparkEmitter=new Vp,this._moteEmitter=new Vp}static ELEMENT_BURST={ice:{a:`#a9e4ff`,b:`#cdefff`,c:`#f2feff`},fire:{a:`#ffd27a`,b:`#ff6a12`,c:`#fff3d0`},storm:{a:`#a98bff`,b:`#d3f4ff`,c:`#ffffff`},basic:{a:`#9fd8ff`,b:`#d3f4ff`,c:`#ffffff`}};sparkBurst(t,n,r={}){let i=e.ELEMENT_BURST[n]??e.ELEMENT_BURST.basic,a=r.count??60;this.sparks.setGradient(`#ffffff`,i.c,i.b,i.a),this.sparks.uniforms.uGravity.value.set(0,r.gravity??-11,0),this.sparks.uniforms.uSizeScale.value=r.size??1.2,this.sparks.uniforms.uLifeScale.value=r.life??.8,this.sparks.uniforms.uGlow.value=1.6;let o=this._emit;o.position=t,o.radius=r.radius??.25,o.direction=this._dir.set(0,r.up??.7,0).normalize(),o.speed=r.speed??9,o.speedVariance=.85,o.spread=1,o.size=.22,o.sizeVariance=.8,o.life=.6,o.lifeVariance=.6,o.spin=0,o.tint=null,o.time=sp.uTime.value,this.sparks.emit(a,o)}killBurst(t,n,r=1){let i=e.ELEMENT_BURST[n]??e.ELEMENT_BURST.basic,a={ice:Kp.FROST,fire:Kp.FIRE,storm:Kp.STORM,basic:Kp.AIR};this.bursts.spawn(a[n]??Kp.AIR,t,{radius:.2*r,endRadius:(n===`basic`?2.6:3.4)*r,life:.55+.15*r,intensity:1.1,opacity:.95,fresnel:n===`basic`?2.2:1.6,displace:.45,colorA:i.a,colorB:i.b,colorC:i.c}),this.decals.spawn(Xp.SHOCKWAVE,t,{radius:2.2*r,life:.5,width:.05,intensity:.85,colorA:i.b,colorB:`#ffffff`}),this.sparkBurst(t,n,{count:Math.round(46*r),speed:8*r,life:.9,size:1.1})}update(e,t,n){if(sp.uTime.value+=e,sp.uDelta.value=e,n){let e=n.getSize(new B),t=n.getPixelRatio();sp.uResolution.value.set(e.x*t,e.y*t)}t&&(sp.uCameraNear.value=t.near,sp.uCameraFar.value=t.far),this.bursts.update(e),this.decals.update(e),this.particles.flush()}clear(){this.bursts.clear(),this.decals.clear(),this.particles.reset(),this._sparkEmitter.reset(),this._moteEmitter.reset()}dispose(){this.bursts.dispose(),this.decals.dispose(),this.particles.dispose()}},tm={ice:{core:`#ffffff`,inner:`#d3f4ff`,outer:`#56d8ff`},fire:{core:`#ffffff`,inner:`#ffe8c0`,outer:`#ff8a3c`},storm:{core:`#ffffff`,inner:`#e7dcff`,outer:`#a98bff`}};function nm(e){let t=new Mn,n=new J(new ka(.03,.03,.9,8),e);n.rotation.x=Math.PI/2,t.add(n);let r=new J(new Aa(.07,.24,8),e);r.rotation.x=Math.PI/2,r.position.z=.54,t.add(r);let i=new Pa(.18,.24);i.rotateY(Math.PI/2);let a=new li({color:`#ffffff`,transparent:!0,opacity:.9,side:2,depthWrite:!1});for(let e of[Math.PI/4,-Math.PI/4]){let n=new J(i,a);n.position.z=-.36,n.rotation.z=e,t.add(n)}return t}var rm=class{constructor(e,t=1400){this.max=t,this.particles=[],this._positions=new Float32Array(t*3),this._colors=new Float32Array(t*3),this._alphas=new Float32Array(t),this._sizes=new Float32Array(t);let n=new Nr;n.setAttribute(`position`,new K(this._positions,3)),n.setAttribute(`aColor`,new K(this._colors,3)),n.setAttribute(`aAlpha`,new K(this._alphas,1)),n.setAttribute(`aSize`,new K(this._sizes,1)),n.boundingSphere=null,this._material=new Y({transparent:!0,depthWrite:!1,blending:2,fog:!1,uniforms:{uPixelRatio:{value:1}},vertexShader:`
        uniform float uPixelRatio;
        attribute vec3 aColor;
      ...
      `}),this._points=new ba(n,this._material),this._points.frustumCulled=!1,this._points.renderOrder=3,e.add(this._points),this._geometry=n,this._cA=new G,this._cB=new G}setPixelRatio(e){this._material.uniforms.uPixelRatio.value=e}clear(){this.particles.length=0,this._alphas.fill(0)}emit(e){for(let t=0;t<e.count;t++){this.particles.length>=this.max&&this.particles.shift();let t=Math.random()*Math.PI*2,n=Math.sqrt(Math.random())*(e.spread??1),r=mp(e.speed[0],e.speed[1],Math.random());this.particles.push({x:e.pos.x+Math.cos(t)*n*.3,y:e.pos.y+Math.random()*.2,z:e.pos.z+Math.sin(t)*n*.3,vx:Math.cos(t)*n*r,vy:mp(e.up[0],e.up[1],Math.random()),vz:Math.sin(t)*n*r,life:0,maxLife:mp(e.life[0],e.life[1],Math.random()),size:mp(e.size[0],e.size[1],Math.random()),gravity:e.gravity??-9,drag:e.drag??.6,color:this._cA.set(e.colorA).clone().lerp(this._cB.set(e.colorB),Math.random())})}}update(e){let t=this.particles,n=0;for(let r=0;r<t.length;r++){let i=t[r];if(i.life+=e,i.life>=i.maxLife)continue;let a=Math.max(0,1-i.drag*e);i.vx*=a,i.vz*=a,i.vy=i.vy*a+i.gravity*e,i.x+=i.vx*e,i.y+=i.vy*e,i.z+=i.vz*e,i.y<.03&&i.vy<0&&(i.y=.03,i.vy*=-.35),t[n++]=i}t.length=n;for(let e=0;e<this.max;e++)if(e<t.length){let n=t[e],r=1-n.life/n.maxLife;this._positions[e*3]=n.x,this._positions[e*3+1]=n.y,this._positions[e*3+2]=n.z,this._colors[e*3]=n.color.r,this._colors[e*3+1]=n.color.g,this._colors[e*3+2]=n.color.b,this._alphas[e]=r,this._sizes[e]=n.size}else this._alphas[e]=0;this._geometry.attributes.position.needsUpdate=!0,this._geometry.attributes.aColor.needsUpdate=!0,this._geometry.attributes.aAlpha.needsUpdate=!0,this._geometry.attributes.aSize.needsUpdate=!0}dispose(){this._geometry.dispose(),this._material.dispose()}},im=3,am=44,om=.17,sm=.26,cm=.55,lm=.45,um=1.3,dm=.9,fm=24,pm=class{constructor(e){this.group=new Mn,e.add(this.group),this.material=Ap({colorDeep:`#3e737a`,colorIce:`#8adaff`,colorRim:`#f2feff`,colorCore:`#638797`}),this.meshes=[],this.seedAttrs=[],this.birthAttrs=[];for(let e=0;e<im;e++){let t=Sp({seed:7.3+e*21.7,sides:6,taper:.16,roughness:.24,bend:.3}),n=new Ri(new Float32Array(am),1),r=new Ri(new Float32Array(am),1).setUsage(Ze);t.setAttribute(`aSeed`,n),t.setAttribute(`aBirth`,r);let i=new Ki(t,this.material,am);i.instanceMatrix.setUsage(Ze),i.count=0,i.frustumCulled=!1,i.visible=!1,this.group.add(i),this.meshes.push(i),this.seedAttrs.push(n),this.birthAttrs.push(r)}this._dummy=new jn,this._up=new V(0,1,0),this._lean=new V,this._axis=new V,this._tilt=new It,this._spin=new It}_halfWidth(e){return mp(.55,2.6,pp(e)**.75)}layout(e,t,n,r){let i=e.distanceTo(t),a=[];for(let t=0;t<103;t++){let o=((t+Math.random())/103)**.85,s=gp(-1,1),c=Math.sign(s)*Math.abs(s)**1.35,l=(c+gp(-1,1)*.3)*this._halfWidth(o),u=e.x+n.x*i*o+r.x*l,d=e.z+n.z*i*o+r.z*l,f=mp(.55,3,o**1.4);f*=1+.45*pp((o-.72)/.28),f*=1-.55*pp(Math.abs(c))**1.4,f*=1+gp(-.3,.3),Math.random()<.35&&(f*=.32);let p=c,m=n.x*.75+r.x*p*.85,h=n.z*.75+r.z*p*.85,g=.42*(.35+.65*o)*(1+gp(-.5,.5));a.push({x:u,z:d,along:o,yaw:Math.random()*Math.PI*2,height:f,radius:.3+Math.random()*.28,leanX:m,leanZ:h,lean:g,stagger:Math.random()*.09,eruptTime:-1,variant:t%im,slot:t/im|0,seed:Math.random()})}for(let e=0;e<29;e++){let n=Math.random()*Math.PI*2,r=Math.sqrt(Math.random()),i=this._halfWidth(1)*1.3*r;a.push({x:t.x+Math.cos(n)*i,z:t.z+Math.sin(n)*i,along:1,yaw:Math.random()*Math.PI*2,height:2.1+Math.random()*1.2,radius:.34+Math.random()*.3,leanX:Math.cos(n),leanZ:Math.sin(n),lean:.3+Math.random()*.25,stagger:Math.random()*.12,eruptTime:-1,variant:(103+e)%im,slot:(103+e)/im|0,seed:Math.random()})}for(let e of a)this.seedAttrs[e.variant].array[e.slot]=e.seed;for(let e=0;e<im;e++)this.seedAttrs[e].needsUpdate=!0,this.meshes[e].count=am,this.meshes[e].visible=!0;return a}triggerUpTo(e,t,n,r){for(let i of e)i.eruptTime>=0||i.along>n||i.along>=1&&!r||(i.eruptTime=t+i.stagger)}_emergence(e,t){if(e.eruptTime<0)return-1;let n=t-e.eruptTime;if(n<0)return-1;let r=vp.outQuint(pp(n/om));if(n<=om)return r;let i=n-om;return 1+sm*(Math.sin(i*14)*Math.exp(-i/cm))}update(e,t,n){let r=[0,0,0];for(let n of e){let e=this._emergence(n,t),i=this.meshes[n.variant],a=n.slot;if(r[n.variant]=Math.max(r[n.variant],a+1),e<0){this._dummy.position.set(0,-999,0),this._dummy.scale.setScalar(1e-4),this._dummy.rotation.set(0,0,0),this._dummy.updateMatrix(),i.setMatrixAt(a,this._dummy.matrix),this.birthAttrs[n.variant].array[a]=0;continue}this._lean.set(n.leanX,0,n.leanZ).normalize(),this._axis.crossVectors(this._up,this._lean).normalize(),this._tilt.setFromAxisAngle(this._axis,n.lean),this._spin.setFromAxisAngle(this._up,n.yaw),this._tilt.multiply(this._spin),this._dummy.position.set(n.x,(Math.min(e,1.3)-1)*n.height*.85,n.z),this._dummy.quaternion.copy(this._tilt);let o=Math.min(1,e);this._dummy.scale.set(n.radius,Math.max(.02,o*n.height),n.radius),this._dummy.updateMatrix(),i.setMatrixAt(a,this._dummy.matrix);let s=t-n.eruptTime;this.birthAttrs[n.variant].array[a]=pp(1-s/lm)}for(let e=0;e<im;e++)this.meshes[e].count=r[e],this.meshes[e].instanceMatrix.needsUpdate=!0,this.birthAttrs[e].needsUpdate=!0;if(n>0){let e=vp.inCubic(n);this.group.position.y=-e*4.2}else this.group.position.y=0}hide(){for(let e=0;e<im;e++)this.meshes[e].count=0,this.meshes[e].visible=!1;this.group.position.y=0}dispose(){for(let e of this.meshes)e.geometry.dispose();this.material.dispose(),this.group.parent?.remove(this.group)}},mm=14,hm=class{constructor(e){this.group=new Mn,e.add(this.group),this.material=jp();let t=Ep({seed:11.7,detail:3,lumpiness:.26,noiseScale:1.5,roughness:.16,cuts:9,cutDepth:.28,craters:5,craterDepth:.18,craterSize:.5}),n=new Ri(new Float32Array([3.7]),1);this._rockHeat=new Ri(new Float32Array([0]),1).setUsage(Ze),t.setAttribute(`aSeed`,n),t.setAttribute(`aHeat`,this._rockHeat),this.rock=new Ki(t,this.material,1),this.rock.instanceMatrix.setUsage(Ze),this.rock.frustumCulled=!1,this.rock.visible=!1,this.group.add(this.rock);let r=Ep({seed:47.3,detail:1,lumpiness:.4,noiseScale:1.8,roughness:.3,cuts:5,cutDepth:.32,craters:2,craterDepth:.2,craterSize:.5}),i=new Ri(new Float32Array(mm),1);for(let e=0;e<mm;e++)i.array[e]=Math.random()*40;this._chunkHeat=new Ri(new Float32Array(mm),1).setUsage(Ze),r.setAttribute(`aSeed`,i),r.setAttribute(`aHeat`,this._chunkHeat),this.chunks=new Ki(r,this.material,mm),this.chunks.instanceMatrix.setUsage(Ze),this.chunks.frustumCulled=!1,this.chunks.visible=!1,this.group.add(this.chunks),this._dummy=new jn,this._quat=new It,this._chunkList=[],this._rockScale=1.35}launch(e){this._dummy.position.copy(e),this._dummy.quaternion.identity(),this._dummy.scale.setScalar(this._rockScale),this._dummy.updateMatrix(),this.rock.setMatrixAt(0,this._dummy.matrix),this.rock.instanceMatrix.needsUpdate=!0,this.rock.visible=!0,this._rockHeat.array[0]=1,this._rockHeat.needsUpdate=!0,this.rock.material.userData.sync(0,null)}tickRock(e,t,n,r,i){this._dummy.position.copy(e),this._dummy.rotation.set(t,0,n),this._dummy.scale.setScalar(this._rockScale),this._dummy.updateMatrix(),this.rock.setMatrixAt(0,this._dummy.matrix),this.rock.instanceMatrix.needsUpdate=!0,this._rockHeat.array[0]=1,this._rockHeat.needsUpdate=!0,this.rock.material.userData.sync(r,i)}hideRock(){this.rock.visible=!1}burstChunks(e,t=Math.random){this._chunkList.length=0;for(let n=0;n<mm;n++){let r=t()*Math.PI*2;this._chunkList.push({x:e.x,y:.5,z:e.z,vx:Math.cos(r)*(2+t()*5),vy:4+t()*7,vz:Math.sin(r)*(2+t()*5),rx:t()*Math.PI*2,rz:t()*Math.PI*2,wx:(t()-.5)*12,wz:(t()-.5)*12,scale:.16+t()*.22,heat:1}),this._chunkHeat.array[n]=1}this.chunks.visible=!0}tickChunks(e){if(!this.chunks.visible)return;let t=!1;for(let n=0;n<this._chunkList.length;n++){let r=this._chunkList[n];if(r.heat=Math.max(0,r.heat-e*.75),this._chunkHeat.array[n]=r.heat,r.heat<=0){this._dummy.position.set(0,-999,0),this._dummy.scale.setScalar(1e-4),this._dummy.rotation.set(0,0,0),this._dummy.updateMatrix(),this.chunks.setMatrixAt(n,this._dummy.matrix);continue}t=!0,r.vy-=17*e,r.x+=r.vx*e,r.y+=r.vy*e,r.z+=r.vz*e,r.y<.12&&r.vy<0&&(r.y=.12,r.vy*=-.38,r.vx*=.72,r.vz*=.72),r.rx+=r.wx*e,r.rz+=r.wz*e,this._dummy.position.set(r.x,r.y,r.z),this._dummy.rotation.set(r.rx,0,r.rz),this._dummy.scale.setScalar(r.scale),this._dummy.updateMatrix(),this.chunks.setMatrixAt(n,this._dummy.matrix)}this.chunks.instanceMatrix.needsUpdate=!0,this._chunkHeat.needsUpdate=!0,t||(this.chunks.visible=!1)}reset(){this.rock.visible=!1,this.chunks.visible=!1,this._chunkList.length=0,this._rockHeat.array[0]=0}dispose(){this.rock.geometry.dispose(),this.chunks.geometry.dispose(),this.material.dispose(),this.group.parent?.remove(this.group)}},gm=class{constructor(e,t){this.scene=e,this.vfx=t,this.bursts=new rm(e),this._crystals=new pm(e),this._crystalState=null,this._meteor=new hm(e),this._meteorLight=new Yo(`#ff8a3c`,0,26,2),e.add(this._meteorLight),this._boltConfig=Np({sag:0,strands:14,spread:1.15,spreadNear:.03,spreadCurve:1.5,jitter:.58,jitterScale:.72,width:.042,widthTip:.5,coreWidth:1.55,coreSharp:4.4,glowWidth:8.5,glowOpacity:.6,glowFalloff:2.2,restrike:18,flicker:.35,strandFlash:.55,glow:2.8,colorCore:`#ffffff`,colorInner:`#e9dfff`,colorOuter:`#a98bff`,colorHalo:`#5a2bd6`}),this._boltGeometry=Dp(72,14),this._boltGroup=new Mn,this._boltGroup.visible=!1,e.add(this._boltGroup),this._boltMaterials=[];for(let e of[Mp.GLOW,Mp.CORE]){let t=Ip(e,this._boltConfig),n=new J(this._boltGeometry,t);n.frustumCulled=!1,n.matrixAutoUpdate=!1,n.renderOrder=11+e*2,this._boltGroup.add(n),this._boltMaterials.push(t)}this._boltState={origin:new V,target:new V,side:new V(1,0,0),progress:0,fade:1,seed:0,strands:14},this._boltLight=new Yo(`#c9b8ff`,0,30,2),e.add(this._boltLight),this._balls=[];let n=document.createElement(`canvas`);n.width=n.height=64;let r=n.getContext(`2d`),i=r.createRadialGradient(32,32,2,32,32,30);i.addColorStop(0,`rgba(255,255,255,1)`),i.addColorStop(.4,`rgba(255,255,255,0.32)`),i.addColorStop(1,`rgba(255,255,255,0)`),r.fillStyle=i,r.fillRect(0,0,64,64),this._ballHaloTexture=new Ca(n);for(let t=0;t<8;t++){let t=new Mn,n=new qa({color:`#ffffff`,emissive:`#9fd8ff`,emissiveIntensity:2.6,roughness:.4,metalness:.2,toneMapped:!1}),r=nm(n),i=new $r(new zr({map:this._ballHaloTexture,color:`#9fd8ff`,transparent:!0,opacity:.85,blending:2,depthWrite:!1}));i.scale.setScalar(1.5),i.renderOrder=20,t.add(r,i),t.visible=!1,e.add(t),this._balls.push({group:t,arrow:r,arrowMaterial:n,halo:i,busy:!1})}this._active=[],this._scratchDir=new V,this._scratchUp=new V(0,1,0)}cast(e,t,n,r){e===`ice`?this._castIce(t,n,r):e===`fire`?this._castFire(t,n,r):e===`storm`&&this._castStorm(n,r),$.spellCast(e)}castBasic(e,t,n,r,i){let a=this._balls.find(e=>!e.busy)??this._balls[0];a.busy=!0,a.group.visible=!0,a.group.position.copy(e),a.group.lookAt(t),a.arrowMaterial.emissive.set(n),a.arrowMaterial.color.set(`#ffffff`).lerp(new G(n),.45),a.halo.material.color.set(n),this._active.push({type:`basic`,t:0,duration:Math.max(.12,e.distanceTo(t)/26),start:e.clone(),point:t.clone(),color:n,fired:!1,hitSet:new Set,onMove:r,onImpact:i,slot:a})}_tickBasic(e,t){e.t+=t;let n=Math.min(1,e.t/e.duration);e.slot.group.position.lerpVectors(e.start,e.point,n),e.onMove?.(e.slot.group.position,e.hitSet);let r=this._elementFromColor(e.color),i=tm[r]??tm.ice,a=this.vfx;a.sparks.setGradient(`#ffffff`,i.inner,i.outer,i.outer),a.sparks.uniforms.uGravity.value.set(0,-1.5,0),a.sparks.uniforms.uSizeScale.value=.55,a.sparks.uniforms.uLifeScale.value=.32,a.sparks.uniforms.uGlow.value=1.5;let o=a._emit;return o.position=e.slot.group.position,o.radius=.1,o.direction=null,o.speed=1.2,o.speedVariance=.8,o.spread=1,o.size=.14,o.sizeVariance=.7,o.life=.3,o.lifeVariance=.5,o.spin=0,o.tint=null,o.time=sp.uTime.value,a.sparks.emit(3,o),e.slot.arrow.rotation.z+=t*22,e.slot.halo.material.opacity=.75+.25*Math.sin(e.t*34),n>=1&&!e.fired&&(e.fired=!0,e.slot.group.visible=!1,e.slot.busy=!1,this.vfx.bursts.spawn(Kp.AIR,e.point,{radius:.12,endRadius:1.9,life:.38,intensity:1,opacity:.9,fresnel:2,displace:.3,colorA:e.color,colorB:`#ffffff`,colorC:`#d3f4ff`}),this.vfx.decals.spawn(Xp.SHOCKWAVE,e.point,{radius:2.1,life:.42,width:.06,intensity:.9,colorA:e.color,colorB:`#ffffff`}),this.vfx.sparkBurst(e.point,r,{count:26,speed:5.5,life:.6,size:.9,up:1.2}),this._flash(e.point,e.color,110),e.onImpact(e.point,1.8,e.hitSet)),e.fired&&e.t>e.duration+.15}_elementFromColor(e){return e.startsWith(`#56d8`)?`ice`:e.startsWith(`#ff8a`)?`fire`:e.startsWith(`#a98b`)?`storm`:`basic`}_castIce(e,t,n){this._crystalState&&=(this._crystals.hide(),null);let r=this._scratchDir.set(t.x-e.x,0,t.z-e.z),i=Math.max(3,r.length());r.divideScalar(Math.max(1e-4,r.length()));let a=new V(-r.z,0,r.x),o=this._crystals.layout(e,t,r,a);this._crystalState={age:0,started:!1,fired:!1,retract:0,front:0,len:i,dir:r.clone(),side:a.clone(),start:e.clone(),point:t.clone(),records:o,frostDist:1.2,frostAccum:0,onImpact:n},this._active.push({type:`ice`})}_tickIce(e,t){let n=this._crystalState;n.age+=t;let r=n.len/fm;n.started||(n.started=!0,this.vfx.bursts.spawn(Kp.FROST,n.start.clone().setY(.5),{radius:.18,endRadius:2.2,life:.45,intensity:.85,opacity:.9,fresnel:1.4,displace:.4,colorA:`#a9e4ff`,colorB:`#cdefff`,colorC:`#f2feff`}),this.vfx.decals.spawn(Xp.FROST,n.start,{radius:2.2,life:5.5,intensity:.7,width:1.5,colorA:`#ffffff`,colorB:`#6aa5d4`,height:.045}),this.vfx.sparkBurst(n.start,`ice`,{count:30,speed:5,life:.6,size:.9,up:1.2}),this._flash(n.start,`#8fd8ff`,90)),n.fired||(n.front+=fm*t);let i=pp(n.front/n.len);for(this._crystals.triggerUpTo(n.records,n.age,i,n.fired),n.frostAccum+=fm*t;!n.fired&&n.frostAccum>=2.4&&n.frostDist<n.len-.5;){n.frostAccum-=2.4;let e=n.start.x+n.dir.x*n.frostDist+n.side.x*gp(-1,1),t=n.start.z+n.dir.z*n.frostDist+n.side.z*gp(-1,1);this.vfx.decals.spawn(Xp.FROST,{x:e,z:t},{radius:2,life:5,intensity:.65,width:1.5,colorA:`#ffffff`,colorB:`#6aa5d4`,height:.045}),n.frostDist+=2.4}if(!n.fired&&i>=1&&(n.fired=!0,this.vfx.bursts.spawn(Kp.FROST,n.point.clone().setY(.6),{radius:.3,endRadius:4.4,life:.6,intensity:.95,opacity:.95,fresnel:1.3,displace:.45,colorA:`#a9e4ff`,colorB:`#cdefff`,colorC:`#f2feff`}),this.vfx.decals.spawn(Xp.SHOCKWAVE,n.point,{radius:5.4,life:.55,width:.05,intensity:.95,colorA:`#5fd0ff`,colorB:`#f2feff`}),this.vfx.decals.spawn(Xp.FROST,n.point,{radius:5,life:7,intensity:.95,width:1.5,colorA:`#ffffff`,colorB:`#6aa5d4`,height:.05}),this.vfx.sparkBurst(n.point,`ice`,{count:90,speed:8,life:.9,size:1.1,up:1.4}),this._flash(n.point,`#8fd8ff`,160),n.onImpact(n.point,4.6)),n.age>r+um+.3&&(n.retract=Math.min(1,n.retract+t/dm)),this._crystals.update(n.records,n.age,n.retract),!n.retract){this.vfx.motes.setGradient(`#f2feff`,`#a9e4ff`,`#57c9ff`,`#0a3552`),this.vfx.motes.uniforms.uGravity.value.set(0,1.6,0),this.vfx.motes.uniforms.uSizeScale.value=.7,this.vfx.motes.uniforms.uLifeScale.value=1.4,this.vfx.motes.uniforms.uTurbulence.value=.5,this.vfx.motes.uniforms.uGlow.value=1.2;let e=this.vfx._emit,t=Math.min(n.front,n.len)*(.75+Math.random()*.25);e.position=this._scratchUp.set(n.start.x+n.dir.x*t+n.side.x*gp(-1.5,1.5),.2,n.start.z+n.dir.z*t+n.side.z*gp(-1.5,1.5)),e.radius=1,e.direction=null,e.speed=2.4,e.speedVariance=.8,e.spread=.7,e.size=.1,e.sizeVariance=.6,e.life=1.6,e.lifeVariance=.5,e.spin=0,e.tint=null,e.time=sp.uTime.value,this.vfx.motes.emit(2,e)}return n.retract>=1&&(this._crystals.hide(),this._crystalState=null,!0)}_castFire(e,t,n){let r=this._scratchDir.set(t.x-e.x,0,t.z-e.z).normalize(),i=t.clone().addScaledVector(r,-9).add(new V(0,17,0));this._meteor.launch(i),this._meteorLight.position.copy(i),this._meteorLight.intensity=130,this._active.push({type:`fire`,t:0,duration:.62,start:i,point:t.clone(),fired:!1,onImpact:n})}_tickFire(e,t){e.t+=t;let n=Math.min(1,e.t/e.duration),r=n*n,i=e.start.clone().lerp(e.point,r),a=pp(e.t/e.duration),o=e.point.clone().sub(e.start).normalize();this._meteor.tickRock(i,e.t*7,e.t*5,a,o),this._meteorLight.position.copy(i),this._meteorLight.intensity=130,this.vfx.motes.setGradient(`#fff3d0`,`#ff9a2e`,`#ff3b0d`,`#2b0d05`),this.vfx.motes.uniforms.uGravity.value.set(0,1.5,0),this.vfx.motes.uniforms.uSizeScale.value=1,this.vfx.motes.uniforms.uLifeScale.value=.8,this.vfx.motes.uniforms.uTurbulence.value=.5,this.vfx.motes.uniforms.uGlow.value=1.4;let s=this.vfx._emit;return s.position=i,s.radius=.7,s.direction=null,s.speed=2.4,s.speedVariance=.8,s.spread=.9,s.size=.28,s.sizeVariance=.6,s.life=.7,s.lifeVariance=.5,s.spin=0,s.tint=null,s.time=sp.uTime.value,this.vfx.motes.emit(5,s),this.vfx.sparkBurst(i,`fire`,{count:2,speed:3,life:.4,size:.8,up:.4,radius:.5}),n>=1&&!e.fired&&(e.fired=!0,this._meteor.hideRock(),this._meteor.burstChunks(e.point),this._meteorLight.intensity=260,this.vfx.bursts.spawn(Kp.FIRE,e.point.clone().setY(.8),{radius:.5,endRadius:5.6,life:.7,intensity:1.2,opacity:.95,fresnel:1,displace:.55,turbulence:1.4,colorA:`#ffd27a`,colorB:`#ff6a12`,colorC:`#fff3d0`}),this.vfx.decals.spawn(Xp.SHOCKWAVE,e.point,{radius:6,life:.6,width:.05,intensity:1,colorA:`#ff9a2e`,colorB:`#fff3d0`}),this.vfx.decals.spawn(Xp.CRACK,e.point,{radius:5.2,life:5.5,width:.14,intensity:1.35,colorA:`#0e0703`,colorB:`#ff6a12`,height:.045}),this.vfx.decals.spawn(Xp.SCORCH,e.point,{radius:3.2,life:8,intensity:1,colorA:`#070504`,colorB:`#ff9a2e`,height:.04}),this.vfx.decals.spawn(Xp.DUSTRING,e.point,{radius:4.4,life:1.1,intensity:.7,colorA:`#26201b`,colorB:`#ffb066`,height:.05}),this.vfx.sparkBurst(e.point,`fire`,{count:150,speed:11,life:1.1,size:1.2,up:1.2}),this._flash(e.point,`#ffb066`,220),e.onImpact(e.point,5.4)),e.fired&&(this._meteor.tickChunks(t),this._meteorLight.intensity*=Math.max(0,1-t*5),e.t>e.duration+2.4)?(this._meteorLight.intensity=0,!0):!1}_castStorm(e,t){this._active.push({type:`storm`,t:0,point:e.clone(),fired:!1,seed:Math.random()*100,onImpact:t})}_tickStorm(e,t){if(e.t+=t,!e.fired&&e.t>=.15){e.fired=!0,this._boltState.origin.set(e.point.x+(Math.random()-.5)*2.5,22,e.point.z+(Math.random()-.5)*2.5),this._boltState.target.set(e.point.x,.05,e.point.z),this._boltState.seed=e.seed,this._boltGroup.visible=!0,this._boltLight.position.set(e.point.x,6,e.point.z),this.vfx.bursts.spawn(Kp.STORM,e.point.clone().setY(.7),{radius:.25,endRadius:3.4,life:.6,intensity:1.2,opacity:.95,fresnel:1.6,displace:.5,colorA:`#a98bff`,colorB:`#d3f4ff`,colorC:`#ffffff`}),this.vfx.decals.spawn(Xp.SHOCKWAVE,e.point,{radius:5.6,life:.55,width:.05,intensity:1,colorA:`#c9ecff`,colorB:`#ffffff`}),this.vfx.decals.spawn(Xp.ARC,e.point,{radius:3.6,life:.95,width:.6,intensity:1.25,colorA:`#090407`,colorB:`#c9a6ff`,height:.045});for(let t=0;t<4;t++){let t=Math.random()*Math.PI*2,n=1.6+Math.random()*2.6;this.vfx.decals.spawn(Xp.ARC,{x:e.point.x+Math.cos(t)*n,z:e.point.z+Math.sin(t)*n},{radius:1.3+Math.random()*1.1,life:.8,width:.55,intensity:1,colorA:`#090407`,colorB:`#9fdcff`,height:.04})}this.vfx.decals.spawn(Xp.SCORCH,e.point,{radius:1.6,life:6,intensity:.62,colorA:`#04060b`,colorB:`#8f6bff`,height:.04}),this.vfx.sparkBurst(e.point,`storm`,{count:120,speed:10,life:.8,size:1.1,up:1}),this._flash(e.point,`#c9b8ff`,260),e.onImpact(e.point,5)}if(e.fired){let t=e.t-.15;this._boltState.progress=Math.min(1,t/.08),this._boltState.fade=t<.45?1:Math.max(0,1-(t-.45)/.17);for(let e of this._boltMaterials)e.userData.sync(this._boltState);if(this._boltLight.intensity=Math.max(0,260*(1-t/.5)),this._boltLight.position.y=4,t>.62)return this._boltGroup.visible=!1,this._boltLight.intensity=0,!0}return!1}_flash(e,t,n){this._light||(this._light=new Yo(t,0,30,2),this.scene.add(this._light)),this._light.color.set(t),this._light.position.set(e.x,2.6,e.z),this._light.intensity=n,this._flashT=.22,this._flashIntensity=n}reset(){this._active.length=0,this._crystals.hide(),this._crystalState=null,this._meteor.reset(),this._meteorLight.intensity=0,this._boltGroup.visible=!1,this._boltLight.intensity=0,this._light&&(this._light.intensity=0),this._flashT=0;for(let e of this._balls)e.group.visible=!1,e.busy=!1;this.bursts.clear(),this.vfx?.clear()}update(e){for(let t=this._active.length-1;t>=0;t--){let n=this._active[t];(n.type===`ice`?this._tickIce(n,e):n.type===`fire`?this._tickFire(n,e):n.type===`basic`?this._tickBasic(n,e):this._tickStorm(n,e))&&this._active.splice(t,1)}this._flashT>0&&(this._flashT-=e,this._light.intensity=Math.max(0,this._flashT/.22*this._flashIntensity)),this.bursts.update(e)}dispose(){this.bursts.dispose(),this._crystals.dispose(),this._meteor.dispose();for(let e of this._boltMaterials)e.dispose();this._boltGeometry.dispose();for(let e of this._balls)e.group.traverse(e=>e.geometry?.dispose?.()),e.orb.material.dispose(),e.halo.material.dispose();this._ballHaloTexture.dispose()}},_m=Object.freeze({CORE:0,SHELL:1,HALO:2,COIL:3,RING:4});function vm(e={}){return{radius:.77,radiusNear:.16,radiusCurve:1.27,flare:1.74,flareWidth:.09,throb:0,throbScale:4.8,throbSpeed:2.6,wander:0,wanderScale:.9,wanderSpeed:.7,ripple:.2,rippleBands:2.2,rippleScale:4.25,rippleSpeed:2,streak:1.1,streakSharp:.45,streakScale:4.2,streakBands:1.8,streakGlow:.55,flowSpeed:7,coreWidth:.2,coreSharp:1.55,coreFill:.6,shellWidth:1,shellRim:1.15,shellFill:.18,shellOpacity:.95,haloWidth:2.75,haloRim:4.3,haloOpacity:.14,edgePower:2.2,mouthGlow:1.6,mouthLength:.1,tipGlow:.6,tipLength:.09,coils:4,coilTurns:1.45,coilSpeed:-.69,coilRadius:1.88,coilFlare:.57,coilWidth:.1,coilWidthTip:1.9,coilSharp:2.2,coilPulse:.65,coilPulseFreq:3,coilPulseSpeed:1.6,coilGlow:8,coilOpacity:2,rings:10,ringSpeed:1.31,ringInner:2.42,ringOuter:2.73,ringSwell:.55,ringFade:.18,ringSharp:1.6,ringGlow:2.4,ringOpacity:.7,glow:.74,opacity:.29,colorCore:`#ffffff`,colorInner:`#d3f4ff`,colorOuter:`#3ec6ff`,colorHalo:`#0d3ce0`,colorCoil:`#ffdc8c`,colorCoilEdge:`#ff6a12`,colorRing:`#9ceeff`,...e}}var ym=`
  #define PI  3.141592653589793
  #define TAU 6.283185307179586
...
`;function Em(e={}){let t=new Y({transparent:!0,depthWrite:!1,depthTest:!0,blending:2,side:0,toneMapped:!1,uniforms:cp({uSeed:{value:e.seed??Math.random()*10},uOrbTurbulence:{value:e.turbulence??.22},uOrbScale:{value:e.scale??2.2},uOrbFlow:{value:e.flow??.9},uOrbBands:{value:e.bands??5},uOrbRim:{value:e.rim??1.8},uCharge:{value:1},uOpacity:{value:e.opacity??1},uGlow:{value:e.glow??2.8},uColorCore:{value:new G(e.core??`#ffffff`)},uColorInner:{value:new G(e.inner??`#d3f4ff`)},uColorOuter:{value:new G(e.outer??`#3ec6ff`)}}),vertexShader:wm,fragmentShader:Tm});return t.userData.setPalette=({core:e,inner:n,outer:r,glow:i})=>{e&&t.uniforms.uColorCore.value.set(e),n&&t.uniforms.uColorInner.value.set(n),r&&t.uniforms.uColorOuter.value.set(r),i!==void 0&&(t.uniforms.uGlow.value=i)},t}var Dm=12,Om=40,km=7.2,Am=1.5,jm=25,Mm=1,Nm=.35,Pm=4,Fm=1.8,Im=50,Lm={ice:`#2f7dff`},Rm=20;function zm(){return Mm+Math.random()*9}var Bm=class{constructor(e,t,n){this.scene=e,this.bursts=t,this.vfx=n,this.onCollect=null,this._laserTubeGeo=Op(48,18),this._laserOrbGeo=new Ma(1,3);let r=document.createElement(`canvas`);r.width=r.height=64;let i=r.getContext(`2d`),a=i.createRadialGradient(32,32,2,32,32,30);a.addColorStop(0,`rgba(255,255,255,1)`),a.addColorStop(.35,`rgba(255,255,255,0.45)`),a.addColorStop(1,`rgba(255,255,255,0)`),i.fillStyle=a,i.fillRect(0,0,64,64);let o=new Ca(r);this._group=new Mn,e.add(this._group),this._bodyMaterial=new qa({color:`#dceaff`,emissive:`#8fc6ef`,emissiveIntensity:2.2,roughness:.35,fog:!1}),this._haloMaterial=new zr({map:o,color:`#9cc3e8`,transparent:!0,opacity:.6,blending:2,depthWrite:!1,fog:!1}),this._bandMaterial=new qa({color:`#232833`,roughness:.55,metalness:.75}),this.spirits=[];for(let e=0;e<Dm;e++){let t=new Mn,n=new J(new Na(.3,0),this._bodyMaterial);n.scale.set(.82,1.7,.82);let r=new J(new La(.4,.04,6,22),this._bandMaterial);r.rotation.set(Math.random()*1.2+.5,0,Math.random()*Math.PI);let i=new $r(this._haloMaterial);i.scale.setScalar(2.2),t.add(n,r,i),this._group.add(t),this.spirits.push({group:t,core:n,band:r,halo:i,alive:!1,respawn:0,pos:new V,wander:new V,phase:Math.random()*Math.PI*2,baseY:1.1+Math.random()*.8,chasing:!1}),this._place(this.spirits[e])}for(let e of this.spirits)e.group.visible=!1;this._accent=new G(`#9fd8ff`),this.onPlayerHit=null,this._frozen=!1,this._normalTarget=3,this._specialTarget=1,this.laserTier=1,this.specials=[],this._specialTimer=zm(),this.onSpecialSpawn=null,this.active=!1,this._pendingStart=!1,this._startCountdown=0,this._spawnNormalCount=5;let s=new La(.82,.055,8,42),c=new Aa(.1,.34,5);for(let e=0;e<6;e++){let e=new Mn,t=new J(new Ma(.46,1),new qa({color:`#151922`,emissive:`#9fd8ff`,emissiveIntensity:1.6,roughness:.45,metalness:.7,flatShading:!0,fog:!1})),n=new J(new Na(.26,0),new qa({color:`#dfeeff`,emissive:`#9fd8ff`,emissiveIntensity:2.6,roughness:.25,fog:!1}));n.position.y=.52;let r=new J(s,new li({color:`#9fd8ff`,transparent:!0,opacity:.85,fog:!1}));r.rotation.x=1.35;for(let e=0;e<3;e++){let t=new J(c,this._bandMaterial),n=e/3*Math.PI*2;t.position.set(Math.cos(n)*.82,0,Math.sin(n)*.82),t.rotation.z=Math.PI,t.rotation.y=-n,r.add(t)}let i=new $r(new zr({map:o,color:`#9fd8ff`,transparent:!0,opacity:.85,blending:2,depthWrite:!1}));i.scale.setScalar(3.4),e.add(t,n,r,i),e.visible=!1,this._group.add(e);let a=vm({radius:.16,radiusNear:.06,radiusCurve:1,flare:0,flareWidth:.05,coreWidth:.3,shellWidth:1,haloWidth:2.6,shellOpacity:1.4,haloOpacity:.4,opacity:1.8,glow:1.8,ripple:.3,streak:1,flowSpeed:9,tipGlow:1.6,mouthGlow:.8,wander:.05}),l=[],u=[];for(let e of[_m.HALO,_m.SHELL,_m.CORE]){let t=Cm(e,a),n=new J(this._laserTubeGeo,t);n.frustumCulled=!1,n.matrixAutoUpdate=!1,n.renderOrder=11+(_m.CORE-e),n.visible=!1,this._group.add(n),l.push(n),u.push(t)}let d=new J(this._laserOrbGeo,Em({inner:`#d3f4ff`,outer:`#9fd8ff`,glow:2.6}));d.visible=!1,d.renderOrder=9,this._group.add(d);let f={group:e,core:t,crystal:n,ring:r,halo:i,alive:!1,element:`ice`,pos:new V,baseY:1.4,phase:Math.random()*Math.PI*2,flash:0,basicHits:0,wander:new V,laserMeshes:l,laserMaterials:u,laserConfig:a,laserOrb:d,laserState:{origin:new V,target:new V,side:new V(1,0,0),progress:0,fade:1,widthFade:1,seed:0,coils:0,rings:0},laser:{state:`idle`,t:0,cd:1.5+Math.random()*1.5,from:new V,dir:new V,len:0,hitDone:!1}};this.specials.push(f)}}_laserCd(){return Math.max(.45,2.2-(this.laserTier-5)*.35)*(.8+Math.random()*.4)}_hideLaser(e){for(let t of e.laserMeshes)t.visible=!1;e.laserOrb.visible=!1}_tintLaser(e){let t=Lm[e.element]??Xf[e.element].accent,n=e.laserConfig,r=new G(t);n.colorCore=`#ffffff`,n.colorInner=`#`+r.clone().lerp(new G(`#ffffff`),.55).getHexString(),n.colorOuter=t,n.colorHalo=`#`+r.clone().multiplyScalar(.28).getHexString(),e.laserOrb.material.userData.setPalette({inner:n.colorInner,outer:t})}_syncLaser(e,t,n,r,i,a,o){let s=e.laserState;s.origin.copy(t),s.target.copy(t).addScaledVector(n,r),s.progress=i,s.fade=a,s.widthFade=o;for(let t of e.laserMaterials)t.userData.sync(s)}_updateLaser(e,t,n){let r=e.laser;if(r.t+=t,this.laserTier<5||this._frozen||!n){r.state!==`idle`&&(r.state=`idle`,r.cd=this._laserCd(),this._hideLaser(e));return}switch(r.state){case`idle`:this._hideLaser(e),r.cd-=t,r.cd<=0&&(r.from.set(e.pos.x,e.baseY,e.pos.z),r.dir.set(n.x-r.from.x,1.15-e.baseY,n.z-r.from.z),r.len=r.dir.length(),r.dir.divideScalar(r.len),r.len>2.2?(r.state=`tele`,r.t=0,r.hitDone=!1,this._tintLaser(e),$.laserCharge()):r.cd=.5);break;case`tele`:{r.from.set(e.pos.x,e.baseY,e.pos.z);let t=Math.min(1,Math.max(0,r.t/1));this._syncLaser(e,r.from,r.dir,r.len+170,.055,.35+.45*Math.abs(Math.sin(r.t*12)),1);for(let t of e.laserMeshes)t.visible=!0;e.laserOrb.visible=!0,e.laserOrb.position.copy(r.from),e.laserOrb.scale.setScalar(.26+t*.34),e.laserOrb.material.uniforms.uCharge.value=t,r.t>=1&&(r.state=`fire`,r.t=0,e.laserOrb.visible=!1,this.vfx?.sparkBurst(r.from,e.element,{count:18,speed:5,life:.5,size:.9,up:.6,radius:.3}),$.laserFire());break}case`fire`:{let t=.22;r.from.set(e.pos.x,e.baseY,e.pos.z);let i=r.t/t;if(this._syncLaser(e,r.from,r.dir,r.len+170,1,1-i,1-.45*i),e.laserOrb.visible=i<.4,e.laserOrb.material.uniforms.uCharge.value=Math.max(0,1-i*2.5),!r.hitDone){let e=Math.hypot(r.dir.x,r.dir.z)||1,t=r.dir.x/e,i=r.dir.z/e,a=n.x-r.from.x,o=n.z-r.from.z,s=Math.max(0,Math.min(r.len+170,a*t+o*i)),c=r.from.x+t*s,l=r.from.z+i*s;Math.hypot(n.x-c,n.z-l)<1.1&&(r.hitDone=!0,this.onPlayerHit?.(10))}r.t>=t&&(this._hideLaser(e),r.state=`idle`,r.cd=this._laserCd());break}}}setAccent(e){this._accent.set(e)}setNormalTarget(e){this._normalTarget=Math.min(e,this.spirits.length)}setSpecialTarget(e){this._specialTarget=Math.min(e,this.specials.length)}setSpecialTarget(e){this._specialTarget=Math.min(e,this.specials.length)}setNormalTarget(e){this._activeNormals=Math.min(e,this.spirits.length)}begin(e,t=3){this.active=!0,this._normalTarget=t,this._spawnAll(e,t)}_spawnAll(e,t){for(let n=0;n<t;n++){let r=n/t*Math.PI*2+Math.random()*.8,i=20+Math.random()*20,a=this.spirits[n];a&&(a.alive=!0,a.chasing=!1,a.pos.set((e?e.x:0)+Math.cos(r)*i,a.baseY,(e?e.z:0)+Math.sin(r)*i),a.group.visible=!0)}}setFrozen(e){if(this._frozen=e,e)for(let e of this.specials)this._hideLaser(e),e.laser.state!==`idle`&&(e.laser.state=`idle`,e.laser.cd=this._laserCd())}setTargets(e,t){this._normalTarget=e,this._specialTarget=t}respawnAll(e,t=3){this._normalTarget=t;for(let n=0;n<this.spirits.length;n++){let r=this.spirits[n];n<t?(r.alive=!0,r.chasing=!1,this._place(r,e),r.group.visible=!0):(r.alive=!1,r.group.visible=!1)}for(let e of this.specials)e.alive=!1,e.group.visible=!1,this._hideLaser(e);this._specialTimer=zm()}reset(){this.active=!1,this._pendingStart=!1;for(let e of this.spirits)e.alive=!1,e.chasing=!1,e.group.visible=!1;for(let e of this.specials)e.alive=!1,e.group.visible=!1,this._hideLaser(e);this._specialTimer=zm()}spawnSpecial(e){let t=this.specials.find(e=>!e.alive);if(!t)return;let n=[`ice`,`fire`,`storm`],r=n[Math.floor(Math.random()*n.length)],i=Lm[r]??Xf[r].accent;t.element=r,t.alive=!0,t.flash=0,t.basicHits=0;let a=Math.random()*Math.PI*2,o=Rm+Math.random()*15,s=e?e.x:0,c=e?e.z:0;t.pos.set(s+Math.cos(a)*o,t.baseY,c+Math.sin(a)*o),t.wander.set(0,0,0),t.laser.state=`idle`,t.laser.t=0,t.laser.cd=1.2+Math.random()*1.2,t.laser.hitDone=!1,this._hideLaser(t),t.core.material.emissive.set(i),t.crystal.material.emissive.set(i),t.ring.material.color.set(i),t.halo.material.color.set(i),t.group.visible=!0,t.group.position.set(t.pos.x,t.baseY,t.pos.z),this.onSpecialSpawn?.(r,i)}_place(e,t,n=20,r=40){let i=Math.random()*Math.PI*2,a=n+Math.random()*(r-n),o=t?t.x:0,s=t?t.z:0;e.pos.set(o+Math.cos(i)*a,e.baseY,s+Math.sin(i)*a),e.group.position.copy(e.pos),e.group.visible=e.alive}collectAt(e,t,n=`basic`,r=`neutral`,i){let a=0,o=0,s=0,c=0;for(let n of this.spirits){if(!n.alive)continue;let r=n.pos.x-e.x,i=n.pos.z-e.z;r*r+i*i<=t*t&&(n.alive=!1,n.respawn=2.4+Math.random()*1.4,n.group.visible=!1,this.vfx?.killBurst(n.pos,`basic`,1),a++)}for(let a of this.specials){if(!a.alive)continue;let l=a.pos.x-e.x,u=a.pos.z-e.z;if(l*l+u*u<=t*t){if(n===`basic`){if(i?.has(a))continue;i?.add(a)}n!==`basic`&&a.element===n?(a.alive=!1,a.group.visible=!1,this._hideLaser(a),this.vfx?.killBurst(a.pos,a.element,1.7),o++):n===`basic`&&r===a.element?(a.basicHits++,a.basicHits>=3?(a.alive=!1,a.group.visible=!1,this._hideLaser(a),this.vfx?.killBurst(a.pos,a.element,1.7),o++):(a.flash=Nm,s++,this.vfx?.sparkBurst(a.pos,`basic`,{count:12,speed:3.5,life:.45,size:.6,up:.6,radius:.3}))):(a.flash=Nm,c++)}}return{normal:a,special:o,specialHit:s,immune:c}}update(e,t,n){if(!this._frozen&&this.active){this._specialTimer-=e,this._specialTimer<=0&&(this._specialTimer=zm(),this.specials.filter(e=>e.alive).length<this._specialTarget&&this.spawnSpecial(n));for(let r of this.specials){if(!r.alive){(r.laserMeshes.some(e=>e.visible)||r.laserOrb.visible)&&(this._hideLaser(r),r.laser.state!==`idle`&&(r.laser.state=`idle`,r.laser.cd=this._laserCd()));continue}r.flash=Math.max(0,r.flash-e),r.phase+=e;let i=!1,a=!1;if(n){let t=n.x-r.pos.x,o=n.z-r.pos.z,s=Math.hypot(t,o);s>.001&&(r.pos.x+=t/s*Pm*e,r.pos.z+=o/s*Pm*e,i=!0,s<Fm&&(a=!0))}if(a){r.alive=!1,r.group.visible=!1,this._hideLaser(r),this.vfx?.killBurst(r.pos,r.element,1.7),this.onPlayerHit?.(Im);continue}if(!i){if(r.wander.lengthSq()<.001||Math.random()<e*.4){let e=Math.random()*Math.PI*2;r.wander.set(Math.cos(e),0,Math.sin(e)).multiplyScalar(.35)}r.pos.addScaledVector(r.wander,e),Math.hypot(r.pos.x,r.pos.z)>48&&r.wander.multiplyScalar(-1)}r.group.position.set(r.pos.x,r.baseY+Math.sin(t*1.6+r.pos.x)*.26,r.pos.z),r.ring.rotation.z+=e*1.3,r.ring.rotation.x+=e*.45;let o=r.flash/Nm;r.core.rotation.y+=e*(1.2+o*6),r.core.material.emissiveIntensity=1.6+o*8,r.crystal.rotation.y-=e*(1.8+o*6),r.crystal.material.emissiveIntensity=2.6+o*9+Math.sin(t*3.1+r.phase)*.5,r.halo.scale.setScalar(3.2+o*1.4+Math.sin(t*2.6+r.pos.z)*.2),this._updateLaser(r,e,n)}for(let r=0;r<this.spirits.length;r++){let i=this.spirits[r],a=r<this._normalTarget;if(!i.alive){i.respawn-=e,i.respawn<=0&&a&&(i.alive=!0,i.chasing=!1,this._place(i,n),i.group.visible=!0);continue}if(n){let t=n.x-i.pos.x,r=n.z-i.pos.z,a=Math.hypot(t,r);if(a>.001&&(i.pos.x+=t/a*km*e,i.pos.z+=r/a*km*e,a<Am)){i.alive=!1,i.respawn=2.4+Math.random()*1.4,i.group.visible=!1,this.vfx?.killBurst(i.pos,`basic`,1),this.onPlayerHit?.(jm);continue}}if(!i.chasing){if(i.phase+=e,i.phase>3.5||i.wander.lengthSq()<.001){i.phase=0;let e=Math.random()*Math.PI*2;i.wander.set(Math.cos(e),0,Math.sin(e)).multiplyScalar(.55)}i.pos.addScaledVector(i.wander,e),Math.hypot(i.pos.x,i.pos.z)>Om&&i.wander.multiplyScalar(-1)}i.group.position.set(i.pos.x,i.baseY+Math.sin(t*(i.chasing?3.4:1.7)+i.pos.x)*.22,i.pos.z),i.core.rotation.y+=e*(i.chasing?2.6:1.4),i.core.rotation.x+=e*.6,i.band.rotation.y-=e*(i.chasing?2.2:.8),i.band.rotation.x=.9+Math.sin(t*1.3+i.phase)*.35,i.halo.scale.setScalar((2+Math.sin(t*3.1+i.pos.z)*.25)*(i.chasing?1.3:1))}this._touched>0&&this.onTouch?.(this._touched)}}dispose(){this.scene.remove(this._group),this._group.traverse(e=>{e.geometry&&e.geometry.dispose()});for(let e of this.specials){for(let t of e.laserMaterials)t.dispose();e.laserOrb?.material.dispose()}this._bodyMaterial.dispose(),this._haloMaterial.dispose(),this._bandMaterial.dispose()}},Vm=class{constructor(){this.worldBadge=document.getElementById(`worldBadge`),this.worldGlyph=document.getElementById(`worldGlyph`),this.worldName=document.getElementById(`worldName`),this.lockHint=document.getElementById(`lockHint`),this.lockHint.classList.add(`is-hidden`),this.startScreen=document.getElementById(`startScreen`),this.healthFill=document.getElementById(`healthFill`),this.healthNum=document.getElementById(`healthNum`),this.healthPanel=document.querySelector(`.hud-health`),this.streakEl=document.getElementById(`streak`),this.staminaFill=document.getElementById(`staminaFill`),this.staminaNum=document.getElementById(`staminaNum`),this.fpsNum=document.getElementById(`fpsNum`),this.fpsNum=document.getElementById(`fpsNum`),this.levelBadge=document.getElementById(`levelBadge`),this._levelShown=1,this.gameOverScreen=document.getElementById(`gameOverScreen`),this.pauseScreen=document.getElementById(`pauseScreen`),this.finalScore=document.getElementById(`finalScore`),this.toast=document.getElementById(`toast`),this.edgeHint=document.getElementById(`edgeHint`),this.scoreElement=document.getElementById(`score`),this.scorePanel=document.querySelector(`.hud-score`),this.help=document.getElementById(`help`),this.vignette=document.getElementById(`vignette`),this.castFlashEl=document.getElementById(`castFlash`),this.skills=new Map;for(let e of document.querySelectorAll(`.skill`))this.skills.set(e.dataset.element,{root:e,card:null,numEl:e.querySelector(`.skill__cd-num`)}),e.addEventListener(`pointerdown`,t=>{t.stopPropagation(),this.onSkill?.(e.dataset.element)});this._toastTimer=0,this._cooldownShown=new Map,this.onSkill=null}setWorld(e){this.worldGlyph.textContent=e.glyph,this.worldName.textContent=e.label,this.worldBadge.style.setProperty(`--world-accent`,e.accent),this.worldBadge.style.setProperty(`--world-border`,e.accent+`59`),this.worldBadge.style.setProperty(`--world-glow`,e.accent+`40`),this.worldBadge.classList.remove(`is-pop`),this.worldBadge.offsetWidth,this.worldBadge.classList.add(`is-pop`)}setStamina(e,t){let n=Math.max(0,Math.min(100,e));this.staminaFill.style.width=`${n}%`,this.staminaFill.classList.toggle(`is-exhausted`,t),this.staminaNum.textContent=`${Math.round(n)}%`,this.staminaNum.style.color=t?`#ff5a4d`:`#9fd8ff`}setFps(e){this.fpsNum.textContent=e,this.fpsNum.className=e>=50?`is-ok`:e>=30?`is-mid`:`is-low`}hurtFlash(){this.vignette.classList.remove(`is-hurt`),this.vignette.offsetWidth,this.vignette.classList.add(`is-hurt`)}castFlash(e){this.castFlashEl&&(this.castFlashEl.style.setProperty(`--flash-color`,e),this.castFlashEl.classList.remove(`is-flash`),this.castFlashEl.offsetWidth,this.castFlashEl.classList.add(`is-flash`))}setStreak(e){this._streak=e,this._refreshStreak()}_refreshStreak(){let e=this._streak??0,t=this._hp??100;e>0&&t<100?(this.streakEl.textContent=`生命恢复 ${Math.min(e,9)}/9`,this.streakEl.classList.add(`is-visible`)):this.streakEl.classList.remove(`is-visible`)}setLevel(e){if(e===this._levelShown)return;let t=e>this._levelShown;this._levelShown=e,this.levelBadge.textContent=`LV.${e}`,t&&(this.levelBadge.classList.remove(`is-bump`),this.levelBadge.offsetWidth,this.levelBadge.classList.add(`is-bump`))}hideStartScreen(){this.startScreen.classList.add(`is-hidden`)}showStartScreen(){this.startScreen.classList.remove(`is-hidden`)}setHealth(e){this._hp=e;let t=Math.max(0,Math.min(100,e));this.healthFill.style.width=`${t}%`,this.healthNum.textContent=`${Math.round(t)}%`;let n=t>50?`#6fe38a`:t>25?`#ffb84d`:`#ff5a4d`;this.healthFill.style.background=n,this.healthNum.style.color=n,this._refreshStreak()}setFps(e){this.fpsNum.textContent=e,this.fpsNum.className=e>=50?`is-ok`:e>=30?`is-mid`:`is-low`}showPause(){this.pauseScreen.classList.remove(`is-hidden`)}hidePause(){this.pauseScreen.classList.add(`is-hidden`)}showGameOver(e){this.finalScore.textContent=e,this.gameOverScreen.classList.remove(`is-hidden`)}hideGameOver(){this.gameOverScreen.classList.add(`is-hidden`)}setLockHint(e){this.lockHint.classList.toggle(`is-hidden`,!e)}setEdgeHint(e){this.edgeHint?.classList.toggle(`is-visible`,e)}showToast(e,t=1900){this.toast.textContent=e,this.toast.classList.add(`is-visible`),clearTimeout(this._toastTimer),this._toastTimer=setTimeout(()=>this.toast.classList.remove(`is-visible`),t)}setScore(e){this.scoreElement.textContent=e,this.scorePanel.classList.remove(`is-bump`),this.scorePanel.offsetWidth,this.scorePanel.classList.add(`is-bump`)}setActive(e){for(let[t,{root:n}]of this.skills)n.classList.toggle(`is-active`,t===e)}setCooldown(e,t,n){let r=this.skills.get(e);if(!r)return;let i=t<=.001,a=Math.max(0,Math.min(1,t/Math.max(n,.001)));!i&&Math.abs(a-(this._cooldownShown.get(e)??-1))<.005||(this._cooldownShown.set(e,a),r.root.style.setProperty(`--cd`,a),r.root.classList.toggle(`is-cooling`,!i),r.root.classList.toggle(`is-empty`,!i),r.numEl&&(r.numEl.textContent=i?``:Math.ceil(t)))}toggleHelp(){this.help.classList.toggle(`is-hidden`)}},Hm=58,Um=5.4,Wm=class{constructor(e){this.scene=e,this.uniforms={uTime:{value:0},uColor:{value:new G(`#9fb4c8`)},uProximity:{value:0},uPush:{value:0},uHit:{value:0},uDir:{value:new B(0,-1)},uDim:{value:1}};let t=new Y({transparent:!0,depthWrite:!1,blending:2,fog:!1,uniforms:this.uniforms,vertexShader:`
      ...
      `,fragmentShader:`
        ...
        const float RADIUS = ${Hm.toFixed(1)};
        ...
        void main() {
          ...
          float waveDepth = (1.0 - uHit) * ${Um.toFixed(1)};
    ...
    `,r=new Y({transparent:!0,depthWrite:!1,blending:1,fog:!1,uniforms:this.uniforms,vertexShader:n,fragmentShader:`
      ...
      `});this._mesh=new J(this._geometry,n),this._mesh.frustumCulled=!1,this._mesh.renderOrder=3,e.add(this._mesh),this._points=[],this._time=0,this._scratch=new G}update(e,t,n){this._time+=e,this.uniforms.uTime.value=this._time,this.uniforms.uColor.value.lerp(this._scratch.set(n),Math.min(1,e*8));let r=this._points;for(;r.length&&this._time-r[0].t>qm;)r.shift();if(t){let e=r[r.length-1];(!e||(t.x-e.x)**2+(t.z-e.z)**2>Jm*Jm)&&(r.push({x:t.x,y:t.y,z:t.z,t:this._time}),r.length>Km&&r.shift())}this._rebuild()}_rebuild(){let e=this._points,t=e.length,n=this._positions,r=this._alphas,i=this._across;for(let a=0;a<t;a++){let o=e[a],s=(1-(this._time-o.t)/qm)**1.35,c=e[Math.max(0,a-1)],l=e[Math.min(t-1,a+1)],u=l.x-c.x,d=l.z-c.z,f=Math.hypot(u,d)||1;u/=f,d/=f;let p=Ym*s/2,m=-d*p,h=u*p,g=a*6;n[g]=o.x+m,n[g+1]=o.y,n[g+2]=o.z+h,n[g+3]=o.x-m,n[g+4]=o.y,n[g+5]=o.z-h;let _=s**1.15;r[a*2]=_,r[a*2+1]=_,i[a*2]=0,i[a*2+1]=1}this._geometry.attributes.position.needsUpdate=!0,this._geometry.attributes.aAlpha.needsUpdate=!0,this._geometry.attributes.aAcross.needsUpdate=!0,this._geometry.setDrawRange(0,t>1?(t-1)*6:0)}dispose(){this.scene.remove(this._mesh),this._geometry.dispose(),this._mesh.material.dispose()}},Zm=.5,Qm=2,$m=6,eh=26;function th(){return vm({radius:1.55,radiusNear:.5,radiusCurve:.85,flare:1.15,flareWidth:.14,wander:.04,coreWidth:.16,coreFill:.7,shellOpacity:.9,haloWidth:2.6,haloOpacity:.13,ripple:.25,streak:1.2,flowSpeed:8,tipGlow:1.4,tipLength:.05,coils:3,coilTurns:2.4,coilRadius:1.7,coilWidth:.09,coilOpacity:1.4,coilGlow:5,rings:6,ringSpeed:1.1,ringInner:2.2,ringOuter:2.8,ringOpacity:.9,ringGlow:2,opacity:1.8,glow:1.9,colorCore:`#ffffff`,colorInner:`#d3f4ff`,colorOuter:`#9fb4c8`,colorHalo:`#20304a`,colorCoil:`#bcd2ff`,colorCoilEdge:`#9fb4c8`,colorRing:`#d3f4ff`})}var nh=3,rh=6,ih=class{constructor(e,t,n){this.scene=e,this.onHit=t,this.vfx=n,this.group=new Mn,e.add(this.group),this.beams=[],this.active=!1,this.tier=1,this.accent=new G(`#9fb4c8`),this._spawnT=2,this._tubeGeo=Op(72,22),this._coilGeo=Dp(64,nh),this._ringGeo=kp(rh,36),this._scratchColor=new G,this._state=null}setTier(e){this.tier=e;let t=e>=3;!t&&this.active&&this._clearAll(),this.active=t,this.active&&(this._spawnT=Math.min(this._spawnT,1.5))}setAccent(e){this.accent.set(e);for(let e of this.beams)this._tint(e)}_tint(e){e.ring&&e.ring.material.color.copy(this.accent);let t=e.config;if(!t)return;let n=this._scratchColor.copy(this.accent);t.colorCore=`#ffffff`,t.colorInner=`#`+n.clone().lerp(new G(`#ffffff`),.55).getHexString(),t.colorOuter=`#`+n.getHexString(),t.colorHalo=`#`+n.clone().multiplyScalar(.28).getHexString(),t.colorCoil=`#`+n.clone().lerp(new G(`#ffffff`),.3).getHexString(),t.colorCoilEdge=`#`+n.getHexString(),t.colorRing=`#`+n.clone().lerp(new G(`#ffffff`),.7).getHexString(),e.orb&&e.orb.material.userData.setPalette({inner:t.colorInner,outer:t.colorOuter})}_clearAll(){for(let e of this.beams)this._dispose(e);this.beams.length=0}dispose(){this._clearAll(),this._tubeGeo.dispose(),this._coilGeo.dispose(),this._ringGeo.dispose(),this.scene.remove(this.group)}_dispose(e){e.ring&&(e.ring.material.dispose(),this.group.remove(e.ring)),e.orb&&(e.orb.material.dispose(),this.group.remove(e.orb));for(let t of e.meshes)t.material.dispose(),this.group.remove(t);e.meshes.length=0}update(e,t,n){if(!this.active)return;let r=Math.max(3,Math.min(this.tier*2-3,19));this._spawnT-=e,this._spawnT<=0&&(this._spawnT=Math.max(1.2,3-(this.tier-3)*.22)*(.7+Math.random()*.6),this.beams.length<r&&this._spawn(n));let i=this.beams.filter(e=>e.phase===`strike`).length;for(let r=this.beams.length-1;r>=0;r--){let a=this.beams[r];if(a.t+=e,a.phase===`warn`){let e=a.t/Zm;a.ring.material.opacity=.55+.4*Math.sin(t*22),a.ring.scale.setScalar(1.15-e*.35);let n=pp(a.t/Zm);if(a.orb.visible=!0,a.orb.position.set(a.x,21-n*3,a.z),a.orb.scale.setScalar(.35+n*.85),a.orb.material.uniforms.uCharge.value=n,a.t>=Zm){if(i>=$m)continue;this._strike(a),i++}continue}a.tSinceStrike+=e;let o=a.life-a.tSinceStrike;a.state.progress=Math.min(1,a.tSinceStrike/.09),a.state.fade=Math.min(1,Math.max(0,o/.35)),a.state.widthFade=o<.18?Math.max(.06,o/.18):1;for(let e of a.materials)e.userData.sync(a.state);a.orb.visible=!1,!a.hitDone&&n&&a.tSinceStrike>.04&&Math.hypot(n.x-a.x,n.z-a.z)<Qm&&(a.hitDone=!0,this.onHit?.(30)),o<=0&&(this._dispose(a),this.beams.splice(r,1))}}_spawn(e){let t=0,n=0;for(let r=0;r<20;r++){let r=Math.random()*Math.PI*2,i=5+Math.random()*35;if(t=Math.cos(r)*i,n=Math.sin(r)*i,!e||Math.hypot(t-e.x,n-e.z)>6)break}let r=new J(this._ringGeo2??=new Fa(1.05,2.3,40),new li({color:this.accent.clone(),transparent:!0,opacity:.8,blending:2,depthWrite:!1,side:2,fog:!1}));r.rotation.x=-Math.PI/2,r.position.set(t,.07,n),r.renderOrder=2,this.group.add(r);let i=new J(this._orbGeo??=new Ma(1,3),Em({inner:`#d3f4ff`,outer:`#9fb4c8`,glow:2.6}));i.visible=!1,i.renderOrder=9,this.group.add(i);let a={phase:`warn`,x:t,z:n,t:0,life:1+Math.random()*2,hitDone:!1,ring:r,orb:i,meshes:[],materials:[],config:th(),state:{origin:new V(t,eh,n),target:new V(t,.05,n),side:new V(1,0,0),progress:0,fade:1,widthFade:1,seed:Math.random()*100,coils:nh,rings:rh}};this._tint(a),this._buildBeamMeshes(a),this.beams.push(a),$.pillarWarn()}_buildBeamMeshes(e){let t=[[_m.HALO,this._tubeGeo,11],[_m.SHELL,this._tubeGeo,12],[_m.CORE,this._tubeGeo,13],[_m.COIL,this._coilGeo,13],[_m.RING,this._ringGeo,13]];for(let[n,r,i]of t){let t=Cm(n,e.config),a=new J(r,t);a.frustumCulled=!1,a.matrixAutoUpdate=!1,a.visible=!1,a.renderOrder=i,this.group.add(a),e.meshes.push(a),e.materials.push(t)}}_strike(e){e.phase=`strike`,e.tSinceStrike=0,e.ring&&=(this.group.remove(e.ring),e.ring.material.dispose(),null);for(let t of e.meshes)t.visible=!0;let t=new V(e.x,.5,e.z);this.vfx?.bursts.spawn(Kp.AIR,t,{radius:.3,endRadius:3.2,life:.45,intensity:1,opacity:.9,fresnel:2,displace:.3,colorA:e.config.colorOuter,colorB:`#ffffff`,colorC:e.config.colorInner}),this.vfx?.decals.spawn(Xp.SHOCKWAVE,{x:e.x,z:e.z},{radius:5.2,life:.5,width:.05,intensity:.9,colorA:e.config.colorOuter,colorB:`#ffffff`}),this.vfx?.decals.spawn(Xp.DUSTRING,{x:e.x,z:e.z},{radius:3.6,life:.9,intensity:.6,colorA:`#3d5c74`,colorB:e.config.colorInner,height:.05}),this.vfx?.sparkBurst(t,`basic`,{count:60,speed:8,life:.7,size:1.1,up:1.2}),$.pillarStrike()}};function ah(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(32,32,2,32,32,30);return n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.35,`rgba(255,255,255,0.55)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),new Ca(e)}var oh=class{constructor(e,t,n,r){this.max=t,this.list=[],this._pos=new Float32Array(t*3),this._col=new Float32Array(t*3),this._alpha=new Float32Array(t);let i=new Nr;i.setAttribute(`position`,new K(this._pos,3)),i.setAttribute(`aColor`,new K(this._col,3)),i.setAttribute(`aAlpha`,new K(this._alpha,1));let a=new Y({transparent:!0,depthWrite:!1,blending:r?2:1,uniforms:{uMap:{value:n},uProjScale:{value:800}},vertexShader:`
      ...
      `});this._size=new Float32Array(t),i.setAttribute(`aSize`,new K(this._size,1)),this.points=new ba(i,a),this.points.frustumCulled=!1,this.points.renderOrder=12,e.add(this.points),this.geometry=i}setPixelRatio(e){this.points.material.uniforms.uProjScale.value=window.innerHeight*e*1.123}push(e){this.list.length>=this.max&&this.list.shift(),this.list.push(e)}update(e,t){for(let n=this.list.length-1;n>=0;n--){let r=this.list[n];if(r.life-=e,r.life<=0){this.list.splice(n,1);continue}r.x+=r.vx*e,r.y+=r.vy*e,r.z+=r.vz*e,r.sway&&(r.x+=Math.sin(t*9+r.phase)*.35*e)}for(let e=0;e<this.max;e++)if(e<this.list.length){let t=this.list[e],n=1-t.life/t.maxLife;this._pos[e*3]=t.x,this._pos[e*3+1]=t.y,this._pos[e*3+2]=t.z;let r,i,a;if(n<.35){let e=n/.35;r=t.r0+(t.r1-t.r0)*e,i=t.g0+(t.g1-t.g0)*e,a=t.b0+(t.b1-t.b0)*e}else{let e=(n-.35)/.65;r=t.r1+(t.r2-t.r1)*e,i=t.g1+(t.g2-t.g1)*e,a=t.b1+(t.b2-t.b1)*e}this._col[e*3]=r,this._col[e*3+1]=i,this._col[e*3+2]=a,this._size[e]=t.size0+(t.size1-t.size0)*n,this._alpha[e]=t.alpha*Math.min(1,n*6)*(1-n)**1.1}else this._alpha[e]=0,this._size[e]=0;this.geometry.attributes.position.needsUpdate=!0,this.geometry.attributes.aColor.needsUpdate=!0,this.geometry.attributes.aAlpha.needsUpdate=!0,this.geometry.attributes.aSize.needsUpdate=!0}};function sh(e,t,n,r,i,a={}){e.list.length>=e.max&&e.list.shift();let o=.55;e.list.push({x:t,y:n,z:r,vx:(Math.random()-.5)*.9,vy:1.3+Math.random()*1.1,vz:(Math.random()-.5)*.9,life:.7+Math.random()*.6,maxLife:1.3,size0:1.9,size1:.55,alpha:.8,phase:Math.random()*Math.PI*2,sway:!0,r0:i.r+(1-i.r)*o,g0:i.g+(1-i.g)*o,b0:i.b+(1-i.b)*o,r1:i.r,g1:i.g,b1:i.b,r2:i.r*.32,g2:i.g*.3,b2:i.b*.38,...a})}var ch={x:0,z:0},lh=2.4,uh=7.2,dh=`#40e0d0`,fh=6.55,ph=1.25;function mh(e){let t=e.image,n=t.width,r=t.height,i=document.createElement(`canvas`);i.width=n,i.height=r;let a=document.createElement(`canvas`);a.width=n,a.height=r;let o=i.getContext(`2d`),s=a.getContext(`2d`);o.drawImage(t,0,0);let c=o.getImageData(0,0,n,r),l=s.createImageData(n,r),u=c.data,d=l.data,f=0;for(let e=0;e<u.length;e+=4){let t=u[e],n=u[e+1],r=u[e+2];r>70&&r>n*1.32&&t+r>140&&(d[e]=255,d[e+1]=255,d[e+2]=255,u[e]=t*.16,u[e+1]=n*.16,u[e+2]=r*.2,f++),d[e+3]=255}o.putImageData(c,0,0),s.putImageData(l,0,0);let p=new Ca(i);p.colorSpace=Ge,p.flipY=!1,p.anisotropy=4;let m=new Ca(a);return m.flipY=!1,console.log(`[goblet] 发光区域像素占比 ${(100*f/(n*r)).toFixed(1)}%`),{base:p,mask:m}}var hh=class{constructor(e){this.scene=e,this.ready=!1,this.group=null,this._flameColor=new G(dh),this._targetColor=new G(dh),this._spawnAcc=0,this._pixelRatio=1,this._load()}async _load(){try{let[e,t,n,r,i]=await Promise.all([new id().loadAsync(`goblet/goblet.glb`),new jo().loadAsync(`goblet/base.png`),new jo().loadAsync(`goblet/normal.png`),new jo().loadAsync(`goblet/roughness.png`),new jo().loadAsync(`goblet/metallic.png`)]),{base:a,mask:o}=mh(t);n.flipY=!1,r.flipY=!1,i.flipY=!1;let s=new qa({map:a,normalMap:n,roughnessMap:r,metalnessMap:i,roughness:1,metalness:1,emissive:this._flameColor.clone(),emissiveMap:o,emissiveIntensity:2.3}),c=e.scene;c.traverse(e=>{e.isMesh&&(e.material=s)}),c.updateMatrixWorld(!0);let l=new nr().setFromObject(c),u=l.getSize(new V),d=uh/Math.max(u.y,.001);c.scale.setScalar(d),c.position.x=-(l.min.x+u.x/2)*d,c.position.z=-(l.min.z+u.z/2)*d,c.position.y=-l.min.y*d;let f=new Mn;f.add(c),f.position.set(ch.x,0,ch.z),this._material=s,this.light=new Yo(this._flameColor.clone(),12,40,2),this.light.position.set(0,7.35,0),f.add(this.light);let p=ah();this.flame=new oh(f,130,p,!0),this.flame.setPixelRatio(this._pixelRatio),this.group=f,this.ready=!0,this.scene.add(f)}catch(e){console.error(`[goblet] 圣杯装载失败`,e)}}setPixelRatio(e){this._pixelRatio=e,this.flame?.setPixelRatio(e)}update(e,t,n){if(!this.ready)return;this._targetColor.set(n),this._flameColor.lerp(this._targetColor,Math.min(1,e*2.2)),this._material&&(this._material.emissive.lerp(this._targetColor,Math.min(1,e*2.2)),this._material.emissiveIntensity=2.3),this.light.color.copy(this._flameColor),this.light.intensity=12+Math.sin(t*12.7)*2.6+Math.sin(t*29.3)*1.4;let r=this._flameColor;for(this._spawnAcc+=e*95;this._spawnAcc>=1;){--this._spawnAcc;let e=Math.random()*Math.PI*2,t=Math.random()*ph;sh(this.flame,Math.cos(e)*t,fh+Math.random()*.35,Math.sin(e)*t,r)}this.flame.update(e,t)}dispose(){this.group&&(this.scene.remove(this.group),this.group.traverse(e=>{if(e.geometry&&e.geometry.dispose(),e.material){let t=Array.isArray(e.material)?e.material:[e.material];for(let e of t){for(let t of Object.keys(e)){let n=e[t];n&&n.isTexture&&n.dispose()}e.dispose()}}}),this.group=null,this.ready=!1)}},gh=7.2,_h=2.6,vh=.35,yh=320,bh=class{constructor(e){this.scene=e,this.ready=!1,this.group=null,this.torches=[],this._flameColor=new G(`#40e0d0`),this._targetColor=new G(`#40e0d0`),this._spawnAcc=Array(12).fill(0),this._pixelRatio=1,this._load()}async _load(){try{let[e,t,n,r,i]=await Promise.all([new id().loadAsync(`goblet/torch.glb`),new jo().loadAsync(`goblet/torch_base.png`),new jo().loadAsync(`goblet/torch_normal.png`),new jo().loadAsync(`goblet/torch_roughness.png`),new jo().loadAsync(`goblet/torch_metallic.png`)]);t.colorSpace=Ge,t.anisotropy=4;for(let e of[t,n,r,i])e.flipY=!1;let a=new qa({map:t,normalMap:n,roughnessMap:r,metalnessMap:i,roughness:1,metalness:1}),o=e.scene;o.updateMatrixWorld(!0);let s=new nr().setFromObject(o),c=s.getSize(new V),l=gh/Math.max(c.y,.001);o.traverse(e=>{e.isMesh&&(e.material=a)});let u=new Mn,d=ah();this.flame=new oh(u,yh,d,!0),this.flame.setPixelRatio(this._pixelRatio);for(let e=0;e<12;e++){let t=o.clone(!0);t.scale.setScalar(l),t.position.x=-(s.min.x+c.x/2)*l,t.position.z=-(s.min.z+c.z/2)*l,t.position.y=-s.min.y*l;let n=new Mn;n.add(t);let r=e/12*Math.PI*2,i=_h+Math.sin(e*1.7)*.3;n.position.set(Math.sin(r)*56,i,Math.cos(r)*56),u.add(n),this.torches.push({holder:n,baseY:i,phase:e*.55})}this.group=u,this.ready=!0,this.scene.add(u)}catch(e){console.error(`[torches] 火炬装载失败`,e)}}setPixelRatio(e){this._pixelRatio=e,this.flame?.setPixelRatio(e)}update(e,t,n){if(!this.ready)return;this._targetColor.set(n),this._flameColor.lerp(this._targetColor,Math.min(1,e*2.2));let r=this._flameColor,i=0;for(let n of this.torches){n.holder.position.y=n.baseY+Math.sin(t*1.1+n.phase)*vh;let a=n.holder.position;for(this._spawnAcc[i]=(this._spawnAcc[i]??0)+e*34;this._spawnAcc[i]>=1;){--this._spawnAcc[i];let e=Math.random()*Math.PI*2,t=Math.random()*.3;sh(this.flame,a.x+Math.cos(e)*t,a.y+gh*.82+Math.random()*.2,a.z+Math.sin(e)*t,r,{vy:1.6+Math.random()*1.2,life:.8+Math.random()*.6,maxLife:1.4,size0:1.9,size1:.6,alpha:1})}i++}this.flame.update(e,t)}dispose(){this.group&&(this.scene.remove(this.group),this.group.traverse(e=>{if(e.geometry&&e.geometry.dispose(),e.material){let t=Array.isArray(e.material)?e.material:[e.material];for(let e of t){for(let t of Object.keys(e)){let n=e[t];n&&n.isTexture&&n.dispose()}e.dispose()}}}),this.flame.geometry.dispose(),this.group=null,this.ready=!1)}},xh={ice:5,fire:5,storm:5},Sh=6,Ch=9,wh=25,Th=3,Eh={yaw:Math.PI*.25,pitch:.56,dist:9.5},Dh=26,Oh=class e{constructor(e){this.canvas=e,this.renderer=new Wu({canvas:e,antialias:!0}),this._pxRatioCap=Math.min(window.devicePixelRatio,1.5),this._pxRatio=this._pxRatioCap,this.renderer.setPixelRatio(this._pxRatio),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.5,this.world=new op,this.scene=this.world.scene,this.camera=new Go(48,window.innerWidth/window.innerHeight,.1,1400),this.player=new Hf(this.scene),this.goblet=new hh(this.scene),this.torches=new bh(this.scene),this.player.obstacles=[{x:ch.x,z:ch.z,r:lh}],this.vfx=new em(this.scene,this.renderer),this.spells=new gm(this.scene,this.vfx),this.spirits=new Bm(this.scene,this.spells.bursts,this.vfx),this.edge=new Wm(this.scene),this.groundFx=new Gm(this.scene),this.flightTrail=new Xm(this.scene),this.pillars=new ih(this.scene,e=>this._onPlayerHit(e),this.vfx),this.hud=new Vm,this._normalTarget=3,this._specialTarget=1,this.element=`ice`,this.cooldowns=new Map(Yf.map(e=>[e,0])),this.score=0,this.hp=100,this.over=!1,this.elapsed=0,this._shake=0,this.keys=new Set,this.started=!1,this._invulnT=0,this._killStreak=0,this.stamina=100,this._exhausted=!1,this.paused=!1,this._worldRevertT=0,this._testMode=new URLSearchParams(location.search).get(`test`),this._testT=0,this._instanceId=Math.random().toString(36).slice(2,6),window.__game=this,window.audio=$;let t=document.getElementById(`startBtn`);t?.addEventListener(`click`,()=>this.begin()),t&&(t.disabled=!0,t.textContent=`场景装载中… 0%`),this.world.onArenaReady=e=>{t&&(t.disabled=!1,t.textContent=e?`开始游戏`:`场景加载失败 · 仍可开始`)},this.world.onArenaProgress=(e,n)=>{t&&(t.textContent=e==null?`场景装载中… ${n.toFixed(0)}MB`:`场景装载中… ${e}%`)},document.getElementById(`restartBtn`)?.addEventListener(`click`,()=>this.restart()),document.getElementById(`backToStartBtn`)?.addEventListener(`click`,()=>this.backToStart()),document.getElementById(`pauseBtn`)?.addEventListener(`click`,()=>{this.started&&!this.over&&this._setPaused(!this.paused)}),document.getElementById(`pauseScreen`)?.addEventListener(`click`,()=>{this.paused&&this._setPaused(!1)}),this.orbit={...Eh},this.pointer=new B(0,0),this._aimNDC=new B(0,-.1),this._locked=!1,this.raycaster=new ws,this.groundPlane=new Xi(new V(0,1,0),0),this.aimPoint=new V(0,0,-7),this._scratchF=new V,this._scratchR=new V,this._aimHit=new V,this._hurtColor=new G(`#ff4638`),this.reticle=new Mn;let n=new J(new Fa(.34,.78,40),new li({color:`#04070c`,transparent:!0,opacity:.6,depthWrite:!1,depthTest:!1})),r=new J(new Fa(.42,.7,40),new li({color:`#9fd8ff`,transparent:!0,opacity:1,depthWrite:!1,depthTest:!1})),i=new J(new Oa(.15,20),new li({color:`#ffffff`,transparent:!0,opacity:.95,depthWrite:!1,depthTest:!1}));n.renderOrder=7,r.renderOrder=8,i.renderOrder=8,n.rotation.x=r.rotation.x=i.rotation.x=-Math.PI/2,this.reticle.add(n,r,i),this.reticle.position.y=.03,this._reticleRing=r,this.scene.add(this.reticle),this.rangeRingShadow=new J(new Fa(25.2,25.68,96),new li({color:`#04070c`,transparent:!0,opacity:0,depthWrite:!1,depthTest:!1})),this.rangeRingShadow.rotation.x=-Math.PI/2,this.rangeRingShadow.position.y=.045,this.rangeRingShadow.renderOrder=7,this.scene.add(this.rangeRingShadow),this.rangeRing=new J(new Fa(25.45,Dh,96),new li({color:`#9fd8ff`,transparent:!0,opacity:0,depthWrite:!1,depthTest:!1})),this.rangeRing.rotation.x=-Math.PI/2,this.rangeRing.position.y=.05,this.rangeRing.renderOrder=8,this.scene.add(this.rangeRing),this.aimLine=new J(new Pa(1,.18).rotateX(-Math.PI/2),new li({color:`#9fd8ff`,transparent:!0,opacity:0,depthWrite:!1,depthTest:!1,blending:2})),this.aimLine.renderOrder=7,this.scene.add(this.aimLine),this._aiming=!1,this._lastPointer=null,this._attacking=!1,this._basicT=0,this._orbPos=new V,this.basicRingShadow=new J(new Fa(.3,.92,40),new li({color:`#04070c`,transparent:!0,opacity:.55,depthWrite:!1,depthTest:!1})),this.basicRingShadow.rotation.x=-Math.PI/2,this.basicRingShadow.visible=!1,this.basicRingShadow.renderOrder=7,this.scene.add(this.basicRingShadow),this.basicRing=new J(new Fa(.42,.8,40),new li({color:`#9fd8ff`,transparent:!0,opacity:.9,depthWrite:!1,depthTest:!1})),this.basicRing.rotation.x=-Math.PI/2,this.basicRing.visible=!1,this.basicRing.renderOrder=8,this.scene.add(this.basicRing),this.spells.bursts.setPixelRatio(this._pxRatio),this.world.weather.setPixelRatio(this._pxRatio),this._bind(),this.hud.onSkill=e=>this._select(e),this.player.setElement(Xf[this.element].accent),this.hud.setActive(this.element),this.world.onShift=({theme:e})=>{this.hud.setWorld(e),$.setRealm(e.id),e.id!==`neutral`&&(this.hud.showToast(`世界已改写 → ${e.glyph} ${e.label}`),this.spirits.setAccent(e.accent),this._shake=Math.min(this._shake+.35,.6))},this.spirits.onPlayerHit=e=>this._onPlayerHit(e),this.spirits.onSpecialSpawn=e=>{let t=Xf[e];this.hud.showToast(`⚠ 特殊元素之灵出现 — 用「${t.label}」清除可得 30 分`,2600)}}_bind(){window.addEventListener(`resize`,()=>{this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this._applyPixelRatio()}),window.addEventListener(`keydown`,e=>{if(!e.repeat){if(e.code===`Escape`&&this.started&&!this.over){this._setPaused(!this.paused);return}if(this.keys.add(e.code),!this.paused&&this.started&&!this.over)switch(e.code){case`KeyQ`:this._select(`ice`);break;case`KeyE`:this._select(`fire`);break;case`KeyR`:this._select(`storm`);break;case`KeyH`:this.hud.toggleHelp()}}}),window.addEventListener(`keyup`,e=>this.keys.delete(e.code)),window.addEventListener(`pointermove`,e=>{if(!this.started||this.over)return;let t=e.movementX??0,n=e.movementY??0;if(this._locked){this._aiming||this._attacking?(this._aimNDC.x=Math.max(-1,Math.min(1,this._aimNDC.x+t*.0026)),this._aimNDC.y=Math.max(-1,Math.min(1,this._aimNDC.y-n*.0026)),this.pointer.copy(this._aimNDC)):(this.orbit.yaw-=t*.0032,this.orbit.pitch=Math.max(.3,Math.min(1.25,this.orbit.pitch+n*.0026)));return}this.pointer.set(e.clientX/window.innerWidth*2-1,-(e.clientY/window.innerHeight)*2+1);let r=this._lastPointer,i=r?{dx:e.clientX-r.x,dy:e.clientY-r.y}:null;this._lastPointer={x:e.clientX,y:e.clientY},i&&!this._aiming&&(e.target?.closest?.(`.skill, .panel`)||(this.orbit.yaw-=i.dx*.0038,this.orbit.pitch=Math.max(.3,Math.min(1.25,this.orbit.pitch+i.dy*.0028))))}),this.canvas.addEventListener(`pointerdown`,e=>{!this.started||this.over||this.paused||($.ensure(),e.button===2?(this._aiming=!0,this._resetAimToPlayer(),this._updateAim()):e.button===0&&(this._locked?(this._attacking=!0,this._resetAimToPlayer(),this._updateAim(),this._basicT=0):this._requestLock()))}),window.addEventListener(`pointerup`,e=>{e.button===2&&this._aiming?(this._aiming=!1,this._updateAim(),this._castCurrent()):e.button===0&&(this._attacking=!1)}),window.addEventListener(`contextmenu`,e=>e.preventDefault()),document.addEventListener(`pointerlockchange`,()=>{this._locked=document.pointerLockElement===this.canvas,this._locked?(this._aimNDC.copy(this.pointer),clearTimeout(this._lockRetryTimer),this._lockRetries=0):this._aiming&&=!1,!this._locked&&this.started&&!this.over&&!this.paused?this._setPaused(!0):this.hud.setLockHint(!this._locked&&!this.paused&&this.started&&!this.over)}),document.addEventListener(`pointerlockerror`,()=>{}),window.addEventListener(`wheel`,e=>{this.orbit.dist=Math.max(6.5,Math.min(24,this.orbit.dist+e.deltaY*.012))},{passive:!0})}_setPaused(e){this.paused!==e&&(this.paused=e,e?($.pause(),this._attacking=!1,this._aiming=!1,this.keys.clear(),this.hud.showPause(),this.hud.setLockHint(!1),this.hud.setEdgeHint(!1),document.pointerLockElement&&document.exitPointerLock()):($.unpause(),this.hud.hidePause(),this._ensureLock()))}_ensureLock(){this._locked||this.paused||!this.started||this.over||(this._requestLock(),this._lockRetries=(this._lockRetries??0)+1,clearTimeout(this._lockRetryTimer),this._lockRetries<=12&&(this._lockRetryTimer=setTimeout(()=>this._ensureLock(),350)))}begin(){this.started||($.ensure(),$.click(),$.startMusic(),this.started=!0,this.paused=!1,this.player.respawn(),this.hud.hidePause(),this.hud.hideStartScreen(),this.hud.setLockHint(!1),this._requestLock(),this.spirits.begin(this.player.position,3),this._updateSpiritTargets(),this.hud.showToast(`冒险开始 — 元素之灵已出现`,2200))}_onPlayerHit(e){this.over||this._invulnT>0||($.hurt(),$.shield(),this.hp=Math.max(0,this.hp-e),this.hud.setHealth(this.hp),this.hud.hurtFlash(),this._shake=Math.min(this._shake+.35,.7),this._killStreak>0&&(this._killStreak=0,this.hud.setStreak(0),this.hud.showToast(`连杀中断`,1200)),this._hitLog=this._hitLog||[],this._hitLog.push(`t${this._testT?.toFixed(1)??`-`} 伤${e} 血${this.hp}% 连杀→${this._killStreak}`),this.hp<=0&&this._gameOver(),this._invulnT=1.5)}_heal(e,t){this.over||this.hp>=100||(this.hp=Math.min(100,this.hp+e),this.hud.setHealth(this.hp),$.heal(),this.hud.showToast(`${t} — 生命 +${e}%`,1500))}_countKills(e,t){e<=0||(this._killStreak+=e,this.hud.setStreak(this._killStreak),this._killStreak>=9&&t&&(this._killStreak=0,this.hud.setStreak(0),this._heal(20,`连杀 ×9`)))}_gameOver(){this.over||(this.over=!0,this._attacking=!1,this._aiming=!1,this.keys.clear(),$.death(),$.stopMusic(2.5),this.spirits.setFrozen(!0),document.pointerLockElement&&document.exitPointerLock(),this.hud.setLockHint(!1),this.hud.showGameOver(this.score))}restart(){this.over=!1,this.paused=!1,this.player.respawn(),this.orbit={...Eh},this.hud.hidePause(),this.hud.setEdgeHint(!1),this._edgeWasPushing=!1,this.hp=100,this.stamina=100,this._exhausted=!1,this.score=0,this._shake=0,this._killStreak=0,this._attacking=!1,this._aiming=!1,this._aimNDC.set(0,-.1),this.pointer.copy(this._aimNDC);for(let[e]of this.cooldowns)this.cooldowns.set(e,0);this.spells.reset(),this.spirits.setFrozen(!1),this.spirits.respawnAll(this.player.position,3),$.startMusic(),this.hud.setScore(0),this.hud.setHealth(100),this.hud.setLevel(1),this._updateSpiritTargets(),this.hud.hideGameOver(),this.hud.showToast(`新的冒险开始 — 元素之灵已出现`,2e3),this._ensureLock()}backToStart(){this.started&&$.clickBack(),$.startMusic(),this.over=!1,this.started=!1,document.pointerLockElement&&document.exitPointerLock(),this.paused=!1,this.hud.hidePause(),this.hud.setEdgeHint(!1),this._edgeWasPushing=!1,this.hp=100,this.stamina=100,this._exhausted=!1,this.score=0,this._shake=0,this._killStreak=0,this._attacking=!1,this._aiming=!1,this.element=`ice`,this.player.setElement(Xf.ice.accent),this._aimNDC.set(0,-.1),this.pointer.copy(this._aimNDC);for(let[e]of this.cooldowns)this.cooldowns.set(e,0);this.spells.reset(),this.spirits.setFrozen(!1),this.spirits.reset(),this.world.shift(`neutral`,this.player.position),this.hud.setScore(0),this.hud.setHealth(100),this.hud.setLevel(1),this.hud.hideGameOver(),this.hud.setActive(`ice`),this.hud.setLockHint(!1),this.hud.showStartScreen()}static TIERS=[{normal:3,special:1},{normal:4,special:2},{normal:5,special:2},{normal:6,special:3},{normal:7,special:3},{normal:8,special:4},{normal:9,special:4},{normal:10,special:5},{normal:11,special:5},{normal:12,special:6}];get tier(){return Math.min(Math.floor(this.score/100)+1,e.TIERS.length)}_updateSpiritTargets(){this._tierMem===void 0&&(this._tierMem=this.tier),this.tier>this._tierMem&&$.levelUp(),this._tierMem<3&&this.tier>=3&&this.hud.showToast(`⚠ 天空开始降下元素光柱 — 远离地面光圈！`,3200),this._tierMem=this.tier;let t=e.TIERS[this.tier-1];this.spirits.setNormalTarget(t.normal),this.spirits.setSpecialTarget(t.special),this.hud.setLevel(this.tier)}_resetAimToPlayer(){this._aimNDC.set(0,-.1),this.pointer.copy(this._aimNDC)}_requestLock(){try{let e=this.canvas.requestPointerLock();e&&e.catch&&e.catch(()=>{})}catch{}}_updateAim(){this.raycaster.setFromCamera(this.pointer,this.camera);let e=this._aimHit;if(this.raycaster.ray.intersectPlane(this.groundPlane,e)){let t=this.player.position,n=e.x-t.x,r=e.z-t.z,i=Math.hypot(n,r);i>Dh?(e.x=t.x+n/i*Dh,e.z=t.z+r/i*Dh):i<Th&&i>.001&&(e.x=t.x+n/i*Th,e.z=t.z+r/i*Th),this.aimPoint.copy(e)}}_select(e){if(!Yf.includes(e))return;e!==this.element&&(this.element=e,$.switch(),this.player.setElement(Xf[e].accent),this.hud.setActive(e),this.hud.showToast(`已选择 ${Xf[e].label} — 按住右键瞄准，松开释放`));let t=Xf[this.element].accent;this._reticleRing.material.color.set(t),this.rangeRing.material.color.set(t),this.aimLine.material.color.set(t)}_castCurrent(){let e=this.element;if((this.cooldowns.get(e)??0)>0){this.hud.showToast(`技能冷却中`);return}this.player.playCast(),this.spells.cast(e,this.player.position,this.aimPoint.clone(),(t,n)=>this._onImpact(e,t,n)),this.cooldowns.set(e,xh[e]),this._reticleRing.material.color.set(Xf[e].accent)}_onImpact(e,t,n){let r=Xf[e].accent;this.world.shift(Zf[e],t),this._worldRevertT=6,this.groundFx.burst(t,r),this.hud.castFlash(r),$.impact(e);let i=this.spirits.collectAt(t,n,e,this.world.current);i.special>0&&$.specialKill();let a=i.normal*10+i.special*30;a>0&&(this.score+=a,this.hud.setScore(this.score)),i.immune>0&&this.hud.showToast(`属性不符 — 特殊之灵需要对应元素的技能`,1500),this._countKills(i.normal,!1),this._updateSpiritTargets(),this._shake=Math.min(this._shake+.3,.7)}_basicPathHit(e,t){let n=this.spirits.collectAt(e,1,`basic`,this.world.current,t);n.specialHit>0?$.specialHit():n.immune>0&&$.deflect(),n.normal>0&&($.hit(),this.score+=n.normal*10,this.hud.setScore(this.score)),n.special>0&&($.specialKill(),this.score+=n.special*30,this.hud.setScore(this.score),this._updateSpiritTargets(),this._heal(10*n.special,`普攻净化特殊之灵`)),this._countKills(n.normal,!0)}_basicImpact(e,t=1.6,n){let r=this.spirits.collectAt(e,t,`basic`,this.world.current,n);r.specialHit>0?$.specialHit():r.immune>0&&$.deflect(),r.normal>0&&($.hit(),this.score+=r.normal*10,this.hud.setScore(this.score)),r.special>0&&($.specialKill(),this.score+=r.special*30,this.hud.setScore(this.score),this._updateSpiritTargets(),this._heal(10*r.special,`普攻净化特殊之灵`)),this._countKills(r.normal,!0)}_emitFlightTrail(e){this._trailT=(this._trailT??0)-e,!(this._trailT>0)&&(this._trailT=.05,this._trailPos??=new V,this._trailPos.set(this.player.position.x+(Math.random()-.5)*.5,.35,this.player.position.z+(Math.random()-.5)*.5),this.spells.bursts.emit({pos:this._trailPos,count:3,speed:[.4,1.6],up:[.2,1.2],life:[.25,.55],size:[9,22],colorA:`#ffffff`,colorB:Xf[this.element].accent,gravity:1.5,drag:2.2,spread:.4}))}_updateCamera(e){let{yaw:t,pitch:n,dist:r}=this.orbit,i=this._cameraTarget??=new V;i.set(this.player.position.x+Math.sin(t)*Math.cos(n)*r,Math.sin(n)*r+1.4,this.player.position.z+Math.cos(t)*Math.cos(n)*r),this._shake>.001&&(this._shake*=Math.max(0,1-e*5.5),i.x+=(Math.random()-.5)*this._shake,i.y+=(Math.random()-.5)*this._shake,i.z+=(Math.random()-.5)*this._shake),this.camera.position.lerp(i,Math.min(1,e*9)),this.camera.lookAt(this.player.position.x,1.35,this.player.position.z)}_runStreakTest(e){if(this._testMode!==`streakbreak`||!this.started||this.over)return;this._testT+=e;let t=document.getElementById(`testOut`);if(!t)return;let n=e=>`${e}[实例${this._instanceId} t${this._testT.toFixed(1)} 血${this.hp} 连杀${this._killStreak} 无敌${this._invulnT.toFixed(1)} over${+!!this.over}]`;this._testT>=1&&this._testT-e<1?(this._killStreak=5,this.hud.setStreak(5),t.textContent=n(`注入连杀5`)):this._testT>=4&&this._testT-e<4?(t.textContent+=` ‖ `+n(`受击前`),this._onPlayerHit(25),t.textContent+=` ‖ `+n(`受击后`)):this._testT>=5&&this._testT-e<5&&(t.textContent+=` ‖ `+n(this._killStreak===0?`✅清零正常`:`❌未清零`)+`｜受击日志:${(this._hitLog||[`无`]).join(`;`)}`)}_applyPixelRatio(){this.renderer.setPixelRatio(this._pxRatio),this.renderer.setSize(window.innerWidth,window.innerHeight,!1),this.spells.bursts.setPixelRatio(this._pxRatio),this.world.weather.setPixelRatio(this._pxRatio),this.goblet?.setPixelRatio(this._pxRatio),this.torches?.setPixelRatio(this._pxRatio)}frame(e){if(this.elapsed+=e,this._runStreakTest(e),this._fpsFrames=(this._fpsFrames??0)+1,this._fpsTime=(this._fpsTime??0)+e,this._fpsTime>=.5&&(this._recentFps=Math.round(this._fpsFrames/this._fpsTime),this.hud.setFps(this._recentFps),this._fpsFrames=0,this._fpsTime=0),this._resT=(this._resT??0)+e,this._resT>=1.5){this._resT=0;let e=this._recentFps??0;e>=40&&e<88&&this._pxRatio>.7?(this._pxRatio=Math.max(.7,this._pxRatio-.15),this._applyPixelRatio()):e>100&&this._pxRatio<this._pxRatioCap&&(this._pxRatio=Math.min(this._pxRatioCap,this._pxRatio+.1),this._applyPixelRatio())}if(this.paused){this.renderer.render(this.scene,this.camera);return}let t=new V,n=this._scratchF.set(-Math.sin(this.orbit.yaw),0,-Math.cos(this.orbit.yaw)),r=this._scratchR.set(Math.cos(this.orbit.yaw),0,-Math.sin(this.orbit.yaw));(this.keys.has(`KeyW`)||this.keys.has(`ArrowUp`))&&t.add(n),(this.keys.has(`KeyS`)||this.keys.has(`ArrowDown`))&&t.sub(n),(this.keys.has(`KeyD`)||this.keys.has(`ArrowRight`))&&t.add(r),(this.keys.has(`KeyA`)||this.keys.has(`ArrowLeft`))&&t.sub(r),t.lengthSq()>0&&t.normalize();let i=(this.keys.has(`ShiftLeft`)||this.keys.has(`ShiftRight`))&&!this._exhausted&&!this._attacking&&!this._aiming&&!this.over;i?(this.stamina=Math.max(0,this.stamina-e/Sh*100),this.stamina<=0&&(this._exhausted||$.staminaOut(),this._exhausted=!0)):this.stamina<100&&(this.stamina=Math.min(100,this.stamina+e/Ch*100),this._exhausted&&this.stamina>=wh&&(this._exhausted=!1)),this.hud.setStamina(this.stamina,this._exhausted),i&&t.lengthSq()>0&&this._emitFlightTrail(e),this.over&&t.set(0,0,0),this._invulnT=Math.max(0,this._invulnT-e),this._updateAim(),this.started||(this.orbit.yaw+=e*.06),this.player.update(e,t.lengthSq()>0?t:null,this.aimPoint,this.elapsed,i,this._aiming||this._attacking),this.player.updateShield(this.elapsed,this._invulnT,e),this.flightTrail.update(e,i?this.player.root.position:null,Xf[this.element].accent),this._updateCamera(e),this.edge.update(e,this.elapsed,this.player,this.world.currentAccent,this.world.liveFogFar);let a=this.player.edgePush>.3;this.hud.setEdgeHint(a),a&&(this._edgeWasPushing||(this._shake=Math.min(this._shake+.12,.7),this.elapsed-(this._edgeToastT??-99)>6&&(this._edgeToastT=this.elapsed,this.hud.showToast(`已抵达场地边缘 — 无法再往外走了`,1500))),this._edgeSparkT=(this._edgeSparkT??0)-e,this._edgeSparkT<=0&&(this._edgeSparkT=.16,this.edge.flash(Math.min(1,this.player.edgePush)),this.spells.bursts.emit({pos:this.player.edgePoint,count:5,speed:[1.2,3.4],up:[.6,2.4],life:[.3,.6],size:[7,15],colorA:`#ffffff`,colorB:this.world.currentAccent,gravity:4.5,drag:2.6,spread:.5}))),this._edgeWasPushing=a;let o=this._aiming;o&&this.elapsed-(this._aimTickT??0)>.45&&(this._aimTickT=this.elapsed,$.aimPulse());let s=Xf[this.element].accent;this.reticle.visible=o,this.reticle.position.set(this.aimPoint.x,.03+Math.sin(this.elapsed*4)*.012,this.aimPoint.z),this.reticle.rotation.y=this.elapsed*.8,this.reticle.scale.setScalar(o?1+Math.sin(this.elapsed*10)*.08:1),this._reticleRing.material.color.set(s);let c=Math.min(1,e*10);this.rangeRing.position.set(this.player.position.x,.05,this.player.position.z),this.rangeRingShadow.position.set(this.player.position.x,.045,this.player.position.z),this.rangeRing.material.opacity+=((o?.6:0)-this.rangeRing.material.opacity)*c,this.rangeRingShadow.material.opacity+=((o?.5:0)-this.rangeRingShadow.material.opacity)*c,this.aimLine.material.opacity=this.aimLine.material.opacity+((o?.9:0)-this.aimLine.material.opacity)*c;let l=this.aimPoint.x-this.player.position.x,u=this.aimPoint.z-this.player.position.z,d=Math.max(Math.hypot(l,u),.001);if(this.aimLine.position.set(this.player.position.x+l/2,.1,this.player.position.z+u/2),this.aimLine.rotation.y=-Math.atan2(u,l),this.aimLine.scale.set(d,1,1),this._attacking){if(this._basicT-=e,this._basicT<=0){this._basicT=.32;let e=Xf[this.element].accent;$.shoot(),this.player.playCast(),this.player.getOrbWorldPosition(this._orbPos),this.spells.castBasic(this._orbPos,this.aimPoint.clone(),e,(e,t)=>this._basicPathHit(e,t),(e,t,n)=>this._basicImpact(e,t,n))}this.basicRing.visible=!0,this.basicRingShadow.visible=!0,this.basicRing.position.set(this.aimPoint.x,.05,this.aimPoint.z),this.basicRingShadow.position.set(this.aimPoint.x,.045,this.aimPoint.z),this.basicRing.material.color.set(s),this.basicRing.material.opacity=.85+Math.sin(this.elapsed*10)*.15,this.basicRing.scale.setScalar(1+Math.sin(this.elapsed*10)*.08)}else this.basicRing.visible=!1,this.basicRingShadow.visible=!1;this.spells.update(e),this.spirits.update(e,this.elapsed,this.player.position),this.spirits.laserTier=this.tier,this.world.update(e,this.elapsed,this.player.position,this.hud.vignette);let f=this.world.current===`neutral`?`#40e0d0`:this.world.currentAccent;this.goblet.update(e,this.elapsed,f),this.torches.update(e,this.elapsed,f),this.groundFx.update(e,this.world.currentAccent,this.world.current!==`neutral`),this.pillars.setTier(this.tier),this.pillars.setAccent(this.world.currentAccent),this.pillars.update(e,this.elapsed,this.player.position),this.vfx.update(e,this.camera,this.renderer),this.started&&!this.over&&this._worldRevertT>0&&(this._worldRevertT-=e,this._worldRevertT<=0&&this.world.current!==`neutral`&&(this.world.shift(`neutral`,this.player.position),this.hud.showToast(`元素之力消散 — 世界恢复荒原`,1800)));for(let t of Yf){let n=this.cooldowns.get(t)??0;if(n>0){let r=Math.max(0,n-e);this.cooldowns.set(t,r),r===0&&$.cdReady()}this.hud.setCooldown(t,this.cooldowns.get(t)??0,xh[t])}this.renderer.render(this.scene,this.camera)}dispose(){this.player.dispose(),this.goblet?.dispose(),this.torches?.dispose(),this.spells.dispose(),this.spirits.dispose(),this.edge.dispose(),this.groundFx.dispose(),this.flightTrail.dispose(),this.pillars.dispose(),this.vfx.dispose(),this.world.dispose(),this.renderer.dispose()}},kh=document.getElementById(`app`);function Ah(){$.loadBank();try{let e=new Oh(kh);window.game=e;let t=performance.now(),n=r=>{requestAnimationFrame(n);let i=Math.min(.05,(r-t)/1e3);t=r;try{e.frame(i)}catch(e){let t=document.getElementById(`dbg`);t&&(t.style.color=`#ff8a7a`,t.textContent=`ERR `+(e?.message??e)+` @ `+String(e?.stack??``).split(`
`)[1]),console.error(`[frame]`,e)}};requestAnimationFrame(n)}catch(e){console.error(`[boot] 启动失败`,e),document.body.insertAdjacentHTML(`beforeend`,`<div style="position:fixed;inset:0;display:grid;place-items:center;background:#06090f;color:#ff9a8a;font-size:14px;z-index:99">
       ...
       </div>`)}}Ah(),location.hostname.includes(`github.io`)&&`serviceWorker`in navigator&&navigator.serviceWorker.register(`sw.js`).catch(()=>{});