...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function sc(e,t,n){let r=new Float32Array(qs),i=new V(0,1,0);return new Xa({name:`SphericalGaussianBlur`,defines:{n:qs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:uc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function cc(){return new Xa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:uc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function lc(){return new Xa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:uc(),fragmentShader:`
	...
	`}var dc=class extends tn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new xa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Il={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Ll(e,t){let n=Il[t];return n===void 0?(L(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Rl=new V;function zl(){return U.getLuminanceCoefficients(Rl),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Rl.x.toFixed(4)}, ${Rl.y.toFixed(4)}, ${Rl.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Ol(i,i.VERTEX_SHADER,y),S=Ol(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Pl(i,x,`vertex`),n=Pl(i,S,`fragment`);R(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `});this.mesh=new Y(new Ba(700,32,20),t),this.mesh.frustumCulled=!1,this.mesh.renderOrder=-10,e.add(this.mesh)}update(e){this.uniforms.uTime.value=e}dispose(){this.mesh.geometry.dispose(),this.mesh.material.dispose()}},Zu=class{constructor(e){this.uniforms={uBase:{value:new K(`#252e3a`)},uAccent:{value:new K(`#446080`)},uVein:{value:.22},uKey:{value:new K(`#bcd2ff`)},uAmb:{value:new K(`#334e78`)},uFog:{value:new K(`#141c28`)},uFogNear:{value:26},uFogFar:{value:100},uTime:{value:0}};let t=new Xa({fog:!1,uniforms:this.uniforms,vertexShader:`
        varying vec3 vWorld;
        void main() {
      ...
      `});this.mesh=new Y(new Da(150,72),t),this.mesh.rotation.x=-Math.PI/2,e.add(this.mesh)}update(e){this.uniforms.uTime.value=e}dispose(){this.mesh.geometry.dispose(),this.mesh.material.dispose()}},Qu=6e3,$u=2600,ed=120,td=17,nd={snow:{body:`
    ...
    `,alpha:.8},sparks:{body:`
      ...
      vSz = 0.6 + aSeed * 0.7;
    `,alpha:.85}},rd=class{constructor(e){this.scene=e,this._primary=`none`,this._secondary=`none`,this._systems=new Map;for(let[t,n]of Object.entries(nd)){let r=new Mr,i=new Float32Array(Qu*3),a=new Float32Array(Qu);for(let e=0;e<Qu;e++)i[e*3+0]=(Math.random()-.5)*ed,i[e*3+1]=Math.random()*td,i[e*3+2]=(Math.random()-.5)*ed,a[e]=Math.random();r.setAttribute(`position`,new q(i,3)),r.setAttribute(`aSeed`,new q(a,1)),r.boundingSphere=null;let o=new Xa({transparent:!0,depthWrite:!1,blending:2,fog:!1,uniforms:{uTime:{value:0},uIntensity:{value:0},uH:{value:td},uPixelRatio:{value:1}},vertexShader:`
          uniform float uTime;
          uniform float uH;
        ...
        `}),s=new ya(r,o);s.frustumCulled=!1,s.visible=!1,e.add(s),this._systems.set(t,{obj:s,material:o,intensity:0,isLine:!1})}{let t=new Mr,n=new Float32Array($u*2*3),r=new Float32Array($u*2),i=new Float32Array($u*2);for(let e=0;e<$u;e++){let t=(Math.random()-.5)*ed,a=Math.random()*td,o=(Math.random()-.5)*ed,s=Math.random();for(let c=0;c<2;c++){let l=(e*2+c)*3;n[l]=t,n[l+1]=a,n[l+2]=o,r[e*2+c]=s,i[e*2+c]=c}}t.setAttribute(`position`,new q(n,3)),t.setAttribute(`aSeed`,new q(r,1)),t.setAttribute(`aTip`,new q(i,1)),t.boundingSphere=null;let a=new Xa({transparent:!0,depthWrite:!1,blending:2,fog:!1,uniforms:{uTime:{value:0},uIntensity:{value:0},uH:{value:td}},vertexShader:`
          uniform float uTime;
          uniform float uH;
          attribute float aSeed;
        ...
        `}),o=new fa(t,a);o.frustumCulled=!1,o.visible=!1,e.add(o),this._systems.set(`rain`,{obj:o,material:a,intensity:0,isLine:!0})}{let t=[.35,.8,1.45,2.3],n=[.36,.34,.3,.26],r=[54,50,46,40];this._fogMaterials=[];for(let i=0;i<t.length;i++){let a=new Xa({transparent:!0,depthWrite:!1,blending:1,fog:!1,side:2,uniforms:{uTime:{value:0},uIntensity:{value:0},uPhase:{value:i*37}},vertexShader:`
            varying vec2 vUv;
            varying float vDist;
            void main() {
              vUv = uv;
          ...
          `}),o=new Y(new Da(r[i],48),a);o.rotation.x=-Math.PI/2,o.position.y=t[i],o.renderOrder=5,o.frustumCulled=!1,o.visible=!1,e.add(o),this._fogMaterials.push({mesh:o,material:a,intensity:0})}}this._rayGroup=new G,this._rayMaterials=[];for(let e=0;e<9;e++){let t=1.3+Math.random()*1.1,n=t*(1.12+Math.random()*.3),r=new Xa({transparent:!0,depthWrite:!1,blending:2,side:2,fog:!1,uniforms:{uTime:{value:0},uIntensity:{value:0},uSeed:{value:Math.random()*100}},vertexShader:`
            varying vec2 vUv;
            varying vec3 vN;
            varying vec3 vW;
            varying float vDist;
...
`;function Vf(){return new Xa({transparent:!0,depthWrite:!1,depthTest:!0,blending:2,side:2,toneMapped:!1,uniforms:{uTime:{value:0},uFade:{value:1},uDissolve:{value:0},uSwelling:{value:0},uColorA:{value:new K(`#9fd8ff`)},uColorB:{value:new K(`#ffffff`)}},vertexShader:zf,fragmentShader:Bf})}function Hf(e){let t=e.tracks.find(e=>/Hips.*\.position$/.test(e.name));if(!t)return e;let n=t.values,r=n.length/3,i=n[(r-1)*3]-n[0],a=n[(r-1)*3+2]-n[2];if(Math.hypot(i,a)<.05)return e;for(let e=0;e<r;e++){let t=e/(r-1);n[e*3]-=i*t,n[e*3+2]-=a*t}return e}var Uf={steel:{color:new K(`#96a2b8`),metal:1},helm:{color:new K(`#a5b1c6`),metal:1},cloth:{color:new K(`#b8b8b8`),metal:0,cloth:1},leather:{color:new K(`#463827`),metal:0}};function Wf(e){return/Head|Neck/.test(e)?`helm`:/ForeArm|Shoulder/.test(e)||/Arm$/.test(e)||/UpLeg|Leg$/.test(e)?`steel`:/Hand$/.test(e)||/Foot|Toe/.test(e)||/Hips/.test(e)?`leather`:(/Spine/.test(e),`cloth`)}function Gf(e,t){let n=e.getObjectByProperty(`isSkinnedMesh`,!0);if(!n)return null;let r=n.geometry,i=r.attributes.position.count,a=r.attributes.skinIndex,o=r.attributes.skinWeight,s=r.attributes.position,c=n.skeleton.bones,l=new Float32Array(i*3),u=new Float32Array(i),d=new Float32Array(i),f=new K;for(let e=0;e<i;e++){let t=0,n=-1;for(let r=0;r<4;r++){let i=o.getComponent(e,r);i>n&&(n=i,t=r)}let r=c[a.getComponent(e,t)],i=Uf[Wf(r?.name??``)]??Uf.cloth,p=Math.sin(s.getX(e)*12.9898+s.getY(e)*78.233+s.getZ(e)*37.719)*43758.5453,m=1+(p-Math.floor(p)-.5)*.16;l[e*3]=Math.min(1,f.copy(i.color).r*m),l[e*3+1]=Math.min(1,f.copy(i.color).g*m),l[e*3+2]=Math.min(1,f.copy(i.color).b*m),u[e]=i.metal,d[e]=i.cloth??0}r.setAttribute(`color`,new q(l,3)),r.setAttribute(`aMetal`,new q(u,1)),r.setAttribute(`aCloth`,new q(d,1));let p={value:new K(t).multiplyScalar(.95)},m={value:.45},h=new Qa({vertexColors:!0,roughness:.6,metalness:0,flatShading:!0});h.onBeforeCompile=e=>{e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
...
`))},e.customProgramCacheKey=()=>`arena-marble-v2`,e.needsUpdate=!0)}function Xf(e){let t=[],n=e.geometry;for(let r of n.groups){let i=e.material[r.materialIndex];if(!i||r.count===0)continue;let a=n.clone();if(n.index){let e=n.index.array.slice(r.start,r.start+r.count);a.setIndex(new q(e,1))}else for(let e of Object.keys(a.attributes)){let t=a.attributes[e],n=t.array.slice(t.itemSize*r.start,t.itemSize*(r.start+r.count));a.setAttribute(e,new q(n,t.itemSize))}a.clearGroups(),a.morphAttributes={},t.push({geo:a,material:i})}return t}function Zf(e){e.updateMatrixWorld(!0);let t=new Map,n=[];e.traverse(e=>{if(!e.isMesh||!e.material)return;let r=(e,n)=>{let r=n.uuid;t.has(r)||t.set(r,{material:n,nodes:[],geos:[],indexed:!0});let i=t.get(r);for(let t of Object.keys(e.attributes))t!==`position`&&t!==`normal`&&t!==`uv`&&e.deleteAttribute(t);if(e.morphAttributes={},!e.attributes.uv){let t=e.attributes.position.count;e.setAttribute(`uv`,new q(new Float32Array(t*2),2))}e.attributes.normal||e.computeVertexNormals(),e.index||(i.indexed=!1),i.geos.push(e)};if(Array.isArray(e.material)){let t=new Set,i=Xf(e);for(let n of i)n.geo.applyMatrix4(e.matrixWorld),r(n.geo,n.material),t.add(n.material.uuid);n.push({node:e,usedIds:t,extraGeos:[]})}else{let t=e.geometry.clone();t.applyMatrix4(e.matrixWorld),r(t,e.material),n.push({node:e,usedIds:new Set([e.material.uuid]),extraGeos:[t]})}});let r=[],i=0,a=0;for(let e of t.values()){let t=id(e.indexed?e.geos:e.geos.map(e=>e.index?e.toNonIndexed():e),!1);if(!t){a++;for(let t of e.geos)t.dispose();continue}let n=new Y(t,e.material);n.matrixAutoUpdate=!1,r.push(n);for(let t of e.geos)t.dispose();e.geos=[]}for(let{node:e,usedIds:r,extraGeos:a}of n){let n=r.size>0;for(let e of r){let r=t.get(e);if(!r||r.geos.length>0){n=!1;break}}n&&(e.parent?.remove(e),e.geometry.dispose(),i++);for(let e of a)e.dispose()}return console.info(`[arena] 合并网格：${i} -> ${r.length}（按材质，失败组 ${a} 保留原样）`),Zf.stats={removed:i,failed:a,merged:r.length},r}function Qf(e,t,n){let r=new Y(new Da(59,96),new Qa({color:`#10141c`,roughness:.95,metalness:.05}));r.rotation.x=-Math.PI/2,r.position.y=-.35,e.add(r);let i=new pf;i.setDecoderPath(`draco/`);let a=new ld;a.setDRACOLoader(i),a.load(`arena.glb`,n=>{let r=n.scene;r.traverse(e=>{e.isMesh&&(e.castShadow=!1,e.receiveShadow=!1)});let i=Zf(r);window.__arenaMerge=Zf.stats;for(let e of i)Yf(e.material),r.add(e);e.add(r),t?.(!0)},e=>{n&&(e.total>0?n(Math.min(99,Math.round(e.loaded/e.total*100)),e.loaded/1048576):n(null,e.loaded/1048576))},e=>{console.error(`[arena] 场景加载失败`,e),t?.(!1)})}function $f(e){let t=new es(`#8fb4de`,70,150,1.8);return t.position.set(0,20,0),e.add(t),t}var ep=[`ice`,`fire`,`storm`],tp=`#e6fbf7`,np={ice:{key:`Q`,label:`霜新星`,accent:`#56d8ff`,family:`ice`},fire:{key:`E`,label:`落炎陨石`,accent:`#ff8a3c`,family:`fire`},storm:{key:`R`,label:`天雷殛灭`,accent:`#a98bff`,family:`storm`}},rp={ice:`ice`,fire:`fire`,storm:`storm`},ip={neutral:{id:`neutral`,label:`元素荒原 · Neutral Realm`,glyph:`◇`,accent:`#9fb4c8`,weather:`none`,skyTop:`#0b1120`,skyBottom:`#1b2534`,skyHorizon:`#33475e`,stars:1,fogColor:`#141c28`,fogNear:55,fogFar:235,groundBase:`#252e3a`,groundAccent:`#446080`,veinStrength:.22,keyColor:`#bcd2ff`,keyIntensity:3.4,hemiSky:`#334e78`,hemiGround:`#10161f`,hemiIntensity:1.45,vignette:`rgba(4, 8, 16, 0.55)`},ice:{id:`ice`,label:`冰封领域 · Frozen Realm`,glyph:`❄`,accent:`#56d8ff`,weather:`snow`,skyTop:`#5eb0e0`,skyBottom:`#c4e9fa`,skyHorizon:`#e8f7ff`,stars:.15,fogColor:`#b9dcEE`,fogNear:40,fogFar:170,groundBase:`#9fc0d2`,groundAccent:`#38c8ff`,veinStrength:.85,keyColor:`#ffffff`,keyIntensity:3.7,hemiSky:`#d6f0ff`,hemiGround:`#6d94aa`,hemiIntensity:1.5,vignette:`rgba(150, 205, 235, 0.28)`},fire:{id:`fire`,label:`烈焰领域 · Burning Realm`,glyph:`🔥`,accent:`#ff8a3c`,weather:`fog`,weather2:`embers`,skyTop:`#1b0908`,skyBottom:`#4a180b`,skyHorizon:`#c2531f`,stars:.3,fogColor:`#3a1c0e`,fogNear:5,fogFar:58,groundBase:`#261410`,groundAccent:`#ff5410`,veinStrength:1,keyColor:`#ffd9a8`,keyIntensity:2.4,hemiSky:`#a8462a`,hemiGround:`#170a08`,hemiIntensity:1.2,vignette:`rgba(58, 10, 4, 0.55)`},storm:{id:`storm`,label:`雷暴领域 · Storm Realm`,glyph:`⚡`,accent:`#a98bff`,weather:`rain`,weather2:`sparks`,skyTop:`#0c0f2e`,skyBottom:`#2c3168`,skyHorizon:`#6f6fff`,stars:.6,fogColor:`#181d42`,fogNear:26,fogFar:128,groundBase:`#1b1e3a`,groundAccent:`#8f6bff`,veinStrength:.9,keyColor:`#cfe0ff`,keyIntensity:3,hemiSky:`#4c5cba`,hemiGround:`#0e1024`,hemiIntensity:1.3,vignette:`rgba(10, 12, 40, 0.55)`}},ap=[`skyTop`,`skyBottom`,`skyHorizon`,`fogColor`,`groundBase`,`groundAccent`,`keyColor`,`hemiSky`,`hemiGround`],op=[`stars`,`fogNear`,`fogFar`,`veinStrength`,`keyIntensity`,`hemiIntensity`],sp=2.4,cp=1.5,lp=22,up=-120;function dp(){return new Xa({transparent:!0,depthWrite:!1,blending:2,fog:!1,uniforms:{uTime:{value:cp},uColor:{value:new K(1,1,1)}},vertexShader:`
      varying vec2 vLocal;
      void main() {
        vLocal = uv * 2.0 - 1.0;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,fragmentShader:`
      ...
      void main() {
        float t = clamp(uTime / ${cp.toFixed(1)}, 0.0, 1.0);
        float radius = ${lp.toFixed(1)} * (1.0 - pow(1.0 - t, 3.0));
    ...
    `})}var fp=class e{constructor(){this.scene=new Bn,this.fog=new zn(`#141c28`,55,235),this.scene.fog=this.fog,this.sky=new Xu(this.scene),this.ground=new Zu(this.scene),this.ground.mesh.position.y=up,this.ground.mesh.scale.setScalar(2.6),this.key=new rs(`#bcd2ff`,3.4),this.key.position.set(18,30,10),this.fill=new rs(`#46536e`,1.3),this.fill.position.set(-22,24,-16),this.hemi=new Ro(`#334e78`,`#10161f`,1.45),this.scene.add(this.key,this.fill,this.hemi),this.candle=$f(this.scene),Qf(this.scene,e=>{this.arenaReady=e,this.onArenaReady?.(e)},(e,t)=>this.onArenaProgress?.(e,t)),this.weather=new rd(this.scene);{let e=new Xa({transparent:!0,depthWrite:!1,blending:1,fog:!1,side:1,uniforms:{uColor:{value:new K(`#141c28`)},uOpacity:{value:.12}},vertexShader:`
          varying vec2 vUv;
          varying float vDist;
          void main() {
            vUv = uv;
        ...
        `});this.hazeWall=new Y(new Oa(70,76,22,72,1,!0),e),this.hazeWall.position.y=6,this.hazeWall.renderOrder=1,this.scene.add(this.hazeWall)}this.liveFogFar=this.fog.far,this.current=`neutral`,this.currentAccent=ip.neutral.accent,this.onShift=null,this._waveMaterial=dp(),this._wave=new Y(new Ra(44,44),this._waveMaterial),this._wave.rotation.x=-Math.PI/2,this._wave.visible=!1,this._wave.renderOrder=4,this.scene.add(this._wave),this._waveTime=cp,this._progress=1,this._from={},this._to=null,this._cA=new K,this._cB=new K}get theme(){return ip[this.current]}shift(e,t){let n=ip[e];if(n){if(e!==this.current){let t=this._readLive();for(let e of ap)this._from[e]=t[e];for(let e of op)this._from[e]=t[e];this._to=n,this._progress=0,this.weather.setMode(n.weather,n.weather2),this.current=e}this.currentAccent=n.accent,this._wave.position.set(t.x,.05,t.z),this._waveMaterial.uniforms.uColor.value.set(n.accent),this._waveTime=0,this._wave.visible=!0,this.onShift?.({id:e,theme:n})}}_readLive(){return{skyTop:this._cA.copy(this.sky.uniforms.uTop.value).clone(),skyBottom:this.sky.uniforms.uBottom.value.clone(),skyHorizon:this.sky.uniforms.uHorizon.value.clone(),fogColor:this.fog.color.clone(),groundBase:this.ground.uniforms.uBase.value.clone(),groundAccent:this.ground.uniforms.uAccent.value.clone(),keyColor:this.key.color.clone(),hemiSky:this.hemi.color.clone(),hemiGround:this.hemi.groundColor.clone(),stars:this.sky.uniforms.uStars.value,fogNear:this.fog.near,fogFar:this.fog.far,veinStrength:this.ground.uniforms.uVein.value,keyIntensity:this.key.intensity,hemiIntensity:this.hemi.intensity}}_apply(e,t){switch(e){case`skyTop`:this.sky.uniforms.uTop.value.copy(t);break;case`skyBottom`:this.sky.uniforms.uBottom.value.copy(t);break;case`skyHorizon`:this.sky.uniforms.uHorizon.value.copy(t);break;case`fogColor`:this.fog.color.copy(t),this.ground.uniforms.uFog.value.copy(t),this.hazeWall.material.uniforms.uColor.value.copy(t);break;case`groundBase`:this.ground.uniforms.uBase.value.copy(t);break;case`groundAccent`:this.ground.uniforms.uAccent.value.copy(t);break;case`keyColor`:this.key.color.copy(t);break;case`hemiSky`:this.hemi.color.copy(t);break;case`hemiGround`:this.hemi.groundColor.copy(t);break;case`stars`:this.sky.uniforms.uStars.value=t;break;case`fogNear`:this.fog.near=t,this.ground.uniforms.uFogNear.value=t;break;case`fogFar`:this.fog.far=t,this.ground.uniforms.uFogFar.value=t,this.liveFogFar=t,this.hazeWall.material.uniforms.uOpacity.value=Ft.clamp(1.1-t/170,.1,.5);break;case`veinStrength`:this.ground.uniforms.uVein.value=t;break;case`keyIntensity`:this.key.intensity=t;break;case`hemiIntensity`:this.hemi.intensity=t}}static SOFTEN_DESAT=.42;static SOFTEN_DIM=.8;_soften(t){let n=t.r*.299+t.g*.587+t.b*.114;return t.r+=(n-t.r)*e.SOFTEN_DESAT,t.g+=(n-t.g)*e.SOFTEN_DESAT,t.b+=(n-t.b)*e.SOFTEN_DESAT,t.multiplyScalar(e.SOFTEN_DIM),t}_tickShift(e,t){if(this._progress>=1)return;this._progress=Math.min(1,this._progress+e/sp);let n=this._progress*this._progress*(3-2*this._progress),r=this.current!==`neutral`;for(let e of ap)this._cA.copy(this._from[e]),this._cB.set(this._to[e]),this._cA.lerp(this._cB,n),r&&this._soften(this._cA),this._apply(e,this._cA);for(let e of op){let t=this._from[e]+(this._to[e]-this._from[e])*n;r&&(e===`keyIntensity`||e===`hemiIntensity`?t*=.75:e===`veinStrength`&&(t*=.5)),this._apply(e,t)}let i=this._to.vignette.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?\)/);i&&this._progress>.5&&(t.style.boxShadow=`inset 0 0 190px 30px rgba(${i[1]}, ${i[2]}, ${i[3]}, ${i[4]??.5})`)}update(e,t,n,r){this._tickShift(e,r),this.sky.update(t),this.ground.update(t),this.weather.update(e,t,n),this._waveTime+=e,this._waveTime<cp?this._waveMaterial.uniforms.uTime.value=this._waveTime:this._wave.visible=!1}dispose(){this.sky.dispose(),this.ground.dispose(),this.weather.dispose(),this.scene.remove(this.candle),this._wave.geometry.dispose(),this._waveMaterial.dispose()}},pp={uTime:{value:0},uDelta:{value:0},uResolution:{value:new B(1,1)},uSceneDepth:{value:null},uCameraNear:{value:.1},uCameraFar:{value:1400},uLightDir:{value:new V(.45,.78,.44).normalize()},uShaderIntensity:{value:1},uGlobalGlow:{value:1}};function mp(e={}){return{uTime:pp.uTime,uResolution:pp.uResolution,uSceneDepth:pp.uSceneDepth,uCameraNear:pp.uCameraNear,uCameraFar:pp.uCameraFar,uLightDir:pp.uLightDir,uShaderIntensity:pp.uShaderIntensity,uGlobalGlow:pp.uGlobalGlow,...e}}var hp=e=>440*2**((e-69)/12),gp=(e,t)=>e+Math.random()*(t-e),$=new class{constructor(){this.ctx=null,this.master=null,this.noiseBuf=null,this.realm=`neutral`,this._ambient=null,this._music=null,this._bank={},this._loopBufs={},this._bankLoading=null,this._ctxFactory=null}ensure(){if(!this.ctx){let e=window.AudioContext||window.webkitAudioContext;if(!e&&!this._ctxFactory)return null;try{this.ctx=this._ctxFactory?this._ctxFactory():new e}catch{return null}this._buildMasterChain();let t=Math.floor(this.ctx.sampleRate*2);this.noiseBuf=this.ctx.createBuffer(1,t,this.ctx.sampleRate);let n=this.noiseBuf.getChannelData(0);for(let e=0;e<t;e++)n[e]=Math.random()*2-1;this._startAmbient(this.realm)}if(this.ctx.state===`suspended`&&this.ctx.resume){let e=this.ctx.resume();e&&e.catch&&e.catch(()=>{})}return this.ctx}_buildMasterChain(){let e=this.ctx;this.mix=e.createGain(),this.mix.gain.value=1;let t=e.createDynamicsCompressor();t.threshold.value=-14,t.knee.value=22,t.ratio.value=2.5,t.attack.value=.006,t.release.value=.3,this.master=e.createGain(),this.master.gain.value=.9;let n=e.createDynamicsCompressor();n.threshold.value=-3,n.knee.value=2,n.ratio.value=20,n.attack.value=.001,n.release.value=.08,this.mix.connect(t).connect(this.master).connect(n).connect(e.destination),this.verb=e.createConvolver(),this.verb.buffer=this._buildIR(),this.verbReturn=e.createGain(),this.verbReturn.gain.value=1,this.verb.connect(this.verbReturn).connect(this.mix),this.sfxBus=e.createGain(),this.sfxBus.gain.value=1,this.sfxBus.connect(this.mix),this.sfxSend=e.createGain(),this.sfxSend.gain.value=.34,this.sfxSend.connect(this.verb),this.punch=e.createGain(),this.punch.gain.value=1;let r=e.createDynamicsCompressor();r.threshold.value=-18,r.knee.value=10,r.ratio.value=5,r.attack.value=.002,r.release.value=.1,this.punch.connect(r).connect(this.mix),this.musicBus=e.createGain(),this.musicBus.gain.value=.6,this.musicBus.connect(this.mix)}_buildIR(){let e=this.ctx,t=e.sampleRate,n=Math.floor(t*3.8),r=e.createBuffer(2,n,t);for(let e=0;e<2;e++){let i=r.getChannelData(e),a=0;for(let e=0;e<n;e++){let r=e/n,o=Math.min(1,e/(t*.02)),s=(1-r)**2.4*o,c=Math.random()*2-1;a+=.42*(c-a),i[e]=a*s}let o=[.011,.019,.028,.041,.058,.077],s=[.55,.44,.36,.29,.22,.16];for(let r=0;r<o.length;r++){let a=Math.floor(o[r]*t)+(e?37:0);a<n&&(i[a]+=s[r]*(r%2?-1:1))}}let i=0;for(let e=0;e<2;e++){let t=r.getChannelData(e);for(let e=0;e<n;e++)i=Math.max(i,Math.abs(t[e]))}let a=.4/i;for(let e=0;e<2;e++){let t=r.getChannelData(e);for(let e=0;e<n;e++)t[e]*=a}return r}_driveCurve(e){let t=1024,n=new Float32Array(t),r=Math.tanh(e);for(let i=0;i<t;i++){let t=i/1023*2-1;n[i]=Math.tanh(t*e)/r}return n}tone({type:e=`sine`,f0:t=440,f1:n=t,dur:r=.2,gain:i=.3,attack:a=.005,when:o=0,wet:s=.25,detune:c=0,glide:l=!1,drive:u=0,heavy:d=!1}){let f=this.ensure();if(!f)return;let p=f.currentTime+o,m=f.createOscillator(),h=f.createGain();if(m.type=e,m.detune.value=c,m.frequency.setValueAtTime(Math.max(1,t),p),n!==t&&m.frequency.exponentialRampToValueAtTime(Math.max(1,n),p+r),h.gain.setValueAtTime(1e-4,p),h.gain.exponentialRampToValueAtTime(Math.max(2e-4,i),p+a),h.gain.exponentialRampToValueAtTime(1e-4,p+r),u>1){let e=f.createWaveShaper();e.curve=this._driveCurve(u),e.oversample=`2x`,m.connect(e).connect(h)}else m.connect(h);if(h.connect(d?this.punch:this.sfxBus),s>0){let e=f.createGain();e.gain.value=s,h.connect(e).connect(this.sfxSend)}m.start(p),m.stop(p+r+.05)}noise({dur:e=.3,gain:t=.3,type:n=`lowpass`,f0:r=1e3,f1:i=r,q:a=1,attack:o=.005,when:s=0,wet:c=.25,heavy:l=!1}){let u=this.ensure();if(!u)return;let d=u.currentTime+s,f=u.createBufferSource();f.buffer=this.noiseBuf,f.loop=!0;let p=u.createBiquadFilter();p.type=n,p.frequency.setValueAtTime(Math.max(20,r),d),p.Q.value=a,i!==r&&p.frequency.exponentialRampToValueAtTime(Math.max(20,i),d+e);let m=u.createGain();if(m.gain.setValueAtTime(1e-4,d),m.gain.exponentialRampToValueAtTime(Math.max(2e-4,t),d+o),m.gain.exponentialRampToValueAtTime(1e-4,d+e),f.connect(p).connect(m),m.connect(l?this.punch:this.sfxBus),c>0){let e=u.createGain();e.gain.value=c,m.connect(e).connect(this.sfxSend)}f.start(d,Math.random()),f.stop(d+e+.05)}swell({dur:e=2,gain:t=.1,type:n=`bandpass`,f0:r=400,f1:i=3500,q:a=1,when:o=0,wet:s=.4}){let c=this.ensure();if(!c)return;let l=c.currentTime+o,u=c.createBufferSource();u.buffer=this.noiseBuf,u.loop=!0;let d=c.createBiquadFilter();d.type=n,d.frequency.setValueAtTime(Math.max(20,r),l),d.Q.value=a,i!==r&&d.frequency.exponentialRampToValueAtTime(Math.max(20,i),l+e);let f=c.createGain();if(f.gain.setValueAtTime(1e-4,l),f.gain.linearRampToValueAtTime(t,l+e*.92),f.gain.linearRampToValueAtTime(1e-4,l+e),u.connect(d).connect(f),f.connect(this.sfxBus),s>0){let e=c.createGain();e.gain.value=s,f.connect(e).connect(this.sfxSend)}u.start(l,Math.random()),u.stop(l+e+.05)}metal(e,t,n,r,i=.4,a=[1,2.32,3.01,4.27,5.63],o=[1,.55,.4,.26,.16]){a.forEach((a,s)=>{e*a>12e3||this.tone({type:`sine`,f0:e*a,f1:e*a*.995,dur:n*[1,.72,.55,.4,.28][s],gain:r*o[s],attack:.004,when:t,wet:i})})}SFX_BANK={castA:{file:`cast-a`,start:1,dur:2,fade:.5},castB:{file:`cast-b`,start:1.7,dur:2.2,fade:.6},fireCast:{file:`cast-fire`,start:0,dur:3.2,fade:.6},fireHit:{file:`fire`,start:0,dur:3.6,fade:.7},storm:{file:`storm`,start:.1,dur:5,fade:1.2},ice:{file:`ice`,start:0,dur:1.44,fade:.3},wind:{file:`wind`,start:3.6,dur:4,fade:.8},pillar:{file:`pillar`,start:.42,dur:3,fade:.8}};loadBank(){let e=this.ensure();return!e||this._bankLoading?this._bankLoading||Promise.resolve():(this._bankLoading=Promise.all([...Object.entries(this.SFX_BANK).map(async([t,n])=>{try{let r=await fetch(`sfx/${n.file}.mp3`);if(!r.ok)throw Error(r.status);let i=await e.decodeAudioData(await r.arrayBuffer());this._bank[t]=this._trimSample(i,n)}catch{}}),...Object.entries(this.AMBIENT_LOOPS).map(async([t,n])=>{try{let r=await fetch(`sfx/${n}`);if(!r.ok)throw Error(r.status);this._loopBufs[t]=await e.decodeAudioData(await r.arrayBuffer())}catch{}})]),this._bankLoading)}_trimSample(e,{start:t,dur:n,fade:r}){let i=e.sampleRate,a=Math.min(Math.floor(t*i),Math.max(0,e.length-1)),o=Math.min(Math.floor(n*i),e.length-a),s=this.ctx.createBuffer(2,o,i),c=Math.min(Math.floor(r*i),o>>1),l=Math.min(Math.floor(.006*i),o>>2);for(let t=0;t<2;t++){let n=e.getChannelData(Math.min(t,e.numberOfChannels-1)),r=s.getChannelData(t);for(let e=0;e<o;e++){let t=1;e<l&&(t*=e/l),e>o-c&&(t*=Math.max(0,(o-e)/c)),r[e]=n[a+e]*t}}return s}sample(e,{gain:t=1,when:n=0,wet:r=.35,heavy:i=!1,rate:a=1}={}){let o=this.ensure();if(!o||!this._bank||!this._bank[e])return!1;let s=o.currentTime+n,c=o.createBufferSource();c.buffer=this._bank[e],c.playbackRate.value=Math.max(.5,a);let l=o.createGain();if(l.gain.value=t,c.connect(l),l.connect(i?this.punch:this.sfxBus),r>0){let e=o.createGain();e.gain.value=r,l.connect(e).connect(this.sfxSend)}return c.start(s),!0}click(){this.tone({type:`sine`,f0:130,f1:56,dur:.22,gain:.34,wet:.3}),this.noise({dur:.28,gain:.12,type:`lowpass`,f0:950,f1:260,wet:.3}),this.noise({dur:.04,gain:.06,type:`highpass`,f0:2400}),this.metal(1174.7,.03,.7,.045,.5)}clickBack(){this.tone({type:`triangle`,f0:392,f1:196,dur:.22,gain:.16,wet:.35}),this.tone({type:`sine`,f0:98,f1:62,dur:.2,gain:.2,wet:.25,when:.02})}pause(){this.tone({type:`triangle`,f0:293.66,dur:.5,gain:.1,attack:.02,wet:.5}),this.tone({type:`triangle`,f0:220,dur:.7,gain:.1,attack:.02,when:.16,wet:.5}),this.duckMusic(!0)}unpause(){this.tone({type:`triangle`,f0:220,dur:.4,gain:.1,attack:.02,wet:.5}),this.tone({type:`triangle`,f0:293.66,dur:.7,gain:.11,attack:.02,when:.14,wet:.5}),this.tone({type:`sine`,f0:587.33,dur:.6,gain:.04,attack:.02,when:.14,wet:.5}),this.duckMusic(!1)}shoot(){let e=.9+Math.random()*.24;this.tone({type:`sawtooth`,f0:1350*e,f1:185*e,dur:.17,gain:.15,drive:3.2,wet:.25}),this.tone({type:`square`,f0:660*e,f1:92*e,dur:.15,gain:.075,drive:2.6,wet:.25}),this.noise({dur:.15,gain:.12,type:`bandpass`,f0:3e3*e,f1:600,q:1.2,wet:.3}),this.tone({type:`sine`,f0:185,f1:64,dur:.11,gain:.13,wet:.2})}hit(){this.noise({dur:.13,gain:.26,type:`lowpass`,f0:1800,f1:320}),this.tone({type:`sine`,f0:220,f1:85,dur:.12,gain:.22})}spellCast(e){if(!this.ensure())return;let t=!1;e===`fire`?t=this.sample(`fireCast`,{gain:.45,rate:gp(.95,1.05),wet:.45}):e===`ice`?(t=this.sample(`wind`,{gain:.28,rate:gp(1.1,1.25),wet:.4}),this.sample(`castA`,{gain:.28,rate:gp(1.05,1.18),wet:.5}),t||=this._bank&&this._bank.castA):t=this.sample(`castB`,{gain:.42,rate:gp(.98,1.1),wet:.45}),!t&&(this.tone({type:`sawtooth`,f0:220,f1:660,dur:.3,gain:.06,attack:.06,wet:.4}),this.noise({dur:.35,gain:.09,type:`bandpass`,f0:600,f1:2600,q:1.2,wet:.4}))}specialHit(){let e=.94+Math.random()*.12;this.metal(590*e,0,.42,.14,.45),this.noise({dur:.06,gain:.12,type:`highpass`,f0:2600,wet:.3}),this.tone({type:`sine`,f0:95,f1:52,dur:.16,gain:.2,wet:.25})}deflect(){this.tone({type:`sine`,f0:245,f1:168,dur:.1,gain:.1,wet:.3}),this.noise({dur:.08,gain:.05,type:`bandpass`,f0:760,q:2,wet:.3})}pillarWarn(){this.tone({type:`sawtooth`,f0:220,f1:293.66,dur:.5,gain:.07,attack:.09,wet:.5}),this.tone({type:`sine`,f0:440,f1:587.33,dur:.5,gain:.04,attack:.09,wet:.5}),this.noise({dur:.5,gain:.05,type:`bandpass`,f0:700,f1:2200,q:1.4,wet:.5})}pillarStrike(){let e=this.sample(`pillar`,{gain:.7,rate:gp(.96,1.04),wet:.5,heavy:!0});this.tone({type:`sine`,f0:120,f1:30,dur:.9,gain:.4,attack:.006,wet:.45,heavy:!0}),this.tone({type:`sawtooth`,f0:420,f1:58,dur:.4,gain:.16,drive:4,wet:.4,heavy:!0}),this.noise({dur:.09,gain:.24,type:`highpass`,f0:1800,wet:.4,heavy:!0}),!e&&(this.noise({dur:1.5,gain:.2,type:`lowpass`,f0:1900,f1:110,wet:.55}),this.metal(1244.5,.02,.9,.035,.6))}laserCharge(){this.tone({type:`sawtooth`,f0:175,f1:620,dur:1,gain:.16,attack:.12,wet:.4,heavy:!0}),this.tone({type:`sine`,f0:68,f1:128,dur:1,gain:.13,attack:.1,wet:.35,heavy:!0}),[0,.3,.55,.75,.9].forEach((e,t)=>this.tone({type:`sine`,f0:620+t*260,dur:.06,gain:.1,when:e,wet:.35})),this.tone({type:`sine`,f0:1200,f1:2700,dur:1,gain:.055,attack:.25,wet:.4}),this.noise({dur:1,gain:.055,type:`bandpass`,f0:900,f1:2600,q:2.2,wet:.4})}laserFire(){this.noise({dur:.06,gain:.24,type:`highpass`,f0:4200,wet:.35,heavy:!0}),this.tone({type:`sawtooth`,f0:1500,f1:175,dur:.28,gain:.24,drive:3.4,wet:.35,heavy:!0}),this.tone({type:`square`,f0:340,f1:60,dur:.22,gain:.12,drive:2.6,wet:.3}),this.noise({dur:.2,gain:.12,type:`bandpass`,f0:3400,f1:900,q:1.4,wet:.35}),this.tone({type:`sine`,f0:130,f1:42,dur:.34,gain:.32,when:.02,wet:.35,heavy:!0})}hurt(){this.tone({type:`sine`,f0:150,f1:52,dur:.3,gain:.32,wet:.3}),this.noise({dur:.22,gain:.16,type:`lowpass`,f0:760,f1:160,wet:.3}),this.tone({type:`triangle`,f0:233.08,dur:.3,gain:.07,when:.02,wet:.45}),this.tone({type:`triangle`,f0:220,dur:.3,gain:.07,when:.02,wet:.45})}shield(){this.sample(`wind`,{gain:.4,rate:gp(1.15,1.3),wet:.4}),this.noise({dur:.45,gain:.13,type:`bandpass`,f0:500,f1:2600,q:1.1,wet:.4}),this.tone({type:`sine`,f0:587.33,dur:.7,gain:.07,attack:.08,wet:.5}),this.tone({type:`sine`,f0:880,dur:.7,gain:.05,attack:.1,wet:.5}),this.tone({type:`triangle`,f0:146.83,dur:.5,gain:.07,attack:.04,wet:.4})}switch(){this.tone({type:`sine`,f0:195,f1:128,dur:.07,gain:.16,wet:.2}),this.noise({dur:.03,gain:.05,type:`highpass`,f0:2e3}),this.metal(2349,.015,.3,.02,.35)}cdReady(){this.metal(880,0,.8,.06,.5),this.tone({type:`sine`,f0:1760,dur:.3,gain:.025,when:.01,wet:.5})}aimPulse(){this.tone({type:`sine`,f0:1175,dur:.035,gain:.045,wet:.12})}levelUp(){[146.83,174.61,220].forEach((e,t)=>{this.tone({type:`sawtooth`,f0:e*.97,f1:e,dur:.16,gain:.11,attack:.02,when:t*.1,wet:.4}),this.tone({type:`sawtooth`,f0:e*.97*1.006,f1:e*1.006,dur:.16,gain:.08,attack:.02,when:t*.1,wet:.4})}),this.tone({type:`sawtooth`,f0:290,f1:293.66,dur:.9,gain:.12,attack:.03,when:.3,wet:.45}),this.tone({type:`sawtooth`,f0:436,f1:440,dur:.9,gain:.08,attack:.03,when:.3,wet:.45}),this.tone({type:`sine`,f0:146.83,dur:.9,gain:.12,attack:.03,when:.3,wet:.4}),this.noise({dur:.5,gain:.05,type:`highpass`,f0:5200,when:.3,wet:.55})}heal(){[587.33,659.26,698.46,880,1174.66].forEach((e,t)=>this.tone({type:`triangle`,f0:e,dur:.5,gain:.06,attack:.004,when:t*.055,wet:.5})),this.tone({type:`triangle`,f0:293.66,dur:.8,gain:.05,attack:.12,when:.1,wet:.55})}staminaOut(){this.noise({dur:.6,gain:.07,type:`bandpass`,f0:950,f1:240,q:1.2,wet:.3}),this.tone({type:`triangle`,f0:330,f1:158,dur:.5,gain:.07,attack:.03,wet:.35})}specialKill(){this.tone({type:`sine`,f0:125,f1:40,dur:.55,gain:.34,wet:.35,heavy:!0}),this.tone({type:`sawtooth`,f0:520,f1:95,dur:.24,gain:.14,drive:3.4,wet:.35,heavy:!0}),this.noise({dur:.35,gain:.17,type:`highpass`,f0:3e3,wet:.45}),[1568,1975.5,2349,2793,3322].forEach((e,t)=>this.tone({type:`sine`,f0:e*gp(.98,1.02),dur:gp(.25,.4),gain:.06,when:.05+t*.035,wet:.55})),this.tone({type:`triangle`,f0:293.66,dur:1.3,gain:.055,attack:.15,when:.1,wet:.6}),this.tone({type:`triangle`,f0:440,dur:1.3,gain:.04,attack:.2,when:.1,wet:.6})}death(){[36.71,73.42,110].forEach((e,t)=>this.tone({type:`sawtooth`,f0:e*.96,f1:e,dur:2.6,gain:.13,attack:.2,when:t*.02,wet:.55,heavy:!0})),this.tone({type:`sine`,f0:36.71,dur:3,gain:.24,attack:.15,wet:.45,heavy:!0}),[293.66,261.63,233.08,220].forEach((e,t)=>{this.tone({type:`sawtooth`,f0:e,dur:.85,gain:.09,attack:.12,when:.3+t*.5,wet:.6}),this.tone({type:`sine`,f0:e*2,dur:.7,gain:.04,attack:.12,when:.3+t*.5,wet:.6})}),this.metal(146.83,1.6,2.4,.08,.65,[1,2.4,3.9,5.4],[1,.5,.3,.2]),this.noise({dur:3.2,gain:.09,type:`lowpass`,f0:700,f1:70,when:.3,wet:.5})}impact(e){if(e===`ice`){if(this.sample(`ice`,{gain:.6,rate:gp(.9,1.1),wet:.5,heavy:!0})){this.tone({type:`sine`,f0:120,f1:34,dur:.5,gain:.3,wet:.35,heavy:!0}),[1568,2093,2637,3136,3951].forEach((e,t)=>this.tone({type:`sine`,f0:e*gp(.97,1.03),f1:e*.9,dur:gp(.2,.35),gain:.045,when:.02+t*.03,wet:.55})),this.noise({dur:.5,gain:.09,type:`bandpass`,f0:5800,f1:1700,q:1.2,wet:.5});return}this.tone({type:`sine`,f0:120,f1:34,dur:.5,gain:.32,wet:.35,heavy:!0}),this.tone({type:`sawtooth`,f0:380,f1:95,dur:.3,gain:.12,drive:3.4,wet:.35,heavy:!0}),this.noise({dur:.11,gain:.26,type:`highpass`,f0:3400,wet:.4,heavy:!0}),[1568,2093,2637,3136,3951,4699].forEach((e,t)=>this.tone({type:`sine`,f0:e*gp(.97,1.03),f1:e*.9,dur:gp(.2,.35),gain:.06,when:.02+t*.03,wet:.55})),this.noise({dur:.55,gain:.13,type:`bandpass`,f0:5800,f1:1700,q:1.2,wet:.5})}else if(e===`fire`){if(this.sample(`fireHit`,{gain:.62,rate:gp(.93,1.05),wet:.5,heavy:!0})){this.tone({type:`sine`,f0:150,f1:30,dur:.95,gain:.4,attack:.005,wet:.4,heavy:!0}),this.noise({dur:.09,gain:.16,type:`bandpass`,f0:2800,q:.7,wet:.4,heavy:!0});return}this.tone({type:`sine`,f0:150,f1:30,dur:.95,gain:.5,attack:.005,wet:.4,heavy:!0}),this.tone({type:`sawtooth`,f0:320,f1:52,dur:.5,gain:.26,drive:4.2,wet:.4,heavy:!0}),this.noise({dur:.09,gain:.26,type:`bandpass`,f0:2800,q:.7,wet:.4,heavy:!0}),this.noise({dur:1.5,gain:.28,type:`lowpass`,f0:1700,f1:130,wet:.5})}else{if(this.sample(`storm`,{gain:.62,rate:gp(.95,1.05),wet:.5,heavy:!0})){this.noise({dur:.05,gain:.26,type:`highpass`,f0:4600,wet:.4,heavy:!0}),this.tone({type:`sine`,f0:95,f1:32,dur:.85,gain:.26,wet:.4,heavy:!0});return}this.noise({dur:.05,gain:.34,type:`highpass`,f0:4600,wet:.4,heavy:!0}),this.tone({type:`square`,f0:190,f1:52,dur:.24,gain:.12,drive:3,wet:.3}),this.tone({type:`sine`,f0:95,f1:32,dur:.85,gain:.3,wet:.4,heavy:!0}),this.noise({dur:2.2,gain:.26,type:`lowpass`,f0:560,f1:52,q:.7,when:.03,wet:.55}),this.noise({dur:1,gain:.11,type:`lowpass`,f0:320,f1:85,when:.55,wet:.55})}}startMusic(){let e=this.ensure();e&&(this._music||=new _p(e,this.musicBus,this.verb),this._music.start())}stopMusic(e=1.5){this._music?.stop(e),this._music=null}duckMusic(e){this._music?.duck(e)}AMBIENT_LOOPS={rain:`rain.mp3`};AMBIENT={neutral:{type:`lowpass`,f0:320,q:.55,gain:.05,lfoF:.11,lfoAmt:110,drone:[38],droneGain:.016},ice:{type:`bandpass`,f0:1250,q:2.2,gain:.05,lfoF:.23,lfoAmt:620,drone:[38,45],droneGain:.011,shimmer:1174.66},fire:{type:`lowpass`,f0:240,q:.8,gain:.065,lfoF:.5,lfoAmt:85,drone:[38],droneGain:.02},storm:{type:`bandpass`,f0:520,q:.75,gain:.05,lfoF:.37,lfoAmt:340,drone:[33,38],droneGain:.014,loop:{buf:`rain`,gain:.055}}};setRealm(e){this.realm=this.AMBIENT[e]?e:`neutral`;let t=this.ensure();if(t&&!(this._ambient&&this._ambient.realm===this.realm)){if(this._ambient){let{out:e,sources:n}=this._ambient,r=t.currentTime;e.gain.cancelScheduledValues(r),e.gain.setValueAtTime(Math.max(1e-4,e.gain.value),r),e.gain.exponentialRampToValueAtTime(1e-4,r+.8),n.forEach(e=>{try{e.stop(r+.85)}catch{}}),this._ambient=null}this._startAmbient(this.realm)}}_startAmbient(e){let t=this.AMBIENT[e];if(!t||!this.ctx)return;let n=this.ctx,r=n.currentTime,i=n.createGain();i.gain.setValueAtTime(1e-4,r),i.gain.exponentialRampToValueAtTime(1,r+1.6),i.connect(this.sfxBus);let a=n.createGain();a.gain.value=.3,i.connect(a).connect(this.sfxSend);let o=[],s=[],c=n.createBufferSource();c.buffer=this.noiseBuf,c.loop=!0;let l=n.createBiquadFilter();l.type=t.type,l.frequency.value=t.f0,l.Q.value=t.q;let u=n.createGain();u.gain.value=t.gain;let d=n.createOscillator();d.frequency.value=t.lfoF;let f=n.createGain();if(f.gain.value=t.lfoAmt,d.connect(f).connect(l.frequency),c.connect(l).connect(u).connect(i),c.start(),d.start(),o.push(c,d),(t.drone||[]).forEach((e,r)=>{let a=n.createOscillator();a.type=`triangle`,a.frequency.value=hp(e),a.detune.value=r%2?5:-5;let c=n.createBiquadFilter();c.type=`lowpass`,c.frequency.value=300;let l=n.createGain();l.gain.value=t.droneGain;let u=n.createOscillator();u.frequency.value=.06+r*.017;let d=n.createGain();d.gain.value=t.droneGain*.4,u.connect(d).connect(l.gain),a.connect(c).connect(l).connect(i),a.start(),u.start(),o.push(a,u),s.push(a,u)}),t.shimmer){let e=n.createOscillator();e.type=`sine`,e.frequency.value=t.shimmer;let r=n.createOscillator();r.frequency.value=.4;let a=n.createGain();a.gain.value=4,r.connect(a).connect(e.detune);let s=n.createGain();s.gain.value=.006,e.connect(s).connect(i),e.start(),r.start(),o.push(e,r)}if(t.loop&&this._loopBufs[t.loop.buf]){let e=n.createBufferSource();e.buffer=this._loopBufs[t.loop.buf],e.loop=!0;let r=n.createGain();r.gain.value=t.loop.gain,e.connect(r).connect(i),e.start(),o.push(e)}this._ambient={realm:e,out:i,sources:o}}},_p=class{constructor(e,t,n){this.ctx=e,this.BPM=66,this.stepDur=60/this.BPM/4,this.STEPS=128,this.level=e.createGain(),this.level.gain.value=1e-4,this.level.connect(t),this.wetOut=e.createGain(),this.wetOut.gain.value=.9,this.level.connect(this.wetOut).connect(n),this.dry=e.createGain(),this.dry.gain.value=.62,this.dry.connect(this.level),this.wet=e.createGain(),this.wet.gain.value=1,this.wet.connect(this.level),this.CHORDS=[{bass:38,ost:50,ost5:45,choir:[50,57,62,65],brass:[50,53,57],harp:[62,65,69,74,77]},{bass:34,ost:46,ost5:41,choir:[58,65,70,74],brass:[58,62,65],harp:[70,74,77,82]},{bass:41,ost:53,ost5:48,choir:[53,60,65,69],brass:[53,57,60],harp:[65,69,72,77]},{bass:36,ost:48,ost5:43,choir:[55,60,64,67],brass:[48,52,55],harp:[67,72,76,79]}],this.OST=[{o:0,a:1},{o:0,a:.75},{o:-7,a:.8},{o:0,a:.75},{o:12,a:1.1},{o:0,a:.75},{o:-7,a:.8},{o:0,a:.75}],this.DRUMS={0:[`boom`,1],1:[`tom`,.35],6:[`tom`,.55],10:[`tom`,.6],13:[`tom`,.45],16:[`boom`,.85],17:[`tom`,.3],22:[`tom`,.5],24:[`tom`,.55],26:[`tom`,.6],28:[`tom`,.7],30:[`tom`,.8]},this.HEART={0:[`boom`,.5],3:[`boom`,.32]},this.CHOIR_VEL=[.5,.75,1,.6],this.step=0,this.cycle=0,this.nextTime=0,this.timer=null,this.ducked=!1,this.stopping=!1}start(){this.timer||=(this.stopping=!1,this.level.gain.cancelScheduledValues(this.ctx.currentTime),this.level.gain.setTargetAtTime(this.ducked?.2:1,this.ctx.currentTime,.9),this.nextTime=this.ctx.currentTime+.2,setInterval(()=>this._tick(),250))}stop(e=1.5){if(!this.timer)return;clearInterval(this.timer),this.timer=null,this.stopping=!0;let t=this.ctx.currentTime;this.level.gain.cancelScheduledValues(t),this.level.gain.setTargetAtTime(1e-4,t,e/3);let n=this;setTimeout(()=>{try{n.level.disconnect(),n.wetOut.disconnect()}catch{}},e*1e3+500)}duck(e){this.ducked=e,!this.stopping&&this.level.gain.setTargetAtTime(e?.2:1,this.ctx.currentTime,.5)}_tick(){for(;this.nextTime<this.ctx.currentTime+1.5;)this._scheduleStep(this.step,this.cycle,this.nextTime),this.step++,this.step>=this.STEPS&&(this.step=0,this.cycle=(this.cycle+1)%4),this.nextTime+=this.stepDur}_scheduleStep(e,t,n){let r=this.CHORDS[Math.floor(e/32)],i=e%16,a=e%32,o=Math.floor(e/16),s=()=>gp(-.006,.006),c=()=>gp(.92,1.08);if(e===0&&(this._drone(36.71,n,2.2,.03),this._drone(73.42,n,2.2,.032),this._drone(110,n,2.2,.016)),e===0&&(t===0&&this._bell(hp(50),n,.14),t===2&&(this._braam(n),this._crash(n)),t===3&&(this._bell(hp(50),n,.07),this._bell(hp(50)*1.003,n+.9,.045))),e===112&&this._riser(n,this.stepDur*16),a===0){let e=this.CHOIR_VEL[t];r.choir.forEach((t,r)=>{let i=[1,.8,.65,.45][r]*e*.04;this._choir(hp(t+12),n,this.stepDur*31,i)})}if(t===2&&a===0&&r.brass.forEach((e,t)=>this._brass(hp(e),n,this.stepDur*30,.022+(t===0?.008:0))),t>=1&&i%2==0){let e=this.OST[i/2],a=r.ost+e.o;this._ostinato(hp(a),n+s(),this.stepDur*1.7,(t===1?.05:.065)*e.a*c()),t===2&&i===14&&this._ostinato(hp(r.ost-2),n+this.stepDur,this.stepDur*.8,.028)}if(t===1){let e=this.HEART[i];e&&this._drum(e[0],n+s(),e[1]*c()*.55)}else if(t===2){let e=this.DRUMS[a];e&&this._drum(e[0],n+s(),e[1]*c())}if((t===0||t===3)&&(i===4||i===12)){let e=(o*2+ +(i===12))%r.harp.length;this._harp(hp(r.harp[e]+12),n+s(),t===0?.05:.04)}}_route(e,t){if(e.connect(this.dry),t>0){let n=this.ctx.createGain();n.gain.value=t,e.connect(n),n.connect(this.wet)}}_drone(e,t,n,r){let i=this.ctx,a=this.STEPS*this.stepDur;for(let[o,s,c]of[[`sawtooth`,1,.6],[`triangle`,1,1],[`sawtooth`,1.005,.5]]){let l=i.createOscillator();l.type=o,l.frequency.value=e*s;let u=i.createBiquadFilter();u.type=`lowpass`,u.frequency.value=240;let d=i.createGain();d.gain.setValueAtTime(1e-4,t),d.gain.linearRampToValueAtTime(r*c,t+n),d.gain.setValueAtTime(r*c,t+a-2.4),d.gain.linearRampToValueAtTime(1e-4,t+a),l.connect(u).connect(d),this._route(d,.25),l.start(t),l.stop(t+a+.1)}}_choir(e,t,n,r){let i=this.ctx,a=i.createGain();a.gain.setValueAtTime(1e-4,t),a.gain.linearRampToValueAtTime(r,t+1.5),a.gain.setValueAtTime(r,t+n-2.2),a.gain.linearRampToValueAtTime(1e-4,t+n);let o=i.createOscillator();o.frequency.value=.24;let s=i.createGain();s.gain.value=r*.22,o.connect(s).connect(a.gain),o.start(t),o.stop(t+n+.1);let c=i.createBiquadFilter();c.type=`lowpass`,c.frequency.value=1350;let l=i.createBiquadFilter();l.type=`peaking`,l.frequency.value=900,l.Q.value=1.1,l.gain.value=7,a.connect(c).connect(l),this._route(l,.6);let u=i.createOscillator();u.frequency.value=4.8;let d=i.createGain();d.gain.value=5,u.connect(d),u.start(t),u.stop(t+n+.1);for(let r of[-6,6]){let o=i.createOscillator();o.type=`sawtooth`,o.frequency.value=e,o.detune.value=r,d.connect(o.detune),o.connect(a),o.start(t),o.stop(t+n+.1)}}_ostinato(e,t,n,r){let i=this.ctx,a=i.createGain();a.gain.setValueAtTime(1e-4,t),a.gain.exponentialRampToValueAtTime(r,t+.012),a.gain.exponentialRampToValueAtTime(1e-4,t+n);let o=i.createBiquadFilter();o.type=`lowpass`,o.frequency.setValueAtTime(2600,t),o.frequency.exponentialRampToValueAtTime(900,t+n),a.connect(o),this._route(o,.3);for(let r of[-7,7]){let o=i.createOscillator();o.type=`sawtooth`,o.frequency.value=e,o.detune.value=r,o.connect(a),o.start(t),o.stop(t+n+.05)}}_drum(e,t,n){let r=this.ctx;if(e===`boom`){let e=r.createOscillator();e.type=`sine`,e.frequency.setValueAtTime(150,t),e.frequency.exponentialRampToValueAtTime(46,t+.22);let i=r.createGain();i.gain.setValueAtTime(n*.5,t),i.gain.exponentialRampToValueAtTime(1e-4,t+.34),e.connect(i),this._route(i,.35),e.start(t),e.stop(t+.38);let a=r.createBufferSource();a.buffer=this._noise();let o=r.createBiquadFilter();o.type=`lowpass`,o.frequency.value=340;let s=r.createGain();s.gain.setValueAtTime(n*.16,t),s.gain.exponentialRampToValueAtTime(1e-4,t+.1),a.connect(o).connect(s),this._route(s,.35),a.start(t,Math.random()),a.stop(t+.12)}else{let e=r.createOscillator();e.type=`sine`,e.frequency.setValueAtTime(98,t),e.frequency.exponentialRampToValueAtTime(58,t+.12);let i=r.createGain();i.gain.setValueAtTime(n*.3,t),i.gain.exponentialRampToValueAtTime(1e-4,t+.18),e.connect(i),this._route(i,.35),e.start(t),e.stop(t+.2);let a=r.createBufferSource();a.buffer=this._noise();let o=r.createBiquadFilter();o.type=`bandpass`,o.frequency.value=520,o.Q.value=1.2;let s=r.createGain();s.gain.setValueAtTime(n*.12,t),s.gain.exponentialRampToValueAtTime(1e-4,t+.06),a.connect(o).connect(s),this._route(s,.35),a.start(t,Math.random()),a.stop(t+.08)}}_brass(e,t,n,r){let i=this.ctx,a=i.createGain();a.gain.setValueAtTime(1e-4,t),a.gain.linearRampToValueAtTime(r,t+1.1),a.gain.setValueAtTime(r,t+n-1.8),a.gain.linearRampToValueAtTime(1e-4,t+n);let o=i.createBiquadFilter();o.type=`lowpass`,o.frequency.setValueAtTime(500,t),o.frequency.exponentialRampToValueAtTime(2400,t+1.4),o.frequency.exponentialRampToValueAtTime(1300,t+n),a.connect(o),this._route(o,.45);for(let r of[-9,9]){let o=i.createOscillator();o.type=`sawtooth`,o.frequency.setValueAtTime(e*.94,t),o.frequency.exponentialRampToValueAtTime(e,t+.14),o.detune.value=r,o.connect(a),o.start(t),o.stop(t+n+.1)}}_bell(e,t,n){let r=this.ctx,i=[1,2.4,3.9,5.4],a=[1,.5,.28,.16],o=[1,.72,.5,.34];i.forEach((i,s)=>{let c=r.createOscillator();c.type=`sine`,c.frequency.value=e*i;let l=r.createGain(),u=5.5*o[s];l.gain.setValueAtTime(1e-4,t),l.gain.exponentialRampToValueAtTime(n*a[s],t+.008),l.gain.exponentialRampToValueAtTime(1e-4,t+u),c.connect(l),this._route(l,.7),c.start(t),c.stop(t+u+.1)})}_braam(e){let t=this.ctx;[36.71,73.42,110].forEach(n=>{let r=t.createOscillator();r.type=`sawtooth`,r.frequency.setValueAtTime(n*.94,e),r.frequency.exponentialRampToValueAtTime(n,e+.4);let i=t.createBiquadFilter();i.type=`lowpass`,i.frequency.setValueAtTime(300,e),i.frequency.exponentialRampToValueAtTime(1100,e+.5);let a=t.createGain();a.gain.setValueAtTime(1e-4,e),a.gain.linearRampToValueAtTime(.05,e+.35),a.gain.setValueAtTime(.05,e+2.6),a.gain.linearRampToValueAtTime(1e-4,e+3.4),r.connect(i).connect(a),this._route(a,.5),r.start(e),r.stop(e+3.5)});let n=t.createOscillator();n.type=`sine`,n.frequency.setValueAtTime(33,e),n.frequency.exponentialRampToValueAtTime(36.71,e+.4);let r=t.createGain();r.gain.setValueAtTime(1e-4,e),r.gain.linearRampToValueAtTime(.14,e+.3),r.gain.exponentialRampToValueAtTime(1e-4,e+2.8),n.connect(r),this._route(r,.35),n.start(e),n.stop(e+2.9)}_crash(e){let t=this.ctx,n=t.createBufferSource();n.buffer=this._noise();let r=t.createBiquadFilter();r.type=`highpass`,r.frequency.value=5200;let i=t.createGain();i.gain.setValueAtTime(.09,e),i.gain.exponentialRampToValueAtTime(1e-4,e+2.4),n.connect(r).connect(i),this._route(i,.55),n.start(e,Math.random()),n.stop(e+2.5)}_riser(e,t){let n=this.ctx,r=n.createBufferSource();r.buffer=this._noise();let i=n.createBiquadFilter();i.type=`bandpass`,i.Q.value=1,i.frequency.setValueAtTime(320,e),i.frequency.exponentialRampToValueAtTime(3800,e+t);let a=n.createGain();a.gain.setValueAtTime(1e-4,e),a.gain.linearRampToValueAtTime(.06,e+t*.94),a.gain.linearRampToValueAtTime(1e-4,e+t),r.connect(i).connect(a),this._route(a,.5),r.start(e,Math.random()),r.stop(e+t+.05);let o=n.createOscillator();o.type=`sine`,o.frequency.setValueAtTime(587.33,e),o.frequency.exponentialRampToValueAtTime(1174.66,e+t);let s=n.createGain();s.gain.setValueAtTime(1e-4,e),s.gain.linearRampToValueAtTime(.02,e+t*.9),s.gain.linearRampToValueAtTime(1e-4,e+t),o.connect(s),this._route(s,.6),o.start(e),o.stop(e+t+.05)}_harp(e,t,n){let r=this.ctx,i=r.createGain();i.gain.setValueAtTime(1e-4,t),i.gain.exponentialRampToValueAtTime(n,t+.006),i.gain.exponentialRampToValueAtTime(1e-4,t+1.4),i.connect(this.dry);let a=r.createGain();a.gain.value=.6,i.connect(a).connect(this.wet);let o=r.createOscillator();o.type=`triangle`,o.frequency.value=e;let s=r.createOscillator();s.type=`sine`,s.frequency.value=e*2;let c=r.createGain();c.gain.value=.35,o.connect(i),s.connect(c).connect(i),o.start(t),o.stop(t+1.45),s.start(t),s.stop(t+1.45)}_noise(){let e=this.ctx,t=Math.floor(e.sampleRate*1.5),n=e.createBuffer(1,t,e.sampleRate),r=n.getChannelData(0);for(let e=0;e<t;e++)r[e]=Math.random()*2-1;return n}},vp=(e,t,n)=>e<t?t:e>n?n:e,yp=e=>vp(e,0,1),bp=(e,t,n)=>e+(t-e)*n,xp=(e,t,n)=>{let r=yp((n-e)/(t-e||1e-6));return r*r*(3-2*r)},Sp=(e,t)=>e+Math.random()*(t-e);function Cp(e){let t=Math.sin(e*127.1)*43758.5453123;return t-Math.floor(t)}var wp={linear:e=>e,inQuad:e=>e*e,outQuad:e=>e*(2-e),inOutQuad:e=>e<.5?2*e*e:-1+(4-2*e)*e,inCubic:e=>e*e*e,outCubic:e=>1-(1-e)**3,inOutCubic:e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2,outQuint:e=>1-(1-e)**5,outExpo:e=>e>=1?1:1-2**(-10*e),pop:e=>Math.sin(Math.min(1,e)*Math.PI)**.6},Tp=Math.PI*2,Ep=[0,.22,.5,.75,.92];function Dp(e,t){return t+(1-t)*(1-e)**1.15}function Op({seed:e=1,sides:t=6,taper:n=.13,roughness:r=.28,bend:i=.22}={}){let a=Math.max(3,Math.round(t)),o=Math.min(.9,Math.max(.01,n)),s=Cp(e*1.77)*Tp,c=Math.cos(s),l=Math.sin(s),u=e=>i*.5*e**1.6,d=[];for(let t=0;t<a;t++){let n=(Cp(e*3.13+t*7.7)-.5)*(Tp/a)*.55*r*3;d.push(t/a*Tp+n)}let f=Ep.map((t,n)=>{let i=Dp(t,o)*.5,a=u(t),s=t+(Cp(e*5.9+n*2.3)-.5)*.06*r*(t>0);return d.map((o,u)=>{let d=1+(Cp(e*11.1+n*13.7+u*3.9)-.5)*r*1.3*(.35+.65*t),f=Math.max(.002,i*d);return[Math.cos(o)*f+c*a,s,Math.sin(o)*f+l*a]})}),p=u(1),m=[c*p+(Cp(e*17.3)-.5)*.09*r,1,l*p+(Cp(e*19.7)-.5)*.09*r],h=[0,0,0],g=[],_=e=>g.push(e[0],e[1],e[2]);for(let e=0;e<f.length-1;e++){let t=f[e],n=f[e+1];for(let e=0;e<a;e++){let r=(e+1)%a;_(t[e]),_(t[r]),_(n[e]),_(t[r]),_(n[r]),_(n[e])}}let v=f[f.length-1],y=f[0];for(let e=0;e<a;e++){let t=(e+1)%a;_(v[e]),_(v[t]),_(m),_(h),_(y[t]),_(y[e])}let b=new Mr;return b.setAttribute(`position`,new J(g,3)),b.computeVertexNormals(),b}function kp(e,t,n,r){return Cp(e*127.1+t*311.7+n*74.7+r*19.19)}function Ap(e,t,n,r){let i=Math.floor(e),a=Math.floor(t),o=Math.floor(n),s=e-i,c=t-a,l=n-o,u=s*s*(3-2*s),d=c*c*(3-2*c),f=l*l*(3-2*l),p=kp(i,a,o,r),m=kp(i+1,a,o,r),h=kp(i,a+1,o,r),g=kp(i+1,a+1,o,r),_=kp(i,a,o+1,r),v=kp(i+1,a,o+1,r),y=kp(i,a+1,o+1,r),b=kp(i+1,a+1,o+1,r),x=p+(m-p)*u,S=h+(g-h)*u,C=_+(v-_)*u,w=y+(b-y)*u,T=x+(S-x)*d;return T+(C+(w-C)*d-T)*f}function jp(e,t,n,r,i){let a=0,o=.5,s=1;for(let c=0;c<i;c++)a+=o*(Ap(e*s,t*s,n*s,r+c*7.7)*2-1),s*=2.03,o*=.5;return a}function Mp({seed:e=1,detail:t=3,lumpiness:n=.26,noiseScale:r=1.5,roughness:i=.16,cuts:a=7,cutDepth:o=.2,craters:s=5,craterDepth:c=.18,craterSize:l=.5}={}){let u=new Ia(1,vp(Math.round(t),0,3)).toNonIndexed(),d=u.attributes.position.array,f=(e,t)=>{let n=Math.acos(2*Cp(e)-1),r=Cp(t)*Tp,i=Math.sin(n);return{x:i*Math.cos(r),y:Math.cos(n),z:i*Math.sin(r)}},p=[];for(let t=0;t<Math.max(0,Math.round(a));t++){let n=f(e*2.3+t*9.1,e*5.7+t*4.3);n.offset=1-o*(.35+.9*Cp(e*13.1+t*6.7)),p.push(n)}let m=[];for(let t=0;t<Math.max(0,Math.round(s));t++){let n=f(e*3.1+t*12.9,e*7.7+t*5.3);n.radius=Math.max(.08,l*(.45+.8*Cp(e*11.3+t*3.7))),n.depth=c*(.5+Cp(e*17.9+t*2.1)),m.push(n)}for(let t=0;t<d.length;t+=3){let a=d[t],o=d[t+1],s=d[t+2],c=1;c+=jp(a*r,o*r,s*r,e,3)*n,c+=jp(a*r*4.3,o*r*4.3,s*r*4.3,e+31.7,2)*i*.5;for(let e of m){let t=Math.acos(vp(a*e.x+o*e.y+s*e.z,-1,1))/e.radius;t>=1.4||(c-=e.depth*Math.max(0,1-t*t),c+=e.depth*.5*xp(.72,1,t)*(1-xp(1,1.4,t)))}c=Math.max(.35,c);let l=a*c,u=o*c,f=s*c;for(let e of p){let t=l*e.x+u*e.y+f*e.z-e.offset;t<=0||(l-=e.x*t,u-=e.y*t,f-=e.z*t)}d[t]=l,d[t+1]=u,d[t+2]=f}return u.attributes.position.needsUpdate=!0,u.computeVertexNormals(),u.computeBoundingSphere(),u}function Np(e=72,t=24){let n=Math.max(2,Math.round(e)),r=Math.max(1,Math.round(t)),i=new Float32Array(n*2*3);for(let e=0;e<n;e++){let t=e/(n-1),r=e*6;i[r+0]=t,i[r+1]=-1,i[r+3]=t,i[r+4]=1}let a=new Uint16Array((n-1)*6);for(let e=0;e<n-1;e++){let t=e*2,n=e*6;a[n+0]=t,a[n+1]=t+1,a[n+2]=t+2,a[n+3]=t+1,a[n+4]=t+3,a[n+5]=t+2}let o=new Float32Array(r);for(let e=0;e<r;e++)o[e]=e;let s=new as;return s.setAttribute(`position`,new q(i,3)),s.setAttribute(`aStrand`,new Li(o,1)),s.setIndex(new q(a,1)),s.instanceCount=r,s.boundingSphere=new wr(new V,1e4),s}function Pp(e=96,t=26){let n=Math.max(2,Math.round(e)),r=Math.max(3,Math.round(t)),i=r+1,a=new Float32Array(n*i*3),o=0;for(let e=0;e<n;e++){let t=e/(n-1);for(let e=0;e<i;e++)a[o++]=t,a[o++]=e/r,a[o++]=0}let s=new Uint16Array((n-1)*r*6),c=0;for(let e=0;e<n-1;e++)for(let t=0;t<r;t++){let n=e*i+t,r=n+i;s[c++]=n,s[c++]=r,s[c++]=n+1,s[c++]=r,s[c++]=r+1,s[c++]=n+1}let l=new Mr;return l.setAttribute(`position`,new q(a,3)),l.setIndex(new q(s,1)),l.boundingSphere=new wr(new V,1e4),l}function Fp(e=10,t=44){let n=Math.max(1,Math.round(e)),r=Math.max(6,Math.round(t)),i=r+1,a=new Float32Array(2*i*3),o=0;for(let e=0;e<2;e++)for(let t=0;t<i;t++)a[o++]=e,a[o++]=t/r,a[o++]=0;let s=new Uint16Array(r*6),c=0;for(let e=0;e<r;e++){let t=e,n=i+e;s[c++]=t,s[c++]=n,s[c++]=t+1,s[c++]=n,s[c++]=n+1,s[c++]=t+1}let l=new Float32Array(n);for(let e=0;e<n;e++)l[e]=e;let u=new as;return u.setAttribute(`position`,new q(a,3)),u.setAttribute(`aRing`,new Li(l,1)),u.setIndex(new q(s,1)),u.instanceCount=n,u.boundingSphere=new wr(new V,1e4),u}function Ip(e={}){let t=new Qa({color:16777215,roughness:.16,metalness:0,flatShading:!0,transparent:!0,side:2,depthWrite:!0,opacity:.92}),n={uTime:pp.uTime,uColorDeep:{value:new K(e.colorDeep??`#3e737a`)},uColorIce:{value:new K(e.colorIce??`#8adaff`)},uColorRim:{value:new K(e.colorRim??`#f2feff`)},uColorCore:{value:new K(e.colorCore??`#638797`)},uDensity:{value:1.15},uFresnel:{value:2.3},uFresnelPower:{value:2.4},uTranslucency:{value:1.5},uFacetSharp:{value:.68},uFracture:{value:.62},uFractureScale:{value:6.5},uVeins:{value:.45},uVeinScale:{value:3.2},uSparkle:{value:1.1},uSparkleScale:{value:34},uSparkleSpeed:{value:.7},uFrostLine:{value:.5},uGlow:{value:.85},uEdgeGlow:{value:1.1},uBirthGlow:{value:1.6}};return t.onBeforeCompile=e=>{Object.assign(e.uniforms,n),e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
         ...
         ${Of}`).replace(`#include <emissivemap_fragment>`,`#include <emissivemap_fragment>
         {
...
`;function Hp(e=Rp.CORE,t){let n=t,r=e===Rp.GLOW,i=new Xa({defines:r?{BOLT_GLOW:``}:{},transparent:!0,depthWrite:!1,depthTest:!0,blending:2,side:2,toneMapped:!1,uniforms:mp({uOrigin:{value:new V},uTarget:{value:new V(0,0,1)},uSide:{value:new V(1,0,0)},uSag:{value:n.sag},uSeed:{value:0},uRestrike:{value:n.restrike},uProgress:{value:0},uFade:{value:1},uStrands:{value:n.strands},uSpread:{value:n.spread},uSpreadNear:{value:n.spreadNear},uSpreadCurve:{value:n.spreadCurve},uTwist:{value:n.twist},uTwistSpeed:{value:n.twistSpeed},uBranchDim:{value:n.branchDim},uJitter:{value:n.jitter},uJitterScale:{value:n.jitterScale},uOctaves:{value:n.octaves},uJitterFalloff:{value:n.jitterFalloff},uCrawl:{value:n.crawl},uPinch:{value:n.pinch},uConverge:{value:n.converge},uWidth:{value:n.width},uWidthTip:{value:n.widthTip},uWidthCurve:{value:n.widthCurve},uCoreWidth:{value:n.coreWidth},uGlowFalloff:{value:n.glowFalloff},uCoreSharp:{value:n.coreSharp},uWidthScale:{value:r?n.glowWidth:1},uPassOpacity:{value:r?n.glowOpacity:1},uFlicker:{value:n.flicker},uFlickerSpeed:{value:n.flickerSpeed},uStrandFlash:{value:n.strandFlash},uTipGlow:{value:n.tipGlow},uTipLength:{value:n.tipLength},uOpacity:{value:n.opacity},uGlow:{value:n.glow},uColorCore:{value:new K(n.colorCore)},uColorInner:{value:new K(n.colorInner)},uColorOuter:{value:new K(n.colorOuter)},uColorHalo:{value:new K(n.colorHalo)}}),vertexShader:Bp,fragmentShader:Vp});return i.userData.sync=e=>{let t=i.uniforms;t.uOrigin.value.copy(e.origin),t.uTarget.value.copy(e.target),t.uSide.value.copy(e.side),t.uSeed.value=e.seed,t.uProgress.value=e.progress,t.uFade.value=e.fade,t.uStrands.value=e.strands,t.uGlow.value=n.glow,t.uOpacity.value=n.opacity,t.uColorCore.value.set(n.colorCore),t.uColorInner.value.set(n.colorInner),t.uColorOuter.value.set(n.colorOuter),t.uColorHalo.value.set(n.colorHalo)},i}var Up=Object.freeze({SOFT:0,SMOKE:1,STREAK:2}),Wp={start:3,origin:3,velocity:3,color:3,spawn:1,life:1,size:1,seed:1,spin:1},Gp=new V,Kp=class{constructor({name:e,capacity:t=2e3,shape:n=Up.SOFT,additive:r=!0,curl:i=!1,stretch:a=!1}){this.name=e,this.capacity=t,this.cursor=0;let o=new as;o.setAttribute(`position`,new q(new Float32Array([-.5,-.5,0,.5,-.5,0,.5,.5,0,-.5,.5,0]),3)),o.setAttribute(`uv`,new q(new Float32Array([0,0,1,0,1,1,0,1]),2)),o.setIndex(new q(new Uint16Array([0,1,2,0,2,3]),1)),this.data={},this.attributes={};for(let[e,n]of Object.entries(Wp)){let r=new Float32Array(t*n),i=new Li(r,n).setUsage(Ze);this.data[e]=r,this.attributes[e]=i,o.setAttribute(`a${e[0].toUpperCase()}${e.slice(1)}`,i)}this.data.life.fill(0),o.instanceCount=t,o.boundingSphere=new wr(new V,1e4),this.geometry=o;let s={SHAPE:n};i&&(s.USE_CURL=``),a&&(s.USE_STRETCH=``),this.material=new Xa({defines:s,transparent:!0,depthWrite:!1,depthTest:!0,blending:r?2:1,side:2,toneMapped:!1,uniforms:mp({uGravity:{value:new V(0,-4.5,0)},uDrag:{value:.9},uTurbulence:{value:.6},uTurbFrequency:{value:.45},uTurbSpeed:{value:.35},uSpeedScale:{value:1},uSizeScale:{value:1},uLifeScale:{value:1},uEndSize:{value:.4},uSizeIn:{value:.08},uFadeIn:{value:.08},uFadeOut:{value:.55},uOpacity:{value:1},uGlow:{value:1},uStretch:{value:.15},uColor0:{value:new K(1,1,1)},uColor1:{value:new K(1,.7,.3)},uColor2:{value:new K(.6,.15,.05)},uColor3:{value:new K(.08,.06,.06)}}),vertexShader:Yp,fragmentShader:Xp}),this.mesh=new Y(o,this.material),this.mesh.frustumCulled=!1,this.mesh.matrixAutoUpdate=!1,this.mesh.renderOrder=r?12:10,this.mesh.name=`Particles:${e}`,this._ranges=[],this._dirty=!1}get uniforms(){return this.material.uniforms}emit(e,t){if(e<=0)return;e=Math.min(e,this.capacity);let{position:n,radius:r=0,direction:i=null,speed:a=1,speedVariance:o=.35,spread:s=.5,size:c=.2,sizeVariance:l=.4,life:u=1,lifeVariance:d=.3,spin:f=0,tint:p=null,time:m=0}=t,h=this.data;for(let t=0;t<e;t++){let e=this.cursor;this.cursor=(this.cursor+1)%this.capacity,this._markDirty(e);let t=e*3,g=0,_=0,v=0;if(r>0){let e=r*Math.cbrt(Math.random()),t=Math.random()*Math.PI*2,n=Math.acos(2*Math.random()-1),i=Math.sin(n);g=e*i*Math.cos(t),_=e*Math.cos(n),v=e*i*Math.sin(t)}h.start[t+0]=n.x+g,h.start[t+1]=n.y+_,h.start[t+2]=n.z+v,i?Gp.copy(i):Gp.set(0,1,0),s>0&&(Gp.x+=(Math.random()-.5)*2*s,Gp.y+=(Math.random()-.5)*2*s,Gp.z+=(Math.random()-.5)*2*s),Gp.normalize().multiplyScalar(a*(1+(Math.random()-.5)*2*o)),h.velocity[t+0]=Gp.x,h.velocity[t+1]=Gp.y,h.velocity[t+2]=Gp.z,h.spawn[e]=m,h.life[e]=Math.max(.05,u*(1+(Math.random()-.5)*2*d)),h.size[e]=Math.max(.001,c*(1+(Math.random()-.5)*2*l)),h.seed[e]=Math.random(),h.spin[e]=(Math.random()-.5)*2*f,p?(h.color[t+0]=p.r,h.color[t+1]=p.g,h.color[t+2]=p.b):(h.color[t+0]=1,h.color[t+1]=1,h.color[t+2]=1)}}_markDirty(e){this._dirty=!0;let t=this._ranges,n=t[t.length-1];n&&e===n[0]+n[1]?n[1]++:t.push([e,1])}flush(){if(this._dirty){for(let[e,t]of Object.entries(Wp)){let n=this.attributes[e];n.needsUpdate=!0,n.clearUpdateRanges?.();for(let[e,r]of this._ranges)n.addUpdateRange?.(e*t,r*t)}this._ranges.length=0,this._dirty=!1}}setGradient(e,t,n,r){let i=this.uniforms;i.uColor0.value.set(e),i.uColor1.value.set(t),i.uColor2.value.set(n),i.uColor3.value.set(r??n)}reset(){this.data.life.fill(0),this.data.spawn.fill(-1e4);for(let e of Object.keys(Wp))this.attributes[e].needsUpdate=!0;this._ranges.length=0,this._dirty=!1,this.cursor=0}dispose(){this.geometry.dispose(),this.material.dispose()}},qp=class{constructor(){this._acc=0}reset(){this._acc=0}tick(e,t){this._acc+=t*e;let n=Math.floor(this._acc);return n>0&&(this._acc-=n),n}},Jp=class{constructor(e){this.scene=e,this.systems=new Map}get(e,t){let n=this.systems.get(e);return n||(n=new Kp({name:e,...t}),this.systems.set(e,n),this.scene.add(n.mesh)),n}flush(){for(let e of this.systems.values())e.flush()}reset(){for(let e of this.systems.values())e.reset()}dispose(){for(let e of this.systems.values())this.scene.remove(e.mesh),e.dispose();this.systems.clear()}},Yp=`
  uniform float uTime;
...
`,Zp=class{constructor(e,t){this._create=e,this._release=t,this._free=[]}acquire(){return this._free.length>0?this._free.pop():this._create()}release(e){this._release?.(e),this._free.push(e)}dispose(e){if(e)for(let t of this._free)e(t);this._free.length=0}},Qp=Object.freeze({FIRE:0,AIR:2,FROST:4,STORM:5}),$p=`
  uniform float uTime;
  uniform float uAge;
...
`,tm=class{constructor(e){this.group=new G,this.group.name=`Bursts`,e.add(this.group),this.geometry=new Ia(1,4),this.pools=new Map,this.active=[]}_poolFor(e){let t=this.pools.get(e);return t||(t=new Zp(()=>this._create(e),e=>{e.mesh.visible=!1,this.group.remove(e.mesh)}),this.pools.set(e,t)),t}_create(e){let t=new Xa({defines:{BURST_MODE:e},transparent:!0,depthWrite:!1,depthTest:!0,blending:2,side:2,toneMapped:!1,uniforms:mp({uAge:{value:0},uSeed:{value:Math.random()},uDisplace:{value:.45},uTurbulence:{value:1},uIntensity:{value:1},uFresnel:{value:1},uOpacity:{value:1},uColorA:{value:new K(1,.9,.6)},uColorB:{value:new K(1,.45,.1)},uColorC:{value:new K(.4,.08,.03)}}),vertexShader:$p,fragmentShader:em}),n=new Y(this.geometry,t);return n.renderOrder=14,n.frustumCulled=!1,{mesh:n,material:t,mode:e,age:0,life:1,radius:1,endRadius:2}}spawn(e,t,n={}){let{radius:r=.4,endRadius:i=3,life:a=.9,intensity:o=1,opacity:s=1,fresnel:c=1,displace:l=.45,turbulence:u=1,colorA:d=null,colorB:f=null,colorC:p=null,squash:m=1}=n,h=this._poolFor(e).acquire(),g=h.material.uniforms;return h.age=0,h.life=Math.max(.05,a),h.radius=r,h.endRadius=i,h.squash=m,g.uAge.value=0,g.uSeed.value=Math.random()*10,g.uIntensity.value=o,g.uOpacity.value=s,g.uFresnel.value=c,g.uDisplace.value=l,g.uTurbulence.value=u,d&&g.uColorA.value.copy(d),f&&g.uColorB.value.copy(f),p&&g.uColorC.value.copy(p),h.mesh.position.copy(t),h.mesh.scale.setScalar(r),h.mesh.visible=!0,this.group.add(h.mesh),this.active.push(h),h}update(e){for(let t=this.active.length-1;t>=0;t--){let n=this.active[t];n.age+=e;let r=Math.min(1,n.age/n.life);n.material.uniforms.uAge.value=r;let i=n.radius+(n.endRadius-n.radius)*wp.outQuint(r);n.mesh.scale.set(i,i*n.squash,i),r>=1&&(this.active.splice(t,1),this._poolFor(n.mode).release(n))}}clear(){for(let e of this.active)this._poolFor(e.mode).release(e);this.active.length=0}dispose(){this.clear();for(let e of this.pools.values())e.dispose(e=>e.material.dispose());this.pools.clear(),this.geometry.dispose(),this.group.parent?.remove(this.group)}},nm=Object.freeze({SCORCH:0,CRACK:2,SHOCKWAVE:3,DUSTRING:4,FROST:6,ARC:7}),rm=`
...
`,am=class{constructor(e){this.group=new G,this.group.name=`GroundDecals`,e.add(this.group),this.geometry=new Ra(1,1).rotateX(-Math.PI/2),this.active=[],this.pools=new Map}_poolFor(e){let t=this.pools.get(e);return t||(t=new Zp(()=>this._createDecal(e),e=>{e.mesh.visible=!1,this.group.remove(e.mesh)}),this.pools.set(e,t)),t}_createDecal(e){let t=e===nm.SHOCKWAVE||e===nm.ARC,n=new Xa({defines:{DECAL:e},transparent:!0,depthWrite:!1,depthTest:!0,blending:t?2:1,toneMapped:!1,uniforms:mp({uAge:{value:0},uSeed:{value:Math.random()},uIntensity:{value:1},uWidth:{value:.12},uRadius:{value:1},uColorA:{value:new K(.1,.06,.05)},uColorB:{value:new K(1,.5,.15)}}),vertexShader:rm,fragmentShader:im}),r=new Y(this.geometry,n);return r.renderOrder=t?8:6,r.frustumCulled=!1,{mesh:r,material:n,type:e,age:0,life:1,radius:1,growth:0}}spawn(e,t,n={}){let{radius:r=2,life:i=2,colorA:a=null,colorB:o=null,intensity:s=1,width:c=.12,growth:l=0,height:u=.02}=n,d=this._poolFor(e).acquire(),f=d.material.uniforms;return d.age=0,d.life=Math.max(.05,i),d.radius=r,d.growth=l,f.uAge.value=0,f.uSeed.value=Math.random(),f.uIntensity.value=s,f.uWidth.value=c,f.uRadius.value=r,a&&f.uColorA.value.set(a),o&&f.uColorB.value.set(o),d.mesh.position.set(t.x,u,t.z),d.mesh.rotation.y=Math.random()*Math.PI*2,d.mesh.scale.setScalar(r*2),d.mesh.visible=!0,this.group.add(d.mesh),this.active.push(d),d}update(e){for(let t=this.active.length-1;t>=0;t--){let n=this.active[t];n.age+=e;let r=n.age/n.life;n.material.uniforms.uAge.value=r,n.growth!==0&&n.mesh.scale.setScalar(n.radius*2*(1+n.growth*r)),r>=1&&(this.active.splice(t,1),this._poolFor(n.type).release(n))}}clear(){for(let e of this.active)this._poolFor(e.type).release(e);this.active.length=0}dispose(){this.clear();for(let e of this.pools.values())e.dispose(e=>e.material.dispose());this.pools.clear(),this.geometry.dispose(),this.group.parent?.remove(this.group)}},om=class e{constructor(e,t){this.scene=e,this.renderer=t,this.bursts=new tm(e),this.decals=new am(e),this.particles=new Jp(e),this._scratchColor=new K,this._emit={},this._dir=new V,this.sparks=this.particles.get(`sparks`,{capacity:4e3,shape:Up.STREAK,additive:!0,stretch:!0}),this.sparks.uniforms.uDrag.value=1.4,this.sparks.uniforms.uEndSize.value=.25,this.sparks.uniforms.uSizeIn.value=.02,this.sparks.uniforms.uFadeIn.value=.03,this.sparks.uniforms.uFadeOut.value=.45,this.motes=this.particles.get(`motes`,{capacity:2400,shape:Up.SOFT,additive:!0,curl:!0}),this.motes.uniforms.uDrag.value=1.2,this.motes.uniforms.uEndSize.value=.16,this.motes.uniforms.uSizeIn.value=.05,this.motes.uniforms.uFadeIn.value=.07,this.motes.uniforms.uFadeOut.value=.4,this.smoke=this.particles.get(`smoke`,{capacity:1600,shape:Up.SMOKE,additive:!1,curl:!0}),this.smoke.uniforms.uDrag.value=1.7,this.smoke.uniforms.uEndSize.value=3,this.smoke.uniforms.uSizeIn.value=.12,this.smoke.uniforms.uFadeIn.value=.16,this.smoke.uniforms.uFadeOut.value=.3,this.smoke.uniforms.uOpacity.value=.55,this._sparkEmitter=new qp,this._moteEmitter=new qp}static ELEMENT_BURST={ice:{a:`#a9e4ff`,b:`#cdefff`,c:`#f2feff`},fire:{a:`#ffd27a`,b:`#ff6a12`,c:`#fff3d0`},storm:{a:`#a98bff`,b:`#d3f4ff`,c:`#ffffff`},basic:{a:`#9fd8ff`,b:`#d3f4ff`,c:`#ffffff`}};sparkBurst(t,n,r={}){let i=e.ELEMENT_BURST[n]??e.ELEMENT_BURST.basic,a=r.count??60;this.sparks.setGradient(`#ffffff`,i.c,i.b,i.a),this.sparks.uniforms.uGravity.value.set(0,r.gravity??-11,0),this.sparks.uniforms.uSizeScale.value=r.size??1.2,this.sparks.uniforms.uLifeScale.value=r.life??.8,this.sparks.uniforms.uGlow.value=1.6;let o=this._emit;o.position=t,o.radius=r.radius??.25,o.direction=this._dir.set(0,r.up??.7,0).normalize(),o.speed=r.speed??9,o.speedVariance=.85,o.spread=1,o.size=.22,o.sizeVariance=.8,o.life=.6,o.lifeVariance=.6,o.spin=0,o.tint=null,o.time=pp.uTime.value,this.sparks.emit(a,o)}killBurst(t,n,r=1){let i=e.ELEMENT_BURST[n]??e.ELEMENT_BURST.basic,a={ice:Qp.FROST,fire:Qp.FIRE,storm:Qp.STORM,basic:Qp.AIR};this.bursts.spawn(a[n]??Qp.AIR,t,{radius:.2*r,endRadius:(n===`basic`?2.6:3.4)*r,life:.55+.15*r,intensity:1.1,opacity:.95,fresnel:n===`basic`?2.2:1.6,displace:.45,colorA:i.a,colorB:i.b,colorC:i.c}),this.decals.spawn(nm.SHOCKWAVE,t,{radius:2.2*r,life:.5,width:.05,intensity:.85,colorA:i.b,colorB:`#ffffff`}),this.sparkBurst(t,n,{count:Math.round(46*r),speed:8*r,life:.9,size:1.1})}update(e,t,n){if(pp.uTime.value+=e,pp.uDelta.value=e,n){let e=n.getSize(new B),t=n.getPixelRatio();pp.uResolution.value.set(e.x*t,e.y*t)}t&&(pp.uCameraNear.value=t.near,pp.uCameraFar.value=t.far),this.bursts.update(e),this.decals.update(e),this.particles.flush()}clear(){this.bursts.clear(),this.decals.clear(),this.particles.reset(),this._sparkEmitter.reset(),this._moteEmitter.reset()}dispose(){this.bursts.dispose(),this.decals.dispose(),this.particles.dispose()}},sm={ice:{core:`#ffffff`,inner:`#d3f4ff`,outer:`#56d8ff`},fire:{core:`#ffffff`,inner:`#ffe8c0`,outer:`#ff8a3c`},storm:{core:`#ffffff`,inner:`#e7dcff`,outer:`#a98bff`}};function cm(e){let t=new G,n=new Y(new Oa(.03,.03,.9,8),e);n.rotation.x=Math.PI/2,t.add(n);let r=new Y(new ka(.07,.24,8),e);r.rotation.x=Math.PI/2,r.position.z=.54,t.add(r);let i=new Ra(.18,.24);i.rotateY(Math.PI/2);let a=new ci({color:`#ffffff`,transparent:!0,opacity:.9,side:2,depthWrite:!1});for(let e of[Math.PI/4,-Math.PI/4]){let n=new Y(i,a);n.position.z=-.36,n.rotation.z=e,t.add(n)}return t}var lm=class{constructor(e,t=1400){this.max=t,this.particles=[],this._positions=new Float32Array(t*3),this._colors=new Float32Array(t*3),this._alphas=new Float32Array(t),this._sizes=new Float32Array(t);let n=new Mr;n.setAttribute(`position`,new q(this._positions,3)),n.setAttribute(`aColor`,new q(this._colors,3)),n.setAttribute(`aAlpha`,new q(this._alphas,1)),n.setAttribute(`aSize`,new q(this._sizes,1)),n.boundingSphere=null,this._material=new Xa({transparent:!0,depthWrite:!1,blending:2,fog:!1,uniforms:{uPixelRatio:{value:1}},vertexShader:`
        uniform float uPixelRatio;
        attribute vec3 aColor;
      ...
      `}),this._points=new ya(n,this._material),this._points.frustumCulled=!1,this._points.renderOrder=3,e.add(this._points),this._geometry=n,this._cA=new K,this._cB=new K}setPixelRatio(e){this._material.uniforms.uPixelRatio.value=e}clear(){this.particles.length=0,this._alphas.fill(0)}emit(e){for(let t=0;t<e.count;t++){this.particles.length>=this.max&&this.particles.shift();let t=Math.random()*Math.PI*2,n=Math.sqrt(Math.random())*(e.spread??1),r=bp(e.speed[0],e.speed[1],Math.random());this.particles.push({x:e.pos.x+Math.cos(t)*n*.3,y:e.pos.y+Math.random()*.2,z:e.pos.z+Math.sin(t)*n*.3,vx:Math.cos(t)*n*r,vy:bp(e.up[0],e.up[1],Math.random()),vz:Math.sin(t)*n*r,life:0,maxLife:bp(e.life[0],e.life[1],Math.random()),size:bp(e.size[0],e.size[1],Math.random()),gravity:e.gravity??-9,drag:e.drag??.6,color:this._cA.set(e.colorA).clone().lerp(this._cB.set(e.colorB),Math.random())})}}update(e){let t=this.particles,n=0;for(let r=0;r<t.length;r++){let i=t[r];if(i.life+=e,i.life>=i.maxLife)continue;let a=Math.max(0,1-i.drag*e);i.vx*=a,i.vz*=a,i.vy=i.vy*a+i.gravity*e,i.x+=i.vx*e,i.y+=i.vy*e,i.z+=i.vz*e,i.y<.03&&i.vy<0&&(i.y=.03,i.vy*=-.35),t[n++]=i}t.length=n;for(let e=0;e<this.max;e++)if(e<t.length){let n=t[e],r=1-n.life/n.maxLife;this._positions[e*3]=n.x,this._positions[e*3+1]=n.y,this._positions[e*3+2]=n.z,this._colors[e*3]=n.color.r,this._colors[e*3+1]=n.color.g,this._colors[e*3+2]=n.color.b,this._alphas[e]=r,this._sizes[e]=n.size}else this._alphas[e]=0;this._geometry.attributes.position.needsUpdate=!0,this._geometry.attributes.aColor.needsUpdate=!0,this._geometry.attributes.aAlpha.needsUpdate=!0,this._geometry.attributes.aSize.needsUpdate=!0}dispose(){this._geometry.dispose(),this._material.dispose()}},um=3,dm=44,fm=.17,pm=.26,mm=.55,hm=.45,gm=1.3,_m=.9,vm=24,ym=class{constructor(e){this.group=new G,e.add(this.group),this.material=Ip({colorDeep:`#3e737a`,colorIce:`#8adaff`,colorRim:`#f2feff`,colorCore:`#638797`}),this.meshes=[],this.seedAttrs=[],this.birthAttrs=[];for(let e=0;e<um;e++){let t=Op({seed:7.3+e*21.7,sides:6,taper:.16,roughness:.24,bend:.3}),n=new Li(new Float32Array(dm),1),r=new Li(new Float32Array(dm),1).setUsage(Ze);t.setAttribute(`aSeed`,n),t.setAttribute(`aBirth`,r);let i=new Gi(t,this.material,dm);i.instanceMatrix.setUsage(Ze),i.count=0,i.frustumCulled=!1,i.visible=!1,this.group.add(i),this.meshes.push(i),this.seedAttrs.push(n),this.birthAttrs.push(r)}this._dummy=new jn,this._up=new V(0,1,0),this._lean=new V,this._axis=new V,this._tilt=new It,this._spin=new It}_halfWidth(e){return bp(.55,2.6,yp(e)**.75)}layout(e,t,n,r){let i=e.distanceTo(t),a=[];for(let t=0;t<103;t++){let o=((t+Math.random())/103)**.85,s=Sp(-1,1),c=Math.sign(s)*Math.abs(s)**1.35,l=(c+Sp(-1,1)*.3)*this._halfWidth(o),u=e.x+n.x*i*o+r.x*l,d=e.z+n.z*i*o+r.z*l,f=bp(.55,3,o**1.4);f*=1+.45*yp((o-.72)/.28),f*=1-.55*yp(Math.abs(c))**1.4,f*=1+Sp(-.3,.3),Math.random()<.35&&(f*=.32);let p=c,m=n.x*.75+r.x*p*.85,h=n.z*.75+r.z*p*.85,g=.42*(.35+.65*o)*(1+Sp(-.5,.5));a.push({x:u,z:d,along:o,yaw:Math.random()*Math.PI*2,height:f,radius:.3+Math.random()*.28,leanX:m,leanZ:h,lean:g,stagger:Math.random()*.09,eruptTime:-1,variant:t%um,slot:t/um|0,seed:Math.random()})}for(let e=0;e<29;e++){let n=Math.random()*Math.PI*2,r=Math.sqrt(Math.random()),i=this._halfWidth(1)*1.3*r;a.push({x:t.x+Math.cos(n)*i,z:t.z+Math.sin(n)*i,along:1,yaw:Math.random()*Math.PI*2,height:2.1+Math.random()*1.2,radius:.34+Math.random()*.3,leanX:Math.cos(n),leanZ:Math.sin(n),lean:.3+Math.random()*.25,stagger:Math.random()*.12,eruptTime:-1,variant:(103+e)%um,slot:(103+e)/um|0,seed:Math.random()})}for(let e of a)this.seedAttrs[e.variant].array[e.slot]=e.seed;for(let e=0;e<um;e++)this.seedAttrs[e].needsUpdate=!0,this.meshes[e].count=dm,this.meshes[e].visible=!0;return a}triggerUpTo(e,t,n,r){for(let i of e)i.eruptTime>=0||i.along>n||i.along>=1&&!r||(i.eruptTime=t+i.stagger)}_emergence(e,t){if(e.eruptTime<0)return-1;let n=t-e.eruptTime;if(n<0)return-1;let r=wp.outQuint(yp(n/fm));if(n<=fm)return r;let i=n-fm;return 1+pm*(Math.sin(i*14)*Math.exp(-i/mm))}update(e,t,n){let r=[0,0,0];for(let n of e){let e=this._emergence(n,t),i=this.meshes[n.variant],a=n.slot;if(r[n.variant]=Math.max(r[n.variant],a+1),e<0){this._dummy.position.set(0,-999,0),this._dummy.scale.setScalar(1e-4),this._dummy.rotation.set(0,0,0),this._dummy.updateMatrix(),i.setMatrixAt(a,this._dummy.matrix),this.birthAttrs[n.variant].array[a]=0;continue}this._lean.set(n.leanX,0,n.leanZ).normalize(),this._axis.crossVectors(this._up,this._lean).normalize(),this._tilt.setFromAxisAngle(this._axis,n.lean),this._spin.setFromAxisAngle(this._up,n.yaw),this._tilt.multiply(this._spin),this._dummy.position.set(n.x,(Math.min(e,1.3)-1)*n.height*.85,n.z),this._dummy.quaternion.copy(this._tilt);let o=Math.min(1,e);this._dummy.scale.set(n.radius,Math.max(.02,o*n.height),n.radius),this._dummy.updateMatrix(),i.setMatrixAt(a,this._dummy.matrix);let s=t-n.eruptTime;this.birthAttrs[n.variant].array[a]=yp(1-s/hm)}for(let e=0;e<um;e++)this.meshes[e].count=r[e],this.meshes[e].instanceMatrix.needsUpdate=!0,this.birthAttrs[e].needsUpdate=!0;if(n>0){let e=wp.inCubic(n);this.group.position.y=-e*4.2}else this.group.position.y=0}hide(){for(let e=0;e<um;e++)this.meshes[e].count=0,this.meshes[e].visible=!1;this.group.position.y=0}dispose(){for(let e of this.meshes)e.geometry.dispose();this.material.dispose(),this.group.parent?.remove(this.group)}},bm=14,xm=class{constructor(e){this.group=new G,e.add(this.group),this.material=Lp();let t=Mp({seed:11.7,detail:3,lumpiness:.26,noiseScale:1.5,roughness:.16,cuts:9,cutDepth:.28,craters:5,craterDepth:.18,craterSize:.5}),n=new Li(new Float32Array([3.7]),1);this._rockHeat=new Li(new Float32Array([0]),1).setUsage(Ze),t.setAttribute(`aSeed`,n),t.setAttribute(`aHeat`,this._rockHeat),this.rock=new Gi(t,this.material,1),this.rock.instanceMatrix.setUsage(Ze),this.rock.frustumCulled=!1,this.rock.visible=!1,this.group.add(this.rock);let r=Mp({seed:47.3,detail:1,lumpiness:.4,noiseScale:1.8,roughness:.3,cuts:5,cutDepth:.32,craters:2,craterDepth:.2,craterSize:.5}),i=new Li(new Float32Array(bm),1);for(let e=0;e<bm;e++)i.array[e]=Math.random()*40;this._chunkHeat=new Li(new Float32Array(bm),1).setUsage(Ze),r.setAttribute(`aSeed`,i),r.setAttribute(`aHeat`,this._chunkHeat),this.chunks=new Gi(r,this.material,bm),this.chunks.instanceMatrix.setUsage(Ze),this.chunks.frustumCulled=!1,this.chunks.visible=!1,this.group.add(this.chunks),this._dummy=new jn,this._quat=new It,this._chunkList=[],this._rockScale=1.35}launch(e){this._dummy.position.copy(e),this._dummy.quaternion.identity(),this._dummy.scale.setScalar(this._rockScale),this._dummy.updateMatrix(),this.rock.setMatrixAt(0,this._dummy.matrix),this.rock.instanceMatrix.needsUpdate=!0,this.rock.visible=!0,this._rockHeat.array[0]=1,this._rockHeat.needsUpdate=!0,this.rock.material.userData.sync(0,null)}tickRock(e,t,n,r,i){this._dummy.position.copy(e),this._dummy.rotation.set(t,0,n),this._dummy.scale.setScalar(this._rockScale),this._dummy.updateMatrix(),this.rock.setMatrixAt(0,this._dummy.matrix),this.rock.instanceMatrix.needsUpdate=!0,this._rockHeat.array[0]=1,this._rockHeat.needsUpdate=!0,this.rock.material.userData.sync(r,i)}hideRock(){this.rock.visible=!1}burstChunks(e,t=Math.random){this._chunkList.length=0;for(let n=0;n<bm;n++){let r=t()*Math.PI*2;this._chunkList.push({x:e.x,y:.5,z:e.z,vx:Math.cos(r)*(2+t()*5),vy:4+t()*7,vz:Math.sin(r)*(2+t()*5),rx:t()*Math.PI*2,rz:t()*Math.PI*2,wx:(t()-.5)*12,wz:(t()-.5)*12,scale:.16+t()*.22,heat:1}),this._chunkHeat.array[n]=1}this.chunks.visible=!0}tickChunks(e){if(!this.chunks.visible)return;let t=!1;for(let n=0;n<this._chunkList.length;n++){let r=this._chunkList[n];if(r.heat=Math.max(0,r.heat-e*.75),this._chunkHeat.array[n]=r.heat,r.heat<=0){this._dummy.position.set(0,-999,0),this._dummy.scale.setScalar(1e-4),this._dummy.rotation.set(0,0,0),this._dummy.updateMatrix(),this.chunks.setMatrixAt(n,this._dummy.matrix);continue}t=!0,r.vy-=17*e,r.x+=r.vx*e,r.y+=r.vy*e,r.z+=r.vz*e,r.y<.12&&r.vy<0&&(r.y=.12,r.vy*=-.38,r.vx*=.72,r.vz*=.72),r.rx+=r.wx*e,r.rz+=r.wz*e,this._dummy.position.set(r.x,r.y,r.z),this._dummy.rotation.set(r.rx,0,r.rz),this._dummy.scale.setScalar(r.scale),this._dummy.updateMatrix(),this.chunks.setMatrixAt(n,this._dummy.matrix)}this.chunks.instanceMatrix.needsUpdate=!0,this._chunkHeat.needsUpdate=!0,t||(this.chunks.visible=!1)}reset(){this.rock.visible=!1,this.chunks.visible=!1,this._chunkList.length=0,this._rockHeat.array[0]=0}dispose(){this.rock.geometry.dispose(),this.chunks.geometry.dispose(),this.material.dispose(),this.group.parent?.remove(this.group)}},Sm=class{constructor(e,t){this.scene=e,this.vfx=t,this.bursts=new lm(e),this._crystals=new ym(e),this._crystalState=null,this._meteor=new xm(e),this._meteorLight=new es(`#ff8a3c`,0,26,2),e.add(this._meteorLight),this._boltConfig=zp({sag:0,strands:14,spread:1.15,spreadNear:.03,spreadCurve:1.5,jitter:.58,jitterScale:.72,width:.042,widthTip:.5,coreWidth:1.55,coreSharp:4.4,glowWidth:8.5,glowOpacity:.6,glowFalloff:2.2,restrike:18,flicker:.35,strandFlash:.55,glow:2.8,colorCore:`#ffffff`,colorInner:`#e9dfff`,colorOuter:`#a98bff`,colorHalo:`#5a2bd6`}),this._boltGeometry=Np(72,14),this._boltGroup=new G,this._boltGroup.visible=!1,e.add(this._boltGroup),this._boltMaterials=[];for(let e of[Rp.GLOW,Rp.CORE]){let t=Hp(e,this._boltConfig),n=new Y(this._boltGeometry,t);n.frustumCulled=!1,n.matrixAutoUpdate=!1,n.renderOrder=11+e*2,this._boltGroup.add(n),this._boltMaterials.push(t)}this._boltState={origin:new V,target:new V,side:new V(1,0,0),progress:0,fade:1,seed:0,strands:14},this._boltLight=new es(`#c9b8ff`,0,30,2),e.add(this._boltLight),this._balls=[];let n=document.createElement(`canvas`);n.width=n.height=64;let r=n.getContext(`2d`),i=r.createRadialGradient(32,32,2,32,32,30);i.addColorStop(0,`rgba(255,255,255,1)`),i.addColorStop(.4,`rgba(255,255,255,0.32)`),i.addColorStop(1,`rgba(255,255,255,0)`),r.fillStyle=i,r.fillRect(0,0,64,64),this._ballHaloTexture=new Sa(n);for(let t=0;t<8;t++){let t=new G,n=new Qa({color:`#ffffff`,emissive:`#9fd8ff`,emissiveIntensity:2.6,roughness:.4,metalness:.2,toneMapped:!1}),r=cm(n),i=new Qr(new Rr({map:this._ballHaloTexture,color:`#9fd8ff`,transparent:!0,opacity:.85,blending:2,depthWrite:!1}));i.scale.setScalar(1.5),i.renderOrder=20,t.add(r,i),t.visible=!1,e.add(t),this._balls.push({group:t,arrow:r,arrowMaterial:n,halo:i,busy:!1})}this._active=[],this._scratchDir=new V,this._scratchUp=new V(0,1,0)}cast(e,t,n,r){e===`ice`?this._castIce(t,n,r):e===`fire`?this._castFire(t,n,r):e===`storm`&&this._castStorm(n,r),$.spellCast(e)}castBasic(e,t,n,r,i){let a=this._balls.find(e=>!e.busy)??this._balls[0];a.busy=!0,a.group.visible=!0,a.group.position.copy(e),a.group.lookAt(t),a.arrowMaterial.emissive.set(n),a.arrowMaterial.color.set(`#ffffff`).lerp(new K(n),.45),a.halo.material.color.set(n),this._active.push({type:`basic`,t:0,duration:Math.max(.12,e.distanceTo(t)/26),start:e.clone(),point:t.clone(),color:n,fired:!1,hitSet:new Set,onMove:r,onImpact:i,slot:a})}_tickBasic(e,t){e.t+=t;let n=Math.min(1,e.t/e.duration);e.slot.group.position.lerpVectors(e.start,e.point,n),e.onMove?.(e.slot.group.position,e.hitSet);let r=this._elementFromColor(e.color),i=sm[r]??sm.ice,a=this.vfx;a.sparks.setGradient(`#ffffff`,i.inner,i.outer,i.outer),a.sparks.uniforms.uGravity.value.set(0,-1.5,0),a.sparks.uniforms.uSizeScale.value=.55,a.sparks.uniforms.uLifeScale.value=.32,a.sparks.uniforms.uGlow.value=1.5;let o=a._emit;return o.position=e.slot.group.position,o.radius=.1,o.direction=null,o.speed=1.2,o.speedVariance=.8,o.spread=1,o.size=.14,o.sizeVariance=.7,o.life=.3,o.lifeVariance=.5,o.spin=0,o.tint=null,o.time=pp.uTime.value,a.sparks.emit(3,o),e.slot.arrow.rotation.z+=t*22,e.slot.halo.material.opacity=.75+.25*Math.sin(e.t*34),n>=1&&!e.fired&&(e.fired=!0,e.slot.group.visible=!1,e.slot.busy=!1,this.vfx.bursts.spawn(Qp.AIR,e.point,{radius:.12,endRadius:1.9,life:.38,intensity:1,opacity:.9,fresnel:2,displace:.3,colorA:e.color,colorB:`#ffffff`,colorC:`#d3f4ff`}),this.vfx.decals.spawn(nm.SHOCKWAVE,e.point,{radius:2.1,life:.42,width:.06,intensity:.9,colorA:e.color,colorB:`#ffffff`}),this.vfx.sparkBurst(e.point,r,{count:26,speed:5.5,life:.6,size:.9,up:1.2}),this._flash(e.point,e.color,110),e.onImpact(e.point,1.8,e.hitSet)),e.fired&&e.t>e.duration+.15}_elementFromColor(e){return e.startsWith(`#56d8`)?`ice`:e.startsWith(`#ff8a`)?`fire`:e.startsWith(`#a98b`)?`storm`:`basic`}_castIce(e,t,n){this._crystalState&&=(this._crystals.hide(),null);let r=this._scratchDir.set(t.x-e.x,0,t.z-e.z),i=Math.max(3,r.length());r.divideScalar(Math.max(1e-4,r.length()));let a=new V(-r.z,0,r.x),o=this._crystals.layout(e,t,r,a);this._crystalState={age:0,started:!1,fired:!1,retract:0,front:0,len:i,dir:r.clone(),side:a.clone(),start:e.clone(),point:t.clone(),records:o,frostDist:1.2,frostAccum:0,onImpact:n},this._active.push({type:`ice`})}_tickIce(e,t){let n=this._crystalState;n.age+=t;let r=n.len/vm;n.started||(n.started=!0,this.vfx.bursts.spawn(Qp.FROST,n.start.clone().setY(.5),{radius:.18,endRadius:2.2,life:.45,intensity:.85,opacity:.9,fresnel:1.4,displace:.4,colorA:`#a9e4ff`,colorB:`#cdefff`,colorC:`#f2feff`}),this.vfx.decals.spawn(nm.FROST,n.start,{radius:2.2,life:5.5,intensity:.7,width:1.5,colorA:`#ffffff`,colorB:`#6aa5d4`,height:.045}),this.vfx.sparkBurst(n.start,`ice`,{count:30,speed:5,life:.6,size:.9,up:1.2}),this._flash(n.start,`#8fd8ff`,90)),n.fired||(n.front+=vm*t);let i=yp(n.front/n.len);for(this._crystals.triggerUpTo(n.records,n.age,i,n.fired),n.frostAccum+=vm*t;!n.fired&&n.frostAccum>=2.4&&n.frostDist<n.len-.5;){n.frostAccum-=2.4;let e=n.start.x+n.dir.x*n.frostDist+n.side.x*Sp(-1,1),t=n.start.z+n.dir.z*n.frostDist+n.side.z*Sp(-1,1);this.vfx.decals.spawn(nm.FROST,{x:e,z:t},{radius:2,life:5,intensity:.65,width:1.5,colorA:`#ffffff`,colorB:`#6aa5d4`,height:.045}),n.frostDist+=2.4}if(!n.fired&&i>=1&&(n.fired=!0,this.vfx.bursts.spawn(Qp.FROST,n.point.clone().setY(.6),{radius:.3,endRadius:4.4,life:.6,intensity:.95,opacity:.95,fresnel:1.3,displace:.45,colorA:`#a9e4ff`,colorB:`#cdefff`,colorC:`#f2feff`}),this.vfx.decals.spawn(nm.SHOCKWAVE,n.point,{radius:5.4,life:.55,width:.05,intensity:.95,colorA:`#5fd0ff`,colorB:`#f2feff`}),this.vfx.decals.spawn(nm.FROST,n.point,{radius:5,life:7,intensity:.95,width:1.5,colorA:`#ffffff`,colorB:`#6aa5d4`,height:.05}),this.vfx.sparkBurst(n.point,`ice`,{count:90,speed:8,life:.9,size:1.1,up:1.4}),this._flash(n.point,`#8fd8ff`,160),n.onImpact(n.point,4.6)),n.age>r+gm+.3&&(n.retract=Math.min(1,n.retract+t/_m)),this._crystals.update(n.records,n.age,n.retract),!n.retract){this.vfx.motes.setGradient(`#f2feff`,`#a9e4ff`,`#57c9ff`,`#0a3552`),this.vfx.motes.uniforms.uGravity.value.set(0,1.6,0),this.vfx.motes.uniforms.uSizeScale.value=.7,this.vfx.motes.uniforms.uLifeScale.value=1.4,this.vfx.motes.uniforms.uTurbulence.value=.5,this.vfx.motes.uniforms.uGlow.value=1.2;let e=this.vfx._emit,t=Math.min(n.front,n.len)*(.75+Math.random()*.25);e.position=this._scratchUp.set(n.start.x+n.dir.x*t+n.side.x*Sp(-1.5,1.5),.2,n.start.z+n.dir.z*t+n.side.z*Sp(-1.5,1.5)),e.radius=1,e.direction=null,e.speed=2.4,e.speedVariance=.8,e.spread=.7,e.size=.1,e.sizeVariance=.6,e.life=1.6,e.lifeVariance=.5,e.spin=0,e.tint=null,e.time=pp.uTime.value,this.vfx.motes.emit(2,e)}return n.retract>=1&&(this._crystals.hide(),this._crystalState=null,!0)}_castFire(e,t,n){let r=this._scratchDir.set(t.x-e.x,0,t.z-e.z).normalize(),i=t.clone().addScaledVector(r,-9).add(new V(0,17,0));this._meteor.launch(i),this._meteorLight.position.copy(i),this._meteorLight.intensity=130,this._active.push({type:`fire`,t:0,duration:.62,start:i,point:t.clone(),fired:!1,onImpact:n})}_tickFire(e,t){e.t+=t;let n=Math.min(1,e.t/e.duration),r=n*n,i=e.start.clone().lerp(e.point,r),a=yp(e.t/e.duration),o=e.point.clone().sub(e.start).normalize();this._meteor.tickRock(i,e.t*7,e.t*5,a,o),this._meteorLight.position.copy(i),this._meteorLight.intensity=130,this.vfx.motes.setGradient(`#fff3d0`,`#ff9a2e`,`#ff3b0d`,`#2b0d05`),this.vfx.motes.uniforms.uGravity.value.set(0,1.5,0),this.vfx.motes.uniforms.uSizeScale.value=1,this.vfx.motes.uniforms.uLifeScale.value=.8,this.vfx.motes.uniforms.uTurbulence.value=.5,this.vfx.motes.uniforms.uGlow.value=1.4;let s=this.vfx._emit;return s.position=i,s.radius=.7,s.direction=null,s.speed=2.4,s.speedVariance=.8,s.spread=.9,s.size=.28,s.sizeVariance=.6,s.life=.7,s.lifeVariance=.5,s.spin=0,s.tint=null,s.time=pp.uTime.value,this.vfx.motes.emit(5,s),this.vfx.sparkBurst(i,`fire`,{count:2,speed:3,life:.4,size:.8,up:.4,radius:.5}),n>=1&&!e.fired&&(e.fired=!0,this._meteor.hideRock(),this._meteor.burstChunks(e.point),this._meteorLight.intensity=260,this.vfx.bursts.spawn(Qp.FIRE,e.point.clone().setY(.8),{radius:.5,endRadius:5.6,life:.7,intensity:1.2,opacity:.95,fresnel:1,displace:.55,turbulence:1.4,colorA:`#ffd27a`,colorB:`#ff6a12`,colorC:`#fff3d0`}),this.vfx.decals.spawn(nm.SHOCKWAVE,e.point,{radius:6,life:.6,width:.05,intensity:1,colorA:`#ff9a2e`,colorB:`#fff3d0`}),this.vfx.decals.spawn(nm.CRACK,e.point,{radius:5.2,life:5.5,width:.14,intensity:1.35,colorA:`#0e0703`,colorB:`#ff6a12`,height:.045}),this.vfx.decals.spawn(nm.SCORCH,e.point,{radius:3.2,life:8,intensity:1,colorA:`#070504`,colorB:`#ff9a2e`,height:.04}),this.vfx.decals.spawn(nm.DUSTRING,e.point,{radius:4.4,life:1.1,intensity:.7,colorA:`#26201b`,colorB:`#ffb066`,height:.05}),this.vfx.sparkBurst(e.point,`fire`,{count:150,speed:11,life:1.1,size:1.2,up:1.2}),this._flash(e.point,`#ffb066`,220),e.onImpact(e.point,5.4)),e.fired&&(this._meteor.tickChunks(t),this._meteorLight.intensity*=Math.max(0,1-t*5),e.t>e.duration+2.4)?(this._meteorLight.intensity=0,!0):!1}_castStorm(e,t){this._active.push({type:`storm`,t:0,point:e.clone(),fired:!1,seed:Math.random()*100,onImpact:t})}_tickStorm(e,t){if(e.t+=t,!e.fired&&e.t>=.15){e.fired=!0,this._boltState.origin.set(e.point.x+(Math.random()-.5)*2.5,22,e.point.z+(Math.random()-.5)*2.5),this._boltState.target.set(e.point.x,.05,e.point.z),this._boltState.seed=e.seed,this._boltGroup.visible=!0,this._boltLight.position.set(e.point.x,6,e.point.z),this.vfx.bursts.spawn(Qp.STORM,e.point.clone().setY(.7),{radius:.25,endRadius:3.4,life:.6,intensity:1.2,opacity:.95,fresnel:1.6,displace:.5,colorA:`#a98bff`,colorB:`#d3f4ff`,colorC:`#ffffff`}),this.vfx.decals.spawn(nm.SHOCKWAVE,e.point,{radius:5.6,life:.55,width:.05,intensity:1,colorA:`#c9ecff`,colorB:`#ffffff`}),this.vfx.decals.spawn(nm.ARC,e.point,{radius:3.6,life:.95,width:.6,intensity:1.25,colorA:`#090407`,colorB:`#c9a6ff`,height:.045});for(let t=0;t<4;t++){let t=Math.random()*Math.PI*2,n=1.6+Math.random()*2.6;this.vfx.decals.spawn(nm.ARC,{x:e.point.x+Math.cos(t)*n,z:e.point.z+Math.sin(t)*n},{radius:1.3+Math.random()*1.1,life:.8,width:.55,intensity:1,colorA:`#090407`,colorB:`#9fdcff`,height:.04})}this.vfx.decals.spawn(nm.SCORCH,e.point,{radius:1.6,life:6,intensity:.62,colorA:`#04060b`,colorB:`#8f6bff`,height:.04}),this.vfx.sparkBurst(e.point,`storm`,{count:120,speed:10,life:.8,size:1.1,up:1}),this._flash(e.point,`#c9b8ff`,260),e.onImpact(e.point,5)}if(e.fired){let t=e.t-.15;this._boltState.progress=Math.min(1,t/.08),this._boltState.fade=t<.45?1:Math.max(0,1-(t-.45)/.17);for(let e of this._boltMaterials)e.userData.sync(this._boltState);if(this._boltLight.intensity=Math.max(0,260*(1-t/.5)),this._boltLight.position.y=4,t>.62)return this._boltGroup.visible=!1,this._boltLight.intensity=0,!0}return!1}_flash(e,t,n){this._light||(this._light=new es(t,0,30,2),this.scene.add(this._light)),this._light.color.set(t),this._light.position.set(e.x,2.6,e.z),this._light.intensity=n,this._flashT=.22,this._flashIntensity=n}reset(){this._active.length=0,this._crystals.hide(),this._crystalState=null,this._meteor.reset(),this._meteorLight.intensity=0,this._boltGroup.visible=!1,this._boltLight.intensity=0,this._light&&(this._light.intensity=0),this._flashT=0;for(let e of this._balls)e.group.visible=!1,e.busy=!1;this.bursts.clear(),this.vfx?.clear()}update(e){for(let t=this._active.length-1;t>=0;t--){let n=this._active[t];(n.type===`ice`?this._tickIce(n,e):n.type===`fire`?this._tickFire(n,e):n.type===`basic`?this._tickBasic(n,e):this._tickStorm(n,e))&&this._active.splice(t,1)}this._flashT>0&&(this._flashT-=e,this._light.intensity=Math.max(0,this._flashT/.22*this._flashIntensity)),this.bursts.update(e)}dispose(){this.bursts.dispose(),this._crystals.dispose(),this._meteor.dispose();for(let e of this._boltMaterials)e.dispose();this._boltGeometry.dispose();for(let e of this._balls)e.group.traverse(e=>e.geometry?.dispose?.()),e.orb.material.dispose(),e.halo.material.dispose();this._ballHaloTexture.dispose()}},Cm=Object.freeze({CORE:0,SHELL:1,HALO:2,COIL:3,RING:4});function wm(e={}){return{radius:.77,radiusNear:.16,radiusCurve:1.27,flare:1.74,flareWidth:.09,throb:0,throbScale:4.8,throbSpeed:2.6,wander:0,wanderScale:.9,wanderSpeed:.7,ripple:.2,rippleBands:2.2,rippleScale:4.25,rippleSpeed:2,streak:1.1,streakSharp:.45,streakScale:4.2,streakBands:1.8,streakGlow:.55,flowSpeed:7,coreWidth:.2,coreSharp:1.55,coreFill:.6,shellWidth:1,shellRim:1.15,shellFill:.18,shellOpacity:.95,haloWidth:2.75,haloRim:4.3,haloOpacity:.14,edgePower:2.2,mouthGlow:1.6,mouthLength:.1,tipGlow:.6,tipLength:.09,coils:4,coilTurns:1.45,coilSpeed:-.69,coilRadius:1.88,coilFlare:.57,coilWidth:.1,coilWidthTip:1.9,coilSharp:2.2,coilPulse:.65,coilPulseFreq:3,coilPulseSpeed:1.6,coilGlow:8,coilOpacity:2,rings:10,ringSpeed:1.31,ringInner:2.42,ringOuter:2.73,ringSwell:.55,ringFade:.18,ringSharp:1.6,ringGlow:2.4,ringOpacity:.7,glow:.74,opacity:.29,colorCore:`#ffffff`,colorInner:`#d3f4ff`,colorOuter:`#3ec6ff`,colorHalo:`#0d3ce0`,colorCoil:`#ffdc8c`,colorCoilEdge:`#ff6a12`,colorRing:`#9ceeff`,...e}}var Tm=`
  #define PI  3.141592653589793
  #define TAU 6.283185307179586
...
`;function Mm(e={}){let t=new Xa({transparent:!0,depthWrite:!1,depthTest:!0,blending:2,side:0,toneMapped:!1,uniforms:mp({uSeed:{value:e.seed??Math.random()*10},uOrbTurbulence:{value:e.turbulence??.22},uOrbScale:{value:e.scale??2.2},uOrbFlow:{value:e.flow??.9},uOrbBands:{value:e.bands??5},uOrbRim:{value:e.rim??1.8},uCharge:{value:1},uOpacity:{value:e.opacity??1},uGlow:{value:e.glow??2.8},uColorCore:{value:new K(e.core??`#ffffff`)},uColorInner:{value:new K(e.inner??`#d3f4ff`)},uColorOuter:{value:new K(e.outer??`#3ec6ff`)}}),vertexShader:Am,fragmentShader:jm});return t.userData.setPalette=({core:e,inner:n,outer:r,glow:i})=>{e&&t.uniforms.uColorCore.value.set(e),n&&t.uniforms.uColorInner.value.set(n),r&&t.uniforms.uColorOuter.value.set(r),i!==void 0&&(t.uniforms.uGlow.value=i)},t}function Nm(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(32,32,2,32,32,30);return n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.35,`rgba(255,255,255,0.55)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),new Sa(e)}var Pm=class{constructor(e,t,n,r){this.max=t,this.list=[],this._pos=new Float32Array(t*3),this._col=new Float32Array(t*3),this._alpha=new Float32Array(t);let i=new Mr;i.setAttribute(`position`,new q(this._pos,3)),i.setAttribute(`aColor`,new q(this._col,3)),i.setAttribute(`aAlpha`,new q(this._alpha,1));let a=new Xa({transparent:!0,depthWrite:!1,blending:r?2:1,uniforms:{uMap:{value:n},uProjScale:{value:800}},vertexShader:`
      ...
      `});this._size=new Float32Array(t),i.setAttribute(`aSize`,new q(this._size,1)),this.points=new ya(i,a),this.points.frustumCulled=!1,this.points.renderOrder=12,e.add(this.points),this.geometry=i}setPixelRatio(e){this.points.material.uniforms.uProjScale.value=window.innerHeight*e*1.123}push(e){this.list.length>=this.max&&this.list.shift(),this.list.push(e)}update(e,t){for(let n=this.list.length-1;n>=0;n--){let r=this.list[n];if(r.life-=e,r.life<=0){this.list.splice(n,1);continue}r.x+=r.vx*e,r.y+=r.vy*e,r.z+=r.vz*e,r.sway&&(r.x+=Math.sin(t*9+r.phase)*.35*e)}for(let e=0;e<this.max;e++)if(e<this.list.length){let t=this.list[e],n=1-t.life/t.maxLife;this._pos[e*3]=t.x,this._pos[e*3+1]=t.y,this._pos[e*3+2]=t.z;let r,i,a;if(n<.35){let e=n/.35;r=t.r0+(t.r1-t.r0)*e,i=t.g0+(t.g1-t.g0)*e,a=t.b0+(t.b1-t.b0)*e}else{let e=(n-.35)/.65;r=t.r1+(t.r2-t.r1)*e,i=t.g1+(t.g2-t.g1)*e,a=t.b1+(t.b2-t.b1)*e}this._col[e*3]=r,this._col[e*3+1]=i,this._col[e*3+2]=a,this._size[e]=t.size0+(t.size1-t.size0)*n,this._alpha[e]=t.alpha*Math.min(1,n*6)*(1-n)**1.1}else this._alpha[e]=0,this._size[e]=0;this.geometry.setDrawRange(0,this.list.length),this.geometry.attributes.position.needsUpdate=!0,this.geometry.attributes.aColor.needsUpdate=!0,this.geometry.attributes.aAlpha.needsUpdate=!0,this.geometry.attributes.aSize.needsUpdate=!0}};function Fm(e,t,n,r,i,a={}){e.list.length>=e.max&&e.list.shift();let o=.55;e.list.push({x:t,y:n,z:r,vx:(Math.random()-.5)*.9,vy:1.3+Math.random()*1.1,vz:(Math.random()-.5)*.9,life:.7+Math.random()*.6,maxLife:1.3,size0:1.9,size1:.55,alpha:.8,phase:Math.random()*Math.PI*2,sway:!0,r0:i.r+(1-i.r)*o,g0:i.g+(1-i.g)*o,b0:i.b+(1-i.b)*o,r1:i.r,g1:i.g,b1:i.b,r2:i.r*.32,g2:i.g*.3,b2:i.b*.38,...a})}var Im=12,Lm=40,Rm=7.2,zm=1.5,Bm=25,Vm=1,Hm=.35,Um=4,Wm=1.8,Gm=50,Km={ice:`#2f7dff`},qm=20,Jm=0,Ym=5.5,Xm=.82,Zm=1.35;function Qm(){return Vm+Math.random()*9}var $m=class{constructor(e,t,n){this.scene=e,this.bursts=t,this.vfx=n,this.onCollect=null,this._laserTubeGeo=Pp(48,18),this._laserOrbGeo=new Ia(1,3);let r=document.createElement(`canvas`);r.width=r.height=64;let i=r.getContext(`2d`),a=i.createRadialGradient(32,32,2,32,32,30);a.addColorStop(0,`rgba(255,255,255,1)`),a.addColorStop(.35,`rgba(255,255,255,0.45)`),a.addColorStop(1,`rgba(255,255,255,0)`),i.fillStyle=a,i.fillRect(0,0,64,64);let o=new Sa(r);this._group=new G,e.add(this._group),this._bodyMaterial=new Qa({color:`#dceaff`,emissive:`#8fc6ef`,emissiveIntensity:2.2,roughness:.35,fog:!1}),this._haloMaterial=new Rr({map:o,color:`#9cc3e8`,transparent:!0,opacity:.6,blending:2,depthWrite:!1,fog:!1}),this._bandMaterial=new Qa({color:`#232833`,roughness:.55,metalness:.75}),this.spirits=[];for(let e=0;e<Im;e++){let t=new G,n=new Y(new La(.3,0),this._bodyMaterial);n.scale.set(.82,1.7,.82);let r=new Y(new Va(.46,.045,6,24),this._bandMaterial);r.rotation.set(Math.random()*1.2+.5,0,Math.random()*Math.PI);let i=new Y(new Va(.3,.04,6,20),this._bandMaterial);i.rotation.set(-(Math.random()*1.2+.5),Math.random()*Math.PI,Math.random()*Math.PI);let a=new Qr(this._haloMaterial);a.scale.setScalar(2.2),t.add(n,r,i,a),this._group.add(t),this.spirits.push({group:t,core:n,band:r,band2:i,halo:a,alive:!1,respawn:0,pos:new V,wander:new V,phase:Math.random()*Math.PI*2,baseY:1.1+Math.random()*.8,chasing:!1}),this._place(this.spirits[e])}for(let e of this.spirits)e.group.visible=!1;this._accent=new K(`#9fd8ff`),this.onPlayerHit=null,this._frozen=!1,this._normalTarget=3,this._specialTarget=1,this.laserTier=1,this.specials=[],this._specialTimer=Qm(),this.onSpecialSpawn=null,this.active=!1,this._pendingStart=!1,this._startCountdown=0,this._spawnNormalCount=5;let s=new Va(.82,.055,8,42),c=new ka(.1,.34,5);for(let e=0;e<6;e++){let e=new G,t=new Y(s,new ci({color:`#9fd8ff`,transparent:!0,opacity:.85,fog:!1}));t.rotation.x=1.35;for(let e=0;e<3;e++){let n=new Y(c,this._bandMaterial),r=e/3*Math.PI*2;n.position.set(Math.cos(r)*.82,0,Math.sin(r)*.82),n.rotation.z=Math.PI,n.rotation.y=-r,t.add(n)}let n=new Qr(new Rr({map:o,color:`#9fd8ff`,transparent:!0,opacity:.85,blending:2,depthWrite:!1}));n.scale.setScalar(3.4),e.add(t,n),e.visible=!1,this._group.add(e);let r=wm({radius:.16,radiusNear:.06,radiusCurve:1,flare:0,flareWidth:.05,coreWidth:.3,shellWidth:1,haloWidth:2.6,shellOpacity:1.4,haloOpacity:.4,opacity:1.8,glow:1.8,ripple:.3,streak:1,flowSpeed:9,tipGlow:1.6,mouthGlow:.8,wander:.05}),i=[],a=[];for(let e of[Cm.HALO,Cm.SHELL,Cm.CORE]){let t=km(e,r),n=new Y(this._laserTubeGeo,t);n.frustumCulled=!1,n.matrixAutoUpdate=!1,n.renderOrder=11+(Cm.CORE-e),n.visible=!1,this._group.add(n),i.push(n),a.push(t)}let l=new Y(this._laserOrbGeo,Mm({inner:`#d3f4ff`,outer:`#9fd8ff`,glow:2.6}));l.visible=!1,l.renderOrder=9,this._group.add(l);let u={group:e,ring:t,halo:n,models:null,alive:!1,element:`ice`,pos:new V,baseY:1.4,phase:Math.random()*Math.PI*2,flash:0,basicHits:0,wander:new V,laserMeshes:i,laserMaterials:a,laserConfig:r,laserOrb:l,laserState:{origin:new V,target:new V,side:new V(1,0,0),progress:0,fade:1,widthFade:1,seed:0,coils:0,rings:0},laser:{state:`idle`,t:0,cd:1.5+Math.random()*1.5,from:new V,dir:new V,len:0,hitDone:!1}};this.specials.push(u)}this._fx=new Pm(e,520,Nm(),!0),this._fxAcc=[,,,,,,].fill(0),this._modelsReady=!1,this._protos=null,this._loadModels()}_laserCd(){return Math.max(.45,2.2-(this.laserTier-5)*.35)*(.8+Math.random()*.4)}_hideLaser(e){for(let t of e.laserMeshes)t.visible=!1;e.laserOrb.visible=!1}_laserFrom(e,t){let n=this._modelStats?.[e.element]?.midY??.8;return t.set(e.pos.x,e.baseY+n,e.pos.z)}_tintLaser(e){let t=Km[e.element]??np[e.element].accent,n=e.laserConfig,r=new K(t);n.colorCore=`#ffffff`,n.colorInner=`#`+r.clone().lerp(new K(`#ffffff`),.55).getHexString(),n.colorOuter=t,n.colorHalo=`#`+r.clone().multiplyScalar(.28).getHexString(),e.laserOrb.material.userData.setPalette({inner:n.colorInner,outer:t})}_syncLaser(e,t,n,r,i,a,o){let s=e.laserState;s.origin.copy(t),s.target.copy(t).addScaledVector(n,r),s.progress=i,s.fade=a,s.widthFade=o;for(let t of e.laserMaterials)t.userData.sync(s)}_updateLaser(e,t,n){let r=e.laser;if(r.t+=t,this.laserTier<5||this._frozen||!n){r.state!==`idle`&&(r.state=`idle`,r.cd=this._laserCd(),this._hideLaser(e));return}switch(r.state){case`idle`:this._hideLaser(e),r.cd-=t,r.cd<=0&&(this._laserFrom(e,r.from),r.dir.set(n.x-r.from.x,1.15-r.from.y,n.z-r.from.z),r.len=r.dir.length(),r.dir.divideScalar(r.len),r.len>2.2?(r.state=`tele`,r.t=0,r.hitDone=!1,this._tintLaser(e),$.laserCharge()):r.cd=.5);break;case`tele`:{this._laserFrom(e,r.from);let t=Math.min(1,Math.max(0,r.t/1));this._syncLaser(e,r.from,r.dir,r.len+170,.055,.35+.45*Math.abs(Math.sin(r.t*12)),1);for(let t of e.laserMeshes)t.visible=!0;e.laserOrb.visible=!0,e.laserOrb.position.copy(r.from),e.laserOrb.scale.setScalar(.26+t*.34),e.laserOrb.material.uniforms.uCharge.value=t,r.t>=1&&(r.state=`fire`,r.t=0,e.laserOrb.visible=!1,this.vfx?.sparkBurst(r.from,e.element,{count:18,speed:5,life:.5,size:.9,up:.6,radius:.3}),$.laserFire());break}case`fire`:{let t=.22;this._laserFrom(e,r.from);let i=r.t/t;if(this._syncLaser(e,r.from,r.dir,r.len+170,1,1-i,1-.45*i),e.laserOrb.visible=i<.4,e.laserOrb.material.uniforms.uCharge.value=Math.max(0,1-i*2.5),!r.hitDone){let e=Math.hypot(r.dir.x,r.dir.z)||1,t=r.dir.x/e,i=r.dir.z/e,a=n.x-r.from.x,o=n.z-r.from.z,s=Math.max(0,Math.min(r.len+170,a*t+o*i)),c=r.from.x+t*s,l=r.from.z+i*s;Math.hypot(n.x-c,n.z-l)<1.1&&(r.hitDone=!0,this.onPlayerHit?.(10))}r.t>=t&&(this._hideLaser(e),r.state=`idle`,r.cd=this._laserCd());break}}}setAccent(e){this._accent.set(e)}setNormalTarget(e){this._normalTarget=Math.min(e,this.spirits.length)}setSpecialTarget(e){this._specialTarget=Math.min(e,this.specials.length)}_modelBox(e){e.updateMatrixWorld(!0);let t=new tr().setFromObject(e).getSize(new V);return{midY:t.y/2,radius:Math.max(t.x,t.z)/2}}_prepModel(e,t){e.updateMatrixWorld(!0);let n=new tr().setFromObject(e),r=n.getSize(new V),i=t/Math.max(r.y,.001);e.scale.setScalar(i);let a=new G;return a.add(e),e.position.x=-(n.min.x+r.x/2)*i,e.position.z=-(n.min.z+r.z/2)*i,e.position.y=-n.min.y*i,a}async _loadModels(){try{let e=new ld,[t,n,r]=await Promise.all([e.loadAsync(`spirits/lich.glb`),e.loadAsync(`spirits/fire.glb`),e.loadAsync(`spirits/ipos.glb`)]);this._protos={lich:this._prepModel(t.scene,1.75),fire:this._prepModel(n.scene,1.55),ipos:this._prepModel(r.scene,1.7)},this._modelStats={ice:this._modelBox(this._protos.lich),fire:this._modelBox(this._protos.fire),storm:this._modelBox(this._protos.ipos)};for(let e of this.specials){e.models={ice:this._protos.lich.clone(),fire:this._protos.fire.clone(),storm:this._protos.ipos.clone()};for(let t of Object.values(e.models))t.visible=!1,e.group.add(t)}this._modelsReady=!0}catch(e){console.error(`[spirits] 敌人模型装载失败`,e)}}begin(e,t=3){this.active=!0,this._normalTarget=t,this._spawnAll(e,t)}_spawnAll(e,t){for(let n=0;n<t;n++){let r=n/t*Math.PI*2+Math.random()*.8,i=20+Math.random()*20,a=this.spirits[n];a&&(a.alive=!0,a.chasing=!1,a.pos.set((e?e.x:0)+Math.cos(r)*i,a.baseY,(e?e.z:0)+Math.sin(r)*i),a.group.visible=!0)}}setFrozen(e){if(this._frozen=e,e)for(let e of this.specials)this._hideLaser(e),e.laser.state!==`idle`&&(e.laser.state=`idle`,e.laser.cd=this._laserCd())}setTargets(e,t){this._normalTarget=e,this._specialTarget=t}respawnAll(e,t=3){this._normalTarget=t;for(let n=0;n<this.spirits.length;n++){let r=this.spirits[n];n<t?(r.alive=!0,r.chasing=!1,this._place(r,e),r.group.visible=!0):(r.alive=!1,r.group.visible=!1)}for(let e of this.specials)e.alive=!1,e.group.visible=!1,this._hideLaser(e);this._specialTimer=Qm()}reset(){this.active=!1,this._pendingStart=!1;for(let e of this.spirits)e.alive=!1,e.chasing=!1,e.group.visible=!1;for(let e of this.specials)e.alive=!1,e.group.visible=!1,this._hideLaser(e);this._specialTimer=Qm()}spawnSpecial(e){let t=this.specials.find(e=>!e.alive);if(!t)return;let n=[`ice`,`fire`,`storm`],r=n[Math.floor(Math.random()*n.length)],i=Km[r]??np[r].accent;t.element=r,t.alive=!0,t.flash=0,t.basicHits=0;let a=Math.random()*Math.PI*2,o=qm+Math.random()*15,s=e?e.x:0,c=e?e.z:0;t.pos.set(s+Math.cos(a)*o,t.baseY,c+Math.sin(a)*o),t.wander.set(0,0,0),t.laser.state=`idle`,t.laser.t=0,t.laser.cd=1.2+Math.random()*1.2,t.laser.hitDone=!1,this._hideLaser(t),t.ring.material.color.set(i),t.halo.material.color.set(i);for(let[e,n]of Object.entries(t.models??{}))n.visible=e===r;let l=this._modelStats?.[r];if(l){let e=Math.min(Math.max(l.radius*1.5,1.05),1.8);t.ring.scale.setScalar(e/Xm),t.ring.position.y=l.midY,t.halo.position.y=l.midY}let u=e?Math.atan2(e.x-t.pos.x,e.z-t.pos.z)+Jm:Jm;for(let e of Object.values(t.models??{}))e.rotation.y=u;t.group.visible=!0,t.group.position.set(t.pos.x,t.baseY,t.pos.z),this.onSpecialSpawn?.(r,i)}_place(e,t,n=20,r=40){let i=Math.random()*Math.PI*2,a=n+Math.random()*(r-n),o=t?t.x:0,s=t?t.z:0;e.pos.set(o+Math.cos(i)*a,e.baseY,s+Math.sin(i)*a),e.group.position.copy(e.pos),e.group.visible=e.alive}collectAt(e,t,n=`basic`,r=`neutral`,i){let a=0,o=0,s=0,c=0;for(let n of this.spirits){if(!n.alive)continue;let r=n.pos.x-e.x,i=n.pos.z-e.z;r*r+i*i<=t*t&&(n.alive=!1,n.respawn=2.4+Math.random()*1.4,n.group.visible=!1,this.vfx?.killBurst(n.pos,`basic`,1),a++)}for(let a of this.specials){if(!a.alive)continue;let l=a.pos.x-e.x,u=a.pos.z-e.z;if(l*l+u*u<=t*t){if(n===`basic`){if(i?.has(a))continue;i?.add(a)}n!==`basic`&&a.element===n?(a.alive=!1,a.group.visible=!1,this._hideLaser(a),this.vfx?.killBurst(a.pos,a.element,1.7),o++):n===`basic`&&r===a.element?(a.basicHits++,a.basicHits>=3?(a.alive=!1,a.group.visible=!1,this._hideLaser(a),this.vfx?.killBurst(a.pos,a.element,1.7),o++):(a.flash=Hm,s++,this.vfx?.sparkBurst(a.pos,`basic`,{count:12,speed:3.5,life:.45,size:.6,up:.6,radius:.3}))):(a.flash=Hm,c++)}}return{normal:a,special:o,specialHit:s,immune:c}}update(e,t,n){if(this._frozen||!this.active)return;this._specialTimer-=e,this._specialTimer<=0&&(this._specialTimer=Qm(),this.specials.filter(e=>e.alive).length<this._specialTarget&&this.spawnSpecial(n));let r=0;for(let i of this.specials){if(!i.alive){(i.laserMeshes.some(e=>e.visible)||i.laserOrb.visible)&&(this._hideLaser(i),i.laser.state!==`idle`&&(i.laser.state=`idle`,i.laser.cd=this._laserCd()));continue}i.flash=Math.max(0,i.flash-e),i.phase+=e;let a=!1,o=!1;if(n){let t=n.x-i.pos.x,r=n.z-i.pos.z,s=Math.hypot(t,r);s>.001&&(i.pos.x+=t/s*Um*e,i.pos.z+=r/s*Um*e,a=!0,s<Wm&&(o=!0))}if(o){i.alive=!1,i.group.visible=!1,this._hideLaser(i),this.vfx?.killBurst(i.pos,i.element,1.7),this.onPlayerHit?.(Gm);continue}if(!a){if(i.wander.lengthSq()<.001||Math.random()<e*.4){let e=Math.random()*Math.PI*2;i.wander.set(Math.cos(e),0,Math.sin(e)).multiplyScalar(.35)}i.pos.addScaledVector(i.wander,e),Math.hypot(i.pos.x,i.pos.z)>48&&i.wander.multiplyScalar(-1)}i.group.position.set(i.pos.x,i.baseY+Math.sin(t*1.6+i.pos.x)*.26,i.pos.z),i.ring.rotation.z+=e*1.5,i.ring.rotation.x=Zm+Math.sin(t*.9+i.phase)*.14;let s=i.flash/Hm,c=i.models?.[i.element];if(c&&n){let t=Math.atan2(n.x-i.pos.x,n.z-i.pos.z)+Jm-c.rotation.y;for(;t>Math.PI;)t-=Math.PI*2;for(;t<-Math.PI;)t+=Math.PI*2;c.rotation.y+=t*Math.min(1,e*Ym)}i.halo.scale.setScalar(3.2+s*1.4+Math.sin(t*2.6+i.pos.z)*.2);let l=i.ring.material.color,u=this._modelStats?.[i.element],d=u?u.midY*2:1.6,f=u?Math.min(u.radius*.95,1.05):.6;for(this._fxAcc[r]=(this._fxAcc[r]??0)+e*70;this._fxAcc[r]>=1;){--this._fxAcc[r];let e=Math.random()*Math.PI*2,t=f*(.3+Math.random()*.6),n=i.pos.x+Math.cos(e)*t,a=i.pos.z+Math.sin(e)*t,o=i.baseY+.06+Math.random()*d*.6;i.element===`ice`?Fm(this._fx,n,o,a,l,{vy:1.3+Math.random()*.7,life:.6+Math.random()*.4,maxLife:1,size0:.75+Math.random()*.35,size1:.18,alpha:.85,sway:!0}):i.element===`fire`?Fm(this._fx,n,o,a,l,{vy:1.6+Math.random()*.9,life:.55+Math.random()*.4,maxLife:.95,size0:.9+Math.random()*.4,size1:.22,alpha:1,sway:!0}):Fm(this._fx,n,o,a,l,{vy:1.5+Math.random()*.8,life:.4+Math.random()*.3,maxLife:.7,size0:.75+Math.random()*.35,size1:.15,alpha:1,sway:!0})}this._updateLaser(i,e,n),r++}for(let r=0;r<this.spirits.length;r++){let i=this.spirits[r],a=r<this._normalTarget;if(!i.alive){i.respawn-=e,i.respawn<=0&&a&&(i.alive=!0,i.chasing=!1,this._place(i,n),i.group.visible=!0);continue}if(n){let t=n.x-i.pos.x,r=n.z-i.pos.z,a=Math.hypot(t,r);if(a>.001&&(i.pos.x+=t/a*Rm*e,i.pos.z+=r/a*Rm*e,a<zm)){i.alive=!1,i.respawn=2.4+Math.random()*1.4,i.group.visible=!1,this.vfx?.killBurst(i.pos,`basic`,1),this.onPlayerHit?.(Bm);continue}}if(!i.chasing){if(i.phase+=e,i.phase>3.5||i.wander.lengthSq()<.001){i.phase=0;let e=Math.random()*Math.PI*2;i.wander.set(Math.cos(e),0,Math.sin(e)).multiplyScalar(.55)}i.pos.addScaledVector(i.wander,e),Math.hypot(i.pos.x,i.pos.z)>Lm&&i.wander.multiplyScalar(-1)}i.group.position.set(i.pos.x,i.baseY+Math.sin(t*(i.chasing?3.4:1.7)+i.pos.x)*.22,i.pos.z),i.core.rotation.y+=e*(i.chasing?2.6:1.4),i.core.rotation.x+=e*.6,i.band.rotation.y-=e*(i.chasing?2.2:.8),i.band.rotation.x=.9+Math.sin(t*1.3+i.phase)*.35,i.band2.rotation.y+=e*(i.chasing?1.8:.6),i.band2.rotation.x=-.9-Math.sin(t*1.3+i.phase)*.35,i.halo.scale.setScalar((2+Math.sin(t*3.1+i.pos.z)*.25)*(i.chasing?1.3:1))}this._fx.update(e,t)}setPixelRatio(e){this._fx?.setPixelRatio(e)}dispose(){this.scene.remove(this._group),this._group.traverse(e=>{e.geometry&&e.geometry.dispose()});for(let e of this.specials){for(let t of e.laserMaterials)t.dispose();e.laserOrb?.material.dispose()}this._bodyMaterial.dispose(),this._haloMaterial.dispose(),this._bandMaterial.dispose(),this._fx.geometry.dispose()}},eh=[`荒原过客`,`驱灵学徒`,`缚灵猎人`,`秘法游侠`,`元素使徒`,`圣杯侍祭`,`荒原守卫`,`领域主宰`,`高阶元素使`,`孤独领域传说`],th=class{constructor(){this.worldBadge=document.getElementById(`worldBadge`),this.worldGlyph=document.getElementById(`worldGlyph`),this.worldName=document.getElementById(`worldName`),this.lockHint=document.getElementById(`lockHint`),this.lockHint.classList.add(`is-hidden`),this.startScreen=document.getElementById(`startScreen`),this.startInner=this.startScreen.querySelector(`.start-inner`),this.hudEl=document.getElementById(`hud`),this.healthFill=document.getElementById(`healthFill`),this.healthNum=document.getElementById(`healthNum`),this.healthPanel=document.querySelector(`.hud-health`),this.streakEl=document.getElementById(`streak`),this.staminaFill=document.getElementById(`staminaFill`),this.staminaNum=document.getElementById(`staminaNum`),this.fpsNum=document.getElementById(`fpsNum`),this.fpsNum=document.getElementById(`fpsNum`),this.levelBadge=document.getElementById(`levelBadge`),this._levelShown=1,this.gameOverScreen=document.getElementById(`gameOverScreen`),this.pauseScreen=document.getElementById(`pauseScreen`),this.finalScore=document.getElementById(`finalScore`),this.toast=document.getElementById(`toast`),this.edgeHint=document.getElementById(`edgeHint`),this.scoreElement=document.getElementById(`score`),this.scorePanel=document.querySelector(`.hud-score`),this.help=document.getElementById(`help`),this.vignette=document.getElementById(`vignette`),this.castFlashEl=document.getElementById(`castFlash`),this.skills=new Map;for(let e of document.querySelectorAll(`.skill`))this.skills.set(e.dataset.element,{root:e,card:null,numEl:e.querySelector(`.skill__cd-num`)}),e.addEventListener(`pointerdown`,t=>{t.stopPropagation(),this.onSkill?.(e.dataset.element)});this._toastTimer=0,this._cooldownShown=new Map,this.onSkill=null}setWorld(e){this.worldGlyph.textContent=e.glyph,this.worldName.textContent=e.label,this.worldBadge.style.setProperty(`--world-accent`,e.accent),this.worldBadge.style.setProperty(`--world-border`,e.accent+`59`),this.worldBadge.style.setProperty(`--world-glow`,e.accent+`40`),this.worldBadge.classList.remove(`is-pop`),this.worldBadge.offsetWidth,this.worldBadge.classList.add(`is-pop`)}setStamina(e,t){let n=Math.max(0,Math.min(100,e));(n!==this._staminaShown||t!==this._staminaExhausted)&&(this._staminaShown=n,this._staminaExhausted=t,this.staminaFill.style.width=`${n}%`,this.staminaFill.classList.toggle(`is-exhausted`,t),this.staminaNum.textContent=`${Math.round(n)}%`,this.staminaNum.style.color=t?`#ff5a4d`:`#9fd8ff`)}setFps(e){this.fpsNum.textContent=e,this.fpsNum.className=e>=50?`is-ok`:e>=30?`is-mid`:`is-low`}hurtFlash(){this.vignette.classList.remove(`is-hurt`),this.vignette.offsetWidth,this.vignette.classList.add(`is-hurt`)}castFlash(e){this.castFlashEl&&(this.castFlashEl.style.setProperty(`--flash-color`,e),this.castFlashEl.classList.remove(`is-flash`),this.castFlashEl.offsetWidth,this.castFlashEl.classList.add(`is-flash`))}setStreak(e){this._streak=e,this._refreshStreak()}_refreshStreak(){let e=this._streak??0,t=this._hp??100;e>0&&t<100?(this.streakEl.textContent=`生命恢复 ${Math.min(e,9)}/9`,this.streakEl.classList.add(`is-visible`)):this.streakEl.classList.remove(`is-visible`)}setLevel(e){if(e===this._levelShown)return;let t=e>this._levelShown;this._levelShown=e,this.levelBadge.textContent=`LV.${e}`,t&&(this.levelBadge.classList.remove(`is-bump`),this.levelBadge.offsetWidth,this.levelBadge.classList.add(`is-bump`))}hideStartScreen(){this.startScreen.classList.add(`is-leaving`),clearTimeout(this._startHideT),this._startHideT=setTimeout(()=>this.startScreen.classList.add(`is-hidden`),780)}showStartScreen(){clearTimeout(this._startHideT),this.startScreen.classList.remove(`is-hidden`,`is-leaving`)}setChrome(e){this.hudEl?.classList.toggle(`is-hidden`,!e)}setHealth(e){this._hp=e;let t=Math.max(0,Math.min(100,e));this.healthFill.style.width=`${t}%`,this.healthNum.textContent=`${Math.round(t)}%`;let n=t>50?`#6fe38a`:t>25?`#ffb84d`:`#ff5a4d`;this.healthFill.style.background=n,this.healthNum.style.color=n,this._refreshStreak()}setFps(e){this.fpsNum.textContent=e,this.fpsNum.className=e>=50?`is-ok`:e>=30?`is-mid`:`is-low`}showPause(){this.pauseScreen.classList.remove(`is-hidden`),this.showcase?.show()}hidePause(){this.pauseScreen.classList.add(`is-hidden`),this.showcase?.hide()}setShowcase(e){this.showcase=e}showGameOver(e,t=1){this.finalScore.textContent=e;let n=Math.max(1,Math.min(eh.length,t|0)),r=document.getElementById(`finalRank`);r&&(r.textContent=`${eh[n-1]}`,document.getElementById(`finalRankLv`).textContent=`LV.${n}`),this.gameOverScreen.classList.remove(`is-hidden`)}hideGameOver(){this.gameOverScreen.classList.add(`is-hidden`)}setLockHint(e){this.lockHint.classList.toggle(`is-hidden`,!e)}setEdgeHint(e){this.edgeHint?.classList.toggle(`is-visible`,e)}showToast(e,t=1900){this.toast.textContent=e,this.toast.classList.add(`is-visible`),clearTimeout(this._toastTimer),this._toastTimer=setTimeout(()=>this.toast.classList.remove(`is-visible`),t)}setScore(e){this.scoreElement.textContent=e,this.scorePanel.classList.remove(`is-bump`),this.scorePanel.offsetWidth,this.scorePanel.classList.add(`is-bump`)}setActive(e){for(let[t,{root:n}]of this.skills)n.classList.toggle(`is-active`,t===e)}setCooldown(e,t,n){let r=this.skills.get(e);if(!r)return;let i=t<=.001,a=Math.max(0,Math.min(1,t/Math.max(n,.001)));!i&&Math.abs(a-(this._cooldownShown.get(e)??-1))<.005||(this._cooldownShown.set(e,a),r.root.style.setProperty(`--cd`,a),r.root.classList.toggle(`is-cooling`,!i),r.root.classList.toggle(`is-empty`,!i),r.numEl&&(r.numEl.textContent=i?``:Math.ceil(t)))}toggleHelp(){this.help.classList.toggle(`is-hidden`)}},nh=58,rh=5.4,ih=class{constructor(e){this.scene=e,this.uniforms={uTime:{value:0},uColor:{value:new K(`#9fb4c8`)},uProximity:{value:0},uPush:{value:0},uHit:{value:0},uDir:{value:new B(0,-1)},uDim:{value:1}};let t=new Xa({transparent:!0,depthWrite:!1,blending:2,fog:!1,uniforms:this.uniforms,vertexShader:`
        varying vec2 vLocal;
        void main() {
          vLocal = position.xy;
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,fragmentShader:`
        ...
        const float RADIUS = ${nh.toFixed(1)};
        ...
        void main() {
          ...
          float waveDepth = (1.0 - uHit) * ${rh.toFixed(1)};
      ...
      `});this.ring=new Y(new za(nh-rh,nh+1.2,256,1),t),this.ring.rotation.x=-Math.PI/2,this.ring.position.y=.05,this.ring.renderOrder=2,e.add(this.ring),this.pylonGeometry=new Ea(.14,1.8,.14),this.pylonMaterial=new ci({color:`#9fb4c8`,transparent:!0,opacity:.32,blending:2,depthWrite:!1}),this.pylons=[];for(let t=0;t<12;t++){let n=t/12*Math.PI*2,r=new Y(this.pylonGeometry,this.pylonMaterial);r.position.set(Math.sin(n)*nh,.9,Math.cos(n)*nh),e.add(r),this.pylons.push(r)}this._colorTarget=new K(`#9fb4c8`)}flash(e=1){this.uniforms.uHit.value=Math.max(this.uniforms.uHit.value,e)}update(e,t,n,r,i=235){let a=this.uniforms;a.uTime.value=t,a.uProximity.value=n.edgeProximity,a.uPush.value+=(n.edgePush-a.uPush.value)*Math.min(1,e*10),a.uHit.value=Math.max(0,a.uHit.value-e*2.1);let o=.12+.88*Ft.smoothstep(i,45,150);a.uDim.value+=(o-a.uDim.value)*Math.min(1,e*1.5);let s=n.position.x,c=n.position.z;s*s+c*c>.001&&a.uDir.value.set(s,-c).normalize(),this._colorTarget.set(r),a.uColor.value.lerp(this._colorTarget,Math.min(1,e*3)),this.pylonMaterial.color.copy(a.uColor.value),this.pylonMaterial.opacity=(.2+.16*n.edgeProximity+.14*Math.sin(t*2.2)*.5)*(.3+.7*a.uDim.value)}dispose(){this.scene.remove(this.ring,...this.pylons),this.ring.geometry.dispose(),this.ring.material.dispose(),this.pylonGeometry.dispose(),this.pylonMaterial.dispose()}},ah=class{constructor(e){this.uniforms={uTime:{value:0},uColor:{value:new K(`#9fb4c8`)},uImpact:{value:new B(0,0)},uSince:{value:99},uSeed:{value:1.7},uRealm:{value:0},uPulse:{value:0}};let t=`
        float hash(vec2 p) {
          return fract(sin(dot(p, vec2(127.1, 311.7))) * 43758.5453);
        }
        float valueNoise(vec2 p) {
    ...
    `,r=new Xa({transparent:!0,depthWrite:!1,blending:1,fog:!1,uniforms:this.uniforms,vertexShader:n,fragmentShader:`
        uniform float uTime;
      ...
      `}),i=new Xa({transparent:!0,depthWrite:!1,blending:2,fog:!1,uniforms:this.uniforms,vertexShader:n,fragmentShader:`
        uniform float uTime;
        uniform vec3 uColor;
        uniform vec2 uImpact;
        uniform float uSince;
      ...
      `}),a=new Da(59,96);this.darkMesh=new Y(a,r),this.darkMesh.rotation.x=-Math.PI/2,this.darkMesh.position.y=.055,this.darkMesh.renderOrder=1,e.add(this.darkMesh),this.mesh=new Y(a,i),this.mesh.rotation.x=-Math.PI/2,this.mesh.position.y=.07,this.mesh.renderOrder=1,e.add(this.mesh),this._colorTarget=new K}burst(e,t){this.uniforms.uColor.value.set(t),this.uniforms.uImpact.value.set(e.x,e.z),this.uniforms.uSince.value=0,this.uniforms.uSeed.value=Math.random()*97,this.uniforms.uPulse.value=1}update(e,t,n){let r=this.uniforms;r.uTime.value+=e,r.uSince.value+=e,r.uPulse.value=Math.max(0,r.uPulse.value-e*1.8);let i=+!!n;r.uRealm.value+=(i-r.uRealm.value)*Math.min(1,e*(n?1.5:.8)),this._colorTarget.set(t),r.uColor.value.lerp(this._colorTarget,Math.min(1,e*2))}dispose(){this.darkMesh.geometry.dispose(),this.darkMesh.material.dispose(),this.mesh.geometry.dispose(),this.mesh.material.dispose()}},oh=56,sh=1.3,ch=.18,lh=.62,uh=class{constructor(e){this.scene=e,this.uniforms={uTime:{value:0},uColor:{value:new K(`#9fd8ff`)}},this._geometry=new Mr,this._positions=new Float32Array(336),this._alphas=new Float32Array(112),this._across=new Float32Array(112);let t=new Uint16Array(330);for(let e=0;e<55;e++){let n=e*2,r=n+1,i=n+2,a=n+3;t.set([n,r,i,r,a,i],e*6)}this._geometry.setAttribute(`position`,new q(this._positions,3)),this._geometry.setAttribute(`aAlpha`,new q(this._alphas,1)),this._geometry.setAttribute(`aAcross`,new q(this._across,1)),this._geometry.setIndex(new q(t,1)),this._geometry.setDrawRange(0,0);let n=new Xa({transparent:!0,depthWrite:!1,blending:2,side:2,fog:!1,uniforms:this.uniforms,vertexShader:`
        attribute float aAlpha;
      ...
      `});this._mesh=new Y(this._geometry,n),this._mesh.frustumCulled=!1,this._mesh.renderOrder=3,e.add(this._mesh),this._points=[],this._time=0,this._scratch=new K}update(e,t,n){this._time+=e,this.uniforms.uTime.value=this._time,this.uniforms.uColor.value.lerp(this._scratch.set(n),Math.min(1,e*8));let r=this._points;for(;r.length&&this._time-r[0].t>sh;)r.shift();if(t){let e=r[r.length-1];(!e||(t.x-e.x)**2+(t.z-e.z)**2>ch*ch)&&(r.push({x:t.x,y:t.y,z:t.z,t:this._time}),r.length>oh&&r.shift())}this._rebuild()}_rebuild(){let e=this._points,t=e.length,n=this._positions,r=this._alphas,i=this._across;for(let a=0;a<t;a++){let o=e[a],s=(1-(this._time-o.t)/sh)**1.35,c=e[Math.max(0,a-1)],l=e[Math.min(t-1,a+1)],u=l.x-c.x,d=l.z-c.z,f=Math.hypot(u,d)||1;u/=f,d/=f;let p=lh*s/2,m=-d*p,h=u*p,g=a*6;n[g]=o.x+m,n[g+1]=o.y,n[g+2]=o.z+h,n[g+3]=o.x-m,n[g+4]=o.y,n[g+5]=o.z-h;let _=s**1.15;r[a*2]=_,r[a*2+1]=_,i[a*2]=0,i[a*2+1]=1}this._geometry.attributes.position.needsUpdate=!0,this._geometry.attributes.aAlpha.needsUpdate=!0,this._geometry.attributes.aAcross.needsUpdate=!0,this._geometry.setDrawRange(0,t>1?(t-1)*6:0)}dispose(){this.scene.remove(this._mesh),this._geometry.dispose(),this._mesh.material.dispose()}},dh=.5,fh=2,ph=6,mh=26;function hh(){return wm({radius:1.55,radiusNear:.5,radiusCurve:.85,flare:1.15,flareWidth:.14,wander:.04,coreWidth:.16,coreFill:.7,shellOpacity:.9,haloWidth:2.6,haloOpacity:.13,ripple:.25,streak:1.2,flowSpeed:8,tipGlow:1.4,tipLength:.05,coils:3,coilTurns:2.4,coilRadius:1.7,coilWidth:.09,coilOpacity:1.4,coilGlow:5,rings:6,ringSpeed:1.1,ringInner:2.2,ringOuter:2.8,ringOpacity:.9,ringGlow:2,opacity:1.8,glow:1.9,colorCore:`#ffffff`,colorInner:`#d3f4ff`,colorOuter:`#9fb4c8`,colorHalo:`#20304a`,colorCoil:`#bcd2ff`,colorCoilEdge:`#9fb4c8`,colorRing:`#d3f4ff`})}var gh=3,_h=6,vh=class{constructor(e,t,n){this.scene=e,this.onHit=t,this.vfx=n,this.group=new G,e.add(this.group),this.beams=[],this.active=!1,this.tier=1,this.accent=new K(`#9fb4c8`),this._spawnT=2,this._tubeGeo=Pp(72,22),this._coilGeo=Np(64,gh),this._ringGeo=Fp(_h,36),this._scratchColor=new K,this._state=null}setTier(e){this.tier=e;let t=e>=3;!t&&this.active&&this._clearAll(),this.active=t,this.active&&(this._spawnT=Math.min(this._spawnT,1.5))}setAccent(e){this.accent.set(e);for(let e of this.beams)this._tint(e)}_tint(e){e.ring&&e.ring.material.color.copy(this.accent);let t=e.config;if(!t)return;let n=this._scratchColor.copy(this.accent);t.colorCore=`#ffffff`,t.colorInner=`#`+n.clone().lerp(new K(`#ffffff`),.55).getHexString(),t.colorOuter=`#`+n.getHexString(),t.colorHalo=`#`+n.clone().multiplyScalar(.28).getHexString(),t.colorCoil=`#`+n.clone().lerp(new K(`#ffffff`),.3).getHexString(),t.colorCoilEdge=`#`+n.getHexString(),t.colorRing=`#`+n.clone().lerp(new K(`#ffffff`),.7).getHexString(),e.orb&&e.orb.material.userData.setPalette({inner:t.colorInner,outer:t.colorOuter})}_clearAll(){for(let e of this.beams)this._dispose(e);this.beams.length=0}dispose(){this._clearAll(),this._tubeGeo.dispose(),this._coilGeo.dispose(),this._ringGeo.dispose(),this.scene.remove(this.group)}_dispose(e){e.ring&&(e.ring.material.dispose(),this.group.remove(e.ring)),e.orb&&(e.orb.material.dispose(),this.group.remove(e.orb));for(let t of e.meshes)t.material.dispose(),this.group.remove(t);e.meshes.length=0}update(e,t,n){if(!this.active)return;let r=Math.max(3,Math.min(this.tier*2-3,19));this._spawnT-=e,this._spawnT<=0&&(this._spawnT=Math.max(1.2,3-(this.tier-3)*.22)*(.7+Math.random()*.6),this.beams.length<r&&this._spawn(n));let i=this.beams.filter(e=>e.phase===`strike`).length;for(let r=this.beams.length-1;r>=0;r--){let a=this.beams[r];if(a.t+=e,a.phase===`warn`){let e=a.t/dh;a.ring.material.opacity=.55+.4*Math.sin(t*22),a.ring.scale.setScalar(1.15-e*.35);let n=yp(a.t/dh);if(a.orb.visible=!0,a.orb.position.set(a.x,21-n*3,a.z),a.orb.scale.setScalar(.35+n*.85),a.orb.material.uniforms.uCharge.value=n,a.t>=dh){if(i>=ph)continue;this._strike(a),i++}continue}a.tSinceStrike+=e;let o=a.life-a.tSinceStrike;a.state.progress=Math.min(1,a.tSinceStrike/.09),a.state.fade=Math.min(1,Math.max(0,o/.35)),a.state.widthFade=o<.18?Math.max(.06,o/.18):1;for(let e of a.materials)e.userData.sync(a.state);a.orb.visible=!1,!a.hitDone&&n&&a.tSinceStrike>.04&&Math.hypot(n.x-a.x,n.z-a.z)<fh&&(a.hitDone=!0,this.onHit?.(30)),o<=0&&(this._dispose(a),this.beams.splice(r,1))}}_spawn(e){let t=0,n=0;for(let r=0;r<20;r++){let r=Math.random()*Math.PI*2,i=5+Math.random()*35;if(t=Math.cos(r)*i,n=Math.sin(r)*i,!e||Math.hypot(t-e.x,n-e.z)>6)break}let r=new Y(this._ringGeo2??=new za(1.05,2.3,40),new ci({color:this.accent.clone(),transparent:!0,opacity:.8,blending:2,depthWrite:!1,side:2,fog:!1}));r.rotation.x=-Math.PI/2,r.position.set(t,.07,n),r.renderOrder=2,this.group.add(r);let i=new Y(this._orbGeo??=new Ia(1,3),Mm({inner:`#d3f4ff`,outer:`#9fb4c8`,glow:2.6}));i.visible=!1,i.renderOrder=9,this.group.add(i);let a={phase:`warn`,x:t,z:n,t:0,life:1+Math.random()*2,hitDone:!1,ring:r,orb:i,meshes:[],materials:[],config:hh(),state:{origin:new V(t,mh,n),target:new V(t,.05,n),side:new V(1,0,0),progress:0,fade:1,widthFade:1,seed:Math.random()*100,coils:gh,rings:_h}};this._tint(a),this._buildBeamMeshes(a),this.beams.push(a),$.pillarWarn()}_buildBeamMeshes(e){let t=[[Cm.HALO,this._tubeGeo,11],[Cm.SHELL,this._tubeGeo,12],[Cm.CORE,this._tubeGeo,13],[Cm.COIL,this._coilGeo,13],[Cm.RING,this._ringGeo,13]];for(let[n,r,i]of t){let t=km(n,e.config),a=new Y(r,t);a.frustumCulled=!1,a.matrixAutoUpdate=!1,a.visible=!1,a.renderOrder=i,this.group.add(a),e.meshes.push(a),e.materials.push(t)}}_strike(e){e.phase=`strike`,e.tSinceStrike=0,e.ring&&=(this.group.remove(e.ring),e.ring.material.dispose(),null);for(let t of e.meshes)t.visible=!0;let t=new V(e.x,.5,e.z);this.vfx?.bursts.spawn(Qp.AIR,t,{radius:.3,endRadius:3.2,life:.45,intensity:1,opacity:.9,fresnel:2,displace:.3,colorA:e.config.colorOuter,colorB:`#ffffff`,colorC:e.config.colorInner}),this.vfx?.decals.spawn(nm.SHOCKWAVE,{x:e.x,z:e.z},{radius:5.2,life:.5,width:.05,intensity:.9,colorA:e.config.colorOuter,colorB:`#ffffff`}),this.vfx?.decals.spawn(nm.DUSTRING,{x:e.x,z:e.z},{radius:3.6,life:.9,intensity:.6,colorA:`#3d5c74`,colorB:e.config.colorInner,height:.05}),this.vfx?.sparkBurst(t,`basic`,{count:60,speed:8,life:.7,size:1.1,up:1.2}),$.pillarStrike()}},yh={x:0,z:0},bh=2.4,xh=7.2,Sh=tp,Ch=6.55,wh=1.25;function Th(e){let t=e.image,n=t.width,r=t.height,i=document.createElement(`canvas`);i.width=n,i.height=r;let a=document.createElement(`canvas`);a.width=n,a.height=r;let o=i.getContext(`2d`),s=a.getContext(`2d`);o.drawImage(t,0,0);let c=o.getImageData(0,0,n,r),l=s.createImageData(n,r),u=c.data,d=l.data,f=0;for(let e=0;e<u.length;e+=4){let t=u[e],n=u[e+1],r=u[e+2];r>70&&r>n*1.32&&t+r>140&&(d[e]=255,d[e+1]=255,d[e+2]=255,u[e]=t*.16,u[e+1]=n*.16,u[e+2]=r*.2,f++),d[e+3]=255}o.putImageData(c,0,0),s.putImageData(l,0,0);let p=new Sa(i);p.colorSpace=Ge,p.flipY=!1,p.anisotropy=4;let m=new Sa(a);return m.flipY=!1,console.log(`[goblet] 发光区域像素占比 ${(100*f/(n*r)).toFixed(1)}%`),{base:p,mask:m}}var Eh=class{constructor(e){this.scene=e,this.ready=!1,this.group=null,this._flameColor=new K(Sh),this._targetColor=new K(Sh),this._spawnAcc=0,this._pixelRatio=1,this._load()}async _load(){try{let[e,t,n,r,i]=await Promise.all([new ld().loadAsync(`goblet/goblet.glb`),new Io().loadAsync(`goblet/base.png`),new Io().loadAsync(`goblet/normal.png`),new Io().loadAsync(`goblet/roughness.png`),new Io().loadAsync(`goblet/metallic.png`)]),{base:a,mask:o}=Th(t);n.flipY=!1,r.flipY=!1,i.flipY=!1;let s=new Qa({map:a,normalMap:n,roughnessMap:r,metalnessMap:i,roughness:1,metalness:1,emissive:this._flameColor.clone(),emissiveMap:o,emissiveIntensity:2.3}),c=e.scene;c.traverse(e=>{e.isMesh&&(e.material=s)}),c.updateMatrixWorld(!0);let l=new tr().setFromObject(c),u=l.getSize(new V),d=xh/Math.max(u.y,.001);c.scale.setScalar(d),c.position.x=-(l.min.x+u.x/2)*d,c.position.z=-(l.min.z+u.z/2)*d,c.position.y=-l.min.y*d;let f=new G;f.add(c),f.position.set(yh.x,0,yh.z),this._material=s,this.light=new es(this._flameColor.clone(),12,40,2),this.light.position.set(0,7.35,0),f.add(this.light);let p=Nm();this.flame=new Pm(f,130,p,!0),this.flame.setPixelRatio(this._pixelRatio),this.group=f,this.ready=!0,this.scene.add(f)}catch(e){console.error(`[goblet] 圣杯装载失败`,e)}}setPixelRatio(e){this._pixelRatio=e,this.flame?.setPixelRatio(e)}update(e,t,n){if(!this.ready)return;this._targetColor.set(n),this._flameColor.lerp(this._targetColor,Math.min(1,e*2.2)),this._material&&(this._material.emissive.lerp(this._targetColor,Math.min(1,e*2.2)),this._material.emissiveIntensity=2.3),this.light.color.copy(this._flameColor),this.light.intensity=12+Math.sin(t*12.7)*2.6+Math.sin(t*29.3)*1.4;let r=this._flameColor;for(this._spawnAcc+=e*95;this._spawnAcc>=1;){--this._spawnAcc;let e=Math.random()*Math.PI*2,t=Math.random()*wh;Fm(this.flame,Math.cos(e)*t,Ch+Math.random()*.35,Math.sin(e)*t,r)}this.flame.update(e,t)}dispose(){this.group&&(this.scene.remove(this.group),this.group.traverse(e=>{if(e.geometry&&e.geometry.dispose(),e.material){let t=Array.isArray(e.material)?e.material:[e.material];for(let e of t){for(let t of Object.keys(e)){let n=e[t];n&&n.isTexture&&n.dispose()}e.dispose()}}}),this.group=null,this.ready=!1)}},Dh=7.2,Oh=2.6,kh=.35,Ah=320,jh=class{constructor(e){this.scene=e,this.ready=!1,this.group=null,this.torches=[],this._flameColor=new K(tp),this._targetColor=new K(tp),this._spawnAcc=Array(12).fill(0),this._pixelRatio=1,this._load()}async _load(){try{let[e,t,n,r,i]=await Promise.all([new ld().loadAsync(`goblet/torch.glb`),new Io().loadAsync(`goblet/torch_base.png`),new Io().loadAsync(`goblet/torch_normal.png`),new Io().loadAsync(`goblet/torch_roughness.png`),new Io().loadAsync(`goblet/torch_metallic.png`)]);t.colorSpace=Ge,t.anisotropy=4;for(let e of[t,n,r,i])e.flipY=!1;let a=new Qa({map:t,normalMap:n,roughnessMap:r,metalnessMap:i,roughness:1,metalness:1}),o=e.scene;o.updateMatrixWorld(!0);let s=new tr().setFromObject(o),c=s.getSize(new V),l=Dh/Math.max(c.y,.001);o.traverse(e=>{e.isMesh&&(e.material=a)});let u=new G,d=Nm();this.flame=new Pm(u,Ah,d,!0),this.flame.setPixelRatio(this._pixelRatio);for(let e=0;e<12;e++){let t=o.clone(!0);t.scale.setScalar(l),t.position.x=-(s.min.x+c.x/2)*l,t.position.z=-(s.min.z+c.z/2)*l,t.position.y=-s.min.y*l;let n=new G;n.add(t);let r=e/12*Math.PI*2,i=Oh+Math.sin(e*1.7)*.3;n.position.set(Math.sin(r)*56,i,Math.cos(r)*56),u.add(n),this.torches.push({holder:n,baseY:i,phase:e*.55})}this.group=u,this.ready=!0,this.scene.add(u)}catch(e){console.error(`[torches] 火炬装载失败`,e)}}setPixelRatio(e){this._pixelRatio=e,this.flame?.setPixelRatio(e)}update(e,t,n){if(!this.ready)return;this._targetColor.set(n),this._flameColor.lerp(this._targetColor,Math.min(1,e*2.2));let r=this._flameColor,i=0;for(let n of this.torches){n.holder.position.y=n.baseY+Math.sin(t*1.1+n.phase)*kh;let a=n.holder.position;for(this._spawnAcc[i]=(this._spawnAcc[i]??0)+e*34;this._spawnAcc[i]>=1;){--this._spawnAcc[i];let e=Math.random()*Math.PI*2,t=Math.random()*.3;Fm(this.flame,a.x+Math.cos(e)*t,a.y+Dh*.82+Math.random()*.2,a.z+Math.sin(e)*t,r,{vy:1.6+Math.random()*1.2,life:.8+Math.random()*.6,maxLife:1.4,size0:1.9,size1:.6,alpha:1})}i++}this.flame.update(e,t)}dispose(){this.group&&(this.scene.remove(this.group),this.group.traverse(e=>{if(e.geometry&&e.geometry.dispose(),e.material){let t=Array.isArray(e.material)?e.material:[e.material];for(let e of t){for(let t of Object.keys(e)){let n=e[t];n&&n.isTexture&&n.dispose()}e.dispose()}}}),this.flame.geometry.dispose(),this.group=null,this.ready=!1)}},Mh=.42,Nh=2.1,Ph=new V(.486,1.69,.345),Fh=class{constructor(e){this.renderer=e,this.ready=!1,this.active=!0,this.leaving=!1,this._leaveT=0,this.fade=1,this._parTarget={x:0,y:0},this._par={x:0,y:0},this.scene=new Bn;let t=new rs(`#ffe9c4`,2.6);t.position.set(-2.2,3.4,2.6);let n=new rs(`#7fa8d8`,1.9);n.position.set(2.6,2.8,-2.2);let r=new Ro(`#2c3850`,`#0c0f16`,.9);this.scene.add(t,n,r),this.camera=new Xo(30,1,.1,30),this.camera.position.set(.2,1.76,1.97),this.camera.lookAt(.3,1.68,0),this.scene.add(this.camera),this.glow=new Y(new Ra(5,3.4),new Xa({transparent:!0,depthWrite:!1,uniforms:{uColor:{value:new K(`#182338`)},uFade:{value:1}},vertexShader:`
          varying vec2 vUv;
          void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `})),this.glow.position.set(.35,.05,-2.4),this.camera.add(this.glow),this.root=new G,this.scene.add(this.root),this.flame=new Pm(this.root,120,Nm(),!0),this.flameColor=new K(tp),this.cupLight=new es(this.flameColor,0,1.6,2),this.cupLight.position.copy(Ph).add(new V(0,.08,0)),this.root.add(this.cupLight),this._flameAcc=0,this._load()}async _load(){try{let e=(await new ld().loadAsync(`spirits/cultist.glb`)).scene;e.updateMatrixWorld(!0);let t=new tr().setFromObject(e),n=t.getSize(new V),r=Nh/Math.max(n.y,.001);e.scale.setScalar(r),e.position.x=-(t.min.x+n.x/2)*r,e.position.z=-(t.min.z+n.z/2)*r,e.position.y=-t.min.y*r,e.rotation.y=.26,this.root.add(e);let i=Math.min(8,this.renderer.capabilities.getMaxAnisotropy());this._mats=[],e.traverse(e=>{if(e.isMesh&&e.material){this._mats.push(e.material);for(let t of[`map`,`normalMap`,`roughnessMap`,`metallicMap`]){let n=e.material[t];n&&(n.anisotropy=i)}}}),this.ready=!0}catch(e){console.error(`[startscreen] 教徒模型装载失败`,e)}}resize(e,t){this.camera.aspect=e/t,this.camera.updateProjectionMatrix()}setParallax(e,t){this._parTarget.x=e,this._parTarget.y=t}leave(){this.leaving||(this.leaving=!0,this._leaveT=0)}show(){if(this.leaving=!1,this.active=!0,this._leaveT=0,this.fade=1,this.glow.material.uniforms.uFade.value=1,this._mats)for(let e of this._mats)e.transparent=!1,e.opacity=1;this.root.position.set(0,0,0),this.root.rotation.y=0}update(e,t){if(!this.active)return;let n=Math.min(1,e*5);this._par.x+=(this._parTarget.x-this._par.x)*n,this._par.y+=(this._parTarget.y-this._par.y)*n;let r=Mh+this._par.x*.14,i=this._par.y*.07,a=this._par.x*-.34;this.glow.position.x=.35-this._par.x*.24,this.glow.position.y=.05+this._par.y*-.14;let o=0,s=0;if(this.leaving){this._leaveT=Math.min(1,this._leaveT+e/1.05);let t=this._leaveT,n=t*t;o=n*3.2,s=n*6.5;let r=1-t*t*(3-2*t);this.fade=r,this.glow.material.uniforms&&(this.glow.material.uniforms.uFade.value=r),t>=1&&(this.active=!1)}if(this.root.position.set(r+o,i,0),this.root.rotation.y=a+s,this.ready)for(this.cupLight.intensity=(1.7+Math.sin(t*11.3)*.45+Math.sin(t*27.7)*.28)*this.fade,this._flameAcc+=e*46*this.fade;this._flameAcc>=1;){--this._flameAcc;let e=Math.random()*Math.PI*2,t=Math.random()*.05;Fm(this.flame,Ph.x+Math.cos(e)*t,Ph.y+Math.random()*.04,Ph.z+Math.sin(e)*t,this.flameColor,{vy:.95+Math.random()*.55,life:.6+Math.random()*.35,maxLife:.95,size0:.5+Math.random()*.16,size1:.12,alpha:1,sway:!0})}this.flame.update(e,t)}render(e){if(!this.active)return;let t=new B;e.getSize(t);let n=t.x,r=t.y;e.setScissorTest(!1),e.setViewport(0,0,n,r),e.autoClear=!1,e.clearDepth(),e.render(this.scene,this.camera),e.autoClear=!0}},Ih=[{id:`wraith`,kind:`wraith`,accent:`#9cc3e8`,height:1.2},{id:`ice`,kind:`glb`,url:`spirits/lich.glb`,accent:Km.ice,height:1.75,flame:`ice`},{id:`fire`,kind:`glb`,url:`spirits/fire.glb`,accent:np.fire.accent,height:1.55,flame:`fire`},{id:`storm`,kind:`glb`,url:`spirits/ipos.glb`,accent:np.storm.accent,height:1.7,flame:`storm`}],Lh=10,Rh=32,zh=.82,Bh=1.35,Vh={ice:{vy:[1.3,.7],life:[.6,.4],maxLife:1,size0:[.75,.35],size1:.18,alpha:.85,rate:44},fire:{vy:[1.6,.9],life:[.55,.4],maxLife:.95,size0:[.9,.4],size1:.22,alpha:1,rate:44},storm:{vy:[1.5,.8],life:[.4,.3],maxLife:.7,size0:[.75,.35],size1:.15,alpha:1,rate:44}},Hh=class{constructor(e){this.canvas=e,this.visible=!1,this._raf=0,this._lastT=0,this._elapsed=0,this._loaded=!1,this._loading=!1,this._drag=null,this.renderer=new Yu({canvas:e,alpha:!0,antialias:!0}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio||1,1.75)),this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.3,this.renderer.setClearColor(0,0),this.scene=new Bn;let t=new rs(`#ffe9c4`,2.3);t.position.set(-2.4,3.6,2.8);let n=new rs(`#7fa8d8`,1.8);n.position.set(2.8,2.6,-2.4);let r=new Ro(`#33415e`,`#0b0d13`,1);this.scene.add(t,n,r),this.camera=new Xo(Rh,1,.1,60),this._glow=Nm(),this._bandMaterial=new Qa({color:`#232833`,roughness:.55,metalness:.75}),this.cells=Ih.map((e,t)=>this._buildCell(e,t));let i=document.querySelectorAll(`.bestiary-cell__viewport`);this.cells.forEach((e,t)=>{e.vpEl=i[t]??null});for(let e of this.cells)e.def.kind===`wraith`&&this._attachWraith(e);this._bindPointer()}_buildCell(e,t){let n=new G;n.position.x=t*Lh,this.scene.add(n);let r=new G;r.rotation.order=`YXZ`,n.add(r);let i=new K(e.accent),a=new Y(new Da(1.05,40),new ci({color:`#05070c`,transparent:!0,opacity:.62,depthWrite:!1}));a.rotation.x=-Math.PI/2,a.position.y=.006,a.renderOrder=1;let o=new Y(new za(1.05,1.16,48),new ci({color:i,transparent:!0,opacity:.42,depthWrite:!1}));o.rotation.x=-Math.PI/2,o.position.y=.008,o.renderOrder=1,n.add(a,o);let s=new Qr(new Rr({map:this._glow,color:i,transparent:!0,opacity:.62,depthWrite:!1}));r.add(s);let c=new es(i,9,6,2);return c.position.set(n.position.x,e.height*.75,1.8),this.scene.add(c),{def:e,index:t,group:n,holder:r,halo:s,accent:i,vpEl:null,rect:null,rectGL:null,dist:4,yaw:t*.9,pitch:0,lastTouch:0,height:e.height,midY:e.height/2,radius:.55,ringRadius:1.05,model:null,ring:null,wraith:null,flame:null,flameAcc:0,phase:Math.random()*Math.PI*2}}_attachWraith(e){let t=new Y(new La(.3,0),new Qa({color:`#dceaff`,emissive:`#8fc6ef`,emissiveIntensity:3.4,roughness:.35,flatShading:!0,transparent:!0,opacity:.88,depthWrite:!1}));t.scale.set(.82,1.7,.82);let n=new fa(new Fa(t.geometry),new ea({color:`#eaf6ff`,transparent:!0,opacity:.85}));t.add(n);let r=new Y(new La(.19,0),new ci({color:`#f2fbff`}));r.scale.set(.82,1.7,.82);let i=new Y(new Va(.46,.045,6,24),this._bandMaterial);i.rotation.set(.9,0,.4);let a=new Y(new Va(.3,.04,6,20),this._bandMaterial);a.rotation.set(-.9,.5,1.2);let o=new G;o.add(t,r,i,a),o.position.y=.55,e.holder.add(o),e.wraith={core:t,inner:r,band:i,band2:a},e.height=2.2,e.midY=.8,e.radius=.48,e.ringRadius=.52,e.halo.position.y=1,e.halo.material.opacity=.75,e.halo.scale.setScalar(2.1);let s=new es(`#8fc6ef`,7,3.5,2);s.position.set(0,1,0),e.group.add(s)}_prepModel(e,t){e.updateMatrixWorld(!0);let n=new tr().setFromObject(e),r=n.getSize(new V),i=t/Math.max(r.y,.001);e.scale.setScalar(i);let a=new G;return a.add(e),e.position.x=-(n.min.x+r.x/2)*i,e.position.z=-(n.min.z+r.z/2)*i,e.position.y=-n.min.y*i,a}_ensureLoaded(){if(this._loaded||this._loading)return;this._loading=!0;let e=new ld,t=this.cells.filter(e=>e.def.kind===`glb`);Promise.all(t.map(t=>e.loadAsync(t.def.url).then(e=>({cell:t,gltf:e})))).then(e=>{for(let{cell:t,gltf:n}of e)this._attachModel(t,n.scene);this._loaded=!0}).catch(e=>console.error(`[bestiary] 敌人模型装载失败`,e))}_attachModel(e,t){let n=this._prepModel(t,e.def.height);e.model=n,e.holder.add(n),n.updateMatrixWorld(!0);let r=new tr().setFromObject(n).getSize(new V);e.midY=r.y/2,e.radius=Math.max(r.x,r.z)/2,e.ringRadius=Math.min(Math.max(e.radius*1.5,1.05),1.8),e.halo.position.y=e.midY;let i=new Y(new Va(zh,.05,8,42),new ci({color:e.accent,transparent:!0,opacity:.85}));i.rotation.x=Bh;let a=new ka(.1,.34,5);for(let e=0;e<3;e++){let t=new Y(a,this._bandMaterial),n=e/3*Math.PI*2;t.position.set(Math.cos(n)*zh,0,Math.sin(n)*zh),t.rotation.z=Math.PI,t.rotation.y=-n,i.add(t)}i.scale.setScalar(e.ringRadius/zh),i.position.y=e.midY,e.holder.add(i),e.ring=i,e.def.flame&&(e.flame=new Pm(e.group,90,this._glow,!1));let o=Math.min(8,this.renderer.capabilities.getMaxAnisotropy());n.traverse(e=>{if(e.isMesh&&e.material)for(let t of[`map`,`normalMap`,`roughnessMap`,`metallicMap`]){let n=e.material[t];n&&(n.anisotropy=o)}})}_layout(){let e=this.canvas.clientWidth,t=this.canvas.clientHeight;if(!e||!t)return;this.renderer.setSize(e,t,!1);let n=this.canvas.getBoundingClientRect(),r=Math.tan(Rh*Math.PI/360);for(let e of this.cells){if(!e.vpEl){e.rect=null;continue}let i=e.vpEl.getBoundingClientRect();if(i.width<8||i.height<8){e.rect=null;continue}e.rect={x:i.left-n.left,y:i.top-n.top,w:i.width,h:i.height},e.rectGL={x:e.rect.x,y:t-(i.bottom-n.top),w:i.width,h:i.height};let a=i.width/Math.max(i.height,1),o=e.height*1.42/(2*r),s=e.ringRadius*2*1.24/(2*r*a);e.dist=Math.max(o,s)}}resize(){this._layout()}show(){this._ensureLoaded(),this._layout(),!this.visible&&(this.visible=!0,this._lastT=performance.now(),this._raf=requestAnimationFrame(this._tick))}hide(){this.visible=!1,cancelAnimationFrame(this._raf)}_tick=e=>{if(!this.visible)return;this._raf=requestAnimationFrame(this._tick);let t=Math.min(.05,(e-this._lastT)/1e3);this._lastT=e,this.update(t),this.render()};update(e){this._elapsed+=e;let t=this._elapsed,n=performance.now();for(let r of this.cells){if(r.phase+=e,n-r.lastTouch>2200&&(r.yaw+=e*.38),r.holder.rotation.set(r.pitch,r.yaw,0),r.wraith){let n=r.wraith;n.core.rotation.y+=e*1.4,n.core.rotation.x+=e*.6,n.inner.rotation.y-=e*2.2,n.band.rotation.y-=e*.8,n.band.rotation.x=.9+Math.sin(t*1.3+r.phase)*.35,n.band2.rotation.y+=e*.6,n.band2.rotation.x=-.9-Math.sin(t*1.3+r.phase)*.35,r.halo.scale.setScalar(2+Math.sin(t*3.1+r.phase)*.22)}if(r.ring&&(r.ring.rotation.z+=e*1.5,r.ring.rotation.x=Bh+Math.sin(t*.9+r.phase)*.14,r.halo.scale.setScalar(3+Math.sin(t*2.6+r.phase)*.2)),r.flame){let n=Vh[r.def.flame],i=r.midY*2,a=Math.min(r.radius*.95,1.05);for(r.flameAcc+=e*n.rate;r.flameAcc>=1;){--r.flameAcc;let e=Math.random()*Math.PI*2,t=a*(.3+Math.random()*.6);Fm(r.flame,Math.cos(e)*t,.06+Math.random()*i*.6,Math.sin(e)*t,r.accent,{vy:n.vy[0]+Math.random()*n.vy[1],life:n.life[0]+Math.random()*n.life[1],maxLife:n.maxLife,size0:n.size0[0]+Math.random()*n.size0[1],size1:n.size1,alpha:n.alpha,sway:!0})}r.flame.update(e,t)}}}render(){let e=this.renderer.getPixelRatio(),t=1/(2*Math.tan(Rh*Math.PI/360));this.renderer.setScissorTest(!0);for(let n of this.cells){let r=n.rectGL;r&&(this.renderer.setViewport(r.x,r.y,r.w,r.h),this.renderer.setScissor(r.x,r.y,r.w,r.h),n.flame&&(n.flame.points.material.uniforms.uProjScale.value=r.h*e*t),this.camera.aspect=r.w/Math.max(r.h,1),this.camera.updateProjectionMatrix(),this.camera.position.set(n.group.position.x,n.midY+n.height*.12,n.dist),this.camera.lookAt(n.group.position.x,n.midY,0),this.renderer.render(this.scene,this.camera))}}_cellAt(e,t){let n=this.canvas.getBoundingClientRect(),r=e-n.left,i=t-n.top;return this.cells.find(e=>e.rect&&r>=e.rect.x&&r<=e.rect.x+e.rect.w&&i>=e.rect.y&&i<=e.rect.y+e.rect.h)??null}_bindPointer(){let e=this.canvas,t=e=>e.stopPropagation();for(let n of[`pointerdown`,`pointermove`,`pointerup`,`pointercancel`,`click`,`dblclick`,`wheel`])e.addEventListener(n,t);e.addEventListener(`contextmenu`,e=>{e.preventDefault(),e.stopPropagation()}),e.addEventListener(`pointerdown`,t=>{if(this._drag)return;let n=this._cellAt(t.clientX,t.clientY);if(n){this._drag={cell:n,id:t.pointerId,x:t.clientX,y:t.clientY},n.lastTouch=performance.now(),e.style.cursor=`grabbing`;try{e.setPointerCapture(t.pointerId)}catch{}t.preventDefault()}}),e.addEventListener(`pointermove`,t=>{let n=this._drag;if(!n||t.pointerId!==n.id){e.style.cursor=this._cellAt(t.clientX,t.clientY)?`grab`:`default`;return}let r=n.cell;r.yaw+=(t.clientX-n.x)*.0088,r.pitch=Math.max(-.55,Math.min(.7,r.pitch+(t.clientY-n.y)*.005)),n.x=t.clientX,n.y=t.clientY,r.lastTouch=performance.now()});let n=t=>{this._drag&&t.pointerId===this._drag.id&&(this._drag=null,e.style.cursor=`grab`)};e.addEventListener(`pointerup`,n),e.addEventListener(`pointercancel`,n)}dispose(){this.hide(),this.scene.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&e.material.dispose?.()});for(let e of this.cells)e.flame?.geometry.dispose();this._glow.dispose(),this._bandMaterial.dispose(),this.renderer.dispose()}},Uh={ice:5,fire:5,storm:5},Wh=6,Gh=9,Kh=25,qh=3,Jh={yaw:Math.PI*.25,pitch:.56,dist:9.5},Yh=26,Xh=class e{constructor(e){this.canvas=e,this.renderer=new Yu({canvas:e,antialias:!0,powerPreference:`high-performance`}),this._pxRatioCap=Math.min(window.devicePixelRatio,1.5),this._pxRatio=this._pxRatioCap,this.renderer.setPixelRatio(this._pxRatio),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.5,this.world=new fp,this.scene=this.world.scene,this.camera=new Xo(48,window.innerWidth/window.innerHeight,.1,1400),this.player=new qf(this.scene),this.goblet=new Eh(this.scene),this.torches=new jh(this.scene),this.player.obstacles=[{x:yh.x,z:yh.z,r:bh}],this.vfx=new om(this.scene,this.renderer),this.spells=new Sm(this.scene,this.vfx),this.spirits=new $m(this.scene,this.spells.bursts,this.vfx),this.edge=new ih(this.scene),this.groundFx=new ah(this.scene),this.flightTrail=new uh(this.scene),this.pillars=new vh(this.scene,e=>this._onPlayerHit(e),this.vfx),this.hud=new th,this.hud.setChrome(!1),this.portrait=new Fh(this.renderer),this.portrait.resize(window.innerWidth,window.innerHeight),this.bestiary=new Hh(document.getElementById(`bestiaryCanvas`)),this.hud.setShowcase(this.bestiary),this._parallax={x:0,y:0},this._parallaxCur={x:0,y:0},this._normalTarget=3,this._specialTarget=1,this.element=`ice`,this.cooldowns=new Map(ep.map(e=>[e,0])),this.score=0,this.hp=100,this.over=!1,this.elapsed=0,this._shake=0,this.keys=new Set,this.started=!1,this._invulnT=0,this._killStreak=0,this.stamina=100,this._exhausted=!1,this.paused=!1,this._worldRevertT=0,this._testMode=new URLSearchParams(location.search).get(`test`),this._testT=0,this._instanceId=Math.random().toString(36).slice(2,6),window.__game=this,window.audio=$;let t=document.getElementById(`startBtn`);t?.addEventListener(`click`,()=>this.begin()),t&&(t.disabled=!0,t.textContent=`场景装载中… 0%`),this.world.onArenaReady=e=>{t&&(t.disabled=!1,t.textContent=e?`开始游戏`:`场景加载失败 · 仍可开始`)},this.world.onArenaProgress=(e,n)=>{t&&(t.textContent=e==null?`场景装载中… ${n.toFixed(0)}MB`:`场景装载中… ${e}%`)},document.getElementById(`restartBtn`)?.addEventListener(`click`,()=>this.restart()),document.getElementById(`backToStartBtn`)?.addEventListener(`click`,()=>this.backToStart()),document.getElementById(`pauseBtn`)?.addEventListener(`click`,()=>{this.started&&!this.over&&this._setPaused(!this.paused)}),document.getElementById(`pauseScreen`)?.addEventListener(`click`,()=>{this.paused&&this._setPaused(!1)}),this.orbit={...Jh},this.pointer=new B(0,0),this._aimNDC=new B(0,-.1),this._locked=!1,this.raycaster=new ks,this.groundPlane=new Yi(new V(0,1,0),0),this.aimPoint=new V(0,0,-7),this._scratchF=new V,this._scratchR=new V,this._moveDir=new V,this._aimHit=new V,this._hurtColor=new K(`#ff4638`),this.reticle=new G;let n=new Y(new za(.34,.78,40),new ci({color:`#04070c`,transparent:!0,opacity:.6,depthWrite:!1,depthTest:!1})),r=new Y(new za(.42,.7,40),new ci({color:`#9fd8ff`,transparent:!0,opacity:1,depthWrite:!1,depthTest:!1})),i=new Y(new Da(.15,20),new ci({color:`#ffffff`,transparent:!0,opacity:.95,depthWrite:!1,depthTest:!1}));n.renderOrder=7,r.renderOrder=8,i.renderOrder=8,n.rotation.x=r.rotation.x=i.rotation.x=-Math.PI/2,this.reticle.add(n,r,i),this.reticle.position.y=.03,this._reticleRing=r,this.scene.add(this.reticle),this.rangeRingShadow=new Y(new za(25.2,25.68,96),new ci({color:`#04070c`,transparent:!0,opacity:0,depthWrite:!1,depthTest:!1})),this.rangeRingShadow.rotation.x=-Math.PI/2,this.rangeRingShadow.position.y=.045,this.rangeRingShadow.renderOrder=7,this.scene.add(this.rangeRingShadow),this.rangeRing=new Y(new za(25.45,Yh,96),new ci({color:`#9fd8ff`,transparent:!0,opacity:0,depthWrite:!1,depthTest:!1})),this.rangeRing.rotation.x=-Math.PI/2,this.rangeRing.position.y=.05,this.rangeRing.renderOrder=8,this.scene.add(this.rangeRing),this.aimLine=new Y(new Ra(1,.18).rotateX(-Math.PI/2),new ci({color:`#9fd8ff`,transparent:!0,opacity:0,depthWrite:!1,depthTest:!1,blending:2})),this.aimLine.renderOrder=7,this.scene.add(this.aimLine),this._aiming=!1,this._lastPointer=null,this._attacking=!1,this._basicT=0,this._orbPos=new V,this.basicRingShadow=new Y(new za(.3,.92,40),new ci({color:`#04070c`,transparent:!0,opacity:.55,depthWrite:!1,depthTest:!1})),this.basicRingShadow.rotation.x=-Math.PI/2,this.basicRingShadow.visible=!1,this.basicRingShadow.renderOrder=7,this.scene.add(this.basicRingShadow),this.basicRing=new Y(new za(.42,.8,40),new ci({color:`#9fd8ff`,transparent:!0,opacity:.9,depthWrite:!1,depthTest:!1})),this.basicRing.rotation.x=-Math.PI/2,this.basicRing.visible=!1,this.basicRing.renderOrder=8,this.scene.add(this.basicRing),this.spells.bursts.setPixelRatio(this._pxRatio),this.world.weather.setPixelRatio(this._pxRatio),this._bind(),this.hud.onSkill=e=>this._select(e),this.player.setElement(np[this.element].accent),this.hud.setActive(this.element),this.world.onShift=({theme:e})=>{this.hud.setWorld(e),$.setRealm(e.id),e.id!==`neutral`&&(this.hud.showToast(`世界已改写 → ${e.glyph} ${e.label}`),this.spirits.setAccent(e.accent),this._shake=Math.min(this._shake+.35,.6))},this.spirits.onPlayerHit=e=>this._onPlayerHit(e),this.spirits.onSpecialSpawn=e=>{let t=np[e];this.hud.showToast(`⚠ 特殊元素之灵出现 — 用「${t.label}」清除可得 30 分`,2600)}}_bind(){window.addEventListener(`resize`,()=>{this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.portrait.resize(window.innerWidth,window.innerHeight),this.bestiary.resize(),this._applyPixelRatio()}),window.addEventListener(`keydown`,e=>{if(!e.repeat){if(e.code===`Escape`&&this.started&&!this.over){this._setPaused(!this.paused);return}if(this.keys.add(e.code),!this.paused&&this.started&&!this.over)switch(e.code){case`KeyQ`:this._select(`ice`);break;case`KeyE`:this._select(`fire`);break;case`KeyR`:this._select(`storm`);break;case`KeyH`:this.hud.toggleHelp()}}}),window.addEventListener(`keyup`,e=>this.keys.delete(e.code)),window.addEventListener(`pointermove`,e=>{if(this._parallax.x=e.clientX/window.innerWidth*2-1,this._parallax.y=-(e.clientY/window.innerHeight*2-1),!this.started||this.over)return;let t=e.movementX??0,n=e.movementY??0;if(this._locked){this._aiming||this._attacking?(this._aimNDC.x=Math.max(-1,Math.min(1,this._aimNDC.x+t*.0026)),this._aimNDC.y=Math.max(-1,Math.min(1,this._aimNDC.y-n*.0026)),this.pointer.copy(this._aimNDC)):(this.orbit.yaw-=t*.0032,this.orbit.pitch=Math.max(.3,Math.min(1.25,this.orbit.pitch+n*.0026)));return}this.pointer.set(e.clientX/window.innerWidth*2-1,-(e.clientY/window.innerHeight)*2+1);let r=this._lastPointer,i=r?{dx:e.clientX-r.x,dy:e.clientY-r.y}:null;this._lastPointer={x:e.clientX,y:e.clientY},i&&!this._aiming&&(e.target?.closest?.(`.skill, .panel`)||(this.orbit.yaw-=i.dx*.0038,this.orbit.pitch=Math.max(.3,Math.min(1.25,this.orbit.pitch+i.dy*.0028))))}),this.canvas.addEventListener(`pointerdown`,e=>{!this.started||this.over||this.paused||($.ensure(),e.button===2?(this._aiming=!0,this._resetAimToPlayer(),this._updateAim()):e.button===0&&(this._locked?(this._attacking=!0,this._resetAimToPlayer(),this._updateAim(),this._basicT=0):this._requestLock()))}),window.addEventListener(`pointerup`,e=>{e.button===2&&this._aiming?(this._aiming=!1,this._updateAim(),this._castCurrent()):e.button===0&&(this._attacking=!1)}),window.addEventListener(`contextmenu`,e=>e.preventDefault()),document.addEventListener(`pointerlockchange`,()=>{this._locked=document.pointerLockElement===this.canvas,this._locked?(this._aimNDC.copy(this.pointer),clearTimeout(this._lockRetryTimer),this._lockRetries=0):this._aiming&&=!1,!this._locked&&this.started&&!this.over&&!this.paused?this._setPaused(!0):this.hud.setLockHint(!this._locked&&!this.paused&&this.started&&!this.over)}),document.addEventListener(`pointerlockerror`,()=>{}),window.addEventListener(`wheel`,e=>{this.orbit.dist=Math.max(6.5,Math.min(24,this.orbit.dist+e.deltaY*.012))},{passive:!0})}_setPaused(e){this.paused!==e&&(this.paused=e,e?($.pause(),this._attacking=!1,this._aiming=!1,this.keys.clear(),this.hud.showPause(),this.hud.setLockHint(!1),this.hud.setEdgeHint(!1),document.pointerLockElement&&document.exitPointerLock()):($.unpause(),this.hud.hidePause(),this._ensureLock()))}_ensureLock(){this._locked||this.paused||!this.started||this.over||(this._requestLock(),this._lockRetries=(this._lockRetries??0)+1,clearTimeout(this._lockRetryTimer),this._lockRetries<=12&&(this._lockRetryTimer=setTimeout(()=>this._ensureLock(),350)))}begin(){this.started||($.ensure(),$.click(),$.startMusic(),this.started=!0,this.paused=!1,this.hud.setChrome(!0),this.portrait.leave(),this.player.respawn(),this.hud.hidePause(),this.hud.hideStartScreen(),this.hud.setLockHint(!1),this._requestLock(),this.spirits.begin(this.player.position,3),this._updateSpiritTargets(),this.hud.showToast(`冒险开始 — 元素之灵已出现`,2200))}_onPlayerHit(e){this.over||this._invulnT>0||($.hurt(),$.shield(),this.hp=Math.max(0,this.hp-e),this.hud.setHealth(this.hp),this.hud.hurtFlash(),this._shake=Math.min(this._shake+.35,.7),this._killStreak>0&&(this._killStreak=0,this.hud.setStreak(0),this.hud.showToast(`连杀中断`,1200)),this._hitLog=this._hitLog||[],this._hitLog.push(`t${this._testT?.toFixed(1)??`-`} 伤${e} 血${this.hp}% 连杀→${this._killStreak}`),this.hp<=0&&this._gameOver(),this._invulnT=1.5)}_heal(e,t){this.over||this.hp>=100||(this.hp=Math.min(100,this.hp+e),this.hud.setHealth(this.hp),$.heal(),this.hud.showToast(`${t} — 生命 +${e}%`,1500))}_countKills(e,t){e<=0||(this._killStreak+=e,this.hud.setStreak(this._killStreak),this._killStreak>=9&&t&&(this._killStreak=0,this.hud.setStreak(0),this._heal(20,`连杀 ×9`)))}_gameOver(){this.over||(this.over=!0,this._attacking=!1,this._aiming=!1,this.keys.clear(),$.death(),$.stopMusic(2.5),this.spirits.setFrozen(!0),document.pointerLockElement&&document.exitPointerLock(),this.hud.setLockHint(!1),this.hud.showGameOver(this.score,this.tier))}restart(){this.over=!1,this.paused=!1,this.player.respawn(),this.orbit={...Jh},this.hud.hidePause(),this.hud.setEdgeHint(!1),this._edgeWasPushing=!1,this.hp=100,this.stamina=100,this._exhausted=!1,this.score=0,this._shake=0,this._killStreak=0,this._attacking=!1,this._aiming=!1,this._aimNDC.set(0,-.1),this.pointer.copy(this._aimNDC);for(let[e]of this.cooldowns)this.cooldowns.set(e,0);this.spells.reset(),this.spirits.setFrozen(!1),this.spirits.respawnAll(this.player.position,3),$.startMusic(),this.hud.setScore(0),this.hud.setHealth(100),this.hud.setLevel(1),this._updateSpiritTargets(),this.hud.hideGameOver(),this.hud.showToast(`新的冒险开始 — 元素之灵已出现`,2e3),this._ensureLock()}backToStart(){this.started&&$.clickBack(),$.startMusic(),this.over=!1,this.started=!1,document.pointerLockElement&&document.exitPointerLock(),this.paused=!1,this.hud.hidePause(),this.hud.setEdgeHint(!1),this._edgeWasPushing=!1,this.hp=100,this.stamina=100,this._exhausted=!1,this.score=0,this._shake=0,this._killStreak=0,this._attacking=!1,this._aiming=!1,this.element=`ice`,this.player.setElement(np.ice.accent),this._aimNDC.set(0,-.1),this.pointer.copy(this._aimNDC);for(let[e]of this.cooldowns)this.cooldowns.set(e,0);this.spells.reset(),this.spirits.setFrozen(!1),this.spirits.reset(),this.hud.setChrome(!1),this.portrait.show(),this._parallax.x=this._parallax.y=0,this.world.shift(`neutral`,this.player.position),this.hud.setScore(0),this.hud.setHealth(100),this.hud.setLevel(1),this.hud.hideGameOver(),this.hud.setActive(`ice`),this.hud.setLockHint(!1),this.hud.showStartScreen()}static TIERS=[{normal:3,special:1},{normal:4,special:2},{normal:5,special:2},{normal:6,special:3},{normal:7,special:3},{normal:8,special:4},{normal:9,special:4},{normal:10,special:5},{normal:11,special:5},{normal:12,special:6}];get tier(){return Math.min(Math.floor(this.score/100)+1,e.TIERS.length)}_updateSpiritTargets(){this._tierMem===void 0&&(this._tierMem=this.tier),this.tier>this._tierMem&&$.levelUp(),this._tierMem<3&&this.tier>=3&&this.hud.showToast(`⚠ 天空开始降下元素光柱 — 远离地面光圈！`,3200),this._tierMem=this.tier;let t=e.TIERS[this.tier-1];this.spirits.setNormalTarget(t.normal),this.spirits.setSpecialTarget(t.special),this.hud.setLevel(this.tier)}_resetAimToPlayer(){this._aimNDC.set(0,-.1),this.pointer.copy(this._aimNDC)}_requestLock(){try{let e=this.canvas.requestPointerLock();e&&e.catch&&e.catch(()=>{})}catch{}}_updateAim(){this.raycaster.setFromCamera(this.pointer,this.camera);let e=this._aimHit;if(this.raycaster.ray.intersectPlane(this.groundPlane,e)){let t=this.player.position,n=e.x-t.x,r=e.z-t.z,i=Math.hypot(n,r);i>Yh?(e.x=t.x+n/i*Yh,e.z=t.z+r/i*Yh):i<qh&&i>.001&&(e.x=t.x+n/i*qh,e.z=t.z+r/i*qh),this.aimPoint.copy(e)}}_select(e){if(!ep.includes(e))return;e!==this.element&&(this.element=e,$.switch(),this.player.setElement(np[e].accent),this.hud.setActive(e),this.hud.showToast(`已选择 ${np[e].label} — 按住右键瞄准，松开释放`));let t=np[this.element].accent;this._reticleRing.material.color.set(t),this.rangeRing.material.color.set(t),this.aimLine.material.color.set(t)}_castCurrent(){let e=this.element;if((this.cooldowns.get(e)??0)>0){this.hud.showToast(`技能冷却中`);return}this.player.playCast(),this.spells.cast(e,this.player.position,this.aimPoint.clone(),(t,n)=>this._onImpact(e,t,n)),this.cooldowns.set(e,Uh[e]),this._reticleRing.material.color.set(np[e].accent)}_onImpact(e,t,n){let r=np[e].accent;this.world.shift(rp[e],t),this._worldRevertT=6,this.groundFx.burst(t,r),this.hud.castFlash(r),$.impact(e);let i=this.spirits.collectAt(t,n,e,this.world.current);i.special>0&&$.specialKill();let a=i.normal*10+i.special*30;a>0&&(this.score+=a,this.hud.setScore(this.score)),i.immune>0&&this.hud.showToast(`属性不符 — 特殊之灵需要对应元素的技能`,1500),this._countKills(i.normal,!1),this._updateSpiritTargets(),this._shake=Math.min(this._shake+.3,.7)}_basicPathHit(e,t){let n=this.spirits.collectAt(e,1,`basic`,this.world.current,t);n.specialHit>0?$.specialHit():n.immune>0&&$.deflect(),n.normal>0&&($.hit(),this.score+=n.normal*10,this.hud.setScore(this.score)),n.special>0&&($.specialKill(),this.score+=n.special*30,this.hud.setScore(this.score),this._updateSpiritTargets(),this._heal(10*n.special,`普攻净化特殊之灵`)),this._countKills(n.normal,!0)}_basicImpact(e,t=1.6,n){let r=this.spirits.collectAt(e,t,`basic`,this.world.current,n);r.specialHit>0?$.specialHit():r.immune>0&&$.deflect(),r.normal>0&&($.hit(),this.score+=r.normal*10,this.hud.setScore(this.score)),r.special>0&&($.specialKill(),this.score+=r.special*30,this.hud.setScore(this.score),this._updateSpiritTargets(),this._heal(10*r.special,`普攻净化特殊之灵`)),this._countKills(r.normal,!0)}_emitFlightTrail(e){this._trailT=(this._trailT??0)-e,!(this._trailT>0)&&(this._trailT=.05,this._trailPos??=new V,this._trailPos.set(this.player.position.x+(Math.random()-.5)*.5,.35,this.player.position.z+(Math.random()-.5)*.5),this.spells.bursts.emit({pos:this._trailPos,count:3,speed:[.4,1.6],up:[.2,1.2],life:[.25,.55],size:[9,22],colorA:`#ffffff`,colorB:np[this.element].accent,gravity:1.5,drag:2.2,spread:.4}))}_updateCamera(e){let{yaw:t,pitch:n,dist:r}=this.orbit,i=this.started?0:this._parallaxCur.x*.1,a=this.started?0:this._parallaxCur.y*.05,o=t+i,s=Math.max(.2,n+a),c=this._cameraTarget??=new V;c.set(this.player.position.x+Math.sin(o)*Math.cos(s)*r,Math.sin(s)*r+1.4,this.player.position.z+Math.cos(o)*Math.cos(s)*r),this._shake>.001&&(this._shake*=Math.max(0,1-e*5.5),c.x+=(Math.random()-.5)*this._shake,c.y+=(Math.random()-.5)*this._shake,c.z+=(Math.random()-.5)*this._shake),this.camera.position.lerp(c,Math.min(1,e*9)),this.camera.lookAt(this.player.position.x,1.35,this.player.position.z)}_runStreakTest(e){if(this._testMode!==`streakbreak`||!this.started||this.over)return;this._testT+=e;let t=document.getElementById(`testOut`);if(!t)return;let n=e=>`${e}[实例${this._instanceId} t${this._testT.toFixed(1)} 血${this.hp} 连杀${this._killStreak} 无敌${this._invulnT.toFixed(1)} over${+!!this.over}]`;this._testT>=1&&this._testT-e<1?(this._killStreak=5,this.hud.setStreak(5),t.textContent=n(`注入连杀5`)):this._testT>=4&&this._testT-e<4?(t.textContent+=` ‖ `+n(`受击前`),this._onPlayerHit(25),t.textContent+=` ‖ `+n(`受击后`)):this._testT>=5&&this._testT-e<5&&(t.textContent+=` ‖ `+n(this._killStreak===0?`✅清零正常`:`❌未清零`)+`｜受击日志:${(this._hitLog||[`无`]).join(`;`)}`)}_applyPixelRatio(){this.renderer.setPixelRatio(this._pxRatio),this.renderer.setSize(window.innerWidth,window.innerHeight,!1),this.spells.bursts.setPixelRatio(this._pxRatio),this.world.weather.setPixelRatio(this._pxRatio),this.goblet?.setPixelRatio(this._pxRatio),this.torches?.setPixelRatio(this._pxRatio),this.spirits.setPixelRatio?.(this._pxRatio)}frame(e){if(this.elapsed+=e,this._runStreakTest(e),this._fpsFrames=(this._fpsFrames??0)+1,this._fpsTime=(this._fpsTime??0)+e,this._fpsTime>=.5&&(this._recentFps=Math.round(this._fpsFrames/this._fpsTime),this.hud.setFps(this._recentFps),this._fpsFrames=0,this._fpsTime=0),this._resT=(this._resT??0)+e,this._resT>=1.5){this._resT=0;let e=this._recentFps??0;e>=40&&e<93&&this._pxRatio>.7?(this._pxRatio=Math.max(.7,this._pxRatio-.15),this._applyPixelRatio()):e>101&&this._pxRatio<this._pxRatioCap&&(this._pxRatio=Math.min(this._pxRatioCap,this._pxRatio+.1),this._applyPixelRatio())}if(this.paused){this.renderer.render(this.scene,this.camera);return}let t=this._moveDir.set(0,0,0),n=this._scratchF.set(-Math.sin(this.orbit.yaw),0,-Math.cos(this.orbit.yaw)),r=this._scratchR.set(Math.cos(this.orbit.yaw),0,-Math.sin(this.orbit.yaw));(this.keys.has(`KeyW`)||this.keys.has(`ArrowUp`))&&t.add(n),(this.keys.has(`KeyS`)||this.keys.has(`ArrowDown`))&&t.sub(n),(this.keys.has(`KeyD`)||this.keys.has(`ArrowRight`))&&t.add(r),(this.keys.has(`KeyA`)||this.keys.has(`ArrowLeft`))&&t.sub(r),t.lengthSq()>0&&t.normalize();let i=(this.keys.has(`ShiftLeft`)||this.keys.has(`ShiftRight`))&&!this._exhausted&&!this._attacking&&!this._aiming&&!this.over;i?(this.stamina=Math.max(0,this.stamina-e/Wh*100),this.stamina<=0&&(this._exhausted||$.staminaOut(),this._exhausted=!0)):this.stamina<100&&(this.stamina=Math.min(100,this.stamina+e/Gh*100),this._exhausted&&this.stamina>=Kh&&(this._exhausted=!1)),this.hud.setStamina(this.stamina,this._exhausted),i&&t.lengthSq()>0&&this._emitFlightTrail(e),this.over&&t.set(0,0,0),this._invulnT=Math.max(0,this._invulnT-e),this._updateAim(),this.started||(this.orbit.yaw+=e*.06),this.player.update(e,t.lengthSq()>0?t:null,this.aimPoint,this.elapsed,i,this._aiming||this._attacking),this.player.updateShield(this.elapsed,this._invulnT,e),this.flightTrail.update(e,i?this.player.root.position:null,np[this.element].accent),this._updateCamera(e),this.edge.update(e,this.elapsed,this.player,this.world.currentAccent,this.world.liveFogFar);let a=this.player.edgePush>.3;this.hud.setEdgeHint(a),a&&(this._edgeWasPushing||(this._shake=Math.min(this._shake+.12,.7),this.elapsed-(this._edgeToastT??-99)>6&&(this._edgeToastT=this.elapsed,this.hud.showToast(`已抵达场地边缘 — 无法再往外走了`,1500))),this._edgeSparkT=(this._edgeSparkT??0)-e,this._edgeSparkT<=0&&(this._edgeSparkT=.16,this.edge.flash(Math.min(1,this.player.edgePush)),this.spells.bursts.emit({pos:this.player.edgePoint,count:5,speed:[1.2,3.4],up:[.6,2.4],life:[.3,.6],size:[7,15],colorA:`#ffffff`,colorB:this.world.currentAccent,gravity:4.5,drag:2.6,spread:.5}))),this._edgeWasPushing=a;let o=this._aiming;o&&this.elapsed-(this._aimTickT??0)>.45&&(this._aimTickT=this.elapsed,$.aimPulse());let s=np[this.element].accent;this.reticle.visible=o,this.reticle.position.set(this.aimPoint.x,.03+Math.sin(this.elapsed*4)*.012,this.aimPoint.z),this.reticle.rotation.y=this.elapsed*.8,this.reticle.scale.setScalar(o?1+Math.sin(this.elapsed*10)*.08:1),this._reticleRing.material.color.set(s);let c=Math.min(1,e*10);this.rangeRing.position.set(this.player.position.x,.05,this.player.position.z),this.rangeRingShadow.position.set(this.player.position.x,.045,this.player.position.z),this.rangeRing.material.opacity+=((o?.6:0)-this.rangeRing.material.opacity)*c,this.rangeRingShadow.material.opacity+=((o?.5:0)-this.rangeRingShadow.material.opacity)*c,this.aimLine.material.opacity=this.aimLine.material.opacity+((o?.9:0)-this.aimLine.material.opacity)*c;let l=this.aimPoint.x-this.player.position.x,u=this.aimPoint.z-this.player.position.z,d=Math.max(Math.hypot(l,u),.001);if(this.aimLine.position.set(this.player.position.x+l/2,.1,this.player.position.z+u/2),this.aimLine.rotation.y=-Math.atan2(u,l),this.aimLine.scale.set(d,1,1),this._attacking){if(this._basicT-=e,this._basicT<=0){this._basicT=.32;let e=np[this.element].accent;$.shoot(),this.player.playCast(),this.player.getOrbWorldPosition(this._orbPos),this.spells.castBasic(this._orbPos,this.aimPoint.clone(),e,(e,t)=>this._basicPathHit(e,t),(e,t,n)=>this._basicImpact(e,t,n))}this.basicRing.visible=!0,this.basicRingShadow.visible=!0,this.basicRing.position.set(this.aimPoint.x,.05,this.aimPoint.z),this.basicRingShadow.position.set(this.aimPoint.x,.045,this.aimPoint.z),this.basicRing.material.color.set(s),this.basicRing.material.opacity=.85+Math.sin(this.elapsed*10)*.15,this.basicRing.scale.setScalar(1+Math.sin(this.elapsed*10)*.08)}else this.basicRing.visible=!1,this.basicRingShadow.visible=!1;this.spells.update(e),this.spirits.update(e,this.elapsed,this.player.position),this.spirits.laserTier=this.tier,this.world.update(e,this.elapsed,this.player.position,this.hud.vignette);let f=this.world.current===`neutral`?tp:this.world.currentAccent;this.goblet.update(e,this.elapsed,f),this.torches.update(e,this.elapsed,f),this.groundFx.update(e,this.world.currentAccent,this.world.current!==`neutral`),this.pillars.setTier(this.tier),this.pillars.setAccent(this.world.currentAccent),this.pillars.update(e,this.elapsed,this.player.position),this.vfx.update(e,this.camera,this.renderer),this.started&&!this.over&&this._worldRevertT>0&&(this._worldRevertT-=e,this._worldRevertT<=0&&this.world.current!==`neutral`&&(this.world.shift(`neutral`,this.player.position),this.hud.showToast(`元素之力消散 — 世界恢复荒原`,1800)));for(let t of ep){let n=this.cooldowns.get(t)??0;if(n>0){let r=Math.max(0,n-e);this.cooldowns.set(t,r),r===0&&$.cdReady()}this.hud.setCooldown(t,this.cooldowns.get(t)??0,Uh[t])}if(!this.started&&this.portrait.active){let t=Math.min(1,e*5);this._parallaxCur.x+=(this._parallax.x-this._parallaxCur.x)*t,this._parallaxCur.y+=(this._parallax.y-this._parallaxCur.y)*t,this.portrait.setParallax(this._parallaxCur.x,this._parallaxCur.y),this.portrait.update(e,this.elapsed),this.portrait.render(this.renderer);return}this.renderer.render(this.scene,this.camera);let p=Math.min(1,e*5);this._parallaxCur.x+=(this._parallax.x-this._parallaxCur.x)*p,this._parallaxCur.y+=(this._parallax.y-this._parallaxCur.y)*p,this.portrait.setParallax(this._parallaxCur.x,this._parallaxCur.y),this.portrait.update(e,this.elapsed),this.portrait.render(this.renderer)}dispose(){this.player.dispose(),this.goblet?.dispose(),this.torches?.dispose(),this.bestiary?.dispose(),this.spells.dispose(),this.spirits.dispose(),this.edge.dispose(),this.groundFx.dispose(),this.flightTrail.dispose(),this.pillars.dispose(),this.vfx.dispose(),this.world.dispose(),this.renderer.dispose()}},Zh=document.getElementById(`app`);function Qh(){$.loadBank();try{let e=new Xh(Zh);window.game=e;let t=performance.now(),n=r=>{requestAnimationFrame(n);let i=Math.min(.05,(r-t)/1e3);t=r;try{e.frame(i)}catch(e){let t=document.getElementById(`dbg`);t&&(t.style.color=`#ff8a7a`,t.textContent=`ERR `+(e?.message??e)+` @ `+String(e?.stack??``).split(`
`)[1]),console.error(`[frame]`,e)}};requestAnimationFrame(n)}catch(e){console.error(`[boot] 启动失败`,e),document.body.insertAdjacentHTML(`beforeend`,`<div style="position:fixed;inset:0;display:grid;place-items:center;background:#06090f;color:#ff9a8a;font-size:14px;z-index:99">
       ...
       </div>`)}}Qh(),location.hostname.includes(`github.io`)&&`serviceWorker`in navigator&&navigator.serviceWorker.register(`sw.js`).catch(()=>{});